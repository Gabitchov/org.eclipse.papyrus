...
/**
 * Query to assign values to the "from" attribute of a comment with an Assign stereotype.
 * @author omelois
 *
 */
public class SetFromQuery extends AbstractSetAttributeQuery<Comment> {
	...
	protected EReference getNeededStructuralFeature() {
		return AllocPackage.Literals.ASSIGN__FROM;
	}
