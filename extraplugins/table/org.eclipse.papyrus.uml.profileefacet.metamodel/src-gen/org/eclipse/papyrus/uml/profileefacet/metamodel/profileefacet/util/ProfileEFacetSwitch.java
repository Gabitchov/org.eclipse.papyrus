 ...
 * @generated
 */
public class ProfileEFacetSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ProfileEFacetPackage.PROFILE_FACET_SET: {
			...
			case ProfileEFacetPackage.STEREOTYPE_FACET: {
			...
			case ProfileEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT: {
			...
			case ProfileEFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE: {
			...
			case ProfileEFacetPackage.STEREOTYPE_PROPERTY_FACET_ATTRIBUTE: {
			...
			case ProfileEFacetPackage.EOBJECT_FACET_REPRESENTATION: {
				...
				if (result == null) result = caseEModelElement(eObjectFacetRepresentation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
