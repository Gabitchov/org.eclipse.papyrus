 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.uml.profileefacet.metamodel.profileefacet.impl.StereotypePropertyFacetReferenceImpl#getRepresented_element_xmi_id <em>Represented element xmi id</em>}</li>
...
public class StereotypePropertyFacetReferenceImpl extends FacetReferenceImpl implements StereotypePropertyFacetReference {
	...
	public void setRepresented_element_xmi_id(String newRepresented_element_xmi_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProfileEFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE__REPRESENTED_ELEMENT_XMI_ID, oldRepresented_element_xmi_id, represented_element_xmi_id));
	}
