 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.uml.profileefacet.metamodel.profileefacet.impl.StereotypePropertyElementImpl#getRepresented_element_xmi_id <em>Represented element xmi id</em>}</li>
...
public abstract class StereotypePropertyElementImpl extends FacetElementImpl implements StereotypePropertyElement {
	...
	protected EClass eStaticClass() {
		return ProfileEFacetPackage.Literals.STEREOTYPE_PROPERTY_ELEMENT;
	}
	...
	public void setRepresented_element_xmi_id(String newRepresented_element_xmi_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProfileEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__REPRESENTED_ELEMENT_XMI_ID, oldRepresented_element_xmi_id, represented_element_xmi_id));
	}
	...
	public void setIsDerived(boolean newIsDerived) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProfileEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__IS_DERIVED, oldIsDerived, isDerived));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EObjectFacetRepresentation.class) {
			switch (derivedFeatureID) {
				case ProfileEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__REPRESENTED_ELEMENT_XMI_ID: return ProfileEFacetPackage.EOBJECT_FACET_REPRESENTATION__REPRESENTED_ELEMENT_XMI_ID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EObjectFacetRepresentation.class) {
			switch (baseFeatureID) {
				case ProfileEFacetPackage.EOBJECT_FACET_REPRESENTATION__REPRESENTED_ELEMENT_XMI_ID: return ProfileEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__REPRESENTED_ELEMENT_XMI_ID;
				default: return -1;
			}
		}
