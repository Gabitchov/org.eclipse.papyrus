...
public abstract class StereotypePropertyElementImpl extends FacetElementImpl implements StereotypePropertyElement {
	...
	public void setRepresentedElement_XMI_ID(String newRepresentedElement_XMI_ID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProfileEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__REPRESENTED_ELEMENT_XMI_ID, oldRepresentedElement_XMI_ID, representedElement_XMI_ID));
	}
