 ...
 * @generated
 */
public class UmlEFacetSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UmlEFacetPackage.PROFILE_FACET_SET: {
			...
			case UmlEFacetPackage.STEREOTYPE_PROPERTY_ELEMENT: {
				...
				if (result == null) result = caseFacetElement(stereotypePropertyElement);
				if (result == null) result = caseETypedElement(stereotypePropertyElement);
				if (result == null) result = caseDocumentedElement(stereotypePropertyElement);
				if (result == null) result = caseENamedElement(stereotypePropertyElement);
				if (result == null) result = caseEModelElement(stereotypePropertyElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UmlEFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE: {
				...
				if (result == null) result = caseDerivedTypedElement(stereotypePropertyFacetReference);
				if (result == null) result = caseEStructuralFeature(stereotypePropertyFacetReference);
				if (result == null) result = caseFacetElement(stereotypePropertyFacetReference);
				if (result == null) result = caseETypedElement(stereotypePropertyFacetReference);
				if (result == null) result = caseDocumentedElement(stereotypePropertyFacetReference);
			...
			case UmlEFacetPackage.STEREOTYPE_PROPERTY_FACET_ATTRIBUTE: {
				...
				if (result == null) result = caseDerivedTypedElement(stereotypePropertyFacetAttribute);
				if (result == null) result = caseEStructuralFeature(stereotypePropertyFacetAttribute);
				if (result == null) result = caseFacetElement(stereotypePropertyFacetAttribute);
				if (result == null) result = caseETypedElement(stereotypePropertyFacetAttribute);
				if (result == null) result = caseDocumentedElement(stereotypePropertyFacetAttribute);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Profile Facet Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Profile Facet Set</em>'.
