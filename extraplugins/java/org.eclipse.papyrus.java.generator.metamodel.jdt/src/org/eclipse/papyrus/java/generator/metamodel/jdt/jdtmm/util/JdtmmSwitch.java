	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case JdtmmPackage.JDT_METHOD: {
				...
				if (result == null) result = caseJDTMember(jdtMethod);
				if (result == null) result = caseJDTParentJavaElement(jdtMethod);
				if (result == null) result = caseJDTJavaElement(jdtMethod);
				if (result == null) result = caseJDTParent(jdtMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_MEMBER: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtMember);
				if (result == null) result = caseJDTJavaElement(jdtMember);
				if (result == null) result = caseJDTParent(jdtMember);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_PARENT_JAVA_ELEMENT: {
				...
				if (result == null) result = caseJDTJavaElement(jdtParentJavaElement);
				if (result == null) result = caseJDTParent(jdtParentJavaElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JdtmmPackage.JDT_TYPE_PARAMETER: {
				...
				if (result == null) result = caseJDTJavaElement(jdtTypeParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_TYPE: {
				...
				if (result == null) result = caseJDTMember(jdtType);
				if (result == null) result = caseJDTParentJavaElement(jdtType);
				if (result == null) result = caseJDTJavaElement(jdtType);
				if (result == null) result = caseJDTParent(jdtType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_FIELD: {
				...
				if (result == null) result = caseJDTMember(jdtField);
				if (result == null) result = caseJDTParentJavaElement(jdtField);
				if (result == null) result = caseJDTJavaElement(jdtField);
				if (result == null) result = caseJDTParent(jdtField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_COMPILATION_UNIT: {
				...
				if (result == null) result = caseJDTTypeRoot(jdtCompilationUnit);
				if (result == null) result = caseJDTParentJavaElement(jdtCompilationUnit);
				if (result == null) result = caseJDTJavaElement(jdtCompilationUnit);
				if (result == null) result = caseJDTParent(jdtCompilationUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_TYPE_ROOT: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtTypeRoot);
				if (result == null) result = caseJDTJavaElement(jdtTypeRoot);
				if (result == null) result = caseJDTParent(jdtTypeRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_PACKAGE_FRAGMENT: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtPackageFragment);
				if (result == null) result = caseJDTJavaElement(jdtPackageFragment);
				if (result == null) result = caseJDTParent(jdtPackageFragment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_PACKAGE_FRAGMENT_ROOT: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtPackageFragmentRoot);
				if (result == null) result = caseJDTJavaElement(jdtPackageFragmentRoot);
				if (result == null) result = caseJDTParent(jdtPackageFragmentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_JAVA_PROJECT: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtJavaProject);
				if (result == null) result = caseJDTJavaElement(jdtJavaProject);
				if (result == null) result = caseJDTParent(jdtJavaProject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_JAVA_MODEL: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtJavaModel);
				if (result == null) result = caseJDTJavaElement(jdtJavaModel);
				if (result == null) result = caseJDTParent(jdtJavaModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_PARAMETER: {
				...
				if (result == null) result = caseJDTMember(jdtParameter);
				if (result == null) result = caseJDTParentJavaElement(jdtParameter);
				if (result == null) result = caseJDTJavaElement(jdtParameter);
				if (result == null) result = caseJDTParent(jdtParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_CLASS: {
				...
				if (result == null) result = caseJDTType(jdtClass);
				if (result == null) result = caseJDTMember(jdtClass);
				if (result == null) result = caseJDTParentJavaElement(jdtClass);
				if (result == null) result = caseJDTJavaElement(jdtClass);
				if (result == null) result = caseJDTParent(jdtClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_INTERFACE: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtInterface);
				if (result == null) result = caseJDTJavaElement(jdtInterface);
				if (result == null) result = caseJDTParent(jdtInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_ENUM: {
				...
				if (result == null) result = caseJDTType(jdtEnum);
				if (result == null) result = caseJDTMember(jdtEnum);
				if (result == null) result = caseJDTParentJavaElement(jdtEnum);
				if (result == null) result = caseJDTJavaElement(jdtEnum);
				if (result == null) result = caseJDTParent(jdtEnum);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_IMPORT_DECLARATION: {
				...
				if (result == null) result = caseJDTJavaElement(jdtImportDeclaration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JdtmmPackage.JDT_IMPORT_CONTAINER: {
				...
				if (result == null) result = caseJDTParentJavaElement(jdtImportContainer);
				if (result == null) result = caseJDTJavaElement(jdtImportContainer);
				if (result == null) result = caseJDTParent(jdtImportContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JdtmmPackage.JDT_OPAQUE_BODY: {
				...
				if (result == null) result = caseJDTMethodBody(jdtOpaqueBody);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
