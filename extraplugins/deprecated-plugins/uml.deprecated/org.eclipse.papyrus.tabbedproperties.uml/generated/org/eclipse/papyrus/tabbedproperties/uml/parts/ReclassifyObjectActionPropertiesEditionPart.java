...
public interface ReclassifyObjectActionPropertiesEditionPart {
	...
	/**
	 * @return the oldClassifier to add
	 */
	public List getOldClassifierToAdd();

	/**
	 * @return the oldClassifier to remove
	 */
	public List getOldClassifierToRemove();

	/**
	 * @return the current oldClassifier table
	 */
	...
	/**
	 * @return the newClassifier to add
	 */
	public List getNewClassifierToAdd();

	/**
	 * @return the newClassifier to remove
	 */
	public List getNewClassifierToRemove();

	/**
	 * @return the current newClassifier table
	 */
