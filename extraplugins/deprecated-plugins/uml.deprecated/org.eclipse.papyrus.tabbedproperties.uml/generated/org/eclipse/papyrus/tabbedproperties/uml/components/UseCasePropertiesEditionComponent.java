...
public class UseCasePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The UseCaseBasePropertiesEditionComponent sub component
	 */
	protected UseCaseBasePropertiesEditionComponent useCaseBasePropertiesEditionComponent;
	...
	public UseCasePropertiesEditionComponent(EObject useCase, String editing_mode) {
		...
		if(useCase instanceof UseCase) {
			useCaseBasePropertiesEditionComponent = new UseCaseBasePropertiesEditionComponent(useCase, editing_mode);
			addSubComponent(useCaseBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(useCase, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (UseCasePropertiesEditionPart)useCaseBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.UseCase.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (UseCasePropertiesEditionPart)propertiesEditionPart;
		}
	}
