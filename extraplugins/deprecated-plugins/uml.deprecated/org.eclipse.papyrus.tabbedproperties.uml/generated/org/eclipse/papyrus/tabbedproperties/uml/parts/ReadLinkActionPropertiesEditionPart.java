...
public interface ReadLinkActionPropertiesEditionPart {
	...
	/**
	 * @return the endData to add
	 */
	public List getEndDataToAdd();

	/**
	 * @return the endData to remove
	 */
	public List getEndDataToRemove();

	/**
	 * @return the endData to move
	 */
	public List getEndDataToMove();

	/**
	 * @return the endData to edit
	 */
	public Map getEndDataToEdit();

	/**
	 * @return the current endData table
	 */
	 ...
	 * 
	 * @param newValue
	 *        the endData to update
	 */
	public void updateEndData(EObject newValue);

	/**
	 * Adds the given filter to the endData edition editor.
	 * 
	 * @param filter
	 *        a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the endData table
	 */
	...
	/**
	 * @return the inputValue to remove
	 */
	public List getInputValueToRemove();

	/**
	 * @return the inputValue to move
	 */
	public List getInputValueToMove();

	/**
	 * @return the inputValue to edit
	 */
	...
	/**
	 * Adds the given filter to the inputValue edition editor.
	 * 
	 * @param filter
	 *        a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
