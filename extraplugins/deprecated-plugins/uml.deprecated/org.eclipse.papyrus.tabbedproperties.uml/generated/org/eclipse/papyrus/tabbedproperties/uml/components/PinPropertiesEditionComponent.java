...
public class PinPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The PinBasePropertiesEditionComponent sub component
	 */
	protected PinBasePropertiesEditionComponent pinBasePropertiesEditionComponent;
	...
	public PinPropertiesEditionComponent(EObject pin, String editing_mode) {
		...
		if(pin instanceof Pin) {
			pinBasePropertiesEditionComponent = new PinBasePropertiesEditionComponent(pin, editing_mode);
			addSubComponent(pinBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(pin, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (PinPropertiesEditionPart)pinBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.Pin.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (PinPropertiesEditionPart)propertiesEditionPart;
		}
	}
