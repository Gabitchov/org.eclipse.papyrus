...
public class SendObjectActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SendObjectActionPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.SendObjectAction.ownedComment, PropertiesEditionEvent.CHANGE,
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.ownedComment,
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.SendObjectActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.SendObjectAction.name, UMLViewsRepository.SWT_KIND));
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if(propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.name, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}

		});

		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.SendObjectActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.SendObjectAction.visibility, UMLViewsRepository.SWT_KIND));
		visibility = new EMFComboViewer(parent);
		visibility.setContentProvider(new ArrayContentProvider());
		visibility.setLabelProvider(new AdapterFactoryLabelProvider(new EcoreAdapterFactory()));
		GridData visibilityData = new GridData(GridData.FILL_HORIZONTAL);
		visibility.getCombo().setLayoutData(visibilityData);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
				...
				TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(resourceSet, clientDependencyFilters, clientDependencyBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.clientDependency,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.clientDependency,
	...
	protected void createIsLeafCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.isLeaf, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOutgoingAdvancedReferencesTable(Composite parent) {
				...
				TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(resourceSet, outgoingFilters, outgoingBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.outgoing,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						outgoing.refresh();
					}
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.outgoing, UMLViewsRepository.SWT_KIND));
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.outgoing,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void createIncomingAdvancedReferencesTable(Composite parent) {
				...
				TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(resourceSet, incomingFilters, incomingBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.incoming,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						incoming.refresh();
					}
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.incoming, UMLViewsRepository.SWT_KIND));
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.incoming,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void createInPartitionAdvancedReferencesTable(Composite parent) {
				...
				TabElementTreeSelectionDialog<ActivityPartition> dialog = new TabElementTreeSelectionDialog<ActivityPartition>(resourceSet, inPartitionFilters, inPartitionBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.inPartition,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						inPartition.refresh();
					}
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.inPartition, UMLViewsRepository.SWT_KIND));
	...
	protected void moveInPartition(ActivityPartition element, int oldIndex, int newIndex) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromInPartition(ActivityPartition element) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.inPartition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void createInInterruptibleRegionAdvancedReferencesTable(Composite parent) {
				...
				TabElementTreeSelectionDialog<InterruptibleActivityRegion> dialog = new TabElementTreeSelectionDialog<InterruptibleActivityRegion>(resourceSet, inInterruptibleRegionFilters, inInterruptibleRegionBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.inInterruptibleRegion,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.inInterruptibleRegion, UMLViewsRepository.SWT_KIND));
	...
	protected void moveInInterruptibleRegion(InterruptibleActivityRegion element, int oldIndex, int newIndex) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createRedefinedNodeAdvancedReferencesTable(Composite parent) {
				...
				TabElementTreeSelectionDialog<ActivityNode> dialog = new TabElementTreeSelectionDialog<ActivityNode>(resourceSet, redefinedNodeFilters, redefinedNodeBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.redefinedNode,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.redefinedNode, UMLViewsRepository.SWT_KIND));
	...
	protected void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.redefinedNode,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void createHandlerAdvancedTableComposition(Composite parent) {
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.handler, UMLViewsRepository.SWT_KIND));
	...
	protected void moveHandler(ExceptionHandler element, int oldIndex, int newIndex) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.handler, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToHandler() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.handler,
	...
	protected void createLocalPreconditionAdvancedTableComposition(Composite parent) {
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.localPrecondition, UMLViewsRepository.SWT_KIND));
	...
	protected void moveLocalPrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.localPrecondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToLocalPrecondition() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.SendObjectAction.localPrecondition, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromLocalPrecondition(Constraint element) {
		...
		localPrecondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.localPrecondition,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void createLocalPostconditionAdvancedTableComposition(Composite parent) {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.localPostcondition, UMLViewsRepository.SWT_KIND));
	...
	protected void moveLocalPostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.localPostcondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToLocalPostcondition() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.SendObjectAction.localPostcondition, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromLocalPostcondition(Constraint element) {
		...
		localPostcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.localPostcondition,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void createArgumentAdvancedTableComposition(Composite parent) {
		...
		this.argument.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.SendObjectAction.argument, UMLViewsRepository.SWT_KIND));
	...
	protected void moveArgument(InputPin element, int oldIndex, int newIndex) {
		...
		argument.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.argument, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToArgument() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				argument.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.SendObjectAction.argument,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initOwnedComment(EObject current, EReference
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initClientDependency(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#addBusinessFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initOutgoing(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initIncoming(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initInPartition(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initInInterruptibleRegion(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#addBusinessFilterInInterruptibleRegion(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInInInterruptibleRegionTable(EObject
	 *      element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initRedefinedNode(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initHandler(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initLocalPrecondition(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#addBusinessFilterLocalPrecondition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initLocalPostcondition(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#addBusinessFilterLocalPostcondition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#initArgument(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
