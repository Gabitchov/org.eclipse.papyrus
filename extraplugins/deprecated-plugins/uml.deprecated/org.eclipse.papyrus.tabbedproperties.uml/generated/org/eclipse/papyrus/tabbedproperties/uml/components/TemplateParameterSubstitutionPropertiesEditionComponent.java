...
public class TemplateParameterSubstitutionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public TemplateParameterSubstitutionPropertiesEditionComponent(EObject templateParameterSubstitution, String editing_mode) {
		...
		if(templateParameterSubstitution instanceof TemplateParameterSubstitution) {
			templateParameterSubstitutionBasePropertiesEditionComponent = new TemplateParameterSubstitutionBasePropertiesEditionComponent(templateParameterSubstitution, editing_mode);
			addSubComponent(templateParameterSubstitutionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(templateParameterSubstitution, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (TemplateParameterSubstitutionPropertiesEditionPart)templateParameterSubstitutionBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
