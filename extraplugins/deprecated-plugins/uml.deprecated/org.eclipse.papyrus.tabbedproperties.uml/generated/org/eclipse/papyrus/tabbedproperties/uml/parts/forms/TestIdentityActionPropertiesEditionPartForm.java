...
public class TestIdentityActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TestIdentityActionPropertiesEditionPart {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						...
						UMLViewsRepository.TestIdentityAction.ownedComment, PropertiesEditionEvent.COMMIT,
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this, UMLViewsRepository.TestIdentityAction.ownedComment,
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this,
				UMLViewsRepository.TestIdentityAction.clientDependency, PropertiesEditionEvent.COMMIT,
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this, UMLViewsRepository.TestIdentityAction.outgoing,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editOutgoing(ActivityEdge element) {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.outgoing, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this, UMLViewsRepository.TestIdentityAction.incoming,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editIncoming(ActivityEdge element) {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.incoming, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromInPartition(ActivityPartition element) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this, UMLViewsRepository.TestIdentityAction.inPartition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editInPartition(ActivityPartition element) {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.inPartition, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this,
				UMLViewsRepository.TestIdentityAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this, UMLViewsRepository.TestIdentityAction.redefinedNode,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editRedefinedNode(ActivityNode element) {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.redefinedNode, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void addToHandler() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.handler, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromHandler(ExceptionHandler element) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TestIdentityActionPropertiesEditionPartForm.this, UMLViewsRepository.TestIdentityAction.handler,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void addToLocalPrecondition() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.localPrecondition, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void addToLocalPostcondition() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TestIdentityActionPropertiesEditionPartForm.this,
						UMLViewsRepository.TestIdentityAction.localPostcondition, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initOwnedComment(EObject current, EReference
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInOwnedCommentTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initClientDependency(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#addBusinessFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInClientDependencyTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initOutgoing(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInOutgoingTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initIncoming(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInIncomingTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initInPartition(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInInPartitionTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initInInterruptibleRegion(EObject current,
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#addBusinessFilterInInterruptibleRegion(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInInInterruptibleRegionTable(EObject
	 *      element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initRedefinedNode(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInRedefinedNodeTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initHandler(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInHandlerTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initLocalPrecondition(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#addBusinessFilterLocalPrecondition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInLocalPreconditionTable(EObject
	 *      element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#initLocalPostcondition(EObject current, EReference
	 *      containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#addBusinessFilterLocalPostcondition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TestIdentityActionPropertiesEditionPart#isContainedInLocalPostconditionTable(EObject
	 *      element)
	 */
