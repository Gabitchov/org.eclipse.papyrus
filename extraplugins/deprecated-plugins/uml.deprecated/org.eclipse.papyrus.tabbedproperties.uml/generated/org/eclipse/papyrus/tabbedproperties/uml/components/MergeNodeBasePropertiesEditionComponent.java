 ...
 */
public class MergeNodeBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public java.lang.Class translatePart(String key) {
		if(BASE_PART.equals(key))
			return UMLViewsRepository.MergeNode.class;
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(key == UMLViewsRepository.MergeNode.class)
			this.basePart = (MergeNodePropertiesEditionPart)propertiesEditionPart;
	}
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if(source instanceof MergeNode) {
			...
			mergeNodeToUpdate.getOutgoings().addAll(basePart.getOutgoingToAdd());
			mergeNodeToUpdate.getIncomings().addAll(basePart.getIncomingToAdd());
			mergeNodeToUpdate.getInPartitions().addAll(basePart.getInPartitionToAdd());
	...
	public Diagnostic validate() {
		...
		if(IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(mergeNode);
	...
	public void dispose() {
		if(semanticAdapter != null)
			mergeNode.eAdapters().remove(semanticAdapter);
	}
