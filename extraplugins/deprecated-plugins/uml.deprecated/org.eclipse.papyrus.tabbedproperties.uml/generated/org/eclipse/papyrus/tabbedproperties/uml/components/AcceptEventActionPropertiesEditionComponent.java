...
public class AcceptEventActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public AcceptEventActionPropertiesEditionComponent(EObject acceptEventAction, String editing_mode) {
		...
		if(acceptEventAction instanceof AcceptEventAction) {
			acceptEventActionBasePropertiesEditionComponent = new AcceptEventActionBasePropertiesEditionComponent(acceptEventAction, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (AcceptEventActionPropertiesEditionPart)acceptEventActionBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
