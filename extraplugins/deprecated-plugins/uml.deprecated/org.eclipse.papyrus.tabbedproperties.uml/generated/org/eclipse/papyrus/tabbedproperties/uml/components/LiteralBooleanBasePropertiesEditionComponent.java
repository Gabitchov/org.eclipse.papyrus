...
public class LiteralBooleanBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		if(event.getNewValue() != null) {
			...
			try {
				...
				if(UMLViewsRepository.LiteralBoolean.value == event.getAffectedEditor()) {
					Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getLiteralBoolean_Value().getEAttributeType(), newStringValue);
	...
	public Diagnostic validate() {
		...
		if(IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(literalBoolean);
