...
public interface ExecutionEnvironmentPropertiesEditionPart {
	...
	/**
	 * @return the nestedNode to add
	 */
	public List getNestedNodeToAdd();

	/**
	 * @return the nestedNode to remove
	 */
	public List getNestedNodeToRemove();

	/**
	 * @return the nestedNode to move
	 */
	public List getNestedNodeToMove();

	/**
	 * @return the nestedNode to edit
	 */
	public Map getNestedNodeToEdit();

	/**
	 * @return the current nestedNode table
	 */
	...
	/**
	 * Update the nestedNode
	 * 
	 * @param newValue
	 *        the nestedNode to update
	 */
	public void updateNestedNode(EObject newValue);

	/**
	 * Adds the given filter to the nestedNode edition editor.
	 * 
	 * @param filter
	 *        a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the nestedNode table
	 */
