...
public class LiteralBooleanPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The LiteralBooleanBasePropertiesEditionComponent sub component
	 */
	protected LiteralBooleanBasePropertiesEditionComponent literalBooleanBasePropertiesEditionComponent;
	...
	public LiteralBooleanPropertiesEditionComponent(EObject literalBoolean, String editing_mode) {
		...
		if(literalBoolean instanceof LiteralBoolean) {
			literalBooleanBasePropertiesEditionComponent = new LiteralBooleanBasePropertiesEditionComponent(literalBoolean, editing_mode);
			addSubComponent(literalBooleanBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(literalBoolean, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (LiteralBooleanPropertiesEditionPart)literalBooleanBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.LiteralBoolean.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (LiteralBooleanPropertiesEditionPart)propertiesEditionPart;
		}
	}
