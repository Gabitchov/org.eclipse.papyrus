 ...
 * 
 */
public class DefaultTransactionalMerger implements ITransactionalMerger, IMerger {

	//---------------------These methods comes from ITransactionalMerger
	public Command getApplyInOriginCommand(TransactionalEditingDomain domain) {
		CompoundCommand cmd = new CompoundCommand(NLS.bind("Apply in Origin Command for {0}", this));//TODO, verify this this!
	...
	public Command getUndoInTargetCommand(TransactionalEditingDomain domain) {
		CompoundCommand cmd = new CompoundCommand(NLS.bind("Undo in Target Command for {0}", this));//TODO verify this this
	...
	public boolean canApplyInOrigin() {
		//		return getApplyInOriginCommand(domain)
		return true;//TODO : use the command.canExecute
	}
	...
	public void setEditingDomain(final TransactionalEditingDomain domain) {
		//TODO and add it to the interface
	}
