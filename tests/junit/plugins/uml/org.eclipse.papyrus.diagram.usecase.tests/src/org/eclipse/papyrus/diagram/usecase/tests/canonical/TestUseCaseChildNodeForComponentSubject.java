 ...
 */
public class TestUseCaseChildNodeForComponentSubject extends TestChildNode {

	
	@Override
	protected CreateViewRequest createViewRequestShapeContainer() {
		return CreateViewRequestFactory.getCreateShapeRequest(UMLElementTypes.Component_2015, getDiagramEditPart().getDiagramPreferencesHint());
	}
