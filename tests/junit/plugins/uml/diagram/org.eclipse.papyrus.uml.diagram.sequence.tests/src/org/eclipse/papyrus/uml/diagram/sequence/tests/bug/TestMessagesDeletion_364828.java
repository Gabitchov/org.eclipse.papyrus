...
public class TestMessagesDeletion_364828 extends TestLink{ 
	...
	public void deleteMessageEvents(IElementType sourceType,IElementType targetType, IElementType linkType, ILinkTestProvider provider ) {
		...
		// check MessageSend and MessageRecv events 
		assertTrue("MessageEnd count: ", getMessageEndCount(interaction.getFragments())==2);
		...
		// check MessageSend and MessageRecv events 
		assertTrue("MessageEnd count: ", getMessageEndCount(interaction.getFragments())==0);
