...
public class AllSysMLTests {
	...
	static {
		...
		suiteClasses.add(new FragmentTestSuiteClass("org.eclipse.papyrus.sysml.diagram.parametric.tests", "org.eclipse.papyrus.sysml.diagram.parametric.tests.suites.AllTests"));
	}
