...
public  class NestedAttributeChangeLeftTargetTest_1_LeftToRight extends AbstractNestedAttributeChangeLeftTargetTest{

	@BeforeClass
	public static void init() throws CoreException, IOException, ModelMultiException, ServiceException {
		AbstractNestedAttributeChangeLeftTargetTest.init(true);
	}
