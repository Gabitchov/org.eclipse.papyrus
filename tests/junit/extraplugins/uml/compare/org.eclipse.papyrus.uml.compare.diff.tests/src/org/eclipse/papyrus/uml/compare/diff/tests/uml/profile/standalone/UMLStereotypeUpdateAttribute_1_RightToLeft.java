...
public class UMLStereotypeUpdateAttribute_1_RightToLeft extends AbstractUMLStandaloneCompareTest {
	...
	public void testModificationOnUMLFile() {
		...
		Assert.assertTrue("The stererotype property has not been correctly merged", value == true);
	}
