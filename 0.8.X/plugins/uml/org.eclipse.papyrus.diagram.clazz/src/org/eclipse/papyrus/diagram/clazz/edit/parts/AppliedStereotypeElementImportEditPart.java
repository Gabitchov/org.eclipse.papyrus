 ...
 * @generated
 */
public class AppliedStereotypeElementImportEditPart extends LabelEditPart implements ITextAwareEditPart, ILabelRoleProvider

{
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeElementImportEditPart.VISUAL_ID), new Point(0, 60));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ElementImport_4009, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeElementImportEditPart.VISUAL_ID));
		}
		return parser;
	}
