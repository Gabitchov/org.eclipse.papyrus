 ...
 */
public class InitialNodeAppliedStereotypeEditPart
...
extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart, IPapyrusEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InitialNodeAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InitialNode_3004, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InitialNodeAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
