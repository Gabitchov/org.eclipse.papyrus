...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.communication.edit.parts.TimeObservationNameEditPartCN.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.TimeObservation_8006, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.communication.edit.parts.TimeObservationNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
