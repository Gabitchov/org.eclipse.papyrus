 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.conversion.di2.Reference#isIsIndividualRepresentation <em>Is
 * Individual Representation</em>}</li>
 * <li>{@link org.eclipse.papyrus.conversion.di2.Reference#getReferenced <em>Referenced</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface Reference extends DiagramElement {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Individual Representation</em>' attribute isn't clear, there
	...
	/**
	 * Returns the value of the '<em><b>Referenced</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Referenced</em>' reference isn't clear, there really should be
