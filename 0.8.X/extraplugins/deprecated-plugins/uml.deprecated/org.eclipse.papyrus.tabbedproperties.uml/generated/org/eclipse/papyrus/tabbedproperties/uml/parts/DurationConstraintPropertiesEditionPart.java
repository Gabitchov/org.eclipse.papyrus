...
public interface DurationConstraintPropertiesEditionPart {
	...
	/**
	 * @return the constrainedElement to add
	 */
	public List getConstrainedElementToAdd();

	/**
	 * @return the constrainedElement to remove
	 */
	public List getConstrainedElementToRemove();

	/**
	 * @return the current constrainedElement table
	 */
	 ...
	 * 
	 * @param newValue
	 *        the constrainedElement to update
	 */
