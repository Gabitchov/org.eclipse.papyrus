...
public interface ParameterSetPropertiesEditionPart {
	...
	/**
	 * @return the condition to add
	 */
	public List getConditionToAdd();

	/**
	 * @return the condition to remove
	 */
	public List getConditionToRemove();

	/**
	 * @return the condition to move
	 */
	public List getConditionToMove();

	/**
	 * @return the condition to edit
	 */
	public Map getConditionToEdit();

	/**
	 * @return the current condition table
	 */
	...
	/**
	 * Adds the given filter to the condition edition editor.
	 * 
	 * @param filter
	 *        a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the condition table
	 */
