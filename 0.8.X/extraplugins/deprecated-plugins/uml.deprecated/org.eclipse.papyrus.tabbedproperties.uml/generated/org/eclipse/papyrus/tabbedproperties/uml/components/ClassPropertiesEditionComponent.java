...
public class ClassPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The ClassBasePropertiesEditionComponent sub component
	 */
	protected ClassBasePropertiesEditionComponent classBasePropertiesEditionComponent;
	...
	public ClassPropertiesEditionComponent(EObject class_, String editing_mode) {
		...
		if(class_ instanceof Class) {
			classBasePropertiesEditionComponent = new ClassBasePropertiesEditionComponent(class_, editing_mode);
			addSubComponent(classBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(class_, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (Class_PropertiesEditionPart)classBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.Class_.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (Class_PropertiesEditionPart)propertiesEditionPart;
		}
	}
