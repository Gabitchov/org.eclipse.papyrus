...
public class StateMachinePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The StateMachineBasePropertiesEditionComponent sub component
	 */
	protected StateMachineBasePropertiesEditionComponent stateMachineBasePropertiesEditionComponent;
	...
	public StateMachinePropertiesEditionComponent(EObject stateMachine, String editing_mode) {
		...
		if(stateMachine instanceof StateMachine) {
			stateMachineBasePropertiesEditionComponent = new StateMachineBasePropertiesEditionComponent(stateMachine, editing_mode);
			addSubComponent(stateMachineBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(stateMachine, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (StateMachinePropertiesEditionPart)stateMachineBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.StateMachine.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (StateMachinePropertiesEditionPart)propertiesEditionPart;
		}
	}
