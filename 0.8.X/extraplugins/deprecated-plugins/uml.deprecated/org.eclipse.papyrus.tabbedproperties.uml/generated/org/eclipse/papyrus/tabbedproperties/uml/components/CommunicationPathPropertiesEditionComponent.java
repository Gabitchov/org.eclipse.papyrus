...
public class CommunicationPathPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The CommunicationPathBasePropertiesEditionComponent sub component
	 */
	protected CommunicationPathBasePropertiesEditionComponent communicationPathBasePropertiesEditionComponent;
	...
	public CommunicationPathPropertiesEditionComponent(EObject communicationPath, String editing_mode) {
		...
		if(communicationPath instanceof CommunicationPath) {
			communicationPathBasePropertiesEditionComponent = new CommunicationPathBasePropertiesEditionComponent(communicationPath, editing_mode);
			addSubComponent(communicationPathBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(communicationPath, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (CommunicationPathPropertiesEditionPart)communicationPathBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.CommunicationPath.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (CommunicationPathPropertiesEditionPart)propertiesEditionPart;
		}
	}
