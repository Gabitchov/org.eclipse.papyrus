...
public class ArtifactPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The ArtifactBasePropertiesEditionComponent sub component
	 */
	protected ArtifactBasePropertiesEditionComponent artifactBasePropertiesEditionComponent;
	 ...
	 *        the EObject to edit
	 */
	public ArtifactPropertiesEditionComponent(EObject artifact, String editing_mode) {
		super(editing_mode);
		if(artifact instanceof Artifact) {
			artifactBasePropertiesEditionComponent = new ArtifactBasePropertiesEditionComponent(artifact, editing_mode);
			addSubComponent(artifactBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(artifact, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (ArtifactPropertiesEditionPart)artifactBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.Artifact.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (ArtifactPropertiesEditionPart)propertiesEditionPart;
		}
	}
