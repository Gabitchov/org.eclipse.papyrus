...
import org.eclipse.papyrus.tabbedproperties.uml.components.SignalEventPropertiesEditionComponent;
 ...
 */
public class SignalEventPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof SignalEvent) && (UMLPackage.eINSTANCE.getSignalEvent() == eObject.eClass());
	}
