...
/**
 * A ComponentEditPolicy that prevents the deletion of the underlying models. Will delete the view and remove the element's reference from the diagram upon a delete request.
 * 
