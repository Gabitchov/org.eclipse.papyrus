 ...
 * @generated
 */ 
public class SlotFormForm extends AbstractControlsGroup {
	...
	public SlotFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected AdvancedReferencedEForm definingFeature;
    ...
    public void createDirectChildren() {
		//
		definingFeature = new AdvancedReferencedEForm("DefiningFeature",new org.eclipse.papyrus.tabbedproperties.core.filters.StructuralFeatureFilter(),backContext);
		this.add(definingFeature);
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getDefiningFeature() {
