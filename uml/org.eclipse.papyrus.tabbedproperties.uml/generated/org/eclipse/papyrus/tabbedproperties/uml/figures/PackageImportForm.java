...
/**
 * The PackageImport form
 *
 *
 * @generated
 */ 
public class PackageImportForm extends AbstractControlsGroup {
	...
	public PackageImportForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected RadioButtons visibility;
	protected AdvancedReferencedEForm importedPackage;
    ...
    public void createDirectChildren() {
		...
		//used to to display the importedPackage as qualifiedName
		importedPackage = new AdvancedReferencedEForm("ImportedPackage",new org.eclipse.papyrus.tabbedproperties.core.filters.PackageFilter(),backContext);
		this.add(importedPackage);
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getImportedPackage() {
