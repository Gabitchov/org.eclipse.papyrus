 ...
 * @generated
 */ 
public class ObjectFlowForm extends AbstractControlsGroup {
	...
	public ObjectFlowForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected LabeledCheckBoxFigure isMulticastForm;
	protected LabeledCheckBoxFigure isMultireceiveForm;
    ...
    public void createDirectChildren() {
		...
		isMulticastForm = new LabeledCheckBoxFigure("isMultiCast", "");
		hbox.add(isMulticastForm);
		isMultireceiveForm = new LabeledCheckBoxFigure("isMultireceive", "");
		hbox.add(isMultireceiveForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isMulticastForm
     */
    public LabeledCheckBoxFigure  getIsMulticastForm() {
        return isMulticastForm;
    }
 	
 	    /**
     * @return the isMultireceiveForm
     */
    public LabeledCheckBoxFigure  getIsMultireceiveForm() {
        return isMultireceiveForm;
    }
