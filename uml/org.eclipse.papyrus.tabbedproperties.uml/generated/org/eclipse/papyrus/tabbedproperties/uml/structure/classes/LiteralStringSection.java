...
/**
 * The LiteralString property section for the LiteralString element
 * 
 * A literal string is a specification of a string value.
 *
 * @generated
 */
public class LiteralStringSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private InputTextControls literalString;

	/**
	 * The LiteralString to edit 
	 * @generated
	 */
	private LiteralString literalStringElement;
	...
	public PropertyEditor createFigure() {
		literalString = new InputTextControls("value","A literal string is a specification of a string value.");
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature value of LiteralString
		PropertyChangeListener<String> valueFormListener = new PropertyChangeListener<String>(){
		   public void propertyChanged(PropertyEditor editor, java.lang.String newValue) {
				SetValueCommand command = new SetValueCommand(editingDomain, literalStringElement, UMLPackage.eINSTANCE.getLiteralString_Value(), newValue);
			editingDomain.getCommandStack().execute(command);
			}
		};

		literalString.setPropertyChangeListener(valueFormListener);
	...
	public void refresh() {
		super.refresh();
							...
							literalString.setValue(literalStringElement.getValue());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.literalStringElement = (LiteralString)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof LiteralString;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		literalStringElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		literalStringElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(literalStringElement!=null){
		literalStringElement.eAdapters().remove(modelListener);}
		if(literalString!=null){
		literalString.dispose();
		}
		super.dispose();
	}
