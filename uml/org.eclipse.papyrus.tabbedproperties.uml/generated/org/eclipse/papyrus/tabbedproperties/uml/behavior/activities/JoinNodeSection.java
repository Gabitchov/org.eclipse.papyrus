...
import org.eclipse.papyrus.tabbedproperties.uml.figures.JoinNodeFormForm;
...
/**
 * The JoinNode property section for the JoinNode element
 * 
 *
 * @generated
 */
public class JoinNodeSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private JoinNodeFormForm joinNodeForm;

	/**
	 * The JoinNode to edit 
	 * @generated
	 */
	private JoinNode joinNodeElement;
	...
	public PropertyEditor createFigure() {
		joinNodeForm = new JoinNodeFormForm("JoinNode","A join node is a control node that synchronizes multiple flows."+
""+
"Join nodes have a Boolean value specification using the names of the incoming edges to specify the conditions under which the join will emit a token.");
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isCombineDuplicate of JoinNode
		BooleanPropertyChangeListener isCombineDupicateListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,joinNodeElement, UMLPackage.eINSTANCE.getJoinNode_IsCombineDuplicate(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		joinNodeForm.getIsCombineDupicate().setPropertyChangeListener(isCombineDupicateListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						joinNodeForm.getIsCombineDupicate().setValue(joinNodeElement.isCombineDuplicate());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.joinNodeElement = (JoinNode)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof JoinNode;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		joinNodeElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		joinNodeElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(joinNodeElement!=null){
		joinNodeElement.eAdapters().remove(modelListener);}
		if(joinNodeForm!=null){
		joinNodeForm.dispose();
		}
		super.dispose();
	}
