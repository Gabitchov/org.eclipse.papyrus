...
/**
 * The Model property section for the Model element
 * 
 * A model captures a view of a physical system. It is an abstraction of the physical system, with a certain purpose. This purpose determines what is to be included in the model and what is irrelevant. Thus the model completely describes those aspects of the physical system that are relevant to the purpose of the model, at the appropriate level of detail.
 *
 * @generated
 */
public class ModelSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private InputTextControls model;
	...
	public PropertyEditor createFigure() {
		model = new InputTextControls("viewpoint","A model captures a view of a physical system. It is an abstraction of the physical system, with a certain purpose. This purpose determines what is to be included in the model and what is irrelevant. Thus the model completely describes those aspects of the physical system that are relevant to the purpose of the model, at the appropriate level of detail.");
		return model;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature viewpoint of Model
		PropertyChangeListener<String> viewpointFormListener = new PropertyChangeListener<String>(){
		   public void propertyChanged(PropertyEditor editor, java.lang.String newValue) {
				SetValueCommand command = new SetValueCommand(editingDomain, modelElement, UMLPackage.eINSTANCE.getModel_Viewpoint(), newValue);
			editingDomain.getCommandStack().execute(command);
			}
		};

		model.setPropertyChangeListener(viewpointFormListener);
	...
	public void refresh() {
		super.refresh();
							...
							model.setValue(modelElement.getViewpoint());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.modelElement = (Model)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Model;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		modelElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		modelElement.eAdapters().remove(modelListener);
