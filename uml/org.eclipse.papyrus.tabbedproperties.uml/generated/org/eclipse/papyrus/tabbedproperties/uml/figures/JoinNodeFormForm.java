...
/**
 * The JoinNodeForm form
 *
 *
 * @generated
 */ 
public class JoinNodeFormForm extends AbstractControlsGroup {
	...
	public JoinNodeFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isCombineDupicate;
    ...
    public void createDirectChildren() {
		//
		isCombineDupicate = new LabeledCheckBoxFigure("isCombineDupicate", "");
		this.add(isCombineDupicate);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isCombineDupicate
     */
    public LabeledCheckBoxFigure  getIsCombineDupicate() {
        return isCombineDupicate;
    }
