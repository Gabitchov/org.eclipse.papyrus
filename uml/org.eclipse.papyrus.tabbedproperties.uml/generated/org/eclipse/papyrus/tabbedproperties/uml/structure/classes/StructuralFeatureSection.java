...
import org.eclipse.papyrus.tabbedproperties.uml.figures.StructuralFeatureFormForm;
...
/**
 * The StructuralFeature property section for the StructuralFeature element
 * 
 ...
 * @generated
 */
public class StructuralFeatureSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private StructuralFeatureFormForm structuralFeatureForm;

	/**
	 * The StructuralFeature to edit 
	 * @generated
	 */
	private StructuralFeature structuralFeatureElement;
	 ...
	 * @generated
	 */
	public StructuralFeatureSection() {
	...
	public PropertyEditor createFigure() {
		structuralFeatureForm = new StructuralFeatureFormForm("StructuralFeature Specifications","A structural feature is a typed feature of a classifier that specifies the structure of instances of the classifier."+
""+
"By specializing multiplicity element, it supports a multiplicity that specifies valid cardinalities for the collection of values associated with an instantiation of the structural feature.");
		return structuralFeatureForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isReadOnly of StructuralFeature
		BooleanPropertyChangeListener isReadOnlyListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,structuralFeatureElement, UMLPackage.eINSTANCE.getStructuralFeature_IsReadOnly(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		structuralFeatureForm.getIsReadOnly().setPropertyChangeListener(isReadOnlyListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						structuralFeatureForm.getIsReadOnly().setValue(structuralFeatureElement.isReadOnly());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.structuralFeatureElement = (StructuralFeature)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof StructuralFeature;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		structuralFeatureElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		structuralFeatureElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(structuralFeatureElement!=null){
		structuralFeatureElement.eAdapters().remove(modelListener);}
		if(structuralFeatureForm!=null){
		structuralFeatureForm.dispose();
		}
		super.dispose();
	}
