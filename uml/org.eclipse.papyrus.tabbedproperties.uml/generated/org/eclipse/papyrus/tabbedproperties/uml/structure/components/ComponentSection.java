 ...
 *     Obeo
 *******************************************************************************/
package org.eclipse.papyrus.tabbedproperties.uml.structure.components;
...
import org.eclipse.papyrus.tabbedproperties.uml.figures.ComponentFormForm;
...
/**
 * The Component property section for the Component element
 * 
 ...
 * @generated
 */
public class ComponentSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private ComponentFormForm componentForm;
	...
	public PropertyEditor createFigure() {
		componentForm = new ComponentFormForm("Component Specifications","A component represents a modular part of a system that encapsulates its contents and whose manifestation is replaceable within its environment."+
""+
"In the namespace of a component, all model elements that are involved in or related to its definition are either owned or imported explicitly. This may include, for example, use cases and dependencies (e.g. mappings), packages, components, and artifacts.");
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isIndirectlyInstantiated of Component
		BooleanPropertyChangeListener isIndirectlyInstanciatedListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,componentElement, UMLPackage.eINSTANCE.getComponent_IsIndirectlyInstantiated(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		componentForm.getIsIndirectlyInstanciated().setPropertyChangeListener(isIndirectlyInstanciatedListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						componentForm.getIsIndirectlyInstanciated().setValue(componentElement.isIndirectlyInstantiated());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.componentElement = (Component)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Component;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		componentElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		componentElement.eAdapters().remove(modelListener);
