 ...
 * @generated
 */ 
public class PinFormForm extends AbstractControlsGroup {
	...
	public PinFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isControl;
    ...
    public void createDirectChildren() {
		//
		isControl = new LabeledCheckBoxFigure("isControl", "");
		this.add(isControl);
     ...
     */
    public LabeledCheckBoxFigure  getIsControl() {
        return isControl;
    }
