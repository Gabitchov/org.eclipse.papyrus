...
/**
 * The GeneralizationSet form
 *
 *
 * @generated
 */ 
public class GeneralizationSetForm extends AbstractControlsGroup {
	...
	public GeneralizationSetForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected LabeledCheckBoxFigure isCoveringForm;
	protected LabeledCheckBoxFigure isDisjointForm;
    ...
    public void createDirectChildren() {
		...
		isCoveringForm = new LabeledCheckBoxFigure("isCovering", "");
		hbox.add(isCoveringForm);
		isDisjointForm = new LabeledCheckBoxFigure("isDisjoint", "");
		hbox.add(isDisjointForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isCoveringForm
     */
    public LabeledCheckBoxFigure  getIsCoveringForm() {
        return isCoveringForm;
    }
 	
 	    /**
     * @return the isDisjointForm
     */
    public LabeledCheckBoxFigure  getIsDisjointForm() {
        return isDisjointForm;
    }
