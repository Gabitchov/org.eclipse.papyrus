...
/**
 * The BehavioralFeatureForm form
 *
 *
 * @generated
 */ 
public class BehavioralFeatureFormForm extends AbstractControlsGroup {
	...
	public BehavioralFeatureFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected AdvancedReferencedTable ownedParameter;

	protected AdvancedReferencedTable raisedException;
    ...
    public void createDirectChildren() {
		...
		ownedParameter = new AdvancedReferencedTable("OwnedParameters",new org.eclipse.papyrus.tabbedproperties.core.filters.ParameterFilter(),backContext);
		hbox.add(ownedParameter);
		raisedException = new AdvancedReferencedTable("RaisedExceptions",new org.eclipse.papyrus.tabbedproperties.core.filters.TypeFilter(),backContext);
		hbox.add(raisedException);
...
/**
     * @return the ownedParameter
     */
    public AdvancedReferencedTable getOwnedParameter() {
...
/**
     ...
     */
    public AdvancedReferencedTable getRaisedException() {
