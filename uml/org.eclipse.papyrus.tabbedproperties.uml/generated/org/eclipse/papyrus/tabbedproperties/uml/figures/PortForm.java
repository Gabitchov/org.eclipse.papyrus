 ...
 * @generated
 */ 
public class PortForm extends AbstractControlsGroup {
	...
	public PortForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected LabeledCheckBoxFigure isBehaviorForm;
	protected LabeledCheckBoxFigure isServiceForm;
    ...
    public void createDirectChildren() {
		...
		isBehaviorForm = new LabeledCheckBoxFigure("isBehavior", "");
		hbox.add(isBehaviorForm);
		isServiceForm = new LabeledCheckBoxFigure("isService", "");
		hbox.add(isServiceForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isBehaviorForm
     */
    public LabeledCheckBoxFigure  getIsBehaviorForm() {
        return isBehaviorForm;
    }
 	
 	    /**
     * @return the isServiceForm
     */
    public LabeledCheckBoxFigure  getIsServiceForm() {
        return isServiceForm;
    }
