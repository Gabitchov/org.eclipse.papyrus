...
public class PropertyLabelColorProvider implements IPropertyLabelColorConstants {
    ...
    public static void initializeDefaults(IPreferenceStore aStore) {
        PreferenceConverter.setDefault(aStore,
                IPreferencesConstants.COLOR_DEFAULT, IPropertyLabelColorConstants.RGB_DEFAULT);
        PreferenceConverter.setDefault(aStore,
                IPreferencesConstants.COLOR_KEYWORD, IPropertyLabelColorConstants.RGB_KEYWORD);
        PreferenceConverter.setDefault(aStore,
                IPreferencesConstants.COLOR_STRING, IPropertyLabelColorConstants.RGB_STRING);
        PreferenceConverter.setDefault(aStore,
                IPreferencesConstants.COLOR_SYMBOL, IPropertyLabelColorConstants.RGB_SYMBOL);
    }
    ...
    public Color getColor(String aName) {
        ...
        if (color == null) {
           ...
           // PreferenceConverter.setValue(store, IPreferencesConstants.COLOR_KEYWORD, ILabelColorConstants.RGB_KEYWORD);
            PreferenceConverter.setValue(store, IPreferencesConstants.COLOR_SYMBOL, IPropertyLabelColorConstants.RGB_SYMBOL);
