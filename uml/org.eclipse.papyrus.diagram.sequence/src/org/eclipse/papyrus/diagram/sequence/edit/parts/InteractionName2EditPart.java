 ...
 * @generated
 */
public class InteractionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.Interaction_2001, getParserElement(), parserHint);
	...
	protected void refreshFont() {
		...
		if (style != null) {
			...
			fontData.setStyle(isAbstract() ? SWT.ITALIC | fontData.getStyle() : (~SWT.ITALIC) & fontData.getStyle());
			setFont(fontData);
		} else if (this.getFigure() != null && this.getFigure().getFont() != null && this.getFigure().getFont().getFontData().length > 0) {
