...
import org.eclipse.papyrus.diagram.activity.edit.policies.ActivityPartitionActivityPartitionCompartmentCanonicalEditPolicy;
import org.eclipse.papyrus.diagram.activity.edit.policies.ActivityPartitionActivityPartitionCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ActivityPartitionActivityPartitionCompartmentEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public ActivityPartitionActivityPartitionCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return Messages.ActivityPartitionActivityPartitionCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActivityPartitionActivityPartitionCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new ActivityPartitionActivityPartitionCompartmentCanonicalEditPolicy());
		// fjcano : special Layout policy to treat ActiivtyPartitions
	...
	/**
	 * Modified to refresh <ActivityPartition>s if needed.
	 * 
	 * @generated NOT
	 */
	@Override
	public Command getCommand(Request _request) {
		...
		if (_request instanceof CreateUnspecifiedTypeConnectionRequest) {
			...
			if (org.eclipse.gef.RequestConstants.REQ_CONNECTION_START.equals(type) && String.valueOf(ElementOwnedCommentEditPart.VISUAL_ID).equals(id)) {
				if (cutcr.getTargetEditPart() instanceof ActivityPartitionActivityPartitionCompartmentEditPart)
				...
				if (cutcr.getSourceEditPart() instanceof ActivityPartitionActivityPartitionCompartmentEditPart)
