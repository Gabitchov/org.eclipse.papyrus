 ...
 * @generated
 */
public class ZigZagLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ZigZagLabelEditPart.VISUAL_ID), new Point(0, -5));
	}

	/**
	 * @generated
	 */
	public ZigZagLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.ExceptionHandler_3004, getParserElement(), parserHint);
	 ...
	 * @generated
	 */
	public class ZigZagLabel extends WrappingLabel {
