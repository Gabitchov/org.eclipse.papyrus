...
public class InputPin4CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public InputPin4CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static InputPin4CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new InputPin4CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			ElementInitializers.init_InputPin_2016(newElement);
