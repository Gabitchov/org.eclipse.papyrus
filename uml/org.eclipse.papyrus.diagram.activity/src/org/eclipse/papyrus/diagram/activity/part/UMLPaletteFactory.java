...
public class UMLPaletteFactory {
	...
	private PaletteContainer createObjects4Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(Messages.Objects4Group_title);
	...
	private PaletteContainer createEdges5Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(Messages.Edges5Group_title);
	...
	private PaletteContainer createComments6Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(Messages.Comments6Group_title);
	...
	private ToolEntry createActivity1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Activity_1001));
	...
	private ToolEntry createActivityPartition2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.ActivityPartition2CreationTool_title, Messages.ActivityPartition2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ActivityPartition_2030));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createSendObjectAction1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.SendObjectAction1CreationTool_title, Messages.SendObjectAction1CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.SendObjectAction_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createSendSignalAction2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.SendSignalAction2CreationTool_title, Messages.SendSignalAction2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.SendSignalAction_2005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createAcceptEventAction3CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.AcceptEventAction3CreationTool_title, Messages.AcceptEventAction3CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.AcceptEventAction_2007));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createOpaqueAction4CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.OpaqueAction4CreationTool_title, Messages.OpaqueAction4CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.OpaqueAction_2014));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCallBehaviorAction5CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.CallBehaviorAction5CreationTool_title, Messages.CallBehaviorAction5CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.CallBehaviorAction_2024));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCallOperationAction6CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.CallOperationAction6CreationTool_title, Messages.CallOperationAction6CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.CallOperationAction_2027));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCreateObjectAction7CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.CreateObjectAction7CreationTool_title, Messages.CreateObjectAction7CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.CreateObjectAction_2022));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createActivityFinalNode1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ActivityFinalNode_2009));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createInitialNode2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.InitialNode2CreationTool_title, Messages.InitialNode2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.InitialNode_2012));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createFlowFinalNode3CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.FlowFinalNode_2018));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createDecisionNode4CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.DecisionNode_2010));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createMergeNode5CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.MergeNode_2011));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createForkNode6CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ForkNode_2019));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createJoinNode7CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.JoinNode_2020));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createDatastore1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.DataStoreNode_2013));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createPin2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.Pin2CreationTool_title, Messages.Pin2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Pin_2021));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createValuePin3CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.ValuePin3CreationTool_title, Messages.ValuePin3CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ValuePin_2004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createOutputPin4CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.OutputPin_2008));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createInputPin5CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.InputPin_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createActivityParameter6CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.ActivityParameter6CreationTool_title, Messages.ActivityParameter6CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ActivityParameterNode_2029));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createControlFlow1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ControlFlow_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createObjectFlow2CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ObjectFlow_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createExceptionHandler3CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.ExceptionHandler3CreationTool_title, Messages.ExceptionHandler3CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ExceptionHandler_3004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createComment1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.Comment1CreationTool_title, Messages.Comment1CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Comment_2034));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCommentLink2CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.CommentLink2CreationTool_title, Messages.CommentLink2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ElementOwnedComment_3005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
