...
public class TestLink extends AbstractPapyrusTestCase {
	...
	private static final String THE_LINK_RECONNECT_EXISTS = "The Link exist";
	private static final String RECONNECTION_TARGET = "Reconnection of target";
	private static final String LINK_EXISTS_RECONNECTION_ON_TARGET = "Link exist on the target";
	private static final String THE_LINK_TO_RECONNECT_EXISTS = "The Link exist";
	private static final String RECONNECTION_SOURCE = "Reconnection of source";
	private static final String LINK_EXISTS_RECONNECTION_ON_SOURCE = "Link exist on the source";
	private GraphicalEditPart source=null;
	private GraphicalEditPart sourcePlayer=null;
	private GraphicalEditPart target=null;
	private GraphicalEditPart targetPlayer=null;
