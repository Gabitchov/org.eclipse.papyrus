...
public class CombinedFragmentPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The CombinedFragmentBasePropertiesEditionComponent sub component
	 */
	protected CombinedFragmentBasePropertiesEditionComponent combinedFragmentBasePropertiesEditionComponent;
	...
	public CombinedFragmentPropertiesEditionComponent(EObject combinedFragment, String editing_mode) {
		...
		if(combinedFragment instanceof CombinedFragment) {
			combinedFragmentBasePropertiesEditionComponent = new CombinedFragmentBasePropertiesEditionComponent(combinedFragment, editing_mode);
			addSubComponent(combinedFragmentBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(combinedFragment, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (CombinedFragmentPropertiesEditionPart)combinedFragmentBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.CombinedFragment.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (CombinedFragmentPropertiesEditionPart)propertiesEditionPart;
		}
	}
