...
public interface EnumerationPropertiesEditionPart {
	...
	/**
	 * @return the ownedLiteral to add
	 */
	public List getOwnedLiteralToAdd();

	/**
	 * @return the ownedLiteral to remove
	 */
	public List getOwnedLiteralToRemove();

	/**
	 * @return the ownedLiteral to move
	 */
	public List getOwnedLiteralToMove();

	/**
	 * @return the ownedLiteral to edit
	 */
	public Map getOwnedLiteralToEdit();

	/**
	 * @return the current ownedLiteral table
	 */
	public List getOwnedLiteralTable();

	/**
	 * Init the ownedLiteral
	 * 
	 * @param current
	 *        the current value
	 * @param containgFeature
	...
	/**
	 * Update the ownedLiteral
	 * 
	 * @param newValue
	 *        the ownedLiteral to update
	 */
	public void updateOwnedLiteral(EObject newValue);

	/**
	 * Adds the given filter to the ownedLiteral edition editor.
	 * 
	 * @param filter
	 *        a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the ownedLiteral table
	 */
