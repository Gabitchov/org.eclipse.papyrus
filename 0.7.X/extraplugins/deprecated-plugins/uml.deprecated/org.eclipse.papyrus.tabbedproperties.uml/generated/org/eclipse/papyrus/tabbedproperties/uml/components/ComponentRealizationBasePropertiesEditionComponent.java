...
public class ComponentRealizationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ComponentRealizationBasePropertiesEditionComponent(EObject componentRealization, String editing_mode) {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if(basePart == null)
					ComponentRealizationBasePropertiesEditionComponent.this.dispose();
				else {
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(key == UMLViewsRepository.ComponentRealization.class)
			this.basePart = (ComponentRealizationPropertiesEditionPart)propertiesEditionPart;
	}
	...
	public Diagnostic validate() {
		...
		if(IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(componentRealization);
