...
public class ConstraintConstrainedElementPreferencePage extends InternalBlockDiagramLinkPreferencePage {
	...
	public static String prefKey = InternalBlockDiagramEditPart.DIAGRAM_ID + "_ConstraintConstrainedElement";

	public ConstraintConstrainedElementPreferencePage() {
		super();
		setPreferenceKey(InternalBlockDiagramEditPart.DIAGRAM_ID + "_ConstraintConstrainedElement"); //$NON-NLS-1$
	}
