...
/**
 *this advice helper is used to add the stereotype FLOW PORT with the direction OUT 
 *
 */
public class OutFlowPortAdviceBinding extends AbstractEditHelperAdvice {
			...
			protected CommandResult doExecuteWithResult(IProgressMonitor progressMonitor, IAdaptable info) throws ExecutionException {
				...
				if(type != null) {
					...
					if(partStereotype != null) {
						...
						type.setValue(partStereotype, "direction", FlowDirection.OUT); //$NON-NLS-1$
					}
