...
public class InOutFlowPortHandler extends UMLHandler implements IHandler {

	/** Returns the creation command */
	protected Command getCommand() throws ExecutionException {
		CreateElementRequest request = new CreateElementRequest(SysMLElementTypes.FLOWPORT);
