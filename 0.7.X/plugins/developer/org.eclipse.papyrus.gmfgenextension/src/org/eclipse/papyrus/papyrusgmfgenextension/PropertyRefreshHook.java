 ...
 * 
 * <!-- begin-model-doc -->
 * This class is used to refresh the figure by taking in account a property of domain element (in the case of Ecore, it can be an Efeature or
 * EReference)
 ...
 * 
 * For instance we would like to display active class when the efeature class is "active". Or display composite kind of the association when the kind
 * of the property end is "composite".
 * <!-- end-model-doc -->
 * 
 * <p>
...
public interface PropertyRefreshHook extends ExternalHook {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.papyrus.papyrusgmfgenextension.PropertyRefreshHook#getTriggeringCondition
	 * <em>Triggering Condition</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @param value
