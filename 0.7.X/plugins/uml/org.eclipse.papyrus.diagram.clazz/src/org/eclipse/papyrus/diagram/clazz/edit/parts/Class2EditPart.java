 ...
 * @generated
 */
public class Class2EditPart extends UMLCompartmentEditPart implements
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Class_3004,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.Class2EditPart.VISUAL_ID));
		}
		return parser;
	}
