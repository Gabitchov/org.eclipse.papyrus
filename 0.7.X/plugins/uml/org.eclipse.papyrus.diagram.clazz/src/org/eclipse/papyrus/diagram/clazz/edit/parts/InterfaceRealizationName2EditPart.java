...
public class InterfaceRealizationName2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InterfaceRealization_4003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.InterfaceRealizationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
