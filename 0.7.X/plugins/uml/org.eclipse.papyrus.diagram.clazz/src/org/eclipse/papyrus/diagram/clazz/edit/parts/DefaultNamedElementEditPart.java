...
public class DefaultNamedElementEditPart extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DefaultNamedElementItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomDefaultNamedElementItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DefaultNamedElementNameEditPart) {
			((DefaultNamedElementNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(DefaultNamedElementNameEditPart.VISUAL_ID));
	}
