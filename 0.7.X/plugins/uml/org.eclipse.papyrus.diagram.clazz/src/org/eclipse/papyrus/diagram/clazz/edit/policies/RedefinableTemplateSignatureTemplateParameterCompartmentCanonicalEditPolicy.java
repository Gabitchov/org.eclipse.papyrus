...
public class RedefinableTemplateSignatureTemplateParameterCompartmentCanonicalEditPolicy
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ClassifierTemplateParameterEditPart.VISUAL_ID
				|| visualID == TemplateParameterEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getRedefinableTemplateSignatureTemplateParameterCompartment_7014SemanticChildren((View) getHost()
						.getModel());
