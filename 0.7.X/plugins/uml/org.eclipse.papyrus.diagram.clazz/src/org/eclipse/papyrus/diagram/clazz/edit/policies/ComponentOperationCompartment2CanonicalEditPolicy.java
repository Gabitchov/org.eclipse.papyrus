 ...
 * @generated
 */
public class ComponentOperationCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getComponentOperationCompartment_7024SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getComponentOperationCompartment_7024SemanticChildren((View) getHost()
						.getModel());
