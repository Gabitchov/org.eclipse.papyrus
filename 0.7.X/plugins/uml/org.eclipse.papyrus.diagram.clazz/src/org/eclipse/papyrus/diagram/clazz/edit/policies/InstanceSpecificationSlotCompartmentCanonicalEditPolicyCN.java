 ...
 * @generated
 */
public class InstanceSpecificationSlotCompartmentCanonicalEditPolicyCN extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getInstanceSpecificationSlotCompartment_7035SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getInstanceSpecificationSlotCompartment_7035SemanticChildren((View) getHost()
						.getModel());
