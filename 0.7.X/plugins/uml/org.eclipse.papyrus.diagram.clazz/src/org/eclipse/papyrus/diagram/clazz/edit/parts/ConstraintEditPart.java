...
import org.eclipse.papyrus.diagram.clazz.custom.policies.itemsemantic.CustomConstraintItemSemanticEditPolicy;
...
AbstractConstraintEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomConstraintItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ConstraintBodyEditPart) {
			((ConstraintBodyEditPart) childEditPart).setLabel(getPrimaryShape()
					.getConstraintFigure());
			return true;
		}
