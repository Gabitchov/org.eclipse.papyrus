...
import org.eclipse.papyrus.diagram.clazz.custom.policies.ISRoleSourceDisplayEditPolicy;
import org.eclipse.papyrus.diagram.clazz.custom.policies.InstanceSpecificationRoleDisplayEditPolicy;
 ...
 * @generated
 */
public class SourceISLinkLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.SourceISLinkLabelEditPart.VISUAL_ID), new Point(0, 20));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InstanceSpecification_4021, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.SourceISLinkLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
