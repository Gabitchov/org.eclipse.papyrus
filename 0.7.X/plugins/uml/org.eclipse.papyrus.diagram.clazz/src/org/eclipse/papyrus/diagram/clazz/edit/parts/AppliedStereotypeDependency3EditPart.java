 ...
 * @generated
 */
public class AppliedStereotypeDependency3EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeDependency3EditPart.VISUAL_ID), new Point(0, 60));
	}

	/**
	 * @generated
	 */
	public AppliedStereotypeDependency3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Dependency_4018, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeDependency3EditPart.VISUAL_ID));
		}
		return parser;
	}
