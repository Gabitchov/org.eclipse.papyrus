 ...
 * @generated
 */
public class ConstraintBodyEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.ConstraintBodyEditPart.VISUAL_ID));
		}
		return parser;
	}
