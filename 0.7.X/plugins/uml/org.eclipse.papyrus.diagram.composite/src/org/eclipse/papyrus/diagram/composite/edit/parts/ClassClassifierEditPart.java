...
import org.eclipse.papyrus.diagram.composite.edit.policies.ClassClassifierItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ClassClassifierEditPart extends
...
NamedElementEditPart {
	 ...
	 * @generated
	 */
	public ClassClassifierEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ClassClassifierItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof ClassClassifierNameEditPart) {
			((ClassClassifierNameEditPart)childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassClassifierNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.composite.edit.parts.ClassClassifierEditPart) {
			types.add(UMLElementTypes.ComponentRealization_4004);
		}
	...
	public EditPart getTargetEditPart(Request request) {
		if(request instanceof CreateViewAndElementRequest) {
			...
			if(type == UMLElementTypes.Reception_3100) {
			...
			if(type == UMLElementTypes.Activity_3103) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.Interaction_3104) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.ProtocolStateMachine_3105) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.StateMachine_3106) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.FunctionBehavior_3107) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.OpaqueBehavior_3108) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.Collaboration_3109) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.Interface_3110) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.Enumeration_3111) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.PrimitiveType_3112) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.DataType_3113) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
			if(type == UMLElementTypes.Class_3114) {
				return getChildBySemanticHint(UMLVisualIDRegistry.getType(ClassNestedClassifierCompartmentEditPart.VISUAL_ID));
			}
		}
