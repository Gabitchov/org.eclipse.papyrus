...
public class InternalUmlCollaborationUseLexer extends Lexer {
        ...
        try {
            ...
            if ( ((LA2_0>='0' && LA2_0<='9')) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("391:25: ( '0' .. '9' ( '0' .. '9' )* | '*' )", 2, 0, input);
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            if ( (LA8_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("397:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )", 8, 0, input);
    ...
    static final String DFA14_maxS =
        "\1\ufffe\1\72\1\125\4\uffff\1\71\1\uffff\1\172\1\uffff\2\ufffe\1"+
        "\57\11\uffff\1\71\6\uffff";
    static final String DFA14_acceptS =
        "\3\uffff\1\4\1\5\1\6\1\7\1\uffff\1\10\1\uffff\1\11\3\uffff\1\16"+
        "\1\17\1\3\1\1\1\2\1\4\1\5\1\6\1\7\1\uffff\1\10\1\11\1\13\1\15\1"+
        "\14\1\16";
    static final String DFA14_specialS =
        "\36\uffff}>";
    static final String[] DFA14_transitionS = {
            "\11\17\2\16\2\17\1\16\22\17\1\16\1\17\1\13\1\5\3\17\1\14\2\17"+
            "\1\10\1\3\1\17\1\4\1\17\1\15\12\7\1\1\1\17\1\2\4\17\32\12\3"+
            "\17\1\11\1\12\1\17\32\12\3\17\1\6\uff80\17",
            "\1\20",
            "\1\22",
            "",
            "",
