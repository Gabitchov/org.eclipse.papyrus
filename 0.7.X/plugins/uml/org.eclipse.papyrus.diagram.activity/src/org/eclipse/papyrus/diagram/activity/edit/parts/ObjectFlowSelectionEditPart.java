 ...
 * @generated
 */
public class ObjectFlowSelectionEditPart extends LabelEditPart
...
implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ObjectFlow_4003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ObjectFlowSelectionEditPart.VISUAL_ID));
		}
		return parser;
	}
