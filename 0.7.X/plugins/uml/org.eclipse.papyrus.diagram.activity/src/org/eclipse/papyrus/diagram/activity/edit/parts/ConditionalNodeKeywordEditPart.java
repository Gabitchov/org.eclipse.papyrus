 ...
 * @generated
 */
public class ConditionalNodeKeywordEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ConditionalNode_3069, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ConditionalNodeKeywordEditPart.VISUAL_ID));
		}
		return parser;
	}
