 ...
 * @generated
 */
public class TimeConstraintAsLocalPostcondBodyEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.TimeConstraint_3037, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.TimeConstraintAsLocalPostcondBodyEditPart.VISUAL_ID));
		}
		return parser;
	}
