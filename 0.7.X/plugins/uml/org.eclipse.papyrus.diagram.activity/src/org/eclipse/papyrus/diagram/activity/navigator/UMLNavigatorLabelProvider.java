...
public class UMLNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	public Image getImage(View view) {
		...
		case ReadSelfActionOutputPinEditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://www.eclipse.org/uml2/3.0.0/UML?OutputPin", UMLElementTypes.OutputPin_3082); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case ReadSelfActionOutputPinEditPart.VISUAL_ID:
			return getOutputPin_3082Text(view);
		case OutputPinInCallOpActEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getOutputPin_3082Text(View view) {
		IParser parser = UMLParserProvider.getParser(UMLElementTypes.OutputPin_3082, view.getElement() != null ? view.getElement() : view, UMLVisualIDRegistry.getType(OutputPinInReadSelfActionLabelEditPart.VISUAL_ID));
		if(parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
