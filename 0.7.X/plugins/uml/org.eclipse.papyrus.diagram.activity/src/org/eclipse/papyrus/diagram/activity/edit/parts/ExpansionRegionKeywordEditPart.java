 ...
 * @generated
 */
public class ExpansionRegionKeywordEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ExpansionRegion_3070, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ExpansionRegionKeywordEditPart.VISUAL_ID));
		}
		return parser;
	}
