...
public class ActivityFinalNodePreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		store.setDefault(PreferenceConstantHelper.getElementConstant(key, PreferenceConstantHelper.WIDTH), 22);
		store.setDefault(PreferenceConstantHelper.getElementConstant(key, PreferenceConstantHelper.HEIGHT), 22);
