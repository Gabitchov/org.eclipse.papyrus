 ...
 * @generated
 */
public class CommentCNPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public CommentCNPreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_CommentCN");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ProfileDiagramEditPart.MODEL_ID + "_CommentCN";
