...
import org.eclipse.papyrus.diagram.common.actions.DistributeLinkNodeAction;
...
public class DistributionHandler extends ParametricAndListeningHandler {
	...
	public DistributionHandler() {
		super("org.eclipse.papyrus.diagram.common.commandDistributionParameter"); //$NON-NLS-1$
	}
