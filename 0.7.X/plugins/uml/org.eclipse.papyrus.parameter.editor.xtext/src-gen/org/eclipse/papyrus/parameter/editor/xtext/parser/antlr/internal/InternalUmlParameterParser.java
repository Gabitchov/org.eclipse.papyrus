...
public class InternalUmlParameterParser extends AbstractInternalAntlrParser {
        ...
        try {
            ...
            if ( (LA1_0==RULE_ID) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("169:1: ( ( (lv_type_4_0= ruleTypeRule ) ) | '<Undefined>' )", 1, 0, input);
    ...
    public final Enumerator ruleModifierKind() throws RecognitionException {
        ...
        try {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("728:1: ( ( 'exception' ) | ( 'stream' ) | ( 'ordered' ) | ( 'unique' ) )", 8, 0, input);
    ...
    public final Enumerator ruleEffectKind() throws RecognitionException {
        ...
        try {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("761:1: ( ( 'create' ) | ( 'read' ) | ( 'update' ) | ( 'delete' ) )", 9, 0, input);
    ...
    public final Enumerator ruleVisibilityKind() throws RecognitionException {
        ...
        try {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("794:1: ( ( '+' ) | ( '-' ) | ( '#' ) | ( '~' ) )", 10, 0, input);
    ...
    public final Enumerator ruleDirection() throws RecognitionException {
        ...
        try {
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("827:1: ( ( 'in' ) | ( 'out' ) | ( 'inout' ) | ( 'return' ) )", 11, 0, input);
