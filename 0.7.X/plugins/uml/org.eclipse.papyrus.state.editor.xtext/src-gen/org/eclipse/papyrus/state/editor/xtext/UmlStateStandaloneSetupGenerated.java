...
public class UmlStateStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.papyrus.state.editor.xtext.UmlStateRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/papyrus/state/editor/xtext/UmlState")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/papyrus/state/editor/xtext/UmlState", org.eclipse.papyrus.state.editor.xtext.umlState.UmlStatePackage.eINSTANCE);
	}
