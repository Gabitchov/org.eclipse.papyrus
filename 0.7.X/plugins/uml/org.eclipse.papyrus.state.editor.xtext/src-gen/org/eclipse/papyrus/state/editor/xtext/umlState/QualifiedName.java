 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.state.editor.xtext.umlState.QualifiedName#getPath <em>Path</em>}</li>
 *   <li>{@link org.eclipse.papyrus.state.editor.xtext.umlState.QualifiedName#getRemaining <em>Remaining</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.papyrus.state.editor.xtext.umlState.UmlStatePackage#getQualifiedName()
 * @model
 * @generated
 */
public interface QualifiedName extends EObject
{
   ...
   * @see org.eclipse.papyrus.state.editor.xtext.umlState.UmlStatePackage#getQualifiedName_Path()
   * @model
   * @generated
   */
  Namespace getPath();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.state.editor.xtext.umlState.QualifiedName#getPath <em>Path</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.papyrus.state.editor.xtext.umlState.UmlStatePackage#getQualifiedName_Remaining()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.state.editor.xtext.umlState.QualifiedName#getRemaining <em>Remaining</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
