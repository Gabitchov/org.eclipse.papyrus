		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PapyrusTableConfiguration_fillingMode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PapyrusTableConfiguration_fillingMode_feature", "_UI_PapyrusTableConfiguration_type"),
	...
	protected void addFillingQueriesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PapyrusTableConfiguration_fillingQueries_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PapyrusTableConfiguration_fillingQueries_feature", "_UI_PapyrusTableConfiguration_type"),
	...
	protected void addListenFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PapyrusTableConfiguration_listenFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PapyrusTableConfiguration_listenFeature_feature", "_UI_PapyrusTableConfiguration_type"),
				 PapyrustableconfigurationPackage.Literals.PAPYRUS_TABLE_CONFIGURATION__LISTEN_FEATURE,
				 true,
				 false,
				 true,
				 null,
