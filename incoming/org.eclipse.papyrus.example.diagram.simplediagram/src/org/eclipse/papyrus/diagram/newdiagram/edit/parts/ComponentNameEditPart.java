...
import org.eclipse.papyrus.diagram.newdiagram.edit.policies.UMLTextSelectionEditPolicy;
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.newdiagram.edit.parts.ComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
