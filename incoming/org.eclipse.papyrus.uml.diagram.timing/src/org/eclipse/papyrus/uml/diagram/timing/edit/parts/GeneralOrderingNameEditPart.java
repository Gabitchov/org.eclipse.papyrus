...

{
	...
	public IParser getParser() {
		if(this.parser == null) {
			this.parser = UMLParserProvider.getParser(UMLElementTypes.GeneralOrdering_67, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.timing.edit.parts.GeneralOrderingNameEditPart.VISUAL_ID));
		}
		return this.parser;
	}
				...
				if(Window.OK == dialog.open()) {
					...
					final RecordingCommand command = new RecordingCommand(domain, "Edit Label") {
						...
						protected void doExecute() {
							GeneralOrderingNameEditPart.this.configuration.postEditAction(resolveSemanticElement(), ((ILabelEditorDialog)finalDialog).getValue());
