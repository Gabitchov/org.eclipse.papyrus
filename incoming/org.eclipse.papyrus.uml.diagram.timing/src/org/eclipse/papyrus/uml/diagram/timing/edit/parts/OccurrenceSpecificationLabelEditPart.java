...

{
	...
	public IParser getParser() {
		if(this.parser == null) {
			this.parser = UMLParserProvider.getParser(UMLElementTypes.OccurrenceSpecification_12, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.timing.edit.parts.OccurrenceSpecificationLabelEditPart.VISUAL_ID));
		}
		return this.parser;
	}
				...
				if(Window.OK == dialog.open()) {
					...
					final RecordingCommand command = new RecordingCommand(domain, "Edit Label") {
						...
						protected void doExecute() {
							OccurrenceSpecificationLabelEditPart.this.configuration.postEditAction(resolveSemanticElement(), ((ILabelEditorDialog)finalDialog).getValue());
