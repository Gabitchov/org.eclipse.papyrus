...
import org.eclipse.papyrus.sysml.efacet.extended_sysml.portandflows.*;
...
public class PortandflowsFactoryImpl extends EFactoryImpl implements PortandflowsFactory {
	...
	public static PortandflowsFactory init() {
		try {
			PortandflowsFactory thePortandflowsFactory = (PortandflowsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/papyrus/0.9.0/ExtendedSysML/PortAndFlows"); 
