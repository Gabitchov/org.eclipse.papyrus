...
public class NattableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case NattablePackage.IAXIS_CONTENTS_PROVIDER: {
			...
			case NattablePackage.USER_CONTENT_PROVIDER: {
				UserContentProvider userContentProvider = (UserContentProvider)theEObject;
				T result = caseUserContentProvider(userContentProvider);
				if (result == null) result = caseIAxisContentsProvider(userContentProvider);
				if (result == null) result = caseEModelElement(userContentProvider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NattablePackage.DYNAMIC_EMF_FEATURE_CONTENTS_PROVIDER: {
				DynamicEMFFeatureContentsProvider dynamicEMFFeatureContentsProvider = (DynamicEMFFeatureContentsProvider)theEObject;
				T result = caseDynamicEMFFeatureContentsProvider(dynamicEMFFeatureContentsProvider);
				if (result == null) result = caseIAxisContentsProvider(dynamicEMFFeatureContentsProvider);
				if (result == null) result = caseEModelElement(dynamicEMFFeatureContentsProvider);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>User Content Provider</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>User Content Provider</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUserContentProvider(UserContentProvider object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Dynamic EMF Feature Contents Provider</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Dynamic EMF Feature Contents Provider</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDynamicEMFFeatureContentsProvider(DynamicEMFFeatureContentsProvider object) {
		return null;
	}
