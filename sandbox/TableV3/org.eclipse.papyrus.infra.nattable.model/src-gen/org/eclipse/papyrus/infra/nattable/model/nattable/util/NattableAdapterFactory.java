...
public class NattableAdapterFactory extends AdapterFactoryImpl {
	...
	protected NattableSwitch<Adapter> modelSwitch =
		new NattableSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUserContentProvider(UserContentProvider object) {
				return createUserContentProviderAdapter();
			}
			@Override
			public Adapter caseDynamicEMFFeatureContentsProvider(DynamicEMFFeatureContentsProvider object) {
				return createDynamicEMFFeatureContentsProviderAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.nattable.model.nattable.IAxisContentsProvider <em>IAxis Contents Provider</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.nattable.model.nattable.UserContentProvider <em>User Content Provider</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createUserContentProviderAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.infra.nattable.model.nattable.DynamicEMFFeatureContentsProvider <em>Dynamic EMF Feature Contents Provider</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDynamicEMFFeatureContentsProviderAdapter() {
		return null;
	}
