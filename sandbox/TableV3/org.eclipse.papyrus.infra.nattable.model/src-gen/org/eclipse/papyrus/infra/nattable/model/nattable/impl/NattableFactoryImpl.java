...
public class NattableFactoryImpl extends EFactoryImpl implements NattableFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case NattablePackage.USER_CONTENT_PROVIDER: return createUserContentProvider();
			case NattablePackage.DYNAMIC_EMF_FEATURE_CONTENTS_PROVIDER: return createDynamicEMFFeatureContentsProvider();
	 ...
	 * @generated
	 */
	public UserContentProvider createUserContentProvider() {
		UserContentProviderImpl userContentProvider = new UserContentProviderImpl();
	 ...
	 * @generated
	 */
	public DynamicEMFFeatureContentsProvider createDynamicEMFFeatureContentsProvider() {
		DynamicEMFFeatureContentsProviderImpl dynamicEMFFeatureContentsProvider = new DynamicEMFFeatureContentsProviderImpl();
		return dynamicEMFFeatureContentsProvider;
	}
