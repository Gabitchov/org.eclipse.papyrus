...
public abstract class AbstractDisplayColumnIndexHandler extends AbstractChangeHeaderStyleConfigurationHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if(configuration instanceof DefaultAxisConfiguration) {
			...
			final IEditCommandRequest request = new SetRequest(domain, configuration, NattableaxisconfigurationPackage.eINSTANCE.getDefaultAxisConfiguration_DisplayIndex(), !oldValue);
