...
public class PTabFolder {
	...
	protected void handleDragDetectStarted(Point displayPos, DragDetectEvent e) {
	...
	protected void handleMenuDetect(Point displayPos, MenuDetectEvent e) {
	 ...
	 */
	static public int getItemIndex(CTabItem item) {
