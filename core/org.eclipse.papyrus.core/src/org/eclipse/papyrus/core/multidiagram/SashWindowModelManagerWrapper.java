 ...
 */
public class SashWindowModelManagerWrapper extends SashWindowsModelManagerImpl {
	 ...
	 */
	@Override
	public void moveTab(Object srcfolder, int srcTabIndex, int targetIndex) {
	 ...
	 */
	@Override
	public void moveTab(Object srcfolder, int srcTabIndex, Object targetfolder, int targetIndex) {
	 ...
	 */
	public ITilePartNodeModel createTilePartModel(Object model) {
     ...
     * 
     */
	protected class TabPartNodeModel implements ITilePartNodeModel {
		...
		public void addChangeListener(IListener listener) {
			if (observers == null) {
				observers = new ArrayList<IListener>();
			}
	 ...
	 */
	protected class TabFolderModel extends TabPartNodeModel implements ITabFolderModel {
	 ...
	 */
	protected class SashWindowModel extends TabPartNodeModel implements ISashModel {
