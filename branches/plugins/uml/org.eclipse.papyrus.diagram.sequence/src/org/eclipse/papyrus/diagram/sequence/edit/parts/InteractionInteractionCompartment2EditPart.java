 ...
 * @generated
 */
public class InteractionInteractionCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InteractionInteractionCompartment2ItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new InteractionInteractionCompartment2CanonicalEditPolicy());
	}
