 ...
 * @generated
 */
public class AcceptEventActionEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AcceptEventActionName2EditPart) {
			((AcceptEventActionName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAcceptEventActionFigure_stereotypes());
			return true;
		}
	...
	protected NodeFigure createNodePlate() {
		AcceptEventActionNodeFigure result = new AcceptEventActionNodeFigure(getMapMode().DPtoLP(160), getMapMode().DPtoLP(60));
		return result;
	}
	 ...
	 * @NOT-generated
	 */
	public class AcceptEventActionNodeFigure extends DefaultSizeNodeFigure implements IPolygonAnchorableFigure {
