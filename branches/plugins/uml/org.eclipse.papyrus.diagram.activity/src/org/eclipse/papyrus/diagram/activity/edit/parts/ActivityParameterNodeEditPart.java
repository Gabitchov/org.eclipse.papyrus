...
public class ActivityParameterNodeEditPart extends AbstractBorderItemEditPart implements PrimaryShapeEditPart {
	...
	public class ActivityParameterFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			fFigureActivityParameterFigure_name.setFont(FFIGUREACTIVITYPARAMETERFIGURE_NAME_FONT);
			...
			activityParameterFigure_name1.setBorder(new MarginBorder(getMapMode().DPtoLP(3), getMapMode().DPtoLP(5), getMapMode().DPtoLP(3), getMapMode().DPtoLP(5)));
	 ...
	 * @generated
	 */
	static final Font FFIGUREACTIVITYPARAMETERFIGURE_NAME_FONT = new Font(Display.getCurrent(), "SANS", 10, SWT.BOLD);
