...
public class OutputPin2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public OutputPin2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static OutputPin2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new OutputPin2CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			ElementInitializers.init_OutputPin_2015(newElement);
