...
/*	final static private String[] TVL_Tuple_Strings = {
			computeTVL_Tuple_String(),
	};*/

	/** Text displayed in the information window */
	final static private String[] TVL_Tuple_StringsInfo = {
			NFPMessages.Tuple_StringsInfo,
	}; 

	/** Text displayed in the completion area window */
	final static private String[] TVL_Tuple_StringName = {
			NFPMessages.Tuple_StringName,
	};
	...
	public List<ICompletionProposal> generateCompletionProposals(int documentOffset, int selectionRange, String prefix) {
		...
		if(tupleString.startsWith(prefix)) {
				proposal = new CompletionProposal(
						...
						tupleString.length()-1,
						null,
						tupleTypeString,
						null,
						TVL_Tuple_StringsInfo[0]);
				v.add(proposal);
		}
		return v;
	}
