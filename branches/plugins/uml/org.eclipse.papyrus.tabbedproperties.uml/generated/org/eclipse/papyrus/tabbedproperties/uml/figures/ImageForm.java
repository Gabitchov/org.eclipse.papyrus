 ...
 * @generated
 */ 
public class ImageForm extends AbstractControlsGroup {
	...
	public ImageForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected InputTextControls contentForm;
	protected InputTextControls locationForm;
	protected InputTextControls formatForm;
    ...
    public void createDirectChildren() {
		//
		contentForm = new InputTextControls("content", "");
		 this.add(contentForm);
     
		//
		locationForm = new InputTextControls("location", "");
		 this.add(locationForm);
     
		//
		formatForm = new InputTextControls("format", "");
		 this.add(formatForm);
     ...
     */
 	...
 	/**
     * @return the contentForm
     */
    public InputTextControls getContentForm() {
        return contentForm;
    }
 	
 	/**
     * @return the locationForm
     */
    public InputTextControls getLocationForm() {
        return locationForm;
    }
 	
 	/**
     * @return the formatForm
     */
    public InputTextControls getFormatForm() {
        return formatForm;
    }
