...
/**
 * The BehaviorForm form
 *
 *
 * @generated
 */ 
public class BehaviorFormForm extends AbstractControlsGroup {
	...
	public BehaviorFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isReentrant;
    ...
    public void createDirectChildren() {
		//
		isReentrant = new LabeledCheckBoxFigure("isReentrant", "");
		this.add(isReentrant);
     ...
     */
    public LabeledCheckBoxFigure  getIsReentrant() {
        return isReentrant;
    }
