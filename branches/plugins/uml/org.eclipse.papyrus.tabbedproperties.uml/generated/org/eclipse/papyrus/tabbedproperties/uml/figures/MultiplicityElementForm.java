...
/**
 * The MultiplicityElement form
 *
 *
 * @generated
 */ 
public class MultiplicityElementForm extends AbstractControlsGroup {
	...
	public MultiplicityElementForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected InputTextControls mutiplicityform;
	protected LabeledCheckBoxFigure isOrderedForm;
	protected LabeledCheckBoxFigure isUniqueForm;
    ...
    public void createDirectChildren() {
		...
		mutiplicityform = new InputTextControls("Multiplicity", "use to display the multiplicity as 0..*");
		 hbox.add(mutiplicityform);
		isOrderedForm = new LabeledCheckBoxFigure("IsOrdered", "");
		hbox.add(isOrderedForm);
		isUniqueForm = new LabeledCheckBoxFigure("IsUnique", "");
		hbox.add(isUniqueForm);
     ...
     */
 	...
 	/**
     * @return the mutiplicityform
     */
    public InputTextControls getMutiplicityform() {
        return mutiplicityform;
    }
 	
 	    /**
     * @return the isOrderedForm
     */
    public LabeledCheckBoxFigure  getIsOrderedForm() {
        return isOrderedForm;
    }
 	
 	    /**
     * @return the isUniqueForm
     */
    public LabeledCheckBoxFigure  getIsUniqueForm() {
        return isUniqueForm;
    }
