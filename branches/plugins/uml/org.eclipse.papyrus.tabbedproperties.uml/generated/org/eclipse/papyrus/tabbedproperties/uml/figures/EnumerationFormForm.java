...
/**
 * The EnumerationForm form
 *
 *
 * @generated
 */ 
public class EnumerationFormForm extends AbstractControlsGroup {
	...
	public EnumerationFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected AdvancedReferencedTable ownedLiteral;
    ...
    public void createDirectChildren() {
		//
		ownedLiteral = new AdvancedReferencedTable("ownedLiteral",new org.eclipse.papyrus.tabbedproperties.core.filters.EnumerationLiteralFilter(),backContext);
		this.add(ownedLiteral);
...
/**
     * @return the ownedLiteral
     */
    public AdvancedReferencedTable getOwnedLiteral() {
        return ownedLiteral;
    }
