...
/**
 * The RemoveStructuralFeatureValueActionForm form
 *
 *
 * @generated
 */ 
public class RemoveStructuralFeatureValueActionFormForm extends AbstractControlsGroup {
	...
	public RemoveStructuralFeatureValueActionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isRemoveDuplicates;
    ...
    public void createDirectChildren() {
		//
		isRemoveDuplicates = new LabeledCheckBoxFigure("isRemoveDuplicates", "");
		this.add(isRemoveDuplicates);
     ...
     */
    public LabeledCheckBoxFigure  getIsRemoveDuplicates() {
