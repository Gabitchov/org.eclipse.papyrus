...
import org.eclipse.papyrus.tabbedproperties.uml.figures.LinkEndCreationDataFormForm;
...
/**
 * The LinkEndCreationData property section for the LinkEndCreationData element
 * 
 *
 * @generated
 */
public class LinkEndCreationDataSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private LinkEndCreationDataFormForm linkEndCreationDataForm;

	/**
	 * The LinkEndCreationData to edit 
	 * @generated
	 */
	private LinkEndCreationData linkEndCreationDataElement;
	 ...
	 * @generated
	 */
	public LinkEndCreationDataSection() {
	...
	public PropertyEditor createFigure() {
		linkEndCreationDataForm = new LinkEndCreationDataFormForm("LinkEndCreationData","A link end creation data is not an action. It is an element that identifies links. It identifies one end of a link to be created by a create link action.");
		return linkEndCreationDataForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isReplaceAll of LinkEndCreationData
		BooleanPropertyChangeListener isReplaceAllListener = new BooleanPropertyChangeListener(){
			...
			SetValueCommand command = new SetValueCommand(editingDomain,linkEndCreationDataElement, UMLPackage.eINSTANCE.getLinkEndCreationData_IsReplaceAll(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		linkEndCreationDataForm.getIsReplaceAll().setPropertyChangeListener(isReplaceAllListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						linkEndCreationDataForm.getIsReplaceAll().setValue(linkEndCreationDataElement.isReplaceAll());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.linkEndCreationDataElement = (LinkEndCreationData)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof LinkEndCreationData;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		linkEndCreationDataElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		linkEndCreationDataElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(linkEndCreationDataElement!=null){
		linkEndCreationDataElement.eAdapters().remove(modelListener);}
		if(linkEndCreationDataForm!=null){
		linkEndCreationDataForm.dispose();
		}
		super.dispose();
	}
