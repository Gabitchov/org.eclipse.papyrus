...
import org.eclipse.papyrus.tabbedproperties.uml.figures.ReduceActionFormForm;
...
/**
 * The ReduceAction property section for the ReduceAction element
 * 
 *
 * @generated
 */
public class ReduceActionSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private ReduceActionFormForm reduceActionForm;

	/**
	 * The ReduceAction to edit 
	 * @generated
	 */
	private ReduceAction reduceActionElement;
	...
	public PropertyEditor createFigure() {
		reduceActionForm = new ReduceActionFormForm("ReduceAction","A reduce action is an action that reduces a collection to a single value by combining the elements of the collection.");
		return reduceActionForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isOrdered of ReduceAction
		BooleanPropertyChangeListener isOrderedListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,reduceActionElement, UMLPackage.eINSTANCE.getReduceAction_IsOrdered(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		reduceActionForm.getIsOrdered().setPropertyChangeListener(isOrderedListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						reduceActionForm.getIsOrdered().setValue(reduceActionElement.isOrdered());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.reduceActionElement = (ReduceAction)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof ReduceAction;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		reduceActionElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		reduceActionElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(reduceActionElement!=null){
		reduceActionElement.eAdapters().remove(modelListener);}
		if(reduceActionForm!=null){
		reduceActionForm.dispose();
		}
		super.dispose();
	}
