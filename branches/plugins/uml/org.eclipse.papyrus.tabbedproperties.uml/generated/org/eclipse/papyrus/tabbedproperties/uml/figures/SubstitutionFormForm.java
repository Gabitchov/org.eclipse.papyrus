...
/**
 * The SubstitutionForm form
 *
 *
 * @generated
 */ 
public class SubstitutionFormForm extends AbstractControlsGroup {
	...
	public SubstitutionFormForm(String label, String description){
		this.label=label;
	...
	protected AdvancedReferencedEForm substitutingClassifier;
    ...
    public void createDirectChildren() {
		...
		contract = new AdvancedReferencedEForm("Contract",new org.eclipse.papyrus.tabbedproperties.core.filters.ClassifierFilter(),backContext);
		hbox.add(contract);
		substitutingClassifier = new AdvancedReferencedEForm("SubstitutingClassifier",new org.eclipse.papyrus.tabbedproperties.core.filters.ClassifierFilter(),backContext);
		hbox.add(substitutingClassifier);
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getSubstitutingClassifier() {
