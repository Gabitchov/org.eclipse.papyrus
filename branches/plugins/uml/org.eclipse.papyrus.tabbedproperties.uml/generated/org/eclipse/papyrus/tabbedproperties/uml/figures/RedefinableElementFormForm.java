...
/**
 * The RedefinableElementForm form
 *
 *
 * @generated
 */ 
public class RedefinableElementFormForm extends AbstractControlsGroup {
	...
	public RedefinableElementFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isLeaf;
    ...
    public void createDirectChildren() {
		//
		isLeaf = new LabeledCheckBoxFigure("isLeaf", "");
		this.add(isLeaf);
     ...
     * @return the isLeaf
     */
    public LabeledCheckBoxFigure  getIsLeaf() {
        return isLeaf;
    }
