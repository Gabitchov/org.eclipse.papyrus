...
/**
 * The AcceptEventActionForm form
 *
 *
 * @generated
 */ 
public class AcceptEventActionFormForm extends AbstractControlsGroup {
	...
	public AcceptEventActionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isUnmarshall;
    ...
    public void createDirectChildren() {
		//
		isUnmarshall = new LabeledCheckBoxFigure("isUnmarshall", "");
		this.add(isUnmarshall);
     ...
     */
    public LabeledCheckBoxFigure  getIsUnmarshall() {
        return isUnmarshall;
    }
