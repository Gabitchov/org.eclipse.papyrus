...
/**
 * The ReadIsClassifiedObjectActionForm form
 *
 *
 * @generated
 */ 
public class ReadIsClassifiedObjectActionFormForm extends AbstractControlsGroup {
	...
	public ReadIsClassifiedObjectActionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isDirect;
    ...
    public void createDirectChildren() {
		//
		isDirect = new LabeledCheckBoxFigure("isDirect", "");
		this.add(isDirect);
     ...
     * @return the isDirect
     */
    public LabeledCheckBoxFigure  getIsDirect() {
        return isDirect;
    }
