...
import org.eclipse.papyrus.tabbedproperties.uml.figures.LiteralBooleanFormForm;
...
/**
 * The LiteralBoolean property section for the LiteralBoolean element
 * 
 *
 * @generated
 */
public class LiteralBooleanSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private LiteralBooleanFormForm literalBooleanForm;

	/**
	 * The LiteralBoolean to edit 
	 * @generated
	 */
	private LiteralBoolean literalBooleanElement;
	...
	public PropertyEditor createFigure() {
		literalBooleanForm = new LiteralBooleanFormForm("Literal Boolean Specifications","A literal Boolean is a specification of a Boolean value.");
		return literalBooleanForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature value of LiteralBoolean
		BooleanPropertyChangeListener valueListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,literalBooleanElement, UMLPackage.eINSTANCE.getLiteralBoolean_Value(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		literalBooleanForm.getValue().setPropertyChangeListener(valueListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						literalBooleanForm.getValue().setValue(literalBooleanElement.isValue());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.literalBooleanElement = (LiteralBoolean)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof LiteralBoolean;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		literalBooleanElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		literalBooleanElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(literalBooleanElement!=null){
		literalBooleanElement.eAdapters().remove(modelListener);}
		if(literalBooleanForm!=null){
		literalBooleanForm.dispose();
		}
		super.dispose();
	}
