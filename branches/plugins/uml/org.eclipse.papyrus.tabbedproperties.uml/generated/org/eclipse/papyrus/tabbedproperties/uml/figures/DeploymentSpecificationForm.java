...
/**
 * The DeploymentSpecification form
 *
 *
 * @generated
 */ 
public class DeploymentSpecificationForm extends AbstractControlsGroup {
	...
	public DeploymentSpecificationForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected InputTextControls deploymentLocationForm;
	protected InputTextControls executionLocationForm;
    ...
    public void createDirectChildren() {
		//
		deploymentLocationForm = new InputTextControls("deploymentLocation", "");
		 this.add(deploymentLocationForm);
     
		//
		executionLocationForm = new InputTextControls("executionLocation", "");
		 this.add(executionLocationForm);
     ...
     */
 	...
 	/**
     * @return the deploymentLocationForm
     */
    public InputTextControls getDeploymentLocationForm() {
        return deploymentLocationForm;
    }
 	
 	/**
     * @return the executionLocationForm
     */
    public InputTextControls getExecutionLocationForm() {
        return executionLocationForm;
    }
