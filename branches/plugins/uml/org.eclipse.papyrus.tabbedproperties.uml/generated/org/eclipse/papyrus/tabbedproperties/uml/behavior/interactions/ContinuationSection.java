...
import org.eclipse.papyrus.tabbedproperties.uml.figures.ContinuationFormForm;
...
/**
 * The Continuation property section for the Continuation element
 * 
 *
 * @generated
 */
public class ContinuationSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private ContinuationFormForm continuationForm;

	/**
	 * The Continuation to edit 
	 * @generated
	 */
	private Continuation continuationElement;
	...
	public PropertyEditor createFigure() {
		continuationForm = new ContinuationFormForm("Continuation","A continuation is a syntactic way to define continuations of different branches of an alternative combined fragment. Continuations is intuitively similar to labels representing intermediate points in a flow of control.");
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature setting of Continuation
		BooleanPropertyChangeListener settingListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,continuationElement, UMLPackage.eINSTANCE.getContinuation_Setting(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		continuationForm.getSetting().setPropertyChangeListener(settingListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						continuationForm.getSetting().setValue(continuationElement.isSetting());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.continuationElement = (Continuation)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Continuation;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		continuationElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		continuationElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		...
		continuationElement.eAdapters().remove(modelListener);}
		if(continuationForm!=null){
		continuationForm.dispose();
		}
		super.dispose();
	}
