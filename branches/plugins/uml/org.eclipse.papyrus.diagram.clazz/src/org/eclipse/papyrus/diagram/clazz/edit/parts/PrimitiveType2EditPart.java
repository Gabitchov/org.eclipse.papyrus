...
public class PrimitiveType2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AppliedStereotypeChildNodePrimitiveTypeEditPart) {
			((AppliedStereotypeChildNodePrimitiveTypeEditPart) childEditPart).setLabel(getPrimaryShape().getStereotypesLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(AppliedStereotypeChildNodePrimitiveTypeEditPart.VISUAL_ID));
	}
