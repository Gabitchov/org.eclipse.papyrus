...
public class InstanceSpecification2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AppliedStereotypeChildNodeInstanceSpecificationEditPart) {
			((AppliedStereotypeChildNodeInstanceSpecificationEditPart) childEditPart).setLabel(getPrimaryShape().getInstanceSpecificationStereotypeLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(AppliedStereotypeChildNodeInstanceSpecificationEditPart.VISUAL_ID));
	}
