...
import org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeChildNodeInterfaceEditPart;
...
public class Interface2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(AppliedStereotypeChildNodeInterfaceEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
