...
public class PackageViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(AppliedStereotypePackageEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.PACKAGE_2007_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.PACKAGE_2007_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.PACKAGE_2007_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.PACKAGE_2007_PREF_LINE_COLOR);
