...
import org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeChildNodeSignalEditPart;
...
public class Signal2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(AppliedStereotypeChildNodeSignalEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
