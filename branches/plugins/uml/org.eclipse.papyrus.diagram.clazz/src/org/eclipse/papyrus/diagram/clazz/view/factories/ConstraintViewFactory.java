...
public class ConstraintViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.CONSTRAINT_2011_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.CONSTRAINT_2011_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.CONSTRAINT_2011_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.CONSTRAINT_2011_PREF_LINE_COLOR);
