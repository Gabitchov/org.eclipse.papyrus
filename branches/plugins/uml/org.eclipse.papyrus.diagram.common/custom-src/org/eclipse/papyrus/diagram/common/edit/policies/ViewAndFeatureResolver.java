...
/**
 * Lets a D&D policy know if an <EObject> is a <Node> or a <Edge> in the host <EditPart>. Can resolve the <EStructuralFeature> where an <EObject> is stored by its <ECLass>.
 * 
