...
/**
 * The PackageMergeForm form
 *
 *
 * @generated
 */ 
public class PackageMergeFormForm extends AbstractControlsGroup {
	...
	public PackageMergeFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected AdvancedReferencedEForm mergedPackage;

	protected AdvancedReferencedEForm receivingPackage;
    ...
    public void createDirectChildren() {
		...
		mergedPackage = new AdvancedReferencedEForm("MergedPackage",new org.eclipse.papyrus.tabbedproperties.core.filters.PackageFilter(),backContext);
		hbox.add(mergedPackage);
		receivingPackage = new AdvancedReferencedEForm("ReceivingPackage",new org.eclipse.papyrus.tabbedproperties.core.filters.PackageFilter(),backContext);
		hbox.add(receivingPackage);
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getMergedPackage() {
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getReceivingPackage() {
