...
/**
 * The TimeConstraint property section for the TimeConstraint element
 * 
 * A time constraint is a constraint that refers to a time interval.
 *
 * @generated
 */
public class TimeConstraintSection extends AbstractCheckBoxSection<org.eclipse.uml2.uml.TimeConstraint> implements IFilter {

 	/**
	 * Constructor defining label
	 * @generated 
	 */
    public TimeConstraintSection() {
        super("TimeConstraint", "A time constraint is a constraint that refers to a time interval.");
    }
        ...
        BooleanPropertyChangeListener editorListener = new BooleanPropertyChangeListener(){
			...
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
            	if (editingDomain != null) {
            		SetValueCommand command = new SetValueCommand(editingDomain, businessElement, UMLPackage.eINSTANCE.getTimeConstraint_FirstEvent(), newValue);
   ...
   /**
    ...
    public void setInput(IWorkbenchPart part, ISelection selection) {
        ...
        this.businessElement = (org.eclipse.uml2.uml.TimeConstraint)getBusinessElement(input);
    }
    ...
    public boolean select(Object toTest) {
        return getBusinessElement(toTest) instanceof org.eclipse.uml2.uml.TimeConstraint;
    }
