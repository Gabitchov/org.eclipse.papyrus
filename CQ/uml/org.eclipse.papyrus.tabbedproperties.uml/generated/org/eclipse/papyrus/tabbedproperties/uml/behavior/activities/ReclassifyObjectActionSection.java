...
import org.eclipse.papyrus.tabbedproperties.uml.figures.ReclassifyObjectActionFormForm;
...
/**
 * The ReclassifyObjectAction property section for the ReclassifyObjectAction element
 * 
 *
 * @generated
 */
public class ReclassifyObjectActionSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private ReclassifyObjectActionFormForm reclassifyObjectActionForm;

	/**
	 * The ReclassifyObjectAction to edit 
	 * @generated
	 */
	private ReclassifyObjectAction reclassifyObjectActionElement;
	 ...
	 * @generated
	 */
	public ReclassifyObjectActionSection() {
	...
	public PropertyEditor createFigure() {
		reclassifyObjectActionForm = new ReclassifyObjectActionFormForm("ReclassifyObjectAction","A reclassify object action is an action that changes which classifiers classify an object.");
		return reclassifyObjectActionForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isReplaceAll of ReclassifyObjectAction
		BooleanPropertyChangeListener isReplaceAllListener = new BooleanPropertyChangeListener(){
			...
			SetValueCommand command = new SetValueCommand(editingDomain,reclassifyObjectActionElement, UMLPackage.eINSTANCE.getReclassifyObjectAction_IsReplaceAll(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		reclassifyObjectActionForm.getIsReplaceAll().setPropertyChangeListener(isReplaceAllListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						reclassifyObjectActionForm.getIsReplaceAll().setValue(reclassifyObjectActionElement.isReplaceAll());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.reclassifyObjectActionElement = (ReclassifyObjectAction)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof ReclassifyObjectAction;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		reclassifyObjectActionElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		reclassifyObjectActionElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(reclassifyObjectActionElement!=null){
		reclassifyObjectActionElement.eAdapters().remove(modelListener);}
		if(reclassifyObjectActionForm!=null){
		reclassifyObjectActionForm.dispose();
		}
		super.dispose();
	}
