 ...
 * @generated
 */ 
public class OperationForm extends AbstractControlsGroup {
	...
	public OperationForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isQueryForm;
    ...
    public void createDirectChildren() {
		//
		isQueryForm = new LabeledCheckBoxFigure("isQuery", "");
		this.add(isQueryForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isQueryForm
     */
    public LabeledCheckBoxFigure  getIsQueryForm() {
        return isQueryForm;
    }
