...
/**
 * The ConditionalNode form
 *
 *
 * @generated
 */ 
public class ConditionalNodeForm extends AbstractControlsGroup {
	...
	public ConditionalNodeForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected LabeledCheckBoxFigure isDeterminateForm;
	protected LabeledCheckBoxFigure isAssuredForm;
    ...
    public void createDirectChildren() {
		...
		isDeterminateForm = new LabeledCheckBoxFigure("isDeterminate", "");
		hbox.add(isDeterminateForm);
		isAssuredForm = new LabeledCheckBoxFigure("isAssured", "");
		hbox.add(isAssuredForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isDeterminateForm
     */
    public LabeledCheckBoxFigure  getIsDeterminateForm() {
        return isDeterminateForm;
    }
 	
 	    /**
     * @return the isAssuredForm
     */
    public LabeledCheckBoxFigure  getIsAssuredForm() {
