...
/**
 * The ElementForm form
 *
 *
 * @generated
 */ 
public class ElementFormForm extends AbstractControlsGroup {
	...
	public ElementFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected AdvancedReferencedTable comment;
    ...
    public void createDirectChildren() {
		//view to see all comments of an element
		comment = new AdvancedReferencedTable("Comment",new org.eclipse.papyrus.tabbedproperties.core.filters.CommentFilter(),backContext);
		this.add(comment);
...
/**
     * @return the comment
     */
    public AdvancedReferencedTable getComment() {
        return comment;
    }
