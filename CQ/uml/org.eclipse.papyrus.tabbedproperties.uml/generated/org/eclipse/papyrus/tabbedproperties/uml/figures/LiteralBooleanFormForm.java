...
/**
 * The LiteralBooleanForm form
 *
 *
 * @generated
 */ 
public class LiteralBooleanFormForm extends AbstractControlsGroup {
	...
	public LiteralBooleanFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure value;
    ...
    public void createDirectChildren() {
		//
		value = new LabeledCheckBoxFigure("value", "");
		this.add(value);
     ...
     * @return the value
     */
    public LabeledCheckBoxFigure  getValue() {
        return value;
    }
