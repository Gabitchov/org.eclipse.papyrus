...
/**
 * The InterfaceRealization form
 *
 *
 * @generated
 */ 
public class InterfaceRealizationForm extends AbstractControlsGroup {
	...
	public InterfaceRealizationForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected AdvancedReferencedEForm contract;

	protected AdvancedReferencedEForm implementingClassifier;
    ...
    public void createDirectChildren() {
		...
		contract = new AdvancedReferencedEForm("Contract",new org.eclipse.papyrus.tabbedproperties.core.filters.InterfaceFilter(),backContext);
		hbox.add(contract);
		implementingClassifier = new AdvancedReferencedEForm("ImplementingClassifier",new org.eclipse.papyrus.tabbedproperties.core.filters.BehavioredClassifierFilter(),backContext);
		hbox.add(implementingClassifier);
 ...
 /**
     * @return the contract
     */
    public AdvancedReferencedEForm getContract() {
        return contract;
    }
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getImplementingClassifier() {
