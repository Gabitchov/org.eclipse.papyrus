...
/**
 * The ProfileApplicationForm form
 *
 *
 * @generated
 */ 
public class ProfileApplicationFormForm extends AbstractControlsGroup {
	...
	public ProfileApplicationFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isStrict;
    ...
    public void createDirectChildren() {
		//
		isStrict = new LabeledCheckBoxFigure("isStrict", "");
		this.add(isStrict);
     ...
     * @return the isStrict
     */
    public LabeledCheckBoxFigure  getIsStrict() {
        return isStrict;
    }
