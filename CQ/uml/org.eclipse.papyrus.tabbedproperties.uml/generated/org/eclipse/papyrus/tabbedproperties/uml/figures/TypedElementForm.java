...
/**
 * The TypedElement form
 *
 *
 * @generated
 */ 
public class TypedElementForm extends AbstractControlsGroup {
	...
	public TypedElementForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected AdvancedReferencedEForm type;
    ...
    public void createDirectChildren() {
		//view of a typedElement
		type = new AdvancedReferencedEForm("Type",new org.eclipse.papyrus.tabbedproperties.core.filters.TypeFilter(),backContext);
		this.add(type);
 ...
 /**
     * @return the type
     */
    public AdvancedReferencedEForm getType() {
        return type;
    }
