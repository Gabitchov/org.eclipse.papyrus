...
/**
 * The ClassifierTemplateParameterForm form
 *
 *
 * @generated
 */ 
public class ClassifierTemplateParameterFormForm extends AbstractControlsGroup {
	...
	public ClassifierTemplateParameterFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure allowSubstitutable;
    ...
    public void createDirectChildren() {
		//
		allowSubstitutable = new LabeledCheckBoxFigure("allowSubstitutable", "");
		this.add(allowSubstitutable);
     ...
     */
    public LabeledCheckBoxFigure  getAllowSubstitutable() {
