...
import org.eclipse.papyrus.tabbedproperties.uml.figures.AddVariableValueActionFormForm;
...
/**
 * The AddVariableValueAction property section for the AddVariableValueAction element
 * 
 *
 * @generated
 */
public class AddVariableValueActionSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private AddVariableValueActionFormForm addVariableValueActionForm;

	/**
	 * The AddVariableValueAction to edit 
	 * @generated
	 */
	private AddVariableValueAction addVariableValueActionElement;
	 ...
	 * @generated
	 */
	public AddVariableValueActionSection() {
	...
	public PropertyEditor createFigure() {
		addVariableValueActionForm = new AddVariableValueActionFormForm("AddVariableValueAction","An add variable value action is a write variable action for adding values to a variable.");
		return addVariableValueActionForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isReplaceAll of AddVariableValueAction
		BooleanPropertyChangeListener isReplaceAllListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,addVariableValueActionElement, UMLPackage.eINSTANCE.getAddVariableValueAction_IsReplaceAll(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		addVariableValueActionForm.getIsReplaceAll().setPropertyChangeListener(isReplaceAllListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						addVariableValueActionForm.getIsReplaceAll().setValue(addVariableValueActionElement.isReplaceAll());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.addVariableValueActionElement = (AddVariableValueAction)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof AddVariableValueAction;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		addVariableValueActionElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		addVariableValueActionElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(addVariableValueActionElement!=null){
		addVariableValueActionElement.eAdapters().remove(modelListener);}
		if(addVariableValueActionForm!=null){
		addVariableValueActionForm.dispose();
		}
		super.dispose();
	}
