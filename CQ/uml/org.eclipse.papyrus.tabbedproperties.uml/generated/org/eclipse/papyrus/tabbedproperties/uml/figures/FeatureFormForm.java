...
/**
 * The FeatureForm form
 *
 *
 * @generated
 */ 
public class FeatureFormForm extends AbstractControlsGroup {
	...
	public FeatureFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isStatic;
    ...
    public void createDirectChildren() {
		//
		isStatic = new LabeledCheckBoxFigure("IsStatic", "");
		this.add(isStatic);
     ...
     * @return the isStatic
     */
    public LabeledCheckBoxFigure  getIsStatic() {
        return isStatic;
    }
