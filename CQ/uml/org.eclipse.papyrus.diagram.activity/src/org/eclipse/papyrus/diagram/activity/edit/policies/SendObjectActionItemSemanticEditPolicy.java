...
import org.eclipse.papyrus.diagram.activity.edit.commands.InputPin2CreateCommand;
import org.eclipse.papyrus.diagram.activity.edit.commands.InputPinCreateCommand;
...
import org.eclipse.papyrus.diagram.activity.edit.commands.ValuePinCreateCommand;
...
public class SendObjectActionItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UMLElementTypes.InputPin_2002 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE.getSendObjectAction_Target());
			}
			return getGEFWrapper(new InputPinCreateCommand(req));
		}
		if (UMLElementTypes.InputPin_2003 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE.getSendObjectAction_Request());
			}
			return getGEFWrapper(new InputPin2CreateCommand(req));
		}
		if (UMLElementTypes.ValuePin_2004 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE.getSendObjectAction_Request());
			}
			return getGEFWrapper(new ValuePinCreateCommand(req));
		}
