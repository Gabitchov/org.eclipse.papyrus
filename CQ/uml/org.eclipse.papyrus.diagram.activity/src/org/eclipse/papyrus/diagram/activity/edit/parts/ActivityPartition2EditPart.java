...
public class ActivityPartition2EditPart extends ShapeNodeEditPart implements PrimaryShapeEditPart {
	 ...
	 * @NOT-generated
	 */
	private IGraphicalEditPart getInActivityEditPart(ActivityPartition2EditPart a) {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivityPartitionActivityPartitionCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureActivityPartitionFigure_body();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
			pane.add(((ActivityPartitionActivityPartitionCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ActivityPartitionActivityPartitionCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureActivityPartitionFigure_body();
			pane.remove(((ActivityPartitionActivityPartitionCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
