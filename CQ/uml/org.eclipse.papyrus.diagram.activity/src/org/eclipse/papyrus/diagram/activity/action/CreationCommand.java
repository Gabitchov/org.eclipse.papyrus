...
/**
 * Define a command to create a new Activity Diagram.
 * 
 * @author <a href="mailto:jerome.benois@obeo.fr">Jerome Benois</a>
 */
public class CreationCommand extends CreateGmfActivityDiagramCommandHandler implements ICreationCommand {
