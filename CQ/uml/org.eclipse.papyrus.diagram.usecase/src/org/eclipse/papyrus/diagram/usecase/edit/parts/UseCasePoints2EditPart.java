...
import org.eclipse.papyrus.diagram.usecase.edit.policies.UseCasePoints2CanonicalEditPolicy;
...
public class UseCasePoints2EditPart extends ListCompartmentEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new UseCasePoints2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE, new CreationEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new UseCasePoints2CanonicalEditPolicy());
	}
