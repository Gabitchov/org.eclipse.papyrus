 ...
 * @generated
 */
public class Actor2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(Actor2EditPart.VISUAL_ID);
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.ACTOR_2003_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.ACTOR_2003_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.ACTOR_2003_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.ACTOR_2003_PREF_LINE_COLOR);
