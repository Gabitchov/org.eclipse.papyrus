...
public class Message4EditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.CONNECTION_ROLE, new ConnectionEditPolicy() {
			...
			protected Command createDeleteViewCommand(GroupRequest deleteRequest) {
				...
				command = command.chain(new ICommandProxy(new RemoveEObjectReferencesFromDiagram(getEditingDomain(), Message4EditPart.this.getDiagramView(), Collections
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MessageName4EditPart) {
			((MessageName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureMessageSignalLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	static final Font FFIGUREMESSAGESIGNALLABELFIGURE_FONT = new Font(Display.getCurrent(), "SANS", 9, SWT.NORMAL);
