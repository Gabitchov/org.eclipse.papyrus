...
public class ElementInitializers {
	 ...
	 * @generated
	 */
	public static void init_BehaviorExecutionSpecification_2003(BehaviorExecutionSpecification instance) {
		try {
	...
	public static void init_Message_3002(Message instance) {
		try {
			Object value0 = UMLOCLFactory.getExpression("MessageSort::asynchCall", UMLPackage.eINSTANCE.getMessage()).evaluate(instance);

			value0 = UMLAbstractExpression.performCast(value0, UMLPackage.eINSTANCE.getMessageSort());
	...
	public static void init_Message_3003(Message instance) {
		try {
			Object value0 = UMLOCLFactory.getExpression("MessageSort::reply", UMLPackage.eINSTANCE.getMessage()).evaluate(instance);
	...
	public static void init_Message_3004(Message instance) {
		try {
			Object value0 = UMLOCLFactory.getExpression("MessageSort::asynchSignal", UMLPackage.eINSTANCE.getMessage()).evaluate(instance);
	...
	public static void init_Message_3005(Message instance) {
		try {
			Object value0 = UMLOCLFactory.getExpression("MessageSort::createMessage", UMLPackage.eINSTANCE.getMessage()).evaluate(instance);
	...
	public static void init_Message_3006(Message instance) {
		try {
			Object value0 = UMLOCLFactory.getExpression("MessageSort::deleteMessage", UMLPackage.eINSTANCE.getMessage()).evaluate(instance);
	 ...
	 *            implementation provided
	 */
	private static String name_BehaviorExecutionSpecification_2003(BehaviorExecutionSpecification self) {
		if (self != null && self.eContainer() != null) {
			return LabelHelper.INSTANCE.findName(self.eContainer(), self);
		}
		return "";
