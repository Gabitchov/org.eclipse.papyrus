...
public class UMLPaletteFactory {
	...
	private PaletteContainer createInteraction1Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(Messages.Interaction1Group_title);
	...
	private PaletteContainer createMessages3Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(Messages.Messages3Group_title);
	...
	private PaletteContainer createComments4Group() {
		PaletteDrawer paletteContainer = new PaletteDrawer(Messages.Comments4Group_title);
	...
	private ToolEntry createInteraction1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Interaction_1001));
	...
	private ToolEntry createLifeline1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.Lifeline1CreationTool_title, Messages.Lifeline1CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Lifeline_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createExecutionBehaviour2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.ExecutionBehaviour2CreationTool_title, Messages.ExecutionBehaviour2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.BehaviorExecutionSpecification_2003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCombinedFragment3CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(Messages.CombinedFragment3CreationTool_title, Messages.CombinedFragment3CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.CombinedFragment_2004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCallsynch1CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.Callsynch1CreationTool_title, Messages.Callsynch1CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Message_3001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCallasynch2CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.Callasynch2CreationTool_title, Messages.Callasynch2CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Message_3002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createReply3CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.Reply3CreationTool_title, Messages.Reply3CreationTool_desc, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Message_3003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createSendSignal5CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.SendSignal5CreationTool_title, null, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Message_3004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCreationEvent6CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.CreationEvent6CreationTool_title, null, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Message_3005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createDestructionEvent7CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(Messages.DestructionEvent7CreationTool_title, null, types);
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Message_3006));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createComment1CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.Comment_2005));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCommentLink2CreationTool() {
		...
		entry.setSmallIcon(UMLElementTypes.getImageDescriptor(UMLElementTypes.ElementOwnedComment_3007));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
