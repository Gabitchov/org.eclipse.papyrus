...
public class LifelineNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.Lifeline_2002, getParserElement(), parserHint);
	...
	private void refreshParentLifelineBounds() {
		...
		Command command = ((IGraphicalEditPart) this.getParent()).getCommand(request);
