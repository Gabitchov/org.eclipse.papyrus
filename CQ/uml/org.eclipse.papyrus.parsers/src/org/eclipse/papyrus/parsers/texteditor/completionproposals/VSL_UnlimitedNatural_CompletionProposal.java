...
public class VSL_UnlimitedNatural_CompletionProposal implements ICompletionProposalComputer {
	...
	final static private String[] TVL_UnlimitedNatural_Strings = {
			"",
			"0x",
			"*",
	};
	...
	final static private String[] TVL_UnlimitedNatural_StringsInfo = {
		NFPMessages.UnlimitedNatural_Decimal_StringsInfo,
		NFPMessages.UnlimitedNatural_Hexadecimal_StringsInfo,
		NFPMessages.UnlimitedNatural_Star_StringsInfo,
	}; 

	/** Text displayed in the completion area window */
	final static private String[] TVL_UnlimitedNatural_StringName = {
			NFPMessages.UnlimitedNatural_Decimal_StringName,
			NFPMessages.UnlimitedNatural_Hexadecimal_StringName,
			NFPMessages.UnlimitedNatural_Star_StringName,
	};
		...
		for(int i=0; i < TVL_UnlimitedNatural_Strings.length; i++) {
			if(TVL_UnlimitedNatural_Strings[i].startsWith(prefix)) {
				proposal = new CompletionProposal(
						TVL_UnlimitedNatural_Strings[i],
						documentOffset-prefix.length(),
						prefix.length()+selectionRange,
						TVL_UnlimitedNatural_Strings[i].length(),
						null,
						TVL_UnlimitedNatural_StringName[i],
						null,
						TVL_UnlimitedNatural_StringsInfo[i]);
				v.add(proposal);
			}
		}
