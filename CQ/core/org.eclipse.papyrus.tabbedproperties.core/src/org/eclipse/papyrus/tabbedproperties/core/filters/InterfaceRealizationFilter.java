 ...
 */
public class InterfaceRealizationFilter extends ViewerFilter {
	...
	public boolean select(Viewer viewer, Object parentElement, Object element) {
		...
		if(element instanceof Resource){
			...
			while(iter.hasNext()){
				if (iter.next() instanceof org.eclipse.uml2.uml.InterfaceRealization){
					return true;
				}
			}
		}
		...
		if(element instanceof org.eclipse.uml2.uml.InterfaceRealization){
			return true;
		}
		//else
		return false;
