 ...
 * 
 */
public abstract class VerticalBoxGroup implements ControlGroup, ControlWrapper {
	 ...
	 * Control group
	 */
	protected List<ControlGroupChild> childs = new ArrayList<ControlGroupChild>();;
	 ...
	 * @return ControlNode
	 */
	public final void createAllChilds() {

		// Create children. This will populate children
		createDirectChildren();
		// iterate children
		for (ControlGroupChild control : childs) {
			if (control != null) {
	...
	public void add(PropertyEditor control) {
		if (control != null)
			childs.add(new PropertyEditorToGroupWrapper(control));
	}
