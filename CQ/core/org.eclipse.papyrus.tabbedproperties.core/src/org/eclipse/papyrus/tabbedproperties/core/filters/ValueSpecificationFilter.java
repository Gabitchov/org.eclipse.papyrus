 ...
 */
public class ValueSpecificationFilter extends ViewerFilter {
	...
	public boolean select(Viewer viewer, Object parentElement, Object element) {
		...
		if(element instanceof Resource){
			...
			while(iter.hasNext()){
				if (iter.next() instanceof org.eclipse.uml2.uml.ValueSpecification){
					return true;
				}
			}
		}
		...
		// ok this is finally a ValueSpecification
		if(element instanceof org.eclipse.uml2.uml.ValueSpecification){
			return true;
		}
		//else
		return false;
