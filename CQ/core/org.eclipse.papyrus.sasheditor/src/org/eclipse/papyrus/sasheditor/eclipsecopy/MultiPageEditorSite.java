...
/**
 * Site for a nested editor within a multi-page editor. Selection is handled by forwarding the event to the multi-page editor's selection listeners; most other methods are forwarded to the multi-page
 * editor's site.
 * <p>
...
public class MultiPageEditorSite implements IEditorSite, INestable {
	...
	private void initializeDefaultServices() {
		serviceLocator.registerService(IWorkbenchLocationService.class, new WorkbenchLocationService(IServiceScopes.MPESITE_SCOPE, getWorkbenchWindow().getWorkbench(), getWorkbenchWindow(),
				getMultiPageEditor().getSite(), this, null, 3));
	}
	...
	public IKeyBindingService getKeyBindingService() {
		if (service == null) {
			...
			if (service instanceof INestableKeyBindingService) {
				...
				/*
				 * This is an internal reference, and should not be copied by client code. If you are thinking of copying this, DON'T DO IT.
				 */
				WorkbenchPlugin
