 ...
 */
public abstract class MultiPageEditorTile /* extends EditorPart */{
	 ...
	 * 
	 * @see MultiPageEditorTile#setControl(int, Control)
	 */
	 ...
	 * 
	 * @see MultiPageEditorTile#handlePropertyChange(int) the handler for property change events from the nested editor
	 */
	...
	public void addPage(int index, IEditorPart editor, IEditorInput input) throws PartInitException {
		...
		editor.addPropertyListener(new IPropertyListener() {
			...
			public void propertyChanged(Object source, int propertyId) {
				MultiPageEditorTile.this.handlePropertyChange(propertyId);
			}
		});
	...
	protected CTabFolder createContainer(Composite parent) {
		...
		newContainer.addCTabFolder2Listener(new CTabFolder2Adapter() {
			...
			public void close(CTabFolderEvent event) {
				System.out.println("Close item requested !");
				// Prevent close
				event.doit = false;
			}
		});
	...
	protected void initializePageSwitching() {
		// Not use for now in sash window
	...
	protected IEditorSite createSite(IEditorPart editor) {
		return new MultiPageEditorSite(getMultiPageEditorPart(), editor);
	}
	 ...
	 * @param pageIndex
	 *            the index of the page
	 * @see MultiPageEditorTile#addPage(Control)
	 * @see MultiPageEditorTile#addPage(IEditorPart, IEditorInput)
	 */
	...
	/**
	 * Get the main editor. Needed by MultiPageEditorSite
	 */
	private MultiPageEditorPart getMultiPageEditorPart() {
		// This method assume that the main editor is subclass of MultiPageEditorPart
		return (MultiPageEditorPart) getEditorSite().getPart();
	}

	/**
	 * Set the internal control. Not intended for external use. Needed to initialize the control when the node is synchronized
	 * 
	 * @param control
	 */
	protected void setContainer(CTabFolder control) {
