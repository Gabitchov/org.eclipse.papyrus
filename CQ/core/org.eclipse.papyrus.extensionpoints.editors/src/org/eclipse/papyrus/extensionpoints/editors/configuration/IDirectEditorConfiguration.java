...
public interface IDirectEditorConfiguration {
	 ...
	 * @param newText the text to save
	 * @return the result of this action
	 */
	 ...
	 * @param parent the parent of the returned composite
	 * @return the extended Area for the dialog window or <code>null</code> if no extension is required
	 */
	 ...
	 * @param language the language of the edited body
	 */
