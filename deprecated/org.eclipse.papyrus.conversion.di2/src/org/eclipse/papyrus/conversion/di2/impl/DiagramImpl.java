 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.conversion.di2.impl.DiagramImpl#getOwner <em>Owner</em>}</li>
 * <li>{@link org.eclipse.papyrus.conversion.di2.impl.DiagramImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.papyrus.conversion.di2.impl.DiagramImpl#getZoom <em>Zoom</em>}</li>
 * <li>{@link org.eclipse.papyrus.conversion.di2.impl.DiagramImpl#getViewport <em>Viewport
 * </em>}</li>
 * <li>{@link org.eclipse.papyrus.conversion.di2.impl.DiagramImpl#getDiagramLink <em>Diagram
 * Link</em>}</li>
 * <li>{@link org.eclipse.papyrus.conversion.di2.impl.DiagramImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class DiagramImpl extends GraphNodeImpl implements Diagram {
	...
	protected EClass eStaticClass() {
		return Di2Package.Literals.DIAGRAM;
	}
	...
	public NotificationChain basicSetOwner(SemanticModelBridge newOwner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Di2Package.DIAGRAM__OWNER,
					oldOwner, newOwner);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOwner(SemanticModelBridge newOwner) {
		if (newOwner != owner) {
			...
			if (owner != null)
				msgs = ((InternalEObject) owner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- Di2Package.DIAGRAM__OWNER, null, msgs);
			if (newOwner != null)
				msgs = ((InternalEObject) newOwner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- Di2Package.DIAGRAM__OWNER, null, msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Di2Package.DIAGRAM__OWNER, newOwner, newOwner));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Di2Package.DIAGRAM__NAME, oldName, name));
	}
	...
	public void setZoom(double newZoom) {
		...
		zoom = newZoom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Di2Package.DIAGRAM__ZOOM, oldZoom, zoom));
	}
	...
	public void setViewport(Point newViewport) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Di2Package.DIAGRAM__VIEWPORT, oldViewport, viewport));
	}
	...
	public EList<DiagramLink> getDiagramLink() {
		if (diagramLink == null) {
			diagramLink = new EObjectResolvingEList<DiagramLink>(DiagramLink.class, this,
					Di2Package.DIAGRAM__DIAGRAM_LINK);
		}
		return diagramLink;
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Di2Package.DIAGRAM__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Di2Package.DIAGRAM__OWNER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Di2Package.DIAGRAM__OWNER:
			return getOwner();
		case Di2Package.DIAGRAM__NAME:
			return getName();
		case Di2Package.DIAGRAM__ZOOM:
			return new Double(getZoom());
		case Di2Package.DIAGRAM__VIEWPORT:
			return getViewport();
		case Di2Package.DIAGRAM__DIAGRAM_LINK:
			return getDiagramLink();
		case Di2Package.DIAGRAM__TYPE:
			return getType();
		}
