...
public class ConditionalNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ConditionalNodePropertiesEditionPart {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createClauseAdvancedTableComposition(propertiesGroup);
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.ownedComment,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if(propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.name, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}
				...
				TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(resourceSet, clientDependencyFilters, clientDependencyBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.clientDependency,
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.clientDependency,
	...
	protected void editClientDependency(Dependency element) {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this,
				...
				TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(resourceSet, outgoingFilters, outgoingBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.outgoing,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						outgoing.refresh();
					}
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.outgoing,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
				...
				TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(resourceSet, incomingFilters, incomingBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.incoming,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						incoming.refresh();
					}
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.incoming,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
				...
				TabElementTreeSelectionDialog<ActivityPartition> dialog = new TabElementTreeSelectionDialog<ActivityPartition>(resourceSet, inPartitionFilters, inPartitionBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.inPartition,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						inPartition.refresh();
					}
	...
	protected void moveInPartition(ActivityPartition element, int oldIndex, int newIndex) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromInPartition(ActivityPartition element) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.inPartition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
				...
				TabElementTreeSelectionDialog<InterruptibleActivityRegion> dialog = new TabElementTreeSelectionDialog<InterruptibleActivityRegion>(resourceSet, inInterruptibleRegionFilters, inInterruptibleRegionBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.inInterruptibleRegion,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void moveInInterruptibleRegion(InterruptibleActivityRegion element, int oldIndex, int newIndex) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
				...
				TabElementTreeSelectionDialog<ActivityNode> dialog = new TabElementTreeSelectionDialog<ActivityNode>(resourceSet, redefinedNodeFilters, redefinedNodeBusinessFilters,
					...
					public void process(IStructuredSelection selection) {
						for(Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.redefinedNode,
									PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.redefinedNode,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void moveHandler(ExceptionHandler element, int oldIndex, int newIndex) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.handler, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToHandler() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.handler,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void moveLocalPrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.localPrecondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToLocalPrecondition() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this,
						UMLViewsRepository.ConditionalNode.localPrecondition, PropertiesEditionEvent.CHANGE,
	...
	protected void removeFromLocalPrecondition(Constraint element) {
		...
		localPrecondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.localPrecondition,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void moveLocalPostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.localPostcondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToLocalPostcondition() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this,
						UMLViewsRepository.ConditionalNode.localPostcondition, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromLocalPostcondition(Constraint element) {
		...
		localPostcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.localPostcondition,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.elementImport, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToElementImport() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this,
						UMLViewsRepository.ConditionalNode.elementImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromElementImport(ElementImport element) {
		...
		elementImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.elementImport,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.packageImport, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToPackageImport() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this,
						UMLViewsRepository.ConditionalNode.packageImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromPackageImport(PackageImport element) {
		...
		packageImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.packageImport,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.ownedRule, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToOwnedRule() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.ownedRule,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void moveVariable(Variable element, int oldIndex, int newIndex) {
		...
		variable.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.variable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToVariable() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				variable.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.variable,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromEdge(ActivityEdge element) {
		...
		edge.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.edge,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void removeFromNode(ActivityNode element) {
		...
		node.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.node,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	 ...
	 * @param container
	 */
	protected void createClauseAdvancedTableComposition(Composite parent) {
	...
	protected void moveClause(Clause element, int oldIndex, int newIndex) {
		...
		clause.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.clause, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToClause() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				clause.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.clause,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromClause(Clause element) {
		...
		// Start of user code removeFromClause() method body
		EObject editedElement = clauseEditUtil.foundCorrespondingEObject(element);
	...
	protected void moveResult(OutputPin element, int oldIndex, int newIndex) {
		...
		result.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.result, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void addToResult() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				result.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ConditionalNodePropertiesEditionPartImpl.this, UMLViewsRepository.ConditionalNode.result,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
