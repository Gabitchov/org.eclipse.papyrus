...
public class ExceptionHandlerPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The ExceptionHandlerBasePropertiesEditionComponent sub component
	 */
	protected ExceptionHandlerBasePropertiesEditionComponent exceptionHandlerBasePropertiesEditionComponent;
	...
	public ExceptionHandlerPropertiesEditionComponent(EObject exceptionHandler, String editing_mode) {
		...
		if(exceptionHandler instanceof ExceptionHandler) {
			exceptionHandlerBasePropertiesEditionComponent = new ExceptionHandlerBasePropertiesEditionComponent(exceptionHandler, editing_mode);
			addSubComponent(exceptionHandlerBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(exceptionHandler, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (ExceptionHandlerPropertiesEditionPart)exceptionHandlerBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.ExceptionHandler.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (ExceptionHandlerPropertiesEditionPart)propertiesEditionPart;
		}
	}
