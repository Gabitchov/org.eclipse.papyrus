...
public class ExtensionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public ExtensionPropertiesEditionComponent(EObject extension, String editing_mode) {
		...
		if(extension instanceof Extension) {
			extensionBasePropertiesEditionComponent = new ExtensionBasePropertiesEditionComponent(extension, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (ExtensionPropertiesEditionPart)extensionBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
