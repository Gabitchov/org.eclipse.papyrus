 ...
 *****************************************************************************/
package org.eclipse.papyrus.properties.model.xwt.resource;
...
public class XWTResource extends ResourceImpl {
	...
	private CompositeWidget xmlToUISection(Root genericXMLRoot) {
		URI transformationURI = URI.createURI("platform:/plugin/org.eclipse.papyrus.properties.model.xwt/Transformation/XMLToUI.qvto"); //$NON-NLS-1$
	...
	private Root uiSectionToXML(CompositeWidget widget) {
		URI transformationURI = URI.createURI("platform:/plugin/org.eclipse.papyrus.properties.model.xwt/Transformation/UIToXML.qvto"); //$NON-NLS-1$
		TransformationExecutor executor = new TransformationExecutor(transformationURI);
