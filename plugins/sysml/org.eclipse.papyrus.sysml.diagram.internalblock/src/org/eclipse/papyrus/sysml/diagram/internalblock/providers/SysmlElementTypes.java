...
public class SysmlElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType Resource_1000 = getElementType("org.eclipse.papyrus.sysml.diagram.internalblock.Resource_1000"); //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final IElementType FlowPort_2001 = getElementType("org.eclipse.papyrus.sysml.diagram.internalblock.FlowPort_2001"); //$NON-NLS-1$
	...
	private static ImageDescriptor getProvidedImageDescriptor(ENamedElement element) {
		...
		if (element instanceof EClass) {
			...
			if (!eClass.isAbstract()) {
				return InternalBlockDiagramEditorPlugin.getInstance().getItemImageDescriptor(
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(FlowPort_2001, PortandflowsPackage.eINSTANCE.getFlowPort());
		}
