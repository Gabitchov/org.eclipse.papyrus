...
public class CommentPreferencePage extends InternalBlockDiagramNodePreferencePage {
	...
	public static String prefKey = InternalBlockDiagramEditPart.DIAGRAM_ID + "_Comment";

	public CommentPreferencePage() {
		super();
		setPreferenceKey(InternalBlockDiagramEditPart.DIAGRAM_ID + "_Comment"); //$NON-NLS-1$
	}
