...
implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(SysmlVisualIDRegistry
				.getType(org.eclipse.papyrus.sysml.diagram.parametric.edit.parts.PropertyName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SysmlParserProvider
					.getParser(
							SysmlElementTypes.Property_3002,
							getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this),
					SysmlEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
