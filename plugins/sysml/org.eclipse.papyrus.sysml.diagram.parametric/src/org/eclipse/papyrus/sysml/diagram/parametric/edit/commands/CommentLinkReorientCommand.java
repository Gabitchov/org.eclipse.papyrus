...
public class CommentLinkReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return SysmlBaseItemSemanticEditPolicy.getLinkConstraints().canExistCommentAnnotatedElement_4002(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return SysmlBaseItemSemanticEditPolicy.getLinkConstraints().canExistCommentAnnotatedElement_4002(getOldSource(), getNewTarget());
	}
