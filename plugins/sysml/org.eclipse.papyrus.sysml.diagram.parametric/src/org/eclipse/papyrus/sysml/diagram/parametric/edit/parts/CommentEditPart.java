...
import org.eclipse.papyrus.sysml.diagram.parametric.edit.policies.CommentItemSemanticEditPolicy;
...
public class CommentEditPart extends ShapeNodeEditPart {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(SysmlVisualIDRegistry.getType(CommentBodyLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.sysml.diagram.parametric.edit.parts.CommentEditPart) {
			types.add(SysmlElementTypes.CommentAnnotatedElement_4002);
		}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if(relationshipType == SysmlElementTypes.CommentAnnotatedElement_4002) {
