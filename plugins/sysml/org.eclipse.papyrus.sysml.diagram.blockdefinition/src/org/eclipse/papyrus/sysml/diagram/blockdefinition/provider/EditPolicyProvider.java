...
public class EditPolicyProvider extends AbstractProvider implements IEditPolicyProvider {
	...
	public boolean provides(IOperation operation) {
		...
		if((gep instanceof PackagePackageableElementCompartmentEditPart) || (gep instanceof PackagePackageableElementCompartmentEditPartCN) || (gep instanceof ModelPackageableElementCompartmentEditPartTN) || (gep instanceof ModelPackageableElementCompartmentEditPartCN) || (gep instanceof ModelPackageableElementCompartmentEditPartCN)) {
	...
	public void createEditPolicies(EditPart editPart) {
		...
		if((editPart instanceof PackagePackageableElementCompartmentEditPart) || (editPart instanceof PackagePackageableElementCompartmentEditPartCN)) {
