...
public class DataTypePreferencePage extends BlockDefinitionDiagramNodePreferencePage {
	 ...
	 */
	public static final String compartments[] = { Messages.DataTypeAttributeCompartmentEditPart_title, Messages.DataTypeOperationCompartmentEditPart_title };
	...
	public DataTypePreferencePage() {
		super();
		setPreferenceKey(BlockDefinitionDiagramEditPart.DIAGRAM_ID + "_DataType"); //$NON-NLS-1$
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = BlockDefinitionDiagramEditPart.DIAGRAM_ID + "_DataType";
