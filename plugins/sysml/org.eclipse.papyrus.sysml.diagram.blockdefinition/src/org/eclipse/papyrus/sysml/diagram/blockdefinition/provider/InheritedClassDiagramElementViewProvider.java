...
public class InheritedClassDiagramElementViewProvider extends UMLViewProvider {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		if((elementType == BlockDefinitionDiagramElementTypes.DEPENDENCY) || (elementType == BlockDefinitionDiagramElementTypes.USAGE) || (elementType == BlockDefinitionDiagramElementTypes.INTERFACE_REALIZATION) || (elementType == BlockDefinitionDiagramElementTypes.ASSOCIATION) || (elementType == BlockDefinitionDiagramElementTypes.ASSOCIATION_CLASS_EDGE) || (elementType == BlockDefinitionDiagramElementTypes.ASSOCIATION_CLASS_LINK) || (elementType == BlockDefinitionDiagramElementTypes.GENERALIZATION) || (elementType == BlockDefinitionDiagramElementTypes.GENERALIZATION_SET) || (elementType == BlockDefinitionDiagramElementTypes.COMMENT_ANNOTATED_ELEMENT) || (elementType == BlockDefinitionDiagramElementTypes.CONSTRAINT_CONSTRAINED_ELEMENT) || (elementType == BlockDefinitionDiagramElementTypes.CONTAINMENT_LINK) || (elementType == BlockDefinitionDiagramElementTypes.CONTAINMENT_ADDED_LINK)) {
	...
	public static boolean provides(IElementType elementType) {
		...
		|| (elementType == BlockDefinitionDiagramElementTypes.PRIMITIVE_TYPE) || (elementType == BlockDefinitionDiagramElementTypes.PRIMITIVE_TYPE_CN)
		...
		|| (elementType == BlockDefinitionDiagramElementTypes.DATA_TYPE) || (elementType == BlockDefinitionDiagramElementTypes.DATA_TYPE_CN) || (elementType == BlockDefinitionDiagramElementTypes.DATA_TYPE_PROPERTY_CLN) || (elementType == BlockDefinitionDiagramElementTypes.DATA_TYPE_OPERATION_CLN)

		|| (elementType == BlockDefinitionDiagramElementTypes.INSTANCE_SPECIFICATION) || (elementType == BlockDefinitionDiagramElementTypes.INSTANCE_SPECIFICATION_CN) || (elementType == BlockDefinitionDiagramElementTypes.INSTANCE_SPECIFICATION_SLOT_CLN)
