...
public class InheritedClassDiagramElementEditPartProvider extends CUMLEditPartProvider {
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			System.err.println("etl : " + view.getElement());
			// Elt null ? -> test...
			...
			/** Model */
			if (InheritedElementTypes.MODEL.getSemanticHint().equals(hint)
					|| InheritedElementTypes.MODEL_NAME_LABEL_HINT.equals(hint)
					|| InheritedElementTypes.MODEL_COMPARTMENT_HINT.equals(hint)) {
				return true;
			}

			if (InheritedElementTypes.MODEL_CN.getSemanticHint().equals(hint)
					|| InheritedElementTypes.MODEL_CN_NAME_LABEL_HINT.equals(hint)
					|| InheritedElementTypes.MODEL_CN_COMPARTMENT_HINT.equals(hint)) {
				return true;
			}
			...
			/** Comment */
			if (InheritedElementTypes.COMMENT.getSemanticHint().equals(hint)
					|| InheritedElementTypes.COMMENT_BODY_LABEL_HINT.equals(hint)) {
				return true;
			}

			if (InheritedElementTypes.COMMENT_CN.getSemanticHint().equals(hint)
					|| InheritedElementTypes.COMMENT_CN_BODY_LABEL_HINT.equals(hint)) {
				return true;
			}

			/** Constraint */
			if (InheritedElementTypes.CONSTRAINT.getSemanticHint().equals(hint)
					|| InheritedElementTypes.CONSTRAINT_NAME_LABEL_HINT.equals(hint)
					|| InheritedElementTypes.CONSTRAINT_SPEC_LABEL_HINT.equals(hint)) {
				return true;
			}

			if (InheritedElementTypes.CONSTRAINT_CN.getSemanticHint().equals(hint)
					|| InheritedElementTypes.CONSTRAINT_CN_NAME_LABEL_HINT.equals(hint)
					|| InheritedElementTypes.CONSTRAINT_CN_SPEC_LABEL_HINT.equals(hint)) {
				return true;
			}
			...
			/** GeneralizationSet */
			if (InheritedElementTypes.GENERALIZATION_SET.getSemanticHint().equals(hint)
					|| InheritedElementTypes.GENERALIZATION_SET_LABEL_HINT.equals(hint)) {
				return true;
			}
			...
			/** ContainmentLink */
			if ((InheritedElementTypes.CONTAINMENT_LINK.getSemanticHint().equals(hint))
					|| (InheritedElementTypes.CONTAINMENT_ADDED_LINK.getSemanticHint().equals(hint))) {
				return true;
			}
