...
public class InheritedClassDiagramElementEditPartProvider extends CUMLEditPartProvider {
	...
	public synchronized boolean provides(IOperation operation) {
		if(operation instanceof CreateGraphicEditPartOperation) {
			...
			/** DATA_TYPE */
			if(InheritedElementTypes.DATA_TYPE.getSemanticHint().equals(hint) || InheritedElementTypes.DATA_TYPE_LABEL_NAME_HINT.equals(hint) || InheritedElementTypes.DATA_TYPE_COMPARTMENT_ATTRIBUTE_HINT.equals(hint) || InheritedElementTypes.DATA_TYPE_COMPARTMENT_OPERATION_HINT.equals(hint) || InheritedElementTypes.DATA_TYPE_PROPERTY_CLN.getSemanticHint().equals(hint) || InheritedElementTypes.DATA_TYPE_OPERATION_CLN.getSemanticHint().equals(hint)) {
				return true;
			}
			...
			if(InheritedElementTypes.INSTANCE_SPECIFICATION_CN.getSemanticHint().equals(hint) || InheritedElementTypes.INSTANCE_SPECIFICATION_CN_LABEL_NAME_HINT.equals(hint) || InheritedElementTypes.INSTANCE_SPECIFICATION_CN_COMPARTMENT_SLOT_HINT.equals(hint)) {
				return true;
			}
			...
			if(InheritedElementTypes.COMMENT_CN.getSemanticHint().equals(hint) || InheritedElementTypes.COMMENT_CN_LABEL_BODY2_HINT.equals(hint)) {
				return true;
			}
			...
			if(InheritedElementTypes.CONSTRAINT_CN.getSemanticHint().equals(hint) || InheritedElementTypes.CONSTRAINT_CN_LABEL_NAME2_HINT.equals(hint) || InheritedElementTypes.CONSTRAINT_CN_LABEL_BODY_HINT.equals(hint)) {
				return true;
			}
			...
			/** Association */
			if(InheritedElementTypes.ASSOCIATION.getSemanticHint().equals(hint) || InheritedElementTypes.ASSOCIATION_LABEL_NAME2_HINT.equals(hint) || InheritedElementTypes.ASSOCIATION_LABEL_APPLIED_STEREOTYPE_HINT.equals(hint) || InheritedElementTypes.ASSOCIATION_LABEL_NAME3_HINT.equals(hint) || InheritedElementTypes.ASSOCIATION_LABEL_NAME5_HINT.equals(hint) || InheritedElementTypes.ASSOCIATION_LABEL_MULTIPLICTY_SOURCE_HINT.equals(hint) || InheritedElementTypes.ASSOCIATION_LABEL_MULTIPLICTY_TARGET_HINT.equals(hint)) {
				return true;
			}
