...
public class FlowPortPreferencePage extends BlockDefinitionDiagramNodePreferencePage {
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		store.setDefault(LabelPreferenceHelper.getPreferenceConstant(prefKey, ILabelPreferenceConstants.LABEL_DISPLAY_PREFERENCE), DISP_DIRECTION | DISP_NAME | DISP_TYPE);

		String fportAffixedPrefKey = ElementTypes.DIAGRAM_ID + "_" + SysMLGraphicalTypes.SHAPE_SYSML_FLOWPORT_AS_AFFIXED_ID; //$NON-NLS-1$
		store.setDefault(PreferenceConstantHelper.getElementConstant(fportAffixedPrefKey, PreferenceConstantHelper.WIDTH), 20);
		store.setDefault(PreferenceConstantHelper.getElementConstant(fportAffixedPrefKey, PreferenceConstantHelper.HEIGHT), 20);
		// End of user code
	}
	...
	public static String prefLabelKey = ElementTypes.DIAGRAM_ID + "_" + SysMLGraphicalTypes.SHAPE_SYSML_FLOWPORT_AS_LABEL_ID; //$NON-NLS-1$	
