...
public class CustomEditPartProvider extends CustomAbstractEditPartProvider {
	...
	public CustomEditPartProvider() {
		...
		nodeMap.put(UMLGraphicalTypes.LABEL_UML_NAMEDELEMENT_NAME_ID, NamedElementLabelNameEditPart.class);
	}
	...
	public boolean provides(IOperation operation) {
		if(operation instanceof CreateGraphicEditPartOperation) {
			String graphicalType = ((IEditPartOperation)operation).getView().getType();
			if(!nodeMap.containsKey(graphicalType)) {
				return false;
			}
		}
