...
public class BlockPreferencePage extends BlockDefinitionDiagramNodePreferencePage {
	...
	public static final String compartments[] = { "properties", "parts", "references", "standard ports", "flow ports", "operations", "constraints", "values" };

	/** The list of visible (default preference) compartments for this node */
	public static final String default_compartments[] = { "properties", "operations", "constraints", "values" };
