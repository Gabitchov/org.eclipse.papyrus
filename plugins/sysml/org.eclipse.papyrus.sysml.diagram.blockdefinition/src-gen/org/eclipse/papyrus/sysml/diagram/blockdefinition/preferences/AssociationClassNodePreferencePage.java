...
public class AssociationClassNodePreferencePage extends BlockDefinitionDiagramNodePreferencePage {
	...
	protected static String prefKey = ElementTypes.DIAGRAM_ID + "_AssociationClassNode"; //$NON-NLS-1$
	...
	public AssociationClassNodePreferencePage() {
		super();
		setPreferenceKey(ElementTypes.DIAGRAM_ID + "_AssociationClassNode"); //$NON-NLS-1$
	}
