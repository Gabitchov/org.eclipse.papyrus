...
import org.eclipse.papyrus.sysml.diagram.common.edit.policy.ValueTypeItemSemanticEditPolicy;
...
public class ValueTypeEditPart extends AbstractElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValueTypeItemSemanticEditPolicy());
