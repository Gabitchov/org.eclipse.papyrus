 ...
 */
public class NamedElementAffixedLabelNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart, ILabelRoleProvider {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = ParserService.getInstance().getParser(new ParserHintAdapter(resolveSemanticElement(), getNotationView().getType()));
		}
		return parser;
	}
	...
	protected void initExtendedEditorConfiguration() {
		if(configuration == null) {
			final String languagePreferred = org.eclipse.papyrus.preferences.Activator.getDefault().getPreferenceStore().getString(IDirectEditorsIds.EDITOR_FOR_ELEMENT + resolveSemanticElement().eClass().getInstanceClassName());
	...
	protected void updateExtendedEditorConfiguration() {
		String languagePreferred = org.eclipse.papyrus.preferences.Activator.getDefault().getPreferenceStore().getString(IDirectEditorsIds.EDITOR_FOR_ELEMENT + resolveSemanticElement().eClass().getInstanceClassName());
