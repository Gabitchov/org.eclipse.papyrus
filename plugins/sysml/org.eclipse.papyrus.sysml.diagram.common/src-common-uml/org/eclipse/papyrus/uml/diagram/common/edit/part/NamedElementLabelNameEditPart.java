 ...
 */
public class NamedElementLabelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NamedElementLabelNameEditPart(View view) {
		super(view);
	}
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SelectionEditPolicy() {
			...
			public EditPart getTargetEditPart(Request request) {
				if(RequestConstants.REQ_SELECTION.equals(request.getType())) {
					return getHost().getParent(); // select the parent instead of this edit part
				}
