...
public class BlocksAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * {@link org.eclipse.papyrus.sysml.blocks.BindingConnector <em>Binding Connector</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.ConnectorProperty <em>Connector Property</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.Dimension <em>Dimension</em>}'. <!-- begin-user-doc
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.DistributedProperty <em>Distributed Property</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.NestedConnectorEnd <em>Nested Connector End</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.ParticipantProperty <em>Participant Property</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.PropertySpecificType <em>Property Specific Type</em>}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.papyrus.sysml.blocks.Unit
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.blocks.ValueType <em>Value Type</em>}'. <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
