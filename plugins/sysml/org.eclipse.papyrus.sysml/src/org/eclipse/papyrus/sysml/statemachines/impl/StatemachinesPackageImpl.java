...
public class StatemachinesPackageImpl extends EPackageImpl implements StatemachinesPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link StatemachinesPackage#eINSTANCE} when that field is
	...
	public static StatemachinesPackage init() {
		...
		StatemachinesPackageImpl theStatemachinesPackage = (StatemachinesPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof StatemachinesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
				: new StatemachinesPackageImpl());
