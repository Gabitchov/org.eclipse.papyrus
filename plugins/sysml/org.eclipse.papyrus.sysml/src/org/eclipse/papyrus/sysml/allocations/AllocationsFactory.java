...
public interface AllocationsFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Allocate</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Allocate Activity Partition</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Allocated</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
