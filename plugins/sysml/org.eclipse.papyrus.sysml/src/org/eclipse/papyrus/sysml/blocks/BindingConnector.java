 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.sysml.blocks.BindingConnector#getBase_Connector <em>Base Connector
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public interface BindingConnector extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Base Connector</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Base Connector</em>' reference isn't clear, there really should be
	 ...
	 * <em>Base Connector</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
