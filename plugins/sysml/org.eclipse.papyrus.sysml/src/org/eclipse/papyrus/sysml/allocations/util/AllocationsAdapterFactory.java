...
public class AllocationsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * <em>Allocate Activity Partition</em>}'. <!-- begin-user-doc --> This default implementation
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.allocations.Allocate <em>Allocate</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.papyrus.sysml.allocations.Allocated <em>Allocated</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
