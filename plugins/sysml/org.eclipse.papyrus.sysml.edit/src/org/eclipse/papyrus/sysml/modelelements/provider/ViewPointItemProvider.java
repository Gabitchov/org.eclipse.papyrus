 ...
 * @generated
 */
public class ViewPointItemProvider extends ResourceEObjectItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addStakeHoldersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
				...
				ModelelementsPackage.Literals.VIEW_POINT__STAKE_HOLDERS,
				true,
				false,
				false,
	...
	protected void addPurposePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
				...
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ViewPoint_purpose_feature"),
