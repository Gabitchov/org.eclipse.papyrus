 ...
 * @generated
 */
public class NestedConnectorEndItemProvider extends ResourceEObjectItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addPropertyPathPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
				...
				BlocksPackage.Literals.NESTED_CONNECTOR_END__PROPERTY_PATH,
				true,
				false,
				true,
				null,
	...
	protected void addBase_ConnectorEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
				...
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_NestedConnectorEnd_base_ConnectorEnd_feature"),
