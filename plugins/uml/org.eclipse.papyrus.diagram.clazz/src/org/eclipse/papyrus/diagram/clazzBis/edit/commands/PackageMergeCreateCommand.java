...
public class PackageMergeCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreatePackageMerge_3015(getContainer(), getSource(), getTarget());
	}
