...
import org.eclipse.papyrus.diagram.clazz.edit.parts.AppliedStereotypeSignalEditPart;
...
public class SignalViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(AppliedStereotypeSignalEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.SIGNAL_2003_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.SIGNAL_2003_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.SIGNAL_2003_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.SIGNAL_2003_PREF_LINE_COLOR);
