...
public class AssociationClass_2013PreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	public static void initDefaults(IPreferenceStore store) {
		PreferenceConverter.setDefault(store, IPapyrusPreferencesConstant.ASSOCIATIONCLASS_2013_PREF_FILL_COLOR, new org.eclipse.swt.graphics.RGB(255, 255, 255));
		PreferenceConverter.setDefault(store, IPapyrusPreferencesConstant.ASSOCIATIONCLASS_2013_PREF_LINE_COLOR, new org.eclipse.swt.graphics.RGB(177, 207, 229));
