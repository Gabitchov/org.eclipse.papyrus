 ...
 */
public class AppliedStereotypeLabelDisplayEditPolicy extends GraphicalEditPolicy implements NotificationListener, IPapyrusListener {
	...
	public void activate() {
		...
		getDiagramEventBroker().addNotificationListener((View) getHost().getModel(), this);
	...
	protected Element getUMLElement() {
		return (Element) ((View) (getHost().getModel())).getElement();
	}
	 ...
	 */
	private Map<String, List<String>> parseStereotypeProperties(String stereotypesToDisplay, String stereotypesPropertiesToDisplay) {
