...
public class CommentAnnotatedElementCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateCommentAnnotatedElement_3017(getSource(), getTarget());
	}
