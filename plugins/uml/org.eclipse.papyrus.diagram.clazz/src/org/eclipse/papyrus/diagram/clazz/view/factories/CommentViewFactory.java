...
public class CommentViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.COMMENT_2012_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.COMMENT_2012_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.COMMENT_2012_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.COMMENT_2012_PREF_LINE_COLOR);
