...
public class PrimitiveTypeViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.PRIMITIVETYPE_2009_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.PRIMITIVETYPE_2009_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.PRIMITIVETYPE_2009_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.PRIMITIVETYPE_2009_PREF_LINE_COLOR);
