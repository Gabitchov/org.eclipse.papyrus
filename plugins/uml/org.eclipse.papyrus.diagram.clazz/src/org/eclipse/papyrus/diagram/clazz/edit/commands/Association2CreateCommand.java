...
public class Association2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Association2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Association2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new Association2CreateCommand(req, eObject);
	}
