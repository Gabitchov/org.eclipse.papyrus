...
public class InstanceSpecificationViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.INSTANCESPECIFICATION_2001_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.INSTANCESPECIFICATION_2001_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.INSTANCESPECIFICATION_2001_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.INSTANCESPECIFICATION_2001_PREF_LINE_COLOR);
