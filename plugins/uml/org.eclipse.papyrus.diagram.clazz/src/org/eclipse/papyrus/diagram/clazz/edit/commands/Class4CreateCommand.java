...
public class Class4CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Class4CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Class4CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new Class4CreateCommand(req, eObject);
	}
