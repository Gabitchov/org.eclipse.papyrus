...
import org.eclipse.papyrus.diagram.clazz.custom.policies.itemsemantic.CustomDataTypeItemSemanticEditPolicyCN;
...

{
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataTypeItemSemanticEditPolicyCN());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());

		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.clazz.edit.policies.DataTypeCanonicalEditPolicyCN());
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomDataTypeItemSemanticEditPolicyCN());
		installEditPolicy(
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataTypeNameEditPartCN) {
			((DataTypeNameEditPartCN) childEditPart).setLabel(getPrimaryShape()
					.getNameLabel());
			return true;
		}
		...
		if (childEditPart instanceof DataTypeAttributeCompartment2EditPart) {
			...
			pane.add(((DataTypeAttributeCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		...
		if (childEditPart instanceof DataTypeOperationCompartment2EditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DataTypeOperationCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DataTypeAttributeCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAttributeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((DataTypeAttributeCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof DataTypeOperationCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getOperationCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((DataTypeOperationCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof RedefinableTemplateSignatureEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eclipse.papyrus.diagram.clazz.edit.parts.DataTypeEditPartCN) {
			types.add(UMLElementTypes.AssociationClass_4017);
		}
		if (targetEditPart instanceof AssociationClassEditPart) {
			types.add(UMLElementTypes.Association_4001);
