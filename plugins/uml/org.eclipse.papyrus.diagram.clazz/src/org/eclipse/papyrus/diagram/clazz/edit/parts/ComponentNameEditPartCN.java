 ...
 * @generated
 */
public class ComponentNameEditPartCN extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.ComponentNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
