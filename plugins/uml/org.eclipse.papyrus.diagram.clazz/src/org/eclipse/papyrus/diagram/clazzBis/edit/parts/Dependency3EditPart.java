...
public class Dependency3EditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.Dependency3ItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.DependencyName3EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.DependencyName3EditPart) childEditPart).setLabel(getPrimaryShape().getDependencyNameLabel());
			return true;
		}
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.DependencyName4EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.DependencyName4EditPart) childEditPart).setLabel(getPrimaryShape().getAppliedStereotypeLabel());
			return true;
		}
		return false;
	}
