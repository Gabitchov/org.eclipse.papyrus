...
public class Interface2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Interface2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Interface2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new Interface2CreateCommand(req, eObject);
	}
