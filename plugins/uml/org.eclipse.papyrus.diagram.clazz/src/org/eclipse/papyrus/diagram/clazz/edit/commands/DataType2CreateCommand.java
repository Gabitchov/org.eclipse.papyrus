...
public class DataType2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public DataType2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static DataType2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new DataType2CreateCommand(req, eObject);
	}
