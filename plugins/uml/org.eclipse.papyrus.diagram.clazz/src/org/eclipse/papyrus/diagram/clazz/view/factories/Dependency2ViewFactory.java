...
public class Dependency2ViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.DEPENDENCY_2014_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.DEPENDENCY_2014_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.DEPENDENCY_2014_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.DEPENDENCY_2014_PREF_LINE_COLOR);
