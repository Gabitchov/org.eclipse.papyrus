...
public class UsageCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateUsage_3010(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		org.eclipse.papyrus.diagram.clazzBis.providers.UMLElementTypes.init_Usage_3010(newElement);
