...
public class DependencyPreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	protected String getFillColorPreferenceName() {
		return IPapyrusPreferencesConstant.DEPENDENCY_PREF_FILL_COLOR;
	}
	...
	protected String getGradientColorPreferenceName() {
		return IPapyrusPreferencesConstant.DEPENDENCY_PREF_GRADIENT_COLOR;
	}
	...
	protected String getFillPolicyPreferenceName() {
		return IPapyrusPreferencesConstant.DEPENDENCY_PREF_GRADIENT_POLICY;
	}
	...
	protected String getFontColorPreferenceName() {
		return IPapyrusPreferencesConstant.DEPENDENCY_PREF_FONT_COLOR;
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		store.setDefault(
				IPapyrusPreferencesConstant.DEPENDENCY_PREF_GRADIENT_COLOR,
