 ...
 * @generated
 */
public class AssociationClassName2EditPart extends CompartmentEditPart
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AssociationClassName2EditPart.VISUAL_ID));
		}
		return parser;
	}
