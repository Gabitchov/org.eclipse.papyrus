...
public class Signal2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Signal2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Signal2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new Signal2CreateCommand(req, eObject);
	}
