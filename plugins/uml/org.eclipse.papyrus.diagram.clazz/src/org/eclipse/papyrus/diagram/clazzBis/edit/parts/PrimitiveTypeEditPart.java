...
public class PrimitiveTypeEditPart extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.PrimitiveTypeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeQualifiedNameEditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeQualifiedNameEditPart) childEditPart).setLabel(getPrimaryShape().getQualifiedNameLabel());
			return true;
		}

		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeNameEditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeNameEditPart) childEditPart).setLabel(getPrimaryShape().getStereotypesLabel());
			return true;
		}

		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeName2EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeName2EditPart) childEditPart).setLabel(getPrimaryShape().getNameLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(org.eclipse.papyrus.diagram.clazzBis.part.UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazzBis.edit.parts.PrimitiveTypeNameEditPart.VISUAL_ID));
	}
