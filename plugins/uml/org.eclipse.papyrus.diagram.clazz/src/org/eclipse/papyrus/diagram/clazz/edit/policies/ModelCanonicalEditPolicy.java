...
public class ModelCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	private Collection refreshConnections() {
		...
		for(Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			...
			if(diagramLinkVisualID == -1 || diagramLinkVisualID == CommentLinkDescriptorEditPart.VISUAL_ID || diagramLinkVisualID == InstanceSpecificationLinkEditPart.VISUAL_ID || diagramLinkVisualID == AddedLinkEditPart.VISUAL_ID || diagramLinkVisualID == ContainmentLinkEditPart.VISUAL_ID) {
