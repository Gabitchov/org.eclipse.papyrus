 ...
 * @generated
 */
public class EnumerationEnumerationLiteralCompartment2CanonicalEditPolicy
	...
	private boolean isMyDiagramElement(View view) {
		return EnumerationLiteralEditPart.VISUAL_ID == UMLVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getEnumerationEnumerationLiteralCompartment_7031SemanticChildren((View) getHost()
						.getModel());
