 ...
 * @generated
 */
public class AssociationClassNestedClassifierCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getAssociationClassNestedClassifierCompartment_7037SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Class2EditPart.VISUAL_ID == UMLVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getAssociationClassNestedClassifierCompartment_7037SemanticChildren((View) getHost()
						.getModel());
