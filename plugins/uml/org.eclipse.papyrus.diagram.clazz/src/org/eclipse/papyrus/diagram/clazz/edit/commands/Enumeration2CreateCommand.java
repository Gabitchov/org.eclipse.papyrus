...
public class Enumeration2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Enumeration2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Enumeration2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new Enumeration2CreateCommand(req, eObject);
	}
