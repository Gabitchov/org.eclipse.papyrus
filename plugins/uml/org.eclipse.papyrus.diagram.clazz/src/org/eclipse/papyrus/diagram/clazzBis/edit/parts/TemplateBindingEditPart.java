...
public class TemplateBindingEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.TemplateBindingItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.WrappingLabelEditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.WrappingLabelEditPart) childEditPart).setLabel(getPrimaryShape().getInterfaceRealizationNameLabel());
			return true;
		}
		return false;
	}
