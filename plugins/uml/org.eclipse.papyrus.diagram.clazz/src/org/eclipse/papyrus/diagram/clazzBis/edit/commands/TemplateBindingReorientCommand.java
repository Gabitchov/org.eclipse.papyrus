...
public class TemplateBindingReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistTemplateBinding_3019(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		TemplateableElement container = (TemplateableElement) getLink().eContainer();
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistTemplateBinding_3019(container, source, getNewTarget());
	}
