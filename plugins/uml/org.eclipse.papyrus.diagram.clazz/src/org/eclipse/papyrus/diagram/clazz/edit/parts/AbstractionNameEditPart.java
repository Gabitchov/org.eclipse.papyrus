...
public class AbstractionNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry
				.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AbstractionNameEditPart.VISUAL_ID), new Point(0,
				40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CustomUMLParserProvider.getParser(UMLElementTypes.Abstraction_4006, getParserElement(),
					UMLVisualIDRegistry
