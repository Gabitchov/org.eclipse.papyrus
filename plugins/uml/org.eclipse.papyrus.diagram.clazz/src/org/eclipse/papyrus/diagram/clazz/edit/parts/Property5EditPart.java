 ...
 * @generated
 */
public class Property5EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Property5ItemSemanticEditPolicy());
		...
		installEditPolicy(
				AbstractAppliedStereotypeDisplayEditPolicy.STEREOTYPE_LABEL_POLICY,
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Property_3018,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.Property5EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void performDirectEditRequest(Request request) {
		...
		case IDirectEdition.EXTENDED_DIRECT_EDITOR:
			...
			if (configuration == null || configuration.getLanguage() == null) {
				...
				final ExtendedDirectEditionDialog dialog = new ExtendedDirectEditionDialog(
				...
				if (Window.OK == dialog.open()) {
					...
					RecordingCommand command = new RecordingCommand(domain,
						...
						protected void doExecute() {
							configuration
									.postEditAction(resolveSemanticElement(),
											dialog.getValue());
	...
	protected void initExtendedEditorConfiguration() {
		if (configuration == null) {
			final String languagePreferred = Activator.getDefault()
	...
	protected void updateExtendedEditorConfiguration() {
		String languagePreferred = Activator.getDefault().getPreferenceStore()
				.getString(
						IDirectEditorsIds.EDITOR_FOR_ELEMENT
								+ resolveSemanticElement().eClass()
										.getInstanceClassName());
