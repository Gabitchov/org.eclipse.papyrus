 ...
 * @generated
 */
public class OperationForClassCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public OperationForClassCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static OperationForClassCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new OperationForClassCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public OperationForClassCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
