...
public class Interface_2004PreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	public static void initDefaults(IPreferenceStore store) {
		PreferenceConverter.setDefault(store, IPapyrusPreferencesConstant.INTERFACE_2004_PREF_FILL_COLOR, new org.eclipse.swt.graphics.RGB(255, 255, 255));
		PreferenceConverter.setDefault(store, IPapyrusPreferencesConstant.INTERFACE_2004_PREF_LINE_COLOR, new org.eclipse.swt.graphics.RGB(177, 207, 229));
