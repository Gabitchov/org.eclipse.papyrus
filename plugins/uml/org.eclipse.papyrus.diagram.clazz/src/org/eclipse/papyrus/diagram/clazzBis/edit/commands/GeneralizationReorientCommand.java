...
public class GeneralizationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistGeneralization_3005(getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistGeneralization_3005(source, getNewTarget());
	}
