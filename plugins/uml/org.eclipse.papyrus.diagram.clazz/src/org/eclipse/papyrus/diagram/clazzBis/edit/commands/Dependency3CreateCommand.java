...
public class Dependency3CreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateDependency_3012(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		org.eclipse.papyrus.diagram.clazzBis.providers.UMLElementTypes.init_Dependency_3012(newElement);
