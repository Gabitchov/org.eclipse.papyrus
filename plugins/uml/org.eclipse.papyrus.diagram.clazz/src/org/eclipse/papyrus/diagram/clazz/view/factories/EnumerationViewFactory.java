...
public class EnumerationViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.ENUMERATION_2006_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.ENUMERATION_2006_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.ENUMERATION_2006_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.ENUMERATION_2006_PREF_LINE_COLOR);
