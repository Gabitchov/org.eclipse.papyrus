...

{
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EnumerationItemSemanticEditPolicyCN());
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomEnumerationItemSemanticEditPolicyCN());
		installEditPolicy(
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EnumerationNameEditPartCN) {
			((EnumerationNameEditPartCN) childEditPart)
		...
		if (childEditPart instanceof EnumerationEnumerationLiteralCompartment2EditPart) {
			...
			pane.add(((EnumerationEnumerationLiteralCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EnumerationEnumerationLiteralCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getEnumerationLiteralCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((EnumerationEnumerationLiteralCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
