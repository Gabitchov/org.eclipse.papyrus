 ...
 * @generated
 */
public class PrimitiveTypeNameEditPartCN extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.PrimitiveTypeNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
