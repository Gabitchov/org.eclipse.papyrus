...

{
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ModelNameEditPartCN) {
			((ModelNameEditPartCN) childEditPart).setLabel(getPrimaryShape()
					.getNameLabel());
			return true;
		}
		...
		if (childEditPart instanceof ModelPackageableElementCompartment2EditPart) {
			...
			pane.add(((ModelPackageableElementCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ModelItemSemanticEditPolicyCN());
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomModelItemSemanticEditPolicyCN());
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ModelPackageableElementCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getPackageableElementFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ModelPackageableElementCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof RedefinableTemplateSignatureEditPart) {
