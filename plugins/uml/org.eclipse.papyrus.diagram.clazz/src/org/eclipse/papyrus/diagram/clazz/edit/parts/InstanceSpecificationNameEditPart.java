 ...
 * @generated
 */
public class InstanceSpecificationNameEditPart extends CompartmentEditPart
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.InstanceSpecificationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
