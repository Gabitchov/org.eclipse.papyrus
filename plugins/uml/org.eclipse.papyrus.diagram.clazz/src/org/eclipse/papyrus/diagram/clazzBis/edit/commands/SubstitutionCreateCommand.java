...
public class SubstitutionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateSubstitution_3007(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		org.eclipse.papyrus.diagram.clazzBis.providers.UMLElementTypes.init_Substitution_3007(newElement);
