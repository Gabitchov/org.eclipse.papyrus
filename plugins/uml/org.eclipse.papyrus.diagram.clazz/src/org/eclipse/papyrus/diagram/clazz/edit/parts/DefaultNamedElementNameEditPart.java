 ...
 * @generated
 */
public class DefaultNamedElementNameEditPart extends CompartmentEditPart
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.NamedElement_2097,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.DefaultNamedElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
