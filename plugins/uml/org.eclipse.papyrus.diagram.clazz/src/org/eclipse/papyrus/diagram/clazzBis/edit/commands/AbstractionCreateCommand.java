...
public class AbstractionCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canCreateAbstraction_3009(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		org.eclipse.papyrus.diagram.clazzBis.providers.UMLElementTypes.init_Abstraction_3009(newElement);
