 ...
 * @generated
 */
public class EnumerationLiteralEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EnumerationLiteralItemSemanticEditPolicy());
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.EnumerationLiteralEditPart.VISUAL_ID));
		}
		return parser;
	}
