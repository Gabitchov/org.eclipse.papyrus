...
public class ElementImportEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.ElementImportItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.ElementImportAliasEditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.ElementImportAliasEditPart) childEditPart).setLabel(getPrimaryShape().getDependencyNameLabel());
			return true;
		}
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.ElementImportAlias2EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.ElementImportAlias2EditPart) childEditPart).setLabel(getPrimaryShape().getAppliedStereotypeLabel());
			return true;
		}
		return false;
	}
