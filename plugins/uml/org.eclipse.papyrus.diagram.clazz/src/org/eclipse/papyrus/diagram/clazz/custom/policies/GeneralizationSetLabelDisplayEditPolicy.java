...
/**
 * this policy allows displaying generalizationSet without label if it references the same semantic element. It allows placing correctly anchors in this case
 */
