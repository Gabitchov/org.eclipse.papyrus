...
import org.eclipse.papyrus.diagram.clazz.custom.policies.itemsemantic.CustomInstanceSpecificationItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InstanceSpecificationEditPart extends
...

{
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InstanceSpecificationNameEditPart) {
			((InstanceSpecificationNameEditPart) childEditPart)
		...
		if (childEditPart instanceof InstanceSpecificationSlotCompartmentEditPart) {
			...
			pane.add(((InstanceSpecificationSlotCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InstanceSpecificationItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CustomInstanceSpecificationItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eclipse.papyrus.diagram.clazz.edit.parts.InstanceSpecificationEditPart) {
			types.add(UMLElementTypes.Realization_4005);
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InstanceSpecificationSlotCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getSlotCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((InstanceSpecificationSlotCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
