...
public class PackageEditPart extends DiagramEditPart {
	...
	private ViewAndFeatureResolver resolver = new ViewAndFeatureResolver() {
		...
		public boolean isEObjectNode(EObject element) {
			if (org.eclipse.papyrus.diagram.clazzBis.part.UMLVisualIDRegistry.getNodeVisualID(getNotationView(), element) > -1) {
				return true;
			}
			return false;
		}
		...
		public boolean isEObjectLink(EObject element) {
			if (org.eclipse.papyrus.diagram.clazzBis.part.UMLVisualIDRegistry.getLinkWithClassVisualID(element) > -1) {
				return true;
			}
			return false;
		}
		...
		public int getEObjectSemanticHint(EObject element) {
			if (element != null) {
				return org.eclipse.papyrus.diagram.clazzBis.part.UMLVisualIDRegistry.getNodeVisualID(getNotationView(), element);
			}
			return -1;
		}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.PackageItemSemanticEditPolicy());

		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.PackageCanonicalEditPolicy());
	...
	public Object getAdapter(Class adapter) {
		...
		if (adapter != null && adapter.equals(ViewInfo.class)) {
			return org.eclipse.papyrus.diagram.clazzBis.part.UMLVisualIDRegistry.getDiagramViewInfo();
		}
