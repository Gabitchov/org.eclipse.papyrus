...
public class InstanceSpecification2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public InstanceSpecification2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static InstanceSpecification2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new InstanceSpecification2CreateCommand(req, eObject);
	}
