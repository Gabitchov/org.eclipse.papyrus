 ...
 * @generated
 */
public class ConstraintBodyEditPartCN extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.ConstraintBodyEditPartCN.VISUAL_ID));
		}
		return parser;
	}
