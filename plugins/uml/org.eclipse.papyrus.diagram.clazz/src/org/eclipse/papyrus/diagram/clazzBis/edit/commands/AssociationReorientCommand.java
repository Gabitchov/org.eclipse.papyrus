...
public class AssociationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistAssociation_3003(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Package container = (Package) getLink().eContainer();
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistAssociation_3003(container, source, getNewTarget());
	}
