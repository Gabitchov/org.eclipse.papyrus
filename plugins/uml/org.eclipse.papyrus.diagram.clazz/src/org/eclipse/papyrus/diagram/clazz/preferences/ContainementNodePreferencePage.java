 ...
 * @generated
 */
public class ContainementNodePreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public ContainementNodePreferencePage() {
		super();
		setPreferenceKey(ModelEditPart.MODEL_ID + "_ContainementNode");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ModelEditPart.MODEL_ID + "_ContainementNode";
