 ...
 * @generated
 */
public class InstanceSpecificationViewFactoryCN extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(InstanceSpecificationEditPartCN.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(InstanceSpecificationNameEditPartCN.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
