 ...
 * @generated
 */
public class InstanceSpecificationNameEditPartCN extends CompartmentEditPart
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.InstanceSpecificationNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
