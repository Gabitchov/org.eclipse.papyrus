...
import org.eclipse.papyrus.diagram.clazz.custom.policies.InstanceSpecificationNameLabelEditPolicy;
...
public class InstanceSpecificationNameEditPartCN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InstanceSpecification_3020, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.InstanceSpecificationNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
