...
import org.eclipse.papyrus.diagram.common.figure.node.HTMLCornerBentBodyFigure;
...
public class CommentBodyEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Comment_2012, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.CommentBodyEditPart.VISUAL_ID));
		}
		return parser;
	}
