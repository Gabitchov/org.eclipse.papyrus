...
public class UMLViewProvider extends AbstractProvider implements IViewProvider {
	...
	public Edge createAbstraction_4006(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.ABSTRACTION_PREF_LINE_COLOR);
	...
	public Node createAssociationClass_2013(EObject domainElement,
		...
		initForegroundFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.ASSOCIATIONCLASS_PREF_LINE_COLOR);
	...
	public Node createClass_2008(EObject domainElement, View containerView,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.CLASS_PREF_FONT,
	...
	public Node createDataType_2010(EObject domainElement, View containerView,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.DATATYPE_PREF_FONT,
	...
	public Edge createElementImport_4009(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.ELEMENTIMPORT_PREF_LINE_COLOR);
	...
	public Node createEnumeration_2006(EObject domainElement,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.ENUMERATION_PREF_FONT,
	...
	public Node createInstanceSpecification_2001(EObject domainElement,
		...
		initFontStyleFromPrefs(
				node,
				prefStore,
				IPapyrusPreferencesConstant.INSTANCESPECIFICATION_PREF_FONT,
	...
	public Node createInterface_2004(EObject domainElement, View containerView,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.INTERFACE_PREF_FONT,
	...
	public Edge createInterfaceRealization_4003(EObject domainElement,
		...
		initForegroundFromPrefs(
				edge,
				prefStore,
				IPapyrusPreferencesConstant.INTERFACEREALIZATION_PREF_LINE_COLOR);
	...
	public Node createModel_2005(EObject domainElement, View containerView,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.MODEL_PREF_FONT,
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		case SlotEditPart.VISUAL_ID:
			return createSlot_3001(domainElement, containerView, index,
					persisted, preferencesHint);
	...
	public Edge createPackageImport_4010(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.PACKAGEIMPORT_PREF_LINE_COLOR);
	...
	public Edge createPackageMerge_4011(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.PACKAGEMERGE_PREF_LINE_COLOR);

		initFontStyleFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.PACKAGEMERGE_PREF_FONT,
				IPapyrusPreferencesConstant.PACKAGEMERGE_PREF_FONT_COLOR);
	...
	public Node createPrimitiveType_2009(EObject domainElement,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.PRIMITIVETYPE_PREF_FONT,
	...
	public Edge createProfileApplication_4012(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.PROFILEAPPLICATION_PREF_LINE_COLOR);

		initFontStyleFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.PROFILEAPPLICATION_PREF_FONT,
				IPapyrusPreferencesConstant.PROFILEAPPLICATION_PREF_FONT_COLOR);
	...
	public Edge createRealization_4005(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.REALIZATION_PREF_LINE_COLOR);
	...
	public Node createSignal_2003(EObject domainElement, View containerView,
		...
		initFontStyleFromPrefs(node, prefStore,
				IPapyrusPreferencesConstant.SIGNAL_PREF_FONT,
	 ...
	 * @generated
	 */
	public Node createSlot_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	...
	public Edge createSubstitution_4004(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.SUBSTITUTION_PREF_LINE_COLOR);
	...
	public Edge createTemplateBinding_4015(EObject domainElement,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.TEMPLATEBINDING_PREF_LINE_COLOR);
	...
	public Edge createUsage_4007(EObject domainElement, View containerView,
		...
		initForegroundFromPrefs(edge, prefStore,
				IPapyrusPreferencesConstant.USAGE_PREF_LINE_COLOR);
