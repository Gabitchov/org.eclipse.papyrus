...
public class UMLVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return org.eclipse.papyrus.diagram.clazz.part.UMLVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = org.eclipse.papyrus.diagram.clazz.part.UMLVisualIDRegistry
		...
		if (ModelEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = org.eclipse.papyrus.diagram.clazz.part.UMLVisualIDRegistry
		...
		case ComponentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getRedefinableTemplateSignature()
		...
		case AssociationClassAttributeCompartmentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getProperty().isSuperTypeOf(
					domainElement.eClass())
		...
		case InstanceSpecificationSlotCompartmentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getSlot().isSuperTypeOf(
					domainElement.eClass())
		...
		case ComponentOperationCompartmentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getOperation().isSuperTypeOf(
					domainElement.eClass())
		...
		case RedefinableTemplateSignatureTemplateParameterCompartmentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getClassifierTemplateParameter()
					.isSuperTypeOf(domainElement.eClass())

			) {
				return ClassifierTemplateParameterEditPart.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getTemplateParameter().isSuperTypeOf(
					domainElement.eClass())
		...
		case ModelPackageableElementCompartmentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getInstanceSpecification().isSuperTypeOf(
					domainElement.eClass())
			...
			if (UMLPackage.eINSTANCE.getSignal().isSuperTypeOf(
					domainElement.eClass())
			...
			if (UMLPackage.eINSTANCE.getEnumeration().isSuperTypeOf(
					domainElement.eClass())
			...
			if (UMLPackage.eINSTANCE.getPrimitiveType().isSuperTypeOf(
					domainElement.eClass())

			) {
				return PrimitiveTypeEditPartCN.VISUAL_ID;
			}
			if (UMLPackage.eINSTANCE.getDataType().isSuperTypeOf(
					domainElement.eClass())
		...
		case EnumerationEnumerationLiteralCompartment2EditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getEnumerationLiteral().isSuperTypeOf(
					domainElement.eClass())
		...
		case ClassOperationCompartmentEditPart.VISUAL_ID:
			if (UMLPackage.eINSTANCE.getReception().isSuperTypeOf(
					domainElement.eClass())
		...
		case ModelEditPart.VISUAL_ID:
			...
			if (UMLPackage.eINSTANCE.getAssociationClass().isSuperTypeOf(
					domainElement.eClass())
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (UMLPackage.eINSTANCE.getRealization().isSuperTypeOf(
				domainElement.eClass())
		...
		if (UMLPackage.eINSTANCE.getPackageImport().isSuperTypeOf(
				domainElement.eClass())

		) {
			return PackageImportEditPart.VISUAL_ID;
		}
		if (UMLPackage.eINSTANCE.getPackageMerge().isSuperTypeOf(
				domainElement.eClass())

		) {
			return PackageMergeEditPart.VISUAL_ID;
		}
		if (UMLPackage.eINSTANCE.getProfileApplication().isSuperTypeOf(
				domainElement.eClass())

		) {
			return ProfileApplicationEditPart.VISUAL_ID;
		}
		if (UMLPackage.eINSTANCE.getTemplateBinding().isSuperTypeOf(
				domainElement.eClass())
	...
	protected static ViewInfo getPackage_1000ViewInfo() {
		...
		viewInfo = new BaseViewInfo(2001, ViewInfo.Node,
		...
		viewInfo = new BaseViewInfo(3015, ViewInfo.Node,
		...
		viewInfo = new BaseViewInfo(3031, ViewInfo.Node,
		...
		viewInfo = new BaseViewInfo(3020, ViewInfo.Node,
				"InstanceSpecification");
