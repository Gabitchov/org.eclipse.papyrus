...
public class DependencyName3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry
				.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.DependencyName3EditPart.VISUAL_ID), new Point(0,
				40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CustomUMLParserProvider.getParser(UMLElementTypes.Dependency_4018, getParserElement(),
					UMLVisualIDRegistry
							.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.DependencyName3EditPart.VISUAL_ID));
		}
		return parser;
	}
