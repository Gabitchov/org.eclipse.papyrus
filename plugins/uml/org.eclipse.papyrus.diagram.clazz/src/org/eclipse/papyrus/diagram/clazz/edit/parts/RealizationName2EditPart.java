...
public class RealizationName2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry
				.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.RealizationName2EditPart.VISUAL_ID), new Point(0,
				60));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CustomUMLParserProvider.getParser(UMLElementTypes.Realization_4005, getParserElement(),
					UMLVisualIDRegistry
							.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.RealizationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
