...
public class Model2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Model2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Model2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new Model2CreateCommand(req, eObject);
	}
