...
public class Model_2005PreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	public static void initDefaults(IPreferenceStore store) {
		PreferenceConverter.setDefault(store, IPapyrusPreferencesConstant.MODEL_2005_PREF_FILL_COLOR, new org.eclipse.swt.graphics.RGB(255, 255, 255));
		PreferenceConverter.setDefault(store, IPapyrusPreferencesConstant.MODEL_2005_PREF_LINE_COLOR, new org.eclipse.swt.graphics.RGB(177, 207, 229));
