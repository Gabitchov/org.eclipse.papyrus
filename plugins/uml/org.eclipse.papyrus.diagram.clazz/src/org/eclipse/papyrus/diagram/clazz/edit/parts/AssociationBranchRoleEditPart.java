...
import org.eclipse.papyrus.diagram.clazz.custom.policies.DisplayAssociationBranchEndEditPolicy;
 ...
 * @generated
 */
public class AssociationBranchRoleEditPart extends LabelEditPart implements ITextAwareEditPart, ILabelRoleProvider

{
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AssociationBranchRoleEditPart.VISUAL_ID), new Point(0, -20));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(IMaskManagedLabelEditPolicy.MASK_MANAGED_LABEL_EDIT_POLICY, new DisplayAssociationBranchEndEditPolicy());
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Association_4019, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AssociationBranchRoleEditPart.VISUAL_ID));
		}
		return parser;
	}
