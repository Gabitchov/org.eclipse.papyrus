 ...
 * @generated
 */
public class AssociationBranchRoleEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.AssociationBranchRoleEditPart.VISUAL_ID),
				new Point(0, -20));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new DisplayAssociationEndEditPolicy());
	}
