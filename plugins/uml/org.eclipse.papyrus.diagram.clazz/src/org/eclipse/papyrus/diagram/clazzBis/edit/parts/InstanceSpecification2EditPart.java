 ...
 * @generated
 */
public class InstanceSpecification2EditPart extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.InstanceSpecification2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationName3EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationName3EditPart) childEditPart).setLabel(getPrimaryShape().getInstanceSpecificationStereotypeLabel());
			return true;
		}

		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationQualifiedName2EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationQualifiedName2EditPart) childEditPart).setLabel(getPrimaryShape().getInstanceSpecificationQualifiedNameLabel());
			return true;
		}

		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationName4EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationName4EditPart) childEditPart).setLabel(getPrimaryShape().getInstanceSpecificationNameLabel());
			return true;
		}

		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationSlotCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getSlotCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationSlotCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationSlotCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getSlotCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationSlotCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.InstanceSpecificationSlotCompartment2EditPart) {
