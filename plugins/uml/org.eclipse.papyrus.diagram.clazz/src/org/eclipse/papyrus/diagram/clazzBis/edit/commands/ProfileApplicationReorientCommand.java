...
public class ProfileApplicationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistProfileApplication_3016(getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		return org.eclipse.papyrus.diagram.clazzBis.edit.policies.UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistProfileApplication_3016(source, getNewTarget());
	}
