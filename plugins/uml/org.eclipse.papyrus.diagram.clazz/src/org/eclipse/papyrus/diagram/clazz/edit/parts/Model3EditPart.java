...
public class Model3EditPart extends AbstractBorderedShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AppliedStereotypeChildNodeModelEditPart) {
			((AppliedStereotypeChildNodeModelEditPart) childEditPart).setLabel(getPrimaryShape().getStereotypesLabel());
			return true;
		}
	...
	protected void createDefaultEditPolicies() {
		...
		// installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.clazz.edit.policies.Model3CanonicalEditPolicy());

		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(EditPolicyRoles.OPEN_ROLE, new OpenDiagramEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new RemoveOrphanNodeViewPolicy());
		installEditPolicy("CANONICAL_CONNECTION", new RemoveOphanConnectionViewClazzPolicy()); //$NON-NLS-1$
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(AppliedStereotypeChildNodeModelEditPart.VISUAL_ID));
	}
