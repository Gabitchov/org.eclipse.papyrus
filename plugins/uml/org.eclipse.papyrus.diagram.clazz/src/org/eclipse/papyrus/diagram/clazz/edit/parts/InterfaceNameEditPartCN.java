 ...
 * @generated
 */
public class InterfaceNameEditPartCN extends CompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.InterfaceNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
