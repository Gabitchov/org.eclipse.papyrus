...
public class AssociationClassViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		viewInitializer.initFillColor(IPapyrusPreferencesConstant.ASSOCIATIONCLASS_2013_PREF_FILL_COLOR);
		viewInitializer.initFont(IPapyrusPreferencesConstant.ASSOCIATIONCLASS_2013_PREF_FONT);
		viewInitializer.initFontColor(IPapyrusPreferencesConstant.ASSOCIATIONCLASS_2013_PREF_FONT_COLOR);
		viewInitializer.initLineColor(IPapyrusPreferencesConstant.ASSOCIATIONCLASS_2013_PREF_LINE_COLOR);
