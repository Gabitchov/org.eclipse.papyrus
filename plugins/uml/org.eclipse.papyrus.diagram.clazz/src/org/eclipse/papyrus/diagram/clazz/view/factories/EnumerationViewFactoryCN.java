 ...
 * @generated
 */
public class EnumerationViewFactoryCN extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry.getType(EnumerationEditPartCN.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view, UMLVisualIDRegistry.getType(EnumerationNameEditPartCN.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
