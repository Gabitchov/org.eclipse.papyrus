...
public class RealizationEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new org.eclipse.papyrus.diagram.clazzBis.edit.policies.RealizationItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.RealizationNameEditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.RealizationNameEditPart) childEditPart).setLabel(getPrimaryShape().getAppliedStereotypeLabel());
			return true;
		}
		if (childEditPart instanceof org.eclipse.papyrus.diagram.clazzBis.edit.parts.RealizationName2EditPart) {
			((org.eclipse.papyrus.diagram.clazzBis.edit.parts.RealizationName2EditPart) childEditPart).setLabel(getPrimaryShape().getInterfaceRealizationNameLabel());
			return true;
		}
		return false;
	}
