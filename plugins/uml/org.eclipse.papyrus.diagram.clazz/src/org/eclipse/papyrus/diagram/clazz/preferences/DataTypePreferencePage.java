...
public class DataTypePreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	protected String getFillColorPreferenceName() {
		return IPapyrusPreferencesConstant.DATATYPE_PREF_FILL_COLOR;
	}
	...
	protected String getFillPolicyPreferenceName() {
		return IPapyrusPreferencesConstant.DATATYPE_PREF_GRADIENT_POLICY;
	}
	...
	protected String getFontColorPreferenceName() {
		return IPapyrusPreferencesConstant.DATATYPE_PREF_FONT_COLOR;
	}
	...
	protected String getFontPreferenceName() {
		return IPapyrusPreferencesConstant.DATATYPE_PREF_FONT;
	}
	...
	protected String getGradientColorPreferenceName() {
		return IPapyrusPreferencesConstant.DATATYPE_PREF_GRADIENT_COLOR;
	}
	...
	protected String getLineColorPreferenceName() {
		return IPapyrusPreferencesConstant.DATATYPE_PREF_LINE_COLOR;
	}
