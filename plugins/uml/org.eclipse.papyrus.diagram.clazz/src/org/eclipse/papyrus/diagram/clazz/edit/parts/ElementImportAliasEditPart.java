...

{
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ElementImport_4009, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.clazz.edit.parts.ElementImportAliasEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	public String getIconPathRole() {
		return "platform:/plugin/org.eclipse.papyrus.diagram.common/icons/label_role/alias.png";//$NON-NLS-1$
	}
