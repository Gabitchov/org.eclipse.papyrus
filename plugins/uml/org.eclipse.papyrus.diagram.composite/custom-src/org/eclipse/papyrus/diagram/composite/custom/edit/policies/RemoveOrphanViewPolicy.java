...
public class RemoveOrphanViewPolicy extends OrphanViewPolicy {
	 ...
	 */
	public int[] notOrphanNode = { DataTypeAttributeCompartmentEditPart.VISUAL_ID, DataTypeOperationCompartmentEditPart.VISUAL_ID, DataTypeAttributeCompartmentEditPartCN.VISUAL_ID, DataTypeOperationCompartmentEditPartCN.VISUAL_ID, ClassAttributeCompartmentEditPart.VISUAL_ID, ClassOperationCompartmentEditPart.VISUAL_ID, ClassNestedClassifierCompartmentEditPart.VISUAL_ID, EnumerationEnumerationLiteralCompartmentEditPart.VISUAL_ID, EnumerationEnumerationLiteralCompartmentEditPartCN.VISUAL_ID, ActivityCompositeCompartmentEditPartCN.VISUAL_ID, InteractionCompositeCompartmentEditPartCN.VISUAL_ID, ProtocolStateMachineCompositeCompartmentEditPartCN.VISUAL_ID, StateMachineCompositeCompartmentEditPartCN.VISUAL_ID, FunctionBehaviorCompositeCompartmentEditPartCN.VISUAL_ID, OpaqueBehaviorCompositeCompartmentEditPartCN.VISUAL_ID, ComponentCompositeCompartmentEditPartCN.VISUAL_ID, DeviceCompositeCompartmentEditPartCN.VISUAL_ID, ExecutionEnvironmentCompositeCompartmentEditPartCN.VISUAL_ID, NodeCompositeCompartmentEditPartCN.VISUAL_ID, ClassCompositeCompartmentEditPartCN.VISUAL_ID, CollaborationCompositeCompartmentEditPartCN.VISUAL_ID, InterfaceCompartmentEditPartCN.VISUAL_ID, ActivityCompositeCompartmentEditPart.VISUAL_ID, InteractionCompositeCompartmentEditPart.VISUAL_ID, ProtocolStateMachineCompositeCompartmentEditPart.VISUAL_ID, StateMachineCompositeCompartmentEditPart.VISUAL_ID, FunctionBehaviorCompositeCompartmentEditPart.VISUAL_ID, OpaqueBehaviorCompositeCompartmentEditPart.VISUAL_ID, ComponentCompositeCompartmentEditPart.VISUAL_ID, DeviceCompositeCompartmentEditPart.VISUAL_ID, ExecutionEnvironmentCompositeCompartmentEditPart.VISUAL_ID, NodeCompositeCompartmentEditPart.VISUAL_ID, ClassCompositeCompartmentEditPart.VISUAL_ID, CollaborationCompositeCompartmentEditPart.VISUAL_ID, InterfaceCompartmentEditPart.VISUAL_ID, PropertyPartCompartmentEditPartCN.VISUAL_ID };
