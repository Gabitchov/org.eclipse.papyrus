...
import org.eclipse.papyrus.diagram.composite.edit.parts.ActivityEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.ClassAttributeCompartmentEditPart;
import org.eclipse.papyrus.diagram.composite.edit.parts.ClassEditPartCLN;
...
import org.eclipse.papyrus.diagram.composite.edit.parts.EnumerationEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.FunctionBehaviorEditPartCLN;
...
import org.eclipse.papyrus.diagram.composite.edit.parts.InteractionEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.InterfaceEditPartCLN;
...
import org.eclipse.papyrus.diagram.composite.edit.parts.OpaqueBehaviorEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.OperationEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.PrimitiveTypeEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.PropertyEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.ProtocolStateMachineEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.RealizationEditPart;
import org.eclipse.papyrus.diagram.composite.edit.parts.ReceptionEditPartCLN;
import org.eclipse.papyrus.diagram.composite.edit.parts.RoleBindingEditPart;
import org.eclipse.papyrus.diagram.composite.edit.parts.StateMachineEditPartCLN;
 ...
 * @generated
 */
public class ClassClassifierItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ClassClassifierItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (UMLVisualIDRegistry.getVisualID(incomingLink) == ComponentRealizationEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (UMLVisualIDRegistry.getVisualID(outgoingLink) == InformationFlowEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
				cmd.add(new DestroyElementCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
				continue;
