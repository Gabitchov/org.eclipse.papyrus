 ...
 * @generated
 */
public class CollaborationEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider
					.getParser(
					UMLElementTypes.Collaboration_3109,
					getParserElement(),
					UMLVisualIDRegistry
					.getType(org.eclipse.papyrus.diagram.composite.edit.parts.CollaborationEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
