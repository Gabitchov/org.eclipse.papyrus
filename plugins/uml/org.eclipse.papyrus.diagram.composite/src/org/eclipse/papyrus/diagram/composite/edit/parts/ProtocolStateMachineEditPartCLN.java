 ...
 * @generated
 */
public class ProtocolStateMachineEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.ProtocolStateMachine_3105,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.composite.edit.parts.ProtocolStateMachineEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
