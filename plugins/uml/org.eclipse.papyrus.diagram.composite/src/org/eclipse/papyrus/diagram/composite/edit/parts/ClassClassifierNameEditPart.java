...
public class ClassClassifierNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Class_2074, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.papyrus.diagram.composite.edit.parts.ClassClassifierNameEditPart.VISUAL_ID));
		}
		return parser;
	}
