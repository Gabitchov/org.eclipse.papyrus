 ...
 * @generated
 */
public class DurationConstraintName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DurationConstraintName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.DurationConstraint_3098,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.composite.edit.parts.DurationConstraintName2EditPart.VISUAL_ID));
		}
		return parser;
	}
