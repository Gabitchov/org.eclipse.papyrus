 ...
 * @generated
 */
public class StateMachineEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.StateMachine_3106,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.composite.edit.parts.StateMachineEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
