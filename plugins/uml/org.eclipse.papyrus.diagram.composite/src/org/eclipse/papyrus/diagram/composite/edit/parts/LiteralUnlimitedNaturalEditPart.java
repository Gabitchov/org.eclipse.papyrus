...
ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LiteralUnlimitedNaturalNameEditPart) {
			((LiteralUnlimitedNaturalNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getNamedElementNameLabel());
			return true;
		}
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("LiteralUnlimitedNatural",
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("LiteralUnlimitedNatural",
