...
import org.eclipse.papyrus.diagram.composite.edit.policies.DurationConstraint2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DurationConstraint2EditPart extends
...
ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DurationConstraint2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DurationConstraint2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DurationConstraintName2EditPart) {
			((DurationConstraintName2EditPart) childEditPart).setLabel(getPrimaryShape().getCommentContentLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DurationConstraintName2EditPart.VISUAL_ID));
	}
	...
	public List/* <org.eclipse.gmf.runtime.emf.type.core.IElementType> */getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eclipse.papyrus.diagram.composite.edit.parts.DurationConstraint2EditPart) {
			types.add(UMLElementTypes.ConstraintConstrainedElement_4003);
		}
		if (targetEditPart instanceof ActivityCompositeEditPart) {
			types.add(UMLElementTypes.ComponentRealization_4004);
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("DurationConstraint",
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("DurationConstraint",
