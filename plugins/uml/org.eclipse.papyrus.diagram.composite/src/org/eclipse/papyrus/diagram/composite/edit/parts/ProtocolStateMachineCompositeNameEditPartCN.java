	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider
					.getParser(
					UMLElementTypes.ProtocolStateMachine_3074,
					getParserElement(),
					UMLVisualIDRegistry
					.getType(org.eclipse.papyrus.diagram.composite.edit.parts.ProtocolStateMachineCompositeNameEditPartCN.VISUAL_ID));
		}
		return parser;
	}
