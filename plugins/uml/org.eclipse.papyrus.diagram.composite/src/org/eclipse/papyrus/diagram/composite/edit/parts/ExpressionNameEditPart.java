	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.Expression_2103, getParserElement(), UMLVisualIDRegistry
							.getType(org.eclipse.papyrus.diagram.composite.edit.parts.ExpressionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
