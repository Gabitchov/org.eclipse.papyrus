 ...
 * @generated
 */
public class PrimitiveTypeEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.PrimitiveType_3112,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.composite.edit.parts.PrimitiveTypeEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
