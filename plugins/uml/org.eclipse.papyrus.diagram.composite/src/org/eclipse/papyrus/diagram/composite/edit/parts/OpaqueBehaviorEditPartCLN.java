 ...
 * @generated
 */
public class OpaqueBehaviorEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider
					.getParser(
					UMLElementTypes.OpaqueBehavior_3108,
					getParserElement(),
					UMLVisualIDRegistry
					.getType(org.eclipse.papyrus.diagram.composite.edit.parts.OpaqueBehaviorEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
