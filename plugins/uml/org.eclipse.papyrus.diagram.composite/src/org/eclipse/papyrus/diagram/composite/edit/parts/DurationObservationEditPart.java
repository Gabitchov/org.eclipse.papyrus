...
AbstractObservationEditPart {
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("DurationObservation",
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("DurationObservation",
