...
public class DeviceCompositeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Device_2070, getParserElement(), UMLVisualIDRegistry
					.getType(org.eclipse.papyrus.diagram.composite.edit.parts.DeviceCompositeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
