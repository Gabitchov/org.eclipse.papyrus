 ...
 * @generated
 */
public class InteractionEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(UMLElementTypes.Interaction_3104, getParserElement(), UMLVisualIDRegistry
							.getType(org.eclipse.papyrus.diagram.composite.edit.parts.InteractionEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
