 ...
 * @generated
 */
public class RoleBindingNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.composite.edit.parts.RoleBindingNameEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public RoleBindingNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Dependency_4017, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.composite.edit.parts.RoleBindingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
