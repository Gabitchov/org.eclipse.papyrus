...
* generated by Xtext
*/
package org.eclipse.papyrus.transition.editor.xtext.ui.contentassist.antlr;
...
public class UmlTransitionParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.papyrus.transition.editor.xtext.ui.contentassist.antlr.internal.InternalUmlTransitionParser createParser() {
		org.eclipse.papyrus.transition.editor.xtext.ui.contentassist.antlr.internal.InternalUmlTransitionParser result = new org.eclipse.papyrus.transition.editor.xtext.ui.contentassist.antlr.internal.InternalUmlTransitionParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTransitionRuleAccess().getGroup_1(), "rule__TransitionRule__Group_1__0");
					put(grammarAccess.getTransitionRuleAccess().getGroup_1_1(), "rule__TransitionRule__Group_1_1__0");
					...
					put(grammarAccess.getTransitionRuleAccess().getNameAssignment_0(), "rule__TransitionRule__NameAssignment_0");
					put(grammarAccess.getTransitionRuleAccess().getTriggersAssignment_1_0(), "rule__TransitionRule__TriggersAssignment_1_0");
					put(grammarAccess.getTransitionRuleAccess().getTriggersAssignment_1_1_1(), "rule__TransitionRule__TriggersAssignment_1_1_1");
					put(grammarAccess.getTransitionRuleAccess().getGuardAssignment_2(), "rule__TransitionRule__GuardAssignment_2");
					put(grammarAccess.getTransitionRuleAccess().getEffectAssignment_3(), "rule__TransitionRule__EffectAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.papyrus.transition.editor.xtext.ui.contentassist.antlr.internal.InternalUmlTransitionParser typedParser = (org.eclipse.papyrus.transition.editor.xtext.ui.contentassist.antlr.internal.InternalUmlTransitionParser) parser;
