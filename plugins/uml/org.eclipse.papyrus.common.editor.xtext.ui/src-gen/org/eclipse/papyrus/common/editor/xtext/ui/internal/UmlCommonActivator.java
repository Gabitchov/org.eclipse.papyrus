...
public class UmlCommonActivator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		try {
			...
			injectors.put("org.eclipse.papyrus.common.editor.xtext.UmlCommon", Guice.createInjector(
				Modules.override(Modules.override(getRuntimeModule("org.eclipse.papyrus.common.editor.xtext.UmlCommon")).with(getUiModule("org.eclipse.papyrus.common.editor.xtext.UmlCommon"))).with(getSharedStateModule())
			));
