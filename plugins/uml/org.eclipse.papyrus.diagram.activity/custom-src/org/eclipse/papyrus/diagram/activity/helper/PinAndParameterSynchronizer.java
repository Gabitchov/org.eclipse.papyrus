...
public class PinAndParameterSynchronizer extends AbstractModelConstraint {
	...
	/** The label provider */
	private static final ILabelProvider labelProvider = new AdapterFactoryLabelProvider(
	...
	public IStatus validate(IValidationContext ctx) {
		try {
			...
			if ((EMFEventType.ADD.equals(ctx.getEventType()) || EMFEventType.ADD_MANY
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof CallBehaviorAction) {
				// CallBehaviorAction created
				CompoundCommand cmd = getResetPinsCmd((CallAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
			} else if ((EMFEventType.ADD.equals(ctx.getEventType()) || EMFEventType.ADD_MANY
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof CallOperationAction) {
				...
				if (!cmd.isEmpty() && cmd.canExecute()) {
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof SendSignalAction) {
				// SendSignalAction created
				CompoundCommand cmd = getResetPinsCmd((SendSignalAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof SendObjectAction) {
				// SendObjectAction created
				CompoundCommand cmd = getResetPinsCmd((SendObjectAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof DestroyObjectAction) {
				// SendObjectAction created
				CompoundCommand cmd = getResetPinsCmd((DestroyObjectAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
				...
				CompoundCommand cmd = getResetPinsCmd((AddStructuralFeatureValueAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof ReadStructuralFeatureAction) {
				// SendObjectAction created
				CompoundCommand cmd = getResetPinsCmd((ReadStructuralFeatureAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof AddVariableValueAction) {
				// SendObjectAction created
				CompoundCommand cmd = getResetPinsCmd((AddVariableValueAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof ReadVariableAction) {
				// SendObjectAction created
				CompoundCommand cmd = getResetPinsCmd((ReadVariableAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof BroadcastSignalAction) {
				// SendObjectAction created
				CompoundCommand cmd = getResetPinsCmd((BroadcastSignalAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
					...
					.equals(ctx.getEventType()))
					&& ctx.getFeatureNewValue() instanceof CreateObjectAction) {
				// CreateObject Action created
				CompoundCommand cmd = getResetPinsCmd((CreateObjectAction) ctx
						.getFeatureNewValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					cmd.execute();
				}
			...
			if ((EMFEventType.SET.equals(ctx.getEventType()) || EMFEventType.UNSET
					.equals(ctx.getEventType()))
					&& UMLPackage.eINSTANCE.getOperation_Class().equals(
							ctx.getFeature()) && eObject instanceof Operation) {
				// Operation moved
			...
			if (eObject instanceof Pin) {
				...
				// Parameter
				return handleCallOperationActionModification(
						(CallOperationAction) eObject, ctx);
				...
				// action is modified, ensure deleted/added Pin impact a
				// Parameter
				return handleCallBehaviorActionModification(
						(CallBehaviorAction) eObject, ctx);
				...
				// action is modified, ensure deleted/added Pin impact a
				// Property
				return handleSendSignalActionModification(
						(SendSignalAction) eObject, ctx);
				...
				return handleSendObjectActionModification(
						(SendObjectAction) eObject, ctx);
			} else if (eObject instanceof BroadcastSignalAction) {
				// action is modified, ensure deleted/added Pin impact a
				// Property
				return handleBroadcastSignalActionModification(
						(BroadcastSignalAction) eObject, ctx);
			}
			...
			Log.warning(
					...
					"Unexpected exception during Pin and Parameter synchronization : ",
					rte);
	 ...
	 *         objects
	 */
	protected boolean testPinOrParameterOrPropertyFeature(
			EStructuralFeature modifiedFeature) {
		boolean type = UMLPackage.eINSTANCE.getTypedElement_Type().equals(
				modifiedFeature);
		boolean ordering = UMLPackage.eINSTANCE
				.getMultiplicityElement_IsOrdered().equals(modifiedFeature);
		boolean multiplicity = UMLPackage.eINSTANCE
				.getMultiplicityElement_IsUnique().equals(modifiedFeature)
				|| UMLPackage.eINSTANCE.getMultiplicityElement_Lower().equals(
						modifiedFeature)
				|| UMLPackage.eINSTANCE.getMultiplicityElement_LowerValue()
						.equals(modifiedFeature)
				|| UMLPackage.eINSTANCE.getMultiplicityElement_Upper().equals(
						modifiedFeature)
				|| UMLPackage.eINSTANCE.getMultiplicityElement_UpperValue()
						.equals(modifiedFeature);
		boolean inAValueSpecification = ValueSpecification.class
				.isAssignableFrom(modifiedFeature.getContainerClass());
	...
	protected boolean testActionFeature(EStructuralFeature modifiedFeature) {
		boolean input = UMLPackage.eINSTANCE.getInvocationAction_Argument()
				.equals(modifiedFeature)
				|| UMLPackage.eINSTANCE.getCallOperationAction_Target().equals(
						modifiedFeature);
		boolean output = UMLPackage.eINSTANCE.getCallAction_Result().equals(
				modifiedFeature);
		return input || output;
	}
	 ...
	 * @return status
	 */
	protected IStatus handleTargetPinModification(Pin pin,
			IValidationContext ctx) {
		// the type of the target pin can not be modified.
		if (UMLPackage.eINSTANCE.getTypedElement_Type()
				.equals(ctx.getFeature())) {
			Element owner = pin.getOwner();
			if (owner instanceof CallOperationAction
					&& ((CallOperationAction) owner).getOperation() != null) {
	 ...
	 */
	protected boolean proposeParameterCreation(final NamedElement element,
			final EClass preferredPinClass) {
		final String elementLabel = labelProvider.getText(element);
		final String message = NLS.bind(
				Messages.PinAndParameterSynchronizer_UnauthorizedModification,
				elementLabel);

		final ParameterDirectionKind preferredDirection;
		if (UMLPackage.eINSTANCE.getOutputPin()
				.isSuperTypeOf(preferredPinClass)) {
		...
		SafeDialogOpenerDuringValidation<Boolean> opener = new SafeDialogOpenerDuringValidation<Boolean>() {
			...
			protected Boolean openDialog() {
				WarningAndCreateParameterDialog dialog = new WarningAndCreateParameterDialog(
						new Shell(Display.getDefault()),
						Messages.PinAndParameterSynchronizer_UnauthorizedModificationTitle,
						message, element, labelProvider, preferredDirection);
				boolean result = dialog.open() == Window.OK;
				if (result) {
					Parameter parameter = dialog.getParameter();
					handleParameterCreatedDuringValidation(parameter,
							preferredPinClass);
				}
				return result;
			}
	 ...
	 */
	protected void handleParameterCreatedDuringValidation(Parameter parameter,
			EClass preferredPinClass) {
		if (parameter != null) {
			Map<Integer, Parameter> empty = Collections.emptyMap();
			CompoundCommand globalCmd = new CompoundCommand();
			// explore referencing actions
			List<InvocationAction> callingActions = getCallingActions(parameter
					.getOwner());
			...
			case IN_LITERAL:
				for (InvocationAction action : callingActions) {
					if (action instanceof CallAction) {
						...
						CompoundCommand cmd = getAddPinsCmd(
								(CallAction) action,
								Collections.singletonMap(index, parameter),
								empty, preferredPinClass);
			...
			case INOUT_LITERAL:
				for (InvocationAction action : callingActions) {
					if (action instanceof CallAction) {
						...
						int indexOut = ((CallAction) action).getResults()
								.size();
						CompoundCommand cmd = getAddPinsCmd(
								(CallAction) action,
								Collections.singletonMap(indexIn, parameter),
								Collections.singletonMap(indexOut, parameter),
								preferredPinClass);
						globalCmd.append(cmd);
					}
				}
	 ...
	 *            the direction to select as default (or null)
	 */
	protected boolean proposeAttributeCreation(final NamedElement element,
			final EClass preferredPinClass) {
		final String elementLabel = labelProvider.getText(element);
		final String message = NLS.bind(
				Messages.PinAndParameterSynchronizer_UnauthorizedModification,
		...
		SafeDialogOpenerDuringValidation<Boolean> opener = new SafeDialogOpenerDuringValidation<Boolean>() {
			...
			protected Boolean openDialog() {
				WarningAndCreateAttributeDialog dialog = new WarningAndCreateAttributeDialog(
						new Shell(Display.getDefault()),
						Messages.PinAndParameterSynchronizer_UnauthorizedModificationTitle,
				...
				if (result) {
					...
					handlePropertyCreatedDuringValidation(attribute,
							preferredPinClass);
				}
				return result;
			}
	 ...
	 *            the EClass the user would like to create a pin of
	 */
	protected void handlePropertyCreatedDuringValidation(Property property,
			EClass preferredPinClass) {
		if (property != null) {
			Map<Integer, Parameter> empty = Collections.emptyMap();
			CompoundCommand globalCmd = new CompoundCommand();
			// explore referencing actions
			List<InvocationAction> callingActions = getCallingActions(property
					.getOwner());
			for (InvocationAction action : callingActions) {
				if (action instanceof SendSignalAction
						|| action instanceof BroadcastSignalActionEditPart) {
					int index = action.getArguments().size();
					CompoundCommand cmd = getAddPinsCmd(
							(SendSignalAction) action,
							Collections.singletonMap(index, property),
							preferredPinClass);
					globalCmd.append(cmd);
				}
			}
	...
	protected void proposeNavigation(final NamedElement element) {
		...
		final String message = NLS
				.bind(Messages.PinAndParameterSynchronizer_UnauthorizedModificationRedirection,
						elementLabel);
		SafeDialogOpenerDuringValidation<Void> opener = new SafeDialogOpenerDuringValidation<Void>() {

			protected Void openDialog() {
				WarningAndLinkDialog dialog = new WarningAndLinkDialog(
						new Shell(Display.getDefault()),
						Messages.PinAndParameterSynchronizer_UnauthorizedModificationTitle,
	 ...
	 * @return status
	 */
	protected IStatus handleParameterModification(Parameter parameter,
			IValidationContext ctx) {
		if (EMFEventType.SET.equals(ctx.getEventType())
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (testPinOrParameterOrPropertyFeature(ctx.getFeature())) {
				// Update corresponding pins
				CompoundCommand cmd = getUpdatePinsCmd(getPins(parameter),
						parameter.getType(), parameter.isOrdered(),
						parameter.isUnique(), parameter.getLower(),
						parameter.getLowerValue(), parameter.getUpper(),
						parameter.getUpperValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
			...
			} else if (UMLPackage.eINSTANCE.getParameter_Direction().equals(
					ctx.getFeature())) {
				// Remove/Add corresponding pins with type in accordance to
				// direction
				for (Notification event : ctx.getAllEvents()) {
					if (UMLPackage.eINSTANCE.getParameter_Direction().equals(
							event.getFeature())
							|| UMLPackage.eINSTANCE
									.getBehavioralFeature_OwnedParameter()
									.equals(event.getFeature())) {
						return changePinsBecauseOfParameterDirection(parameter,
								event, ctx);
					}
				}
			} else if (UMLPackage.eINSTANCE.getNamedElement_Name().equals(
					ctx.getFeature())) {
				// Synchronize the pin name if not set yet
				CompoundCommand cmd = getSetPinsNamesCmd(getPins(parameter),
						parameter.getName());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					if (askForValidation(getCallingActions(parameter.getOwner()))) {
						cmd.execute();
	 ...
	 * @return status
	 */
	protected IStatus handlePropertyModification(Property property,
			IValidationContext ctx) {
		if (EMFEventType.SET.equals(ctx.getEventType())
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (testPinOrParameterOrPropertyFeature(ctx.getFeature())) {
				// Update corresponding pins
				CompoundCommand cmd = getUpdatePinsCmd(getPins(property),
						property.getType(), property.isOrdered(),
						property.isUnique(), property.getLower(),
						property.getLowerValue(), property.getUpper(),
						property.getUpperValue());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					...
					ctx.getFeature())) {
				// Synchronize the pin name if not set yet
				CompoundCommand cmd = getSetPinsNamesCmd(getPins(property),
						property.getName());
				if (!cmd.isEmpty() && cmd.canExecute()) {
					if (askForValidation(getCallingActions(property.getOwner()))) {
						cmd.execute();
	 ...
	 * @return status
	 */
	protected IStatus changePinsBecauseOfParameterDirection(
			Parameter parameter, Notification event, IValidationContext ctx) {
		...
		if (ParameterDirectionKind.IN_LITERAL.equals(oldDir)) {
			if (ParameterDirectionKind.OUT_LITERAL.equals(newDir)
					|| ParameterDirectionKind.RETURN_LITERAL.equals(newDir)) {
				// explore referencing actions to remove in and add out
				for (InvocationAction action : callingActions) {
					if (action instanceof CallAction) {
						CompoundCommand cmd = getRemovePinsCmd(
								(CallAction) action,
								Collections.singletonList(inIndex), emptyList);
						globalCmd.append(cmd);
						cmd = getAddPinsCmd((CallAction) action, emptyMap,
								Collections.singletonMap(outIndex, parameter),
								null);
						globalCmd.append(cmd);
					}
				}
		...
		} else if (ParameterDirectionKind.OUT_LITERAL.equals(oldDir)
				|| ParameterDirectionKind.RETURN_LITERAL.equals(oldDir)) {
			if (ParameterDirectionKind.IN_LITERAL.equals(newDir)) {
				// explore referencing actions to remove out and add in
				for (InvocationAction action : callingActions) {
					if (action instanceof CallAction) {
						CompoundCommand cmd = getRemovePinsCmd(
								(CallAction) action, emptyList,
								Collections.singletonList(outIndex));
						globalCmd.append(cmd);
						cmd = getAddPinsCmd((CallAction) action,
								Collections.singletonMap(inIndex, parameter),
								emptyMap, null);
						globalCmd.append(cmd);
					}
				}
			...
			} else if (ParameterDirectionKind.OUT_LITERAL.equals(newDir)
					|| ParameterDirectionKind.RETURN_LITERAL.equals(newDir)) {
	...
	protected static List<InvocationAction> getCallingActions(Element element) {
		...
		if (element instanceof Behavior || element instanceof Operation) {
			Collection<Setting> references = CacheAdapter.INSTANCE
			...
			for (Setting ref : references) {
				...
				boolean operationCase = UMLPackage.eINSTANCE
						.getCallOperationAction_Operation().equals(
								ref.getEStructuralFeature());
				// parameter's owner is action's called Behavior
				boolean behaviorCase = UMLPackage.eINSTANCE
						.getCallBehaviorAction_Behavior().equals(
								ref.getEStructuralFeature());
				if ((operationCase || behaviorCase)
			...
			for (Setting ref : references) {
				...
				boolean signalCase = UMLPackage.eINSTANCE
						.getSendSignalAction_Signal().equals(
								ref.getEStructuralFeature());
				if (signalCase && action instanceof SendSignalAction
						&& action.eContainer() != null) {
	 ...
	 * @return status
	 */
	protected IStatus handleCallOperationActionModification(
			CallOperationAction action, IValidationContext ctx) {
		if (testTransformPinCase(ctx)) {
			return ctx.createSuccessStatus();
		} else if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			if (testActionFeature(ctx.getFeature())
				...
				if (action.getOperation() != null) {
					if (canCreateParameterFromCallAction(action)) {
						...
						boolean parameterCreated = proposeParameterCreation(
								action.getOperation(), ((EObject) pin).eClass());
						if (parameterCreated) {
		...
		} else if (EMFEventType.SET.equals(ctx.getEventType())
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getCallOperationAction_Operation().equals(
					ctx.getFeature())) {
				/*
			...
			if (UMLPackage.eINSTANCE.getCallOperationAction_Target().equals(
					ctx.getFeature())) {
				/*
				...
				final String msg = NLS
						.bind(Messages.PinAndParameterSynchronizer_UndeleteablePinMessage,
								UMLPackage.eINSTANCE
				...
				SafeDialogOpenerDuringValidation<Void> opener = new SafeDialogOpenerDuringValidation<Void>() {
					...
					protected Void openDialog() {
						MessageDialog
								.openWarning(
										new Shell(Display.getDefault()),
										Messages.PinAndParameterSynchronizer_UndeleteablePinTitle,
										msg);
						return null;
					}
				};
	 ...
	 * @return status
	 */
	protected IStatus handleCallBehaviorActionModification(
			CallBehaviorAction action, IValidationContext ctx) {
		if (testTransformPinCase(ctx)) {
			return ctx.createSuccessStatus();
		} else if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			if (testActionFeature(ctx.getFeature())
					&& action.getBehavior() != null) {
				if (action.getBehavior() != null) {
					if (canCreateParameterFromCallAction(action)) {
						Object pin = ctx.getFeatureNewValue();
						boolean parameterCreated = proposeParameterCreation(
								action.getBehavior(), ((EObject) pin).eClass());
						if (parameterCreated) {
							// remove the user-created value
							TransactionalEditingDomain editingdomain = EditorUtils
									.getTransactionalEditingDomain();
			...
			if (testActionFeature(ctx.getFeature())
				...
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getCallBehaviorAction_Behavior().equals(
					ctx.getFeature())) {
				/*
				...
				if (action.getBehavior() != null) {
					...
					if (behaviorName != null && !"".equals(behaviorName)) {
						...
						TransactionalEditingDomain editingdomain = EditorUtils
								.getTransactionalEditingDomain();
						cmd.append(SetCommand.create(editingdomain, action,
	 ...
	 */
	protected boolean canCreateAttributesFromSendSignalAction(
			SendSignalAction action) {
		return true;
	}
	 ...
	 * @return status
	 */
	protected IStatus handleBroadcastSignalActionModification(
			BroadcastSignalAction action, IValidationContext ctx) {
		if (testTransformPinCase(ctx)) {
			return ctx.createSuccessStatus();
		} else if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			if (testActionFeature(ctx.getFeature())
					&& action.getSignal() != null) {
				if (action.getSignal() != null) {

					Object pin = ctx.getFeatureNewValue();
					boolean attributeCreated = proposeAttributeCreation(
							action.getSignal(), ((EObject) pin).eClass());
					if (attributeCreated) {
						// remove the user-created value
						TransactionalEditingDomain editingdomain = EditorUtils
								.getTransactionalEditingDomain();
			...
			if (testActionFeature(ctx.getFeature())
				...
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getBroadcastSignalAction_Signal().equals(
					ctx.getFeature())) {
				/*
	 ...
	 * @return status
	 */
	protected IStatus handleSendSignalActionModification(
			SendSignalAction action, IValidationContext ctx) {
		if (testTransformPinCase(ctx)) {
			return ctx.createSuccessStatus();
		} else if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			...
			if (testActionFeature(ctx.getFeature())
				...
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getSendSignalAction_Signal().equals(
					ctx.getFeature())) {
				/*
				 * The signal changes, so must the pins
				 */
			...
			if (UMLPackage.eINSTANCE.getSendSignalAction_Target().equals(
					ctx.getFeature())) {
				/*
				 * Try to remove or assign target pin. This must not be
				 * authorized.
				...
				final String msg = NLS
						.bind(Messages.PinAndParameterSynchronizer_UndeleteablePinMessage,
								UMLPackage.eINSTANCE
										.getSendSignalAction_Target().getName());
				SafeDialogOpenerDuringValidation<Void> opener = new SafeDialogOpenerDuringValidation<Void>() {
	 ...
	 * @return status
	 */
	protected IStatus handleSendObjectActionModification(
			SendObjectAction action, IValidationContext ctx) {
		if (testTransformPinCase(ctx)) {
			return ctx.createSuccessStatus();
		} else if (EMFEventType.SET.equals(ctx.getEventType())
				|| EMFEventType.UNSET.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getSendObjectAction_Target().equals(
					ctx.getFeature())) {
				/*
				 * Try to remove or assign target pin. This must not be
				 * authorized.
				...
				final String msg = NLS
						.bind(Messages.PinAndParameterSynchronizer_UndeleteablePinMessage,
								UMLPackage.eINSTANCE
										.getSendObjectAction_Target().getName());
				SafeDialogOpenerDuringValidation<Void> opener = new SafeDialogOpenerDuringValidation<Void>() {
			...
			if (UMLPackage.eINSTANCE.getSendObjectAction_Request().equals(
					ctx.getFeature())) {
				/*
				 * Try to remove or assign target pin. This must not be
				 * authorized.
	...
	protected boolean testTransformPinCase(IValidationContext ctx) {
		...
		if (events.size() == 1) {
			...
			if (Notification.REMOVE == remove.getEventType()
					&& Notification.ADD == add.getEventType()) {
				if (remove.getPosition() == add.getPosition()
						&& add.getFeature().equals(remove.getFeature())) {
					removed = remove.getOldValue();
					added = add.getNewValue();
				}
			} else if (Notification.REMOVE_MANY == remove.getEventType()
					&& Notification.ADD_MANY == add.getEventType()) {
				if (Notification.NO_INDEX == remove.getPosition()
						&& add.getFeature().equals(remove.getFeature())) {
					if (remove.getOldValue() instanceof List<?>
							&& add.getNewValue() instanceof List<?>) {
						ArrayList<Object> removeList = new ArrayList<Object>(
								(List<?>) remove.getOldValue());
		...
		if (removed instanceof Pin && added instanceof Pin) {
			...
			// test name
			similars &= removedPin.getName() == null
					|| removedPin.getName().equals(addedPin.getName());
			// test type
			similars &= EcoreUtil.equals(removedPin.getType(),
					addedPin.getType());
			// test is ordered
			...
			similars &= EcoreUtil.equals(removedPin.getLowerValue(),
					addedPin.getLowerValue());
			// test multiplicity : upper value
			similars &= EcoreUtil.equals(removedPin.getUpperValue(),
					addedPin.getUpperValue());
			return similars;
		}
		return false;
	}
	 ...
	 * @return status
	 */
	protected IStatus handleOperationModification(Operation operation,
			IValidationContext ctx) {
		if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getBehavioralFeature_OwnedParameter()
					.equals(ctx.getFeature())) {
	 ...
	 * @return status
	 */
	protected IStatus handleBehaviorModification(Behavior behavior,
			IValidationContext ctx) {
		if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getBehavior_OwnedParameter().equals(
					ctx.getFeature())) {
	 ...
	 * @return status
	 */
	protected IStatus handleSignalModification(Signal signal,
			IValidationContext ctx) {
		if (EMFEventType.ADD.equals(ctx.getEventType())
				|| EMFEventType.ADD_MANY.equals(ctx.getEventType())) {
			if (UMLPackage.eINSTANCE.getSignal_OwnedAttribute().equals(
					ctx.getFeature())) {
	 ...
	 * @return status
	 */
	protected IStatus handleParametersRemoved(NamedElement element,
			IValidationContext ctx) {
		...
		while (removedParameterIndexes.containsKey(correspondingParameterIndex)
				|| parametersIterator.hasNext()) {
			if (removedParameterIndexes
					.containsKey(correspondingParameterIndex)) {
				// parameter removed, pin(s) removed
				switch (removedParameterIndexes
						.get(correspondingParameterIndex)) {
				case IN_LITERAL:
		...
		for (InvocationAction action : callingActions) {
			if (action instanceof CallAction) {
				CompoundCommand cmd = getRemovePinsCmd((CallAction) action,
						removedInputPinIndexes, removedOutputPinIndexes);
				globalCmd.append(cmd);
			}
		}
		if (!globalCmd.isEmpty() && globalCmd.canExecute()) {
	 ...
	 * @return status
	 */
	protected IStatus handleParametersAdded(NamedElement element,
			IValidationContext ctx) {
		...
		for (InvocationAction action : callingActions) {
			if (action instanceof CallAction) {
				CompoundCommand cmd = getAddPinsCmd((CallAction) action,
						addedInputPinMap, addedOutputPinMap, null);
				globalCmd.append(cmd);
			}
		}
		if (!globalCmd.isEmpty() && globalCmd.canExecute()) {
	 ...
	 * @return status
	 */
	protected IStatus handleAttributesRemoved(Signal element,
			IValidationContext ctx) {
		// construct the list of removed indexes and their direction
		...
		for (InvocationAction action : callingActions) {
			if (action instanceof SendSignalAction) {
				CompoundCommand cmd = getRemovePinsCmd(
						(SendSignalAction) action, removedInputPinIndexes);
				globalCmd.append(cmd);
			}
		}
		if (!globalCmd.isEmpty() && globalCmd.canExecute()) {
	 ...
	 * @return status
	 */
	protected IStatus handleAttributesAdded(Signal element,
			IValidationContext ctx) {
		// construct the list of added indexes and their direction
		...
		for (InvocationAction action : callingActions) {
			if (action instanceof SendSignalAction) {
				CompoundCommand cmd = getAddPinsCmd((SendSignalAction) action,
						addedInputPinMap, null);
				globalCmd.append(cmd);
			}
		}
		if (!globalCmd.isEmpty() && globalCmd.canExecute()) {
		...
		if (type != null) {// Get the editing domain
			...
			for (InvocationAction action : getCallingActions(operation)) {// operation
				...
				if (action instanceof CallOperationAction) {
					InputPin targetPin = ((CallOperationAction) action)
							.getTarget();
					if (targetPin != null) {
	 ...
	 */
	protected CompoundCommand getRemovePinsCmd(CallAction action,
			List<Integer> removedInputPinsIndexes,
			List<Integer> removedOutputPinsIndexes) {
		CompoundCommand globalCmd = new CompoundCommand();
		...
		if (action instanceof CallBehaviorAction
			...
			ArrayList<InputPin> removedIn = new ArrayList<InputPin>(
					removedInputPinsIndexes.size());
			...
			if (!removedIn.isEmpty()) {
				Command cmd = RemoveCommand.create(editingdomain, action,
						UMLPackage.eINSTANCE.getInvocationAction_Argument(),
						removedIn);
				globalCmd.append(cmd);
			}
			ArrayList<OutputPin> removedOut = new ArrayList<OutputPin>(
					removedInputPinsIndexes.size());
	 ...
	 * @return the command to remove corresponding Pins
	 */
	protected CompoundCommand getRemovePinsCmd(SendSignalAction action,
			List<Integer> removedInputPinsIndexes) {
		CompoundCommand globalCmd = new CompoundCommand();
		// Get the editing domain
		TransactionalEditingDomain editingdomain = EditorUtils
	 ...
	 */
	protected CompoundCommand getAddPinsCmd(CallAction action,
			Map<Integer, Parameter> addedInputPinMap,
			Map<Integer, Parameter> addedOutputPinMap, EClass preferredPinClass) {
		CompoundCommand globalCmd = new CompoundCommand();
		// Get the editing domain
		TransactionalEditingDomain editingdomain = EditorUtils
				.getTransactionalEditingDomain();
		if (action instanceof CallBehaviorAction
			 ...
			 */
			int nextKey = addedInputPinMap.size()
			...
			while (numberOfPinsToAdd > 0) {
				if (addedInputPinMap.containsKey(nextKey)) {
					...
					InputPin pin = createInputPin(
							addedInputPinMap.get(nextKey), preferredPinClass);
					// index at which pin is added must take in account other
					// pins added after
					int addIndex = nextKey - numberOfPinsToAdd;
					Command cmd = AddCommand
							.create(editingdomain, action, UMLPackage.eINSTANCE
									.getInvocationAction_Argument(), pin,
									addIndex);
					globalCmd.append(cmd);
				}
				nextKey--;
			...
			while (numberOfPinsToAdd > 0) {
				if (addedOutputPinMap.containsKey(nextKey)) {
					numberOfPinsToAdd--;
					OutputPin pin = createOutputPin(addedOutputPinMap
							.get(nextKey));
					// index at which pin is added must take in account other
					// pins added after
					int addIndex = nextKey - numberOfPinsToAdd;
					Command cmd = AddCommand.create(editingdomain, action,
							UMLPackage.eINSTANCE.getCallAction_Result(), pin,
							addIndex);
					globalCmd.append(cmd);
				}
				nextKey--;
	 ...
	 * @return the command to add corresponding Pins
	 */
	protected CompoundCommand getAddPinsCmd(SendSignalAction action,
			Map<Integer, Property> addedInputPinMap, EClass preferredPinClass) {
		CompoundCommand globalCmd = new CompoundCommand();
		// Get the editing domain
		TransactionalEditingDomain editingdomain = EditorUtils
				.getTransactionalEditingDomain();
	...
	protected OutputPin createOutputPin(Parameter parameter) {
		...
		if (lowerValue != null) {
			...
			Command copy = CopyCommand.create(
					EditorUtils.getTransactionalEditingDomain(),
					Collections.singleton(lowerValue));
			copy.execute();
		...
		if (upperValue != null) {
			...
			Command copy = CopyCommand.create(
					EditorUtils.getTransactionalEditingDomain(),
					Collections.singleton(upperValue));
			copy.execute();
			Collection<?> result = copy.getResult();
			Object valueToAffect = null;
			if (!result.isEmpty()) {
	 ...
	 *            null)
	 */
	protected InputPin createInputPin(Property property,
			EClass preferredPinClass) {
		InputPin pin;
		if (UMLPackage.eINSTANCE.getValuePin().equals(preferredPinClass)) {
			pin = UMLFactory.eINSTANCE.createValuePin();
		} else if (UMLPackage.eINSTANCE.getActionInputPin().equals(
				preferredPinClass)) {
	 ...
	 *            null)
	 */
	protected InputPin createInputPin(Parameter parameter,
			EClass preferredPinClass) {
		InputPin pin;
		if (UMLPackage.eINSTANCE.getValuePin().equals(preferredPinClass)) {
			pin = UMLFactory.eINSTANCE.createValuePin();
	 ...
	 * @return command
	 */
	protected CompoundCommand getResetPinsCmd(
		...
		if (action.getValue() == null) {
			...
			Command cmdValuePin = SetCommand.create(editingdomain, action,
					UMLPackage.eINSTANCE
							.getWriteStructuralFeatureAction_Value(), valuePin);
			globalCmd.append(cmdValuePin);
		}
		if (action.getObject() == null) {
			InputPin objectPin = createObjectPinInStructuralFeatureAction(action);
			Command cmd = SetCommand.create(editingdomain, action,
		...
		if (action.getResult() == null) {
			...
			Command cmdResultPin = SetCommand.create(editingdomain, action,
					UMLPackage.eINSTANCE
	...
	protected CompoundCommand getResetPinsCmd(BroadcastSignalAction action) {
		...
		if (action.getSignal() != null) {
			if (action.getArguments().isEmpty()) {
				EList<Property> properties = action.getSignal()
						.getAllAttributes();
				for (Property argument : properties) {
					...
					Command cmdArg = AddCommand.create(editingdomain, action,
							UMLPackage.Literals.INVOCATION_ACTION__ARGUMENT,
							Arrays.asList(argPin));
	...
	protected CompoundCommand getResetPinsCmd(AddVariableValueAction action) {
		...
		CompoundCommand globalCmd = new CompoundCommand();
		if (action.getValue() == null) {
			InputPin valuePin = createValuePinInAddVariableValueAction(action
					.getVariable());
			Command cmdValuePin = SetCommand.create(editingdomain, action,
	...
	protected CompoundCommand getResetPinsCmd(DestroyObjectAction action) {
		...
		if (action.getTarget() == null) {
			...
			Command cmdTargetPin = SetCommand.create(editingdomain, action,
	 ...
	 * @return
	 */
	protected InputPin createValuePinInAddStructuralFeatureAction(
			StructuralFeatureAction action) {
		InputPin pin = UMLFactory.eINSTANCE.createInputPin();
		if (action != null) {
	...
	protected CompoundCommand getResetPinsCmd(ReadStructuralFeatureAction action) {
		...
		if (action.getResult() == null) {
			...
			Command cmd = SetCommand
					.create(editingdomain, action, UMLPackage.eINSTANCE
							.getReadStructuralFeatureAction_Result(), resultPin);
			globalCmd.append(cmd);
		}
		// add object pin
		if (action.getObject() == null) {
	 ...
	 * @return
	 */
	protected InputPin createObjectPinInStructuralFeatureAction(
			StructuralFeatureAction action) {
		InputPin pin = UMLFactory.eINSTANCE.createInputPin();
		if (action != null) {
	 ...
	 * @return
	 */
	protected OutputPin createResultPinInStructuralAction(
			StructuralFeatureAction action) {
		OutputPin pin = UMLFactory.eINSTANCE.createOutputPin();
		Type type = getTypeFromStructuralFeature(action);
		if (type != null) {
	...
	protected CompoundCommand getSetPinsNamesCmd(List<Pin> pins, String name) {
		...
		for (Pin pin : pins) {
			...
			if (pin.getName() == null) {
				// add the command
				Command cmd = SetCommand.create(editingdomain, pin,
	 ...
	 * @return the command to execute
	 */
	protected CompoundCommand getUpdatePinsCmd(List<Pin> pins, Type type,
			boolean ordered, boolean unique, int lower,
			ValueSpecification lowerValue, int upper,
		...
		for (Pin pin : pins) {
			if (!EcoreUtil.equals(pin.getType(), type)) {
				// add the command
				Command cmd = SetCommand.create(editingdomain, pin,
						UMLPackage.eINSTANCE.getTypedElement_Type(), type);
				globalCmd.append(cmd);
			}
			if (pin.isOrdered() != ordered) {
				// add the command
				Command cmd = SetCommand
						.create(editingdomain, pin, UMLPackage.eINSTANCE
								.getMultiplicityElement_IsOrdered(), ordered);
				globalCmd.append(cmd);
			}
			...
			if (!EcoreUtil.equals(pin.getLowerValue(), lowerValue)) {
				...
				if (lowerValue != null) {
					Command copy = CopyCommand.create(editingdomain,
							Collections.singleton(lowerValue));
					copy.execute();
					Collection<?> result = copy.getResult();
					if (!result.isEmpty()) {
	...
	static protected List<Pin> getPins(Property property) {
		...
		if (owner instanceof Signal) {
			...
			for (InvocationAction action : callingActions) {
				...
				Pin pin = ((SendSignalAction) action).getArguments().get(
						inIndex);
				if (pin != null) {
					listOfPins.add(pin);
				}
	...
	static protected List<Pin> getPins(Parameter parameter) {
		...
		if (owner instanceof Operation) {
			...
			for (InvocationAction action : callingActions) {
				...
				switch (parameter.getDirection()) {
				case IN_LITERAL:
					Pin pin = ((CallOperationAction) action).getArguments()
							.get(inIndex);
					if (pin != null) {
						listOfPins.add(pin);
					}
				...
				case OUT_LITERAL:
				case RETURN_LITERAL:
					pin = ((CallOperationAction) action).getResults().get(
							outIndex);
					if (pin != null) {
						listOfPins.add(pin);
					}
					break;
				case INOUT_LITERAL:
					pin = ((CallOperationAction) action).getArguments().get(
							inIndex);
					if (pin != null) {
						listOfPins.add(pin);
					}
			...
			for (InvocationAction action : callingActions) {
				...
				switch (parameter.getDirection()) {
				case IN_LITERAL:
					Pin pin = ((CallBehaviorAction) action).getArguments().get(
							inIndex);
					if (pin != null) {
						listOfPins.add(pin);
					}
				...
				case OUT_LITERAL:
				case RETURN_LITERAL:
					pin = ((CallBehaviorAction) action).getResults().get(
							outIndex);
					if (pin != null) {
						listOfPins.add(pin);
					}
					break;
				case INOUT_LITERAL:
					pin = ((CallBehaviorAction) action).getArguments().get(
							inIndex);
					if (pin != null) {
						listOfPins.add(pin);
					}
	...
	static protected int getIndex(Parameter parameter, boolean in) {
		...
		for (Parameter param : parametersList) {
			...
			if (in
					&& (ParameterDirectionKind.IN_LITERAL.equals(param
							.getDirection()) || ParameterDirectionKind.INOUT_LITERAL
							.equals(param.getDirection()))) {
				index++;
			} else if (!in
					&& (ParameterDirectionKind.OUT_LITERAL.equals(param
							.getDirection())
							|| ParameterDirectionKind.RETURN_LITERAL
									.equals(param.getDirection()) || ParameterDirectionKind.INOUT_LITERAL
								.equals(param.getDirection()))) {
				index++;
			}
		}
	 ...
	 */
	protected boolean askForValidation(
			final List<? extends NamedElement> listOfActions) {
		SafeDialogOpenerDuringValidation<Boolean> opener = new SafeDialogOpenerDuringValidation<Boolean>() {

			protected Boolean openDialog() {
				return ConfirmPinAndParameterSyncDialog
						.openConfirmFromParameter(Display.getDefault()
								.getActiveShell(), listOfActions, labelProvider);
			}
		};
		return opener.execute();
	}
