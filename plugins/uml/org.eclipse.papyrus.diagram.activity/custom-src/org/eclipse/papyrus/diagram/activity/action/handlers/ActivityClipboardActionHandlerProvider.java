...
public class ActivityClipboardActionHandlerProvider extends AbstractGlobalActionHandlerProvider {
	...
	public IGlobalActionHandler getGlobalActionHandler(final IGlobalActionHandlerContext context) {
		...
		return (ActivityClipboardActionHandler) getHandlerList().get(context.getActivePart());
	}
