 ...
 * @generated
 */
public class CallOperationActionInIARNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CallOperationActionInIARNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallOperationAction_3084, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.CallOperationActionInIARNameEditPart.VISUAL_ID));
		}
		return parser;
	}
