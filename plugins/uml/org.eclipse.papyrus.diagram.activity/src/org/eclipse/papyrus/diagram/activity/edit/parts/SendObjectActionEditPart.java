 ...
 * @generated
 */
public class SendObjectActionEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SendObjectActionNameEditPart) {
			((SendObjectActionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionBaseFigure_name());
			return true;
		}
		if (childEditPart instanceof SendObjectActionName2EditPart) {
			((SendObjectActionName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureActionBaseFigure_stereotypes());
			return true;
		}
		if (childEditPart instanceof ValuePinEditPart) {
			...
			getBorderedFigure().getBorderItemContainer().add(((ValuePinEditPart) childEditPart).getFigure(), locator);
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ValuePinEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(((ValuePinEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InputPinEditPart) {
