...
public class PinCreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public PinCreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static PinCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new PinCreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.init_Pin_2021(newElement);
