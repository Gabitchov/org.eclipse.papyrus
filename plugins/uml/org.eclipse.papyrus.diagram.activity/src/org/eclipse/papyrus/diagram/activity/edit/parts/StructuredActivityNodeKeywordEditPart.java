 ...
 * @generated
 */
public class StructuredActivityNodeKeywordEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.StructuredActivityNode_3065, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.StructuredActivityNodeKeywordEditPart.VISUAL_ID));
		}
		return parser;
	}
