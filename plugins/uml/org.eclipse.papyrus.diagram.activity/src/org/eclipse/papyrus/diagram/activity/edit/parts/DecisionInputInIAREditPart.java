 ...
 * @generated
 */
public class DecisionInputInIAREditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DecisionInputInIAREditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public DecisionInputInIAREditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DecisionNode_3089, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DecisionInputInIAREditPart.VISUAL_ID));
		}
		return parser;
	}
