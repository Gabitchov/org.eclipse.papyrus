...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPin5ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPin5EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof InputPinName5EditPart)
				locatorInputPinName5EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof InputPinName5EditPart) {
	 ...
	 * @generated NOT
	 */
	protected void locatorInputPinName5EditPart(BorderItemLocator locator) {
