 ...
 * @generated
 */
public class InputPinName4EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinName4EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(
					UMLElementTypes.InputPin_2016, getParserElement(),
					parserHint);
