 ...
 * @generated
 */
public class FlowFinalNodeNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.FlowFinalNodeNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public FlowFinalNodeNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new NonResizableLabelEditPolicy() {
			...
			protected Command getMoveCommand(ChangeBoundsRequest request) {
				...
				Point normalPoint = new Point(rect.x - refPoint.x, rect.y - refPoint.y);
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.FlowFinalNode_2018, getParserElement(), parserHint);
	...
	protected IFigure createFigurePrim() {
		return new RoundNodesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class RoundNodesLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public RoundNodesLabelFigure() {
			this.setText("");
	 ...
	 * @generated
	 */
	static final Font THIS_FONT = new Font(Display.getCurrent(), "SANS", 10, SWT.BOLD);
}
