...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPin3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPin3EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof InputPinName3EditPart)
				locatorInputPinName3EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof InputPinName3EditPart) {
	 ...
	 * @generated NOT
	 */
	protected void locatorInputPinName3EditPart(BorderItemLocator locator) {
