 ...
 */
public class ActionInputPinInCOActAppliedStereotypeEditPart
...
extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart, IPapyrusEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ActionInputPinInCOActAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ActionInputPin_3021, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ActionInputPinInCOActAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
