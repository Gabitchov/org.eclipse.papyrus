...
import org.eclipse.papyrus.diagram.activity.edit.policies.OutputPin3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPin3EditPart extends BorderedBorderItemEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutputPin3ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof OutputPinName3EditPart)
				locatorOutputPinName3EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof OutputPinName3EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorOutputPinName3EditPart(BorderItemLocator locator) {
