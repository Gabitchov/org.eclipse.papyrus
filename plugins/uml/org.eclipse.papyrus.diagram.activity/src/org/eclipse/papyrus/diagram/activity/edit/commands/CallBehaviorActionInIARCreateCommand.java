 ...
 * @generated
 */
public class CallBehaviorActionInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public CallBehaviorActionInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static CallBehaviorActionInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new CallBehaviorActionInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public CallBehaviorActionInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_CallBehaviorAction_3083(newElement);
