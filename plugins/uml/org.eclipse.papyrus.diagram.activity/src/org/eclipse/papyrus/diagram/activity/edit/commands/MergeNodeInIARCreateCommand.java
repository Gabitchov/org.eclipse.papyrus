 ...
 * @generated
 */
public class MergeNodeInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MergeNodeInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static MergeNodeInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new MergeNodeInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public MergeNodeInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_MergeNode_3090(newElement);
