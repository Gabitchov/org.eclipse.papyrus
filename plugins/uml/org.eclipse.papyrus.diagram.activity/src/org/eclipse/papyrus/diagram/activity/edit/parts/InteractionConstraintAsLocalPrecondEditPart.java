...
import org.eclipse.papyrus.diagram.activity.edit.policies.InteractionConstraintAsLocalPrecondItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InteractionConstraintAsLocalPrecondEditPart extends
...
ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InteractionConstraintAsLocalPrecondEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InteractionConstraintAsLocalPrecondItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof InteractionConstraintAsLocalPrecondNameEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InteractionConstraintAsLocalPrecondNameEditPart.VISUAL_ID));
	}
