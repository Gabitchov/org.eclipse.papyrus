 ...
 * @generated
 */
public class MergeNodeInIARAppliedStereotypeEditPart


extends MergeNodeAppliedStereotypeEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.MergeNodeInIARAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public MergeNodeInIARAppliedStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.MergeNode_3090, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.MergeNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
