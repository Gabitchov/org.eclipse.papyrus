...
import org.eclipse.papyrus.diagram.activity.edit.policies.AcceptEventActionInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AcceptEventActionInIAREditPart extends
...
AcceptEventActionEditPart {
	 ...
	 * @generated
	 */
	public AcceptEventActionInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AcceptEventActionInIARItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());


		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.AcceptEventActionInIARCanonicalEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public AcceptEventActionEditPart.AcceptEventActionFigure getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof AcceptEventActionInIARLabelEditPart) {
			((AcceptEventActionInIARLabelEditPart)childEditPart).setLabel(getPrimaryShape().getAcceptEventActionLabel());
			return true;
		}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof AcceptTimeEventActionInIARLabelEditPart || borderItemEditPart instanceof AcceptTimeEventActionInIARAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(AcceptEventActionInIARLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.AcceptEventActionInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	 ...
	 * @generated
	 */
	public class AcceptEventActionFigure extends ScalablePolygonShape {
		...
		public AcceptEventActionFigure() {
			...
			this.setFill(true);
			this.setBorder(new MarginBorder(getMapMode().DPtoLP(0), getMapMode().DPtoLP(50), getMapMode().DPtoLP(0), getMapMode().DPtoLP(0)));
			createContents();
		}
