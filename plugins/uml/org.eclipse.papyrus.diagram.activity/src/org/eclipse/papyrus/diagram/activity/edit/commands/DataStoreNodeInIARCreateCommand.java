 ...
 * @generated
 */
public class DataStoreNodeInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DataStoreNodeInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static DataStoreNodeInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new DataStoreNodeInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public DataStoreNodeInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
