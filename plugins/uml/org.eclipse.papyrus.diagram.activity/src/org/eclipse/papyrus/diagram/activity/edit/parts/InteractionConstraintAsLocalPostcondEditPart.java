...
import org.eclipse.papyrus.diagram.activity.edit.policies.InteractionConstraintAsLocalPostcondItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InteractionConstraintAsLocalPostcondEditPart extends
...
ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InteractionConstraintAsLocalPostcondEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InteractionConstraintAsLocalPostcondItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof InteractionConstraintAsLocalPostcondNameEditPart) {
			((InteractionConstraintAsLocalPostcondNameEditPart)childEditPart).setLabel(getPrimaryShape().getCornerBentContent());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(InteractionConstraintAsLocalPostcondNameEditPart.VISUAL_ID));
	}
