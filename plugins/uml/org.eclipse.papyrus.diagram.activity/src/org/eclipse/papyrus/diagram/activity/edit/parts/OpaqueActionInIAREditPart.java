...
import org.eclipse.papyrus.diagram.activity.edit.policies.OpaqueActionInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OpaqueActionInIAREditPart extends
...
OpaqueActionEditPart {
	 ...
	 * @generated
	 */
	public OpaqueActionInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OpaqueActionInIARItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());


		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.OpaqueActionInIARCanonicalEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public OpaqueActionEditPart.ActionFigureDescriptor getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof OpaqueActionInIARNameEditPart) {
			((OpaqueActionInIARNameEditPart)childEditPart).setLabel(getPrimaryShape().getActionLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(OpaqueActionInIARNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.OpaqueActionInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public class ActionFigureDescriptor extends AbstractActionFigure {
		...
		public IMapMode getMapMode() {
			//ask the edit part
			return OpaqueActionInIAREditPart.this.getMapMode();
		}
