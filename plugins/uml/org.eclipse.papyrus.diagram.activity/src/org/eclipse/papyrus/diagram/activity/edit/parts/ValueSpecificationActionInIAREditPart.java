...
import org.eclipse.papyrus.diagram.activity.edit.policies.ValueSpecificationActionInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValueSpecificationActionInIAREditPart extends


ValueSpecificationActionEditPart {
	 ...
	 * @generated
	 */
	public ValueSpecificationActionInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValueSpecificationActionInIARItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());


		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.ValueSpecificationActionInIARCanonicalEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public ValueSpecificationActionEditPart.ActionFigureDescriptor getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof ValueSpecificationActionInIARNameEditPart) {
			((ValueSpecificationActionInIARNameEditPart)childEditPart).setLabel(getPrimaryShape().getActionLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValueSpecificationActionInIARNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.ValueSpecificationActionInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public class ActionFigureDescriptor extends AbstractActionFigure {
		...
		public IMapMode getMapMode() {
			//ask the edit part
			return ValueSpecificationActionInIAREditPart.this.getMapMode();
		}
