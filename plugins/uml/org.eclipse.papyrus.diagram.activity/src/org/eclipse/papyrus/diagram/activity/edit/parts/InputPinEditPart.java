...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPinItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPinEditPart extends BorderedBorderItemEditPart implements
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof InputPinNameEditPart)
				locatorInputPinNameEditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof InputPinNameEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorInputPinNameEditPart(BorderItemLocator locator) {
