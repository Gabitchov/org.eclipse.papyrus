 ...
 * @generated
 */
public class DestroyObjectActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DestroyObjectAction_3095, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DestroyObjectActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
