...
import org.eclipse.papyrus.diagram.activity.edit.policies.InitialNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InitialNodeInIAREditPart extends
...
InitialNodeEditPart {
	 ...
	 * @generated
	 */
	public InitialNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InitialNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public InitialNodeEditPart.InitialNodeFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof AppliedStereotypeWrappingLabelEditPart) {
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "InitialNode";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(AppliedStereotypeWrappingLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.InitialNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
