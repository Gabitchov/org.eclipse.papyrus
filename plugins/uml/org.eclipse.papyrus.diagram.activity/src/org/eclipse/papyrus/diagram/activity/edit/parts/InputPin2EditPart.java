...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPin2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPin2EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof InputPinName2EditPart)
				locatorInputPinName2EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof InputPinName2EditPart) {
	 ...
	 * @generated NOT
	 */
	protected void locatorInputPinName2EditPart(BorderItemLocator locator) {
