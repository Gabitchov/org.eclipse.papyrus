...
import org.eclipse.papyrus.diagram.activity.edit.policies.MergeNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MergeNodeInIAREditPart extends
...
MergeNodeEditPart {
	 ...
	 * @generated
	 */
	public MergeNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new MergeNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public MergeNodeEditPart.DiamondFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof MergeNodeInIARAppliedStereotypeEditPart) {
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "MergeNode";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(MergeNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.MergeNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
