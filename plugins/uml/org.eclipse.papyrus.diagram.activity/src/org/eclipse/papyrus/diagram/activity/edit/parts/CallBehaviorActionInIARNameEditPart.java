 ...
 * @generated
 */
public class CallBehaviorActionInIARNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public CallBehaviorActionInIARNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.CallBehaviorAction_3083, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.CallBehaviorActionInIARNameEditPart.VISUAL_ID));
		}
		return parser;
	}
