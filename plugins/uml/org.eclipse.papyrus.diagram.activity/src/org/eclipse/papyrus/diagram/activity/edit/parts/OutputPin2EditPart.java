...
import org.eclipse.papyrus.diagram.activity.edit.policies.OutputPin2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OutputPin2EditPart extends BorderedBorderItemEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutputPin2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof OutputPinName2EditPart)
				locatorOutputPinName2EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof OutputPinName2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorOutputPinName2EditPart(BorderItemLocator locator) {
