 ...
 * @generated
 */
public class AcceptTimeEventActionInIARAppliedStereotypeEditPart


extends AcceptTimeEventActionAppliedStereotypeEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.AcceptTimeEventActionInIARAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public AcceptTimeEventActionInIARAppliedStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AcceptEventAction_3087, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.AcceptTimeEventActionInIARAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
