 ...
 * @generated
 */
public class OutputPin4EditPart extends BorderedBorderItemEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OutputPin4ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof OutputPinName4EditPart)
				locatorOutputPinName4EditPart(locator);
	 ...
	 * @generated NOT
	 */
	protected void locatorOutputPinName4EditPart(BorderItemLocator locator) {
