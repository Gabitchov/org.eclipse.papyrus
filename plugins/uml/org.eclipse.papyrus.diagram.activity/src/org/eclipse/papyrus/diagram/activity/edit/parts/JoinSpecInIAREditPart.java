 ...
 * @generated
 */
public class JoinSpecInIAREditPart


extends JoinSpecEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.JoinSpecInIAREditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public JoinSpecInIAREditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.JoinNode_3092, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.JoinSpecInIAREditPart.VISUAL_ID));
		}
		return parser;
	}
