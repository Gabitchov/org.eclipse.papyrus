 ...
 * @generated
 */
public class InteractionConstraintAsLocalPostcondNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InteractionConstraintAsLocalPostcondNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InteractionConstraint_3031, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InteractionConstraintAsLocalPostcondNameEditPart.VISUAL_ID));
		}
		return parser;
	}
