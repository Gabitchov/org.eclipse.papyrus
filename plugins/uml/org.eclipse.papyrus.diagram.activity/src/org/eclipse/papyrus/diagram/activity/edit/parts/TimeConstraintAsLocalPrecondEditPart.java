 ...
 * @generated
 */
public class TimeConstraintAsLocalPrecondEditPart extends
...
ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof TimeConstraintAsLocalPrecondNameEditPart) {
			((TimeConstraintAsLocalPrecondNameEditPart)childEditPart).setLabel(getPrimaryShape().getCornerBentContent());
			return true;
		}
