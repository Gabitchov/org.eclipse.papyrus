 ...
 * @generated
 */
public class SendObjectActionInIARNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SendObjectActionInIARNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.SendObjectAction_3085, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.SendObjectActionInIARNameEditPart.VISUAL_ID));
		}
		return parser;
	}
