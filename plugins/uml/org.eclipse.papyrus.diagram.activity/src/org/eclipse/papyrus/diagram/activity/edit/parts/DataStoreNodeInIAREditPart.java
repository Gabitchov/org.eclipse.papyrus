...
import org.eclipse.papyrus.diagram.activity.edit.policies.DataStoreNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataStoreNodeInIAREditPart extends


DataStoreNodeEditPart {
	 ...
	 * @generated
	 */
	public DataStoreNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataStoreNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public DataStoreNodeEditPart.ObjectNodeDescriptor getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof DataStoreNodeInIARLabelEditPart) {
			((DataStoreNodeInIARLabelEditPart)childEditPart).setLabel(getPrimaryShape().getObjectNodeLabel());
			return true;
		}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof DataStoreInIARSelectionEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DataStoreNodeInIARLabelEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.DataStoreNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
		if(targetEditPart instanceof InitialNodeEditPart) {
			types.add(UMLElementTypes.ControlFlow_4004);
