 ...
 * @generated
 */
public class SendObjectActionInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SendObjectActionInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static SendObjectActionInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new SendObjectActionInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public SendObjectActionInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_SendObjectAction_3085(newElement);
