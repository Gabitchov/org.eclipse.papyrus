 ...
 * @generated
 */
public class InputPinName6EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinName6EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.InputPin_2028, getParserElement(), parserHint);
	...
	protected IFigure createFigurePrim() {
		return new AttachedPin_external_name();
	}

	/**
	 * @generated
	 */
	public class AttachedPin_external_name extends WrappingLabel {

		/**
		 * @generated
		 */
		public AttachedPin_external_name() {
			this.setText("");
