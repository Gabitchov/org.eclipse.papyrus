 ...
 * 
 * Contributors: Javier Muñoz (Integranova) – Label itelized when classifier is abstract
 *
 ******************************************************************************/
...
public class ActivityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(UMLElementTypes.Activity_1001, getParserElement(), parserHint);
