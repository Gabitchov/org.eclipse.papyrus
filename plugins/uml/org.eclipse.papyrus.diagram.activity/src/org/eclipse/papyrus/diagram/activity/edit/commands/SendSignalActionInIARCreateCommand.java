 ...
 * @generated
 */
public class SendSignalActionInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SendSignalActionInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static SendSignalActionInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new SendSignalActionInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public SendSignalActionInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_SendSignalAction_3086(newElement);
