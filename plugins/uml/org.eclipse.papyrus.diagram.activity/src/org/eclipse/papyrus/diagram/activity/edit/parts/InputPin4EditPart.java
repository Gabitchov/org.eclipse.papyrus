 ...
 * @generated
 */
public class InputPin4EditPart extends BorderedBorderItemEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InputPin4ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof InputPinName4EditPart)
				locatorInputPinName4EditPart(locator);
	 ...
	 * @generated NOT
	 */
	protected void locatorInputPinName4EditPart(BorderItemLocator locator) {
