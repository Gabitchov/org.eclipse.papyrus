 ...
 * @generated
 */
public class InitialNodeInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public InitialNodeInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static InitialNodeInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new InitialNodeInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public InitialNodeInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_InitialNode_3079(newElement);
