...
import org.eclipse.papyrus.diagram.activity.edit.policies.ForkNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ForkNodeInIAREditPart extends
...
ForkNodeEditPart {
	 ...
	 * @generated
	 */
	public ForkNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ForkNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public ForkNodeEditPart.SegmentFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ForkNodeInIARAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ForkNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.ForkNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
