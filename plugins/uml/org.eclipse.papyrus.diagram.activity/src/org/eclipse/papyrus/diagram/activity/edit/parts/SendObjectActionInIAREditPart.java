...
import org.eclipse.papyrus.diagram.activity.edit.policies.SendObjectActionInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SendObjectActionInIAREditPart extends


SendObjectActionEditPart {
	 ...
	 * @generated
	 */
	public SendObjectActionInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SendObjectActionInIARItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());


		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.SendObjectActionInIARCanonicalEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public SendObjectActionEditPart.ActionFigureDescriptor getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof SendObjectActionInIARNameEditPart) {
			((SendObjectActionInIARNameEditPart)childEditPart).setLabel(getPrimaryShape().getActionLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(SendObjectActionInIARNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.SendObjectActionInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public class ActionFigureDescriptor extends AbstractActionFigure {
		...
		public IMapMode getMapMode() {
			//ask the edit part
			return SendObjectActionInIAREditPart.this.getMapMode();
		}
