...
public class SendSignalActionEditPart extends AbstractBorderedShapeEditPart implements PrimaryShapeEditPart {
	...
	public class SendSignalActionFigureAux extends SendSignalActionFigure {
		...
		public SendSignalActionFigureAux() {
			super();
			stereotypeParent = super.getFigureSendSignalActionFigure_stereotypes().getParent();
			createContents();
		}
		 ...
		 */
		private void createContents() {
			if (stereotypeParent.getChildren().contains(super.getFigureSendSignalActionFigure_stereotypes())) {
				stereotypeParent.getChildren().remove(super.getFigureSendSignalActionFigure_stereotypes());
			}
