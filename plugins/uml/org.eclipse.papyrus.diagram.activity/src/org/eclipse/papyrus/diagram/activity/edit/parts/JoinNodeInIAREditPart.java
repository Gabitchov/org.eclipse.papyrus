...
import org.eclipse.papyrus.diagram.activity.edit.policies.JoinNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class JoinNodeInIAREditPart extends
...
JoinNodeEditPart {
	 ...
	 * @generated
	 */
	public JoinNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new JoinNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public JoinNodeEditPart.SegmentFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof JoinSpecInIAREditPart || borderItemEditPart instanceof JoinNodeInIARAppliedStereotypeEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(JoinSpecInIAREditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.JoinNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public class SegmentFigure extends RectangleFigure {
		...
		public SegmentFigure() {
			...
			this.setPreferredSize(new Dimension(getMapMode().DPtoLP(4), getMapMode().DPtoLP(45)));
			this.setMinimumSize(new Dimension(getMapMode().DPtoLP(4), getMapMode().DPtoLP(4)));
			this.setSize(getMapMode().DPtoLP(4), getMapMode().DPtoLP(45));
		}
