...
import org.eclipse.papyrus.diagram.activity.edit.policies.FlowFinalNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FlowFinalNodeInIAREditPart extends


FlowFinalNodeEditPart {
	 ...
	 * @generated
	 */
	public FlowFinalNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new FlowFinalNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public FlowFinalNodeEditPart.FlowFinalNodeFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof FlowFinalNodeInIARAppliedStereotypeEditPart) {
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "FlowFinalNode";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(FlowFinalNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.FlowFinalNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
