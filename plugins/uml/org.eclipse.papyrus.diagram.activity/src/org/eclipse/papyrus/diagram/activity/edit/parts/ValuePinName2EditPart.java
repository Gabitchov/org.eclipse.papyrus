 ...
 * @generated
 */
public class ValuePinName2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ValuePinName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(
					UMLElementTypes.ValuePin_2017, getParserElement(),
					parserHint);
