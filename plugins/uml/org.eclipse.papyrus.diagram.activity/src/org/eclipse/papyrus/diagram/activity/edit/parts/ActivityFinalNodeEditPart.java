...
public class ActivityFinalNodeEditPart extends AbstractBorderedShapeEditPart
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof ActivityFinalNodeNameEditPart)
				locatorActivityFinalNodeNameEditPart(locator);
	 ...
	 * @generated
	 */
	protected void locatorActivityFinalNodeNameEditPart(
	...
	public class ActivityFinalFigure extends Ellipse {
		...
		private void createContents() {
			...
			activityFinalFigure_inner0.setPreferredSize(new Dimension(
					getMapMode().DPtoLP(15), getMapMode().DPtoLP(15)));
			activityFinalFigure_inner0.setMaximumSize(new Dimension(
					getMapMode().DPtoLP(15), getMapMode().DPtoLP(15)));
			activityFinalFigure_inner0.setMinimumSize(new Dimension(
					getMapMode().DPtoLP(15), getMapMode().DPtoLP(15)));
