 ...
 */
public class InputPinInCBActAppliedStereotypeEditPart
...
extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart, IPapyrusEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInCBActAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.InputPin_3019, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.InputPinInCBActAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
