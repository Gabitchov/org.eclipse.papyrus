...
import org.eclipse.papyrus.diagram.activity.edit.policies.CallBehaviorActionInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallBehaviorActionInIAREditPart extends
...
CallBehaviorActionEditPart {
	 ...
	 * @generated
	 */
	public CallBehaviorActionInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallBehaviorActionInIARItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());


		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.CallBehaviorActionInIARCanonicalEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public CallBehaviorActionEditPart.ActionFigureDescriptor getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof CallBehaviorActionInIARNameEditPart) {
			((CallBehaviorActionInIARNameEditPart)childEditPart).setLabel(getPrimaryShape().getActionLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallBehaviorActionInIARNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.CallBehaviorActionInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public class ActionFigureDescriptor extends AbstractActionFigure {
		...
		public IMapMode getMapMode() {
			//ask the edit part
			return CallBehaviorActionInIAREditPart.this.getMapMode();
		}
