...
import org.eclipse.papyrus.diagram.activity.edit.policies.ActivityFinalNodeInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ActivityFinalNodeInIAREditPart extends


ActivityFinalNodeEditPart {
	 ...
	 * @generated
	 */
	public ActivityFinalNodeInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ActivityFinalNodeInIARItemSemanticEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public ActivityFinalNodeEditPart.ActivityFinalNodeFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof ActivityFinalNodeInIARAppliedStereotypeEditPart) {
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "ActivityFinalNode";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActivityFinalNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.ActivityFinalNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
