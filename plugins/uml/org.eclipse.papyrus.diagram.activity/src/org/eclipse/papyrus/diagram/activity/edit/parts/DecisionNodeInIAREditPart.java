 ...
 * @generated
 */
public class DecisionNodeInIAREditPart extends
...
DecisionNodeEditPart {
	 ...
	 * @generated
	 */
	public DecisionNodeInIAREditPart(View view) {
		super(view);
	}
	 ...
	 * @generated NOT use inherited method
	 */
	public DecisionNodeEditPart.DiamondFigure getPrimaryShape() {
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if(borderItemEditPart instanceof DecisionInputInIAREditPart || borderItemEditPart instanceof DecisionNodeInIARAppliedStereotypeEditPart) {
	...
	protected NodeFigure createNodePlate() {
		String prefElementId = "DecisionNode";
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(DecisionInputInIAREditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.DecisionNodeInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
