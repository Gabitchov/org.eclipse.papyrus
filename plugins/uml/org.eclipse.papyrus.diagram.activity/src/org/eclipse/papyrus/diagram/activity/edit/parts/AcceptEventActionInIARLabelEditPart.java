 ...
 * @generated
 */
public class AcceptEventActionInIARLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AcceptEventActionInIARLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AcceptEventAction_3087, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.AcceptEventActionInIARLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
