 ...
 * @generated
 */
public class ActivityFinalNodeInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ActivityFinalNodeInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static ActivityFinalNodeInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new ActivityFinalNodeInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public ActivityFinalNodeInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_ActivityFinalNode_3080(newElement);
