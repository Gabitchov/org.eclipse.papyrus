 ...
 * @generated
 */
public class SendSignalActionInIARNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SendSignalActionInIARNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.SendSignalAction_3086, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.SendSignalActionInIARNameEditPart.VISUAL_ID));
		}
		return parser;
	}
