 ...
 * @generated
 */
public class AcceptTimeEventActionInIARLabelEditPart


extends AcceptTimeEventActionLabelEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.AcceptTimeEventActionInIARLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public AcceptTimeEventActionInIARLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.AcceptEventAction_3087, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.AcceptTimeEventActionInIARLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
