 ...
 * @generated
 */
public class FlowFinalNodeInIARCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FlowFinalNodeInIARCreateCommand(CreateElementRequest req, EObject eObject) {
	 ...
	 * @generated
	 */
	public static FlowFinalNodeInIARCreateCommand create(CreateElementRequest req, EObject eObject) {
		return new FlowFinalNodeInIARCreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public FlowFinalNodeInIARCreateCommand(CreateElementRequest req) {
		super(req.getLabel(), null, req);
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_FlowFinalNode_3081(newElement);
