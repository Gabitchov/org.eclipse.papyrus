...
import org.eclipse.papyrus.diagram.activity.edit.policies.InputPin6ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputPin6EditPart extends BorderedBorderItemEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InputPin6ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof InputPinName6EditPart)
				locatorInputPinName6EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof InputPinName6EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorInputPinName6EditPart(BorderItemLocator locator) {
