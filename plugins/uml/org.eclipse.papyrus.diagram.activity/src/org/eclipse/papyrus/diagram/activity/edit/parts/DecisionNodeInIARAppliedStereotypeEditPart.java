 ...
 * @generated
 */
public class DecisionNodeInIARAppliedStereotypeEditPart


extends DecisionNodeAppliedStereotypeEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DecisionNodeInIARAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public DecisionNodeInIARAppliedStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.DecisionNode_3089, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.DecisionNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
