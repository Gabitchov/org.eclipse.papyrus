...
import org.eclipse.papyrus.diagram.activity.edit.policies.CallOperationActionInIARItemSemanticEditPolicy;
 ...
 * @generated
 */
public class CallOperationActionInIAREditPart extends


CallOperationActionEditPart {
	 ...
	 * @generated
	 */
	public CallOperationActionInIAREditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CallOperationActionInIARItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());


		//in Papyrus diagrams are not strongly synchronised
		//installEditPolicy(org.eclipse.gmf.runtime.diagram.ui.editpolicies.EditPolicyRoles.CANONICAL_ROLE, new org.eclipse.papyrus.diagram.activity.edit.policies.CallOperationActionInIARCanonicalEditPolicy());
	 ...
	 * @generated NOT use inherited method
	 */
	public CallOperationActionEditPart.ActionFigureDescriptor getPrimaryShape() {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof CallOperationActionInIARNameEditPart) {
			((CallOperationActionInIARNameEditPart)childEditPart).setLabel(getPrimaryShape().getActionLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(CallOperationActionInIARNameEditPart.VISUAL_ID));
	}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(IGraphicalEditPart targetEditPart) {
		...
		if(targetEditPart instanceof org.eclipse.papyrus.diagram.activity.edit.parts.CallOperationActionInIAREditPart) {
			types.add(UMLElementTypes.ObjectFlow_4003);
		}
	...
	public class ActionFigureDescriptor extends AbstractActionFigure {
		...
		public IMapMode getMapMode() {
			//ask the edit part
			return CallOperationActionInIAREditPart.this.getMapMode();
		}
