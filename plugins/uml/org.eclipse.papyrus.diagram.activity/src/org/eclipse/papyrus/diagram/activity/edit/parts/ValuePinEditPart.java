...
import org.eclipse.papyrus.diagram.activity.edit.policies.ValuePinItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValuePinEditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ValuePinEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValuePinItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof ValuePinNameEditPart)
				locatorValuePinNameEditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof ValuePinNameEditPart) {
	 ...
	 * @generated NOT
	 */
	protected void locatorValuePinNameEditPart(BorderItemLocator locator) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValuePinNameEditPart.VISUAL_ID));
	}
