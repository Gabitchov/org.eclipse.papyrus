 ...
 * @generated
 */
public class FlowFinalNodeInIARAppliedStereotypeEditPart


extends FlowFinalNodeAppliedStereotypeEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.FlowFinalNodeInIARAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public FlowFinalNodeInIARAppliedStereotypeEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.FlowFinalNode_3081, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.FlowFinalNodeInIARAppliedStereotypeEditPart.VISUAL_ID));
		}
		return parser;
	}
