...
public class UMLVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return org.eclipse.papyrus.diagram.activity.part.UMLVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = org.eclipse.papyrus.diagram.activity.part.UMLVisualIDRegistry
		...
		if (PackageEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = org.eclipse.papyrus.diagram.activity.part.UMLVisualIDRegistry
		...
		case SendObjectActionEditPart.VISUAL_ID:
			// mgil :: modified to check ValuePin before InputPint.
			if (UMLPackage.eINSTANCE.getValuePin().isSuperTypeOf(
					domainElement.eClass())) {
				return ValuePinEditPart.VISUAL_ID;
			}
			// mgil :: also check which inputPin wants to be created: target or
			// request
		...
		case ActivitySubverticesEditPart.VISUAL_ID:
			...
			if (UMLPackage.eINSTANCE.getAcceptEventAction().isSuperTypeOf(
					domainElement.eClass())
					&& isAcceptEventAction_2007((AcceptEventAction) domainElement)) {
		...
		case ActivityPartitionActivityPartitionCompartmentEditPart.VISUAL_ID:
			...
			if (UMLPackage.eINSTANCE.getAcceptEventAction().isSuperTypeOf(
					domainElement.eClass())
					&& isAcceptEventAction_2033((AcceptEventAction) domainElement)) {
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (UMLPackage.eINSTANCE.getObjectFlow().isSuperTypeOf(
				domainElement.eClass())) {
			return ObjectFlowEditPart.VISUAL_ID;
		}
		if (UMLPackage.eINSTANCE.getExceptionHandler().isSuperTypeOf(
				domainElement.eClass())) {
	 ...
	 * @generated
	 */
	private static boolean isAcceptEventAction_2007(
			AcceptEventAction domainElement) {
		if (AcceptEventAction_2007_Constraint == null) { // lazy initialization
			AcceptEventAction_2007_Constraint = UMLOCLFactory
					.getExpression(
		...
		Object result = AcceptEventAction_2007_Constraint
	 ...
	 * @generated
	 */
	private static boolean isAcceptEventAction_2033(
			AcceptEventAction domainElement) {
		if (AcceptEventAction_2033_Constraint == null) { // lazy initialization
			AcceptEventAction_2033_Constraint = UMLOCLFactory
					.getExpression(
							"self.trigger->isEmpty() or (not self.trigger->forAll(tr | tr.event.oclIsKindOf(uml::TimeEvent)))", UMLPackage.eINSTANCE.getAcceptEventAction()); //$NON-NLS-1$
		}
		Object result = AcceptEventAction_2033_Constraint
				.evaluate(domainElement);
		return result instanceof Boolean && ((Boolean) result).booleanValue();
	}
