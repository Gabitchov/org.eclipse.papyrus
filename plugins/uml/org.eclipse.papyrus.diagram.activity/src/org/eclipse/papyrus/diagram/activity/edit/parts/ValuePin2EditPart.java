...
import org.eclipse.papyrus.diagram.activity.draw2d.PinArrowFigure;
import org.eclipse.papyrus.diagram.activity.edit.policies.ValuePin2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ValuePin2EditPart extends BorderedBorderItemEditPart implements PrimaryShapeEditPart {
	 ...
	 * @generated
	 */
	public ValuePin2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ValuePin2ItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		SmallSquareFigure figure = new SmallSquareFigure(this);
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(), PositionConstants.NSEW) {
				...
				protected Point getPreferredLocation(int side, IFigure borderItem) {
					...
					} else if (side == PositionConstants.EAST || side == PositionConstants.WEST) {
						Dimension borderItemSize = getSize(borderItem);
			...
			if (borderItemEditPart instanceof ValuePinName2EditPart)
				locatorValuePinName2EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof ValuePinName2EditPart) {
	 ...
	 * @generated NOT
	 */
	protected void locatorValuePinName2EditPart(BorderItemLocator locator) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ValuePinName2EditPart.VISUAL_ID));
	}
	...
	public class SmallSquareFigure extends RectangleFigure {
		 ...
		 * @NOT generated
		 */
		public SmallSquareFigure(EditPart iep) {
			editPart = iep;
			this.setLayoutManager(new StackLayout());
			this.setForegroundColor(ColorConstants.black);
			this.setBackgroundColor(THIS_BACK);
		...
		private void createContents() {
			if (editPart != null) {
				PinArrowFigure pinArrowFigure0 = new PinArrowFigure(editPart);
				this.add(pinArrowFigure0);
			}
		}
