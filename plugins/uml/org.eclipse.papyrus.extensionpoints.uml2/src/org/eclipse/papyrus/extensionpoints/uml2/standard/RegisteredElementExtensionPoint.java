...
/**
 * Abstract Class that introduces the basic functionalities
 * for Papyrus UML2 extension points
 */
public abstract class RegisteredElementExtensionPoint {
	 ...
	 * @param configElt the configuration element for the extension point
	 * @param ordinal the place of the extension point in the list of registered elements
	 */
	 ...
	 * @param defaultValue value given to the property if it is not already set 
	 * @param isRequired <code>true</code> if the property must be set
	 * @param configElt configuration element from which to retrieve property value
	 ...
	 * @return an icon for the transformation or <code>null</code> if no icon is associated to the profile
	 */
