...
public class RegisteredMetamodel extends RegisteredElementExtensionPoint {
	...
	/**
	 * Returns the list of registered metamodels in the platform, using the 
	...
	public static RegisteredMetamodel[] getRegisteredMetamodels() {
		...
		IConfigurationElement[] configElements = 
			Platform .getExtensionRegistry().getConfigurationElementsFor(ExtensionIds.METAMODEL_EXTENSION_ID);
...
//		metamodels.add(EcoreMetamodel);		
	...
	/**
	 * Returns a registered metamodel using its name. If several mdetamodels are found,
	 * the first found is returned
	 * @param name the name of the metamodel to find
	 * @return the RegisteredMetamodel with given name or <code>null</code> if no
	 * metamodel was found. 
	 */
	...
	/**
	 * Returns a registered metamodel using its name and a given path. If several 
	 * metamodels are found, the first found is returned.
	 * @param name the name of the metamodel to find
	 * @param path the path of the metamodel file 
	 * @return the RegisteredMetamodel with given name or <code>null</code> if no
	 * metamodel was found. 
	 */
	...
	private static RegisteredMetamodel parseMetamodelExtension(IConfigurationElement configElt, int ordinal) {
		...
		try {
			...
			String msg = "Failed to load metamodel named "
							+ name + " in "
							+ configElt
