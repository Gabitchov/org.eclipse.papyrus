 ...
 *******************************************************************************/
package org.eclipse.papyrus.extensionpoints.uml2.profile;
...
/**
 * Shows a list of registered libraries to the user with a text entry field for a string
...
public class FilteredRegisteredProfilesAsLibrarySelectionDialog extends FilteredRegisteredElementsSelectionDialog {
	 ...
	 * @param alreadySelected list of already selected items
	 */
