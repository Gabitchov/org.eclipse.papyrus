...
public class HyperlinkHelper {
	 ...
	 */
	public static RecordingCommand getAddHyperLinkCommand(TransactionalEditingDomain domain, EModelElement object, String localization){
	 ...
	 */
	public static RecordingCommand getAddDocumentCommand(TransactionalEditingDomain domain, EModelElement object, String localization){
		return new CreateHyperLinkCommand(domain, object, VisualInformationPapyrusConstant.HYPERLINK_DOCUMENT, localization);
	}
	 ...
	 */
	public static RecordingCommand getRemoveElementCommand(TransactionalEditingDomain domain, EModelElement object, String localization){
	 ...
	 * 
	 * @param object the object
	 * @param hyperlinkKind the hyperlink kind
	 * 
	...
	protected static ArrayList<String> getAllreferenced(EModelElement object,String hyperlinkKind){
		...
		if (eAnnotation !=null){
			...
			while (iteratorEntry.hasNext()) {
				Map.Entry<java.lang.String,java.lang.String> currentEntry = (Map.Entry<java.lang.String,java.lang.String>) iteratorEntry.next();
