 ...
 * @generated
 */
public class Pseudostate2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate2CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate2CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2010(newElement);
