...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Region2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Region2EditPart extends ShapeNodeEditPart implements
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RegionSubvertices2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRegionFigure_Compartment();
			pane.remove(((RegionSubvertices2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
