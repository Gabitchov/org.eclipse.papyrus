...
public class UMLViewProvider extends AbstractProvider implements IViewProvider {
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		case PseudostateEditPart.VISUAL_ID:
			return createPseudostate_4000(domainElement, containerView, index, persisted, preferencesHint);
	 ...
	 * @generated
	 */
	public Node createPseudostate_4000(EObject domainElement, View containerView, int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label4001 = createLabel(node, UMLVisualIDRegistry.getType(PseudostateNameEditPart.VISUAL_ID));
		label4001.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());

		Location location4001 = (Location)label4001.getLayoutConstraint();
		location4001.setX(0);
		location4001.setY(5);
		Node label4002 = createLabel(node, UMLVisualIDRegistry.getType(PseudostateStereotypeEditPart.VISUAL_ID));
		label4002.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	...
	public Node createState_6000(EObject domainElement, View containerView, int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		Node label6002 = createLabel(node, UMLVisualIDRegistry.getType(StateStereotypeEditPart.VISUAL_ID));
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return StateMachineEditPart.VISUAL_ID == visualID || RegionEditPart.VISUAL_ID == visualID || PseudostateEditPart.VISUAL_ID == visualID || FinalStateEditPart.VISUAL_ID == visualID || StateEditPart.VISUAL_ID == visualID;
	}
