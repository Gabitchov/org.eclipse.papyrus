...
public class UMLDiagramUpdater {
	 ...
	 * @generated
	 */
	public static List<UMLLinkDescriptor> getPseudostate_4000ContainedLinks(View view) {
		return Collections.emptyList();
	}
	 ...
	 * @generated
	 */
	public static List<UMLLinkDescriptor> getPseudostate_4000IncomingLinks(View view) {
	 ...
	 * @generated
	 */
	public static List<UMLLinkDescriptor> getPseudostate_4000OutgoingLinks(View view) {
		Pseudostate modelElement = (Pseudostate)view.getElement();
		LinkedList<UMLLinkDescriptor> result = new LinkedList<UMLLinkDescriptor>();
		result.addAll(getOutgoingTypeModelFacetLinks_Transition_7000(modelElement));
		return result;
