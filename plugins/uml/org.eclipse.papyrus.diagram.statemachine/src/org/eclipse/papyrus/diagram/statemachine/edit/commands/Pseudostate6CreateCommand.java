...
public class Pseudostate6CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate6CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate6CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate6CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if(newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2014(newElement);
