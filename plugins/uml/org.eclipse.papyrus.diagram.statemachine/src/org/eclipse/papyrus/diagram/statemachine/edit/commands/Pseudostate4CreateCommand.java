...
public class Pseudostate4CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate4CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate4CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate4CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if(newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2012(newElement);
