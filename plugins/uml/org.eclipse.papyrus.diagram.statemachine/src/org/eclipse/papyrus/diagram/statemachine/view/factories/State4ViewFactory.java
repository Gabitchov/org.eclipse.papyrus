 ...
 * @generated
 */
public class State4ViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = UMLVisualIDRegistry
					.getType(State4EditPart.VISUAL_ID);
		...
		getViewService().createNode(eObjectAdapter, view,
				UMLVisualIDRegistry.getType(StateName7EditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(eObjectAdapter, view,
				UMLVisualIDRegistry.getType(StateName8EditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
