...
public class Pseudostate9CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate9CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate9CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate9CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if(newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2018(newElement);
