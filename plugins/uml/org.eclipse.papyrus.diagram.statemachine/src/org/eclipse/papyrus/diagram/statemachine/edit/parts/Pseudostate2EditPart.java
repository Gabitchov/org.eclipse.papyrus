...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate2EditPart extends ShapeNodeEditPart implements
	...
	public class ShallowHistoryFigure extends Ellipse {
		...
		public ShallowHistoryFigure() {
			...
			this.setBorder(new MarginBorder(getMapMode().DPtoLP(6),
					getMapMode().DPtoLP(8), getMapMode().DPtoLP(6),
					getMapMode().DPtoLP(8)));
			createContents();
		}
		...
		private void createContents() {
			...
			shallowHistoryFigure_Letter0.addPoint(new Point(getMapMode()
					.DPtoLP(0), getMapMode().DPtoLP(40)));
			shallowHistoryFigure_Letter0.addPoint(new Point(getMapMode()
