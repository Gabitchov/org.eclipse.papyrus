...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.FinalStateNodeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FinalStateNodeEditPart extends
...
AbstractBorderedShapeEditPart {
	 ...
	 * @generated
	 */
	public FinalStateNodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FinalStateNodeItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof FinalStateNameLabelEditPart) {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eclipse.papyrus.diagram.statemachine.edit.parts.FinalStateNodeEditPart) {
			types.add(UMLElementTypes.Transition_5000);
		}
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"FinalStateNode", PreferenceConstantHelper.COLOR_LINE);
			} else if (feature == NotationPackage.eINSTANCE
					.getFontStyle_FontColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"FinalStateNode", PreferenceConstantHelper.COLOR_FONT);
			} else if (feature == NotationPackage.eINSTANCE
					.getFillStyle_FillColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"FinalStateNode", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant(
					"FinalStateNode", PreferenceConstantHelper.COLOR_GRADIENT);
