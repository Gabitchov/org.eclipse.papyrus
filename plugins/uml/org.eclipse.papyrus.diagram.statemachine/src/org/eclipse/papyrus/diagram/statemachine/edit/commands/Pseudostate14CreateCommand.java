 ...
 * @generated
 */
public class Pseudostate14CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate14CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate14CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate14CreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public Pseudostate14CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if(newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2023(newElement);
