 ...
 * @generated
 */
public class PseudostateName6EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
				.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudostateName6EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PseudostateName6EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(
					UMLElementTypes.Pseudostate_2023, getParserElement(),
					parserHint);
	...
	protected IFigure createFigurePrim() {
		return new EntryExitPointFigure_ExternalLabel();
	}

	/**
	 * @generated
	 */
	public class EntryExitPointFigure_ExternalLabel extends WrappingLabel {

		/**
		 * @generated
		 */
		public EntryExitPointFigure_ExternalLabel() {
			this.setText("");
