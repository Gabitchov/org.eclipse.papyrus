...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate9ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate9EditPart extends BorderedBorderItemEditPart implements
	 ...
	 * @generated
	 */
	public Pseudostate9EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate9ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if(borderItemEditPart instanceof LabelEditPart) {
			...
			if(borderItemEditPart instanceof PseudostateNameEditPart)
				locatorPseudostateNameEditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if(borderItemEditPart instanceof PseudostateNameEditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorPseudostateNameEditPart(BorderItemLocator locator) {
