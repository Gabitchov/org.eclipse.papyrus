...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate7ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate7EditPart extends ShapeNodeEditPart implements
	 ...
	 * @generated
	 */
	public Pseudostate7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof PseudostateName7EditPart) {
			((PseudostateName7EditPart)childEditPart)
	...
	protected NodeFigure createNodePlate() {
		ChoiceNodeFigure result = new ChoiceNodeFigure(getMapMode().DPtoLP(40),
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(PseudostateName7EditPart.VISUAL_ID));
	}
	 ...
	 * @NOT-generated
	 */
	public class ChoiceNodeFigure extends DefaultSizeNodeFigure implements
			IPolygonAnchorableFigure {

		public ChoiceNodeFigure(Dimension defSize) {
			super(defSize.width, defSize.height);
		}

		public ChoiceNodeFigure(int width, int height) {
			super(width, height);
		}
