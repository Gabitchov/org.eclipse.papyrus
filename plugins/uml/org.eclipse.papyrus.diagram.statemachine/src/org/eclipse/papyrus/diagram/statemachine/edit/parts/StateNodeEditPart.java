...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.StateNodeItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StateNodeEditPart extends
...
NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StateNodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StateNameLabelEditPart) {
			((StateNameLabelEditPart) childEditPart).setLabel(getPrimaryShape()
					.getNameLabel());
			return true;
		}
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eclipse.papyrus.diagram.statemachine.edit.parts.StateNodeEditPart) {
			types.add(UMLElementTypes.Transition_5000);
		}
		return types;
	}
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"StateNode", PreferenceConstantHelper.COLOR_LINE);
			} else if (feature == NotationPackage.eINSTANCE
					.getFontStyle_FontColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"StateNode", PreferenceConstantHelper.COLOR_FONT);
			} else if (feature == NotationPackage.eINSTANCE
					.getFillStyle_FillColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant(
						"StateNode", PreferenceConstantHelper.COLOR_FILL);
			}
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant(
					"StateNode", PreferenceConstantHelper.COLOR_GRADIENT);
