 ...
 * @generated
 */
public class FinalStateNameLabelEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.FinalStateNameLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public FinalStateNameLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.FinalState_3005,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.FinalStateNameLabelEditPart.VISUAL_ID));
		}
