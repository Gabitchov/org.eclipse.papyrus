 ...
 * @generated
 */
public class PseudoStateNodeStereotypeLabelEditPart
...
implements ITextAwareEditPart, IBorderItemEditPart {
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudoStateNodeStereotypeLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PseudoStateNodeStereotypeLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Pseudostate_3004,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudoStateNodeStereotypeLabelEditPart.VISUAL_ID));
		}
