 ...
 * @generated
 */
public class Pseudostate13CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate13CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate13CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate13CreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public Pseudostate13CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if(newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2022(newElement);
