...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate14ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate14EditPart extends BorderedBorderItemEditPart implements
	 ...
	 * @generated
	 */
	public Pseudostate14EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate14ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if(borderItemEditPart instanceof LabelEditPart) {
			...
			if(borderItemEditPart instanceof PseudostateName6EditPart)
				locatorPseudostateName6EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if(borderItemEditPart instanceof PseudostateName6EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorPseudostateName6EditPart(BorderItemLocator locator) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(PseudostateName6EditPart.VISUAL_ID));
	}
