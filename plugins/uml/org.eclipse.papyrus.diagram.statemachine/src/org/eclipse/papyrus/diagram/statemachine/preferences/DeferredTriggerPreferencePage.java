 ...
 * @generated
 */
public class DeferredTriggerPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public DeferredTriggerPreferencePage() {
		super();
		setPreferenceKey(PackageEditPart.MODEL_ID + "_DeferredTrigger");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		String key = PackageEditPart.MODEL_ID + "_DeferredTrigger";
