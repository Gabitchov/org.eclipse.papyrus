 ...
 * @generated
 */
public class TransitionEditPartReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public TransitionEditPartReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistTransition_5000(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Region container = (Region) getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.LinkConstraints
				.canExistTransition_5000(container, source, getNewTarget());
	}
