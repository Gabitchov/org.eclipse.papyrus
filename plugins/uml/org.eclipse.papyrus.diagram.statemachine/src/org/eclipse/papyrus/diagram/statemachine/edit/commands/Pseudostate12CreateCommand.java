 ...
 * @generated
 */
public class Pseudostate12CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate12CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate12CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate12CreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public Pseudostate12CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2021(newElement);
