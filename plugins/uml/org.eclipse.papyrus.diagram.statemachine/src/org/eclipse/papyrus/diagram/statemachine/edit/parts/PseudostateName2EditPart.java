 ...
 * @generated
 */
public class PseudostateName2EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudostateName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PseudostateName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(
					UMLElementTypes.Pseudostate_2019, getParserElement(),
					parserHint);
