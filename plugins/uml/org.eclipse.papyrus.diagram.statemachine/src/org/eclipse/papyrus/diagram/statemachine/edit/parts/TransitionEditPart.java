...
public class TransitionEditPart extends ConnectionNodeEditPart implements
	...
	public class TransitionConnection extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureTransitionStereotypesLabel;
		...
		private void createContents() {
			...
			fFigureTransitionNameLabel = new WrappingLabel();
			fFigureTransitionNameLabel.setText("");

			fFigureTransitionNameLabel.setFont(FFIGURETRANSITIONNAMELABEL_FONT);

			this.add(fFigureTransitionNameLabel);

			fFigureTransitionStereotypesLabel = new WrappingLabel();
			fFigureTransitionStereotypesLabel.setText("");

			fFigureTransitionStereotypesLabel
					.setFont(FFIGURETRANSITIONSTEREOTYPESLABEL_FONT);

			this.add(fFigureTransitionStereotypesLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTransitionNameLabel() {
			return fFigureTransitionNameLabel;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureTransitionStereotypesLabel() {
			return fFigureTransitionStereotypesLabel;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGURETRANSITIONSTEREOTYPESLABEL_FONT = new Font(Display
			.getCurrent(), "SANS", 9, SWT.NORMAL);
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		features.add(UMLPackage.eINSTANCE.getTransition_Source());
		features.add(UMLPackage.eINSTANCE.getTransition_Target());
