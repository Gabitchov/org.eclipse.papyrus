...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate13ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate13EditPart extends BorderedBorderItemEditPart implements
	 ...
	 * @generated
	 */
	public Pseudostate13EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate13ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if(borderItemEditPart instanceof LabelEditPart) {
			...
			if(borderItemEditPart instanceof PseudostateName5EditPart)
				locatorPseudostateName5EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if(borderItemEditPart instanceof PseudostateName5EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorPseudostateName5EditPart(BorderItemLocator locator) {
