 ...
 * @generated
 */
public class State4CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public State4CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static State4CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new State4CreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public State4CreateCommand(CreateElementRequest req) {
		super(req);
	}
