 ...
 * @generated
 */
public class PseudostateName5EditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
				.getType(org.eclipse.papyrus.diagram.statemachine.edit.parts.PseudostateName5EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PseudostateName5EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(
					UMLElementTypes.Pseudostate_2022, getParserElement(),
					parserHint);
