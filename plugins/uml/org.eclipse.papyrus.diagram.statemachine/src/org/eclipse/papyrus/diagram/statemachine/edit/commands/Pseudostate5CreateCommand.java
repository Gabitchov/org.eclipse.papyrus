...
public class Pseudostate5CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate5CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate5CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate5CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2013(newElement);
