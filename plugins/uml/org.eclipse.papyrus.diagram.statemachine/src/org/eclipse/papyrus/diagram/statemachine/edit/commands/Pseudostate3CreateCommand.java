 ...
 * @generated
 */
public class Pseudostate3CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate3CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate3CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate3CreateCommand(req, eObject);
	}
