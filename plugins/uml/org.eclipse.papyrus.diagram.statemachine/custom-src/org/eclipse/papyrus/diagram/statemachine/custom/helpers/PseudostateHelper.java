...
/**
 * This singleton is used to find a new name for Pseudostate
 * 
 * 
 */
public class PseudostateHelper {

	public static PseudostateHelper EINSTANCE = new PseudostateHelper();
	 ...
	 */
	public String getNewUMLElementName(Element umlParent, Pseudostate pseudo) {
		return getNewUMLElementName(umlParent, pseudo.getKind().getLiteral());
	}
