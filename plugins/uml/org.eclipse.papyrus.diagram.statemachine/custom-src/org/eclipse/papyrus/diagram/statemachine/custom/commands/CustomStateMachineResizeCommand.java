...
public class CustomStateMachineResizeCommand extends AbstractTransactionalCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		View stateMachineLabel = ViewUtil.getChildBySemanticHint(stateMachine,UMLVisualIDRegistry.getType(StateMachineNameEditPart.VISUAL_ID));
		View stateMachineCompartment = (ViewUtil.getChildBySemanticHint(stateMachine,UMLVisualIDRegistry.getType(StateMachineCompartmentEditPart.VISUAL_ID)));
