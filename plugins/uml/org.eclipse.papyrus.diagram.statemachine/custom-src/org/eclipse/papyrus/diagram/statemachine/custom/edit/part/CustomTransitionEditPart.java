...
public class CustomTransitionEditPart extends TransitionEditPart {
	...
	/**
	 * Local cached for finding the state editPart to host this transition if internal
	 */
	private StateEditPart internalTransitionstateHost_cached;
	...
	protected void handleNotificationEvent(Notification event) {
		 ...
		 * then this transition has change its representation TransitionEditPart -> InternalTansitionEditPart
		 */
	 ...
	 * @return
	 */
	protected Command getTransitionDeleteCommand(IGraphicalEditPart customTransitionEditPart) {
		GroupRequest request;
		if(customTransitionEditPart instanceof TransitionEditPart) {
