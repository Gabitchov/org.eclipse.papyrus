...
public class CustomStateMachineNameEditPart extends StateMachineNameEditPart {
	...
	protected void handleNotificationEvent(Notification notification) {
		...
		// Zone.setHeight(stateMachineLabelView, stateMachineLabelBounds.height);
		...
		if ((stateMachineHeight != -1) && (stateMachineLabelBounds.width != 0) && (dy != 0)) {
			...
			CustomStateMachineResizeCommand internalResizeCommand = new CustomStateMachineResizeCommand(
					adaptableForStateMachine, getDiagramPreferencesHint(), getEditingDomain(),
					DiagramUIMessages.CreateCommand_Label, internalResizeRequest, rect, true);
