...
public class CustomListenerPseudoStateKindEditPolicy extends AbstractEditPolicy implements NotificationListener, IPapyrusListener {
	...
	public void notifyChanged(Notification notification) {
		...
		Object object1 = UMLFactory.eINSTANCE.getUMLPackage().getPseudostate_Kind();
		if (UMLFactory.eINSTANCE.getUMLPackage().getPseudostate_Kind().equals(notification.getFeature())){
			int i = 0;
		}
