...
public class DirectionCompletionProposal implements ICompletionProposalComputer {
	 ...
	 */
	final static public String[] directionStrings = {
		"in", 
		"out", 
		"inout", 
		"return",  
	 ...
	 */
	final static public String[] directionStringsInfo = {
		"in direction", 
		"out direction", 
		"inout direction", 
		"return direction", 
	 ...
	 */
	final static public String[] directionStringsName = {
		"in", 
		"out", 
		"inout", 
		"return",  
		...
		for(int i=0; i < directionStrings.length; i++) {
			if(directionStrings[i].startsWith(prefix)) {
				proposal = new CompletionProposal(
						...
						directionStrings[i].length(),
						null,
						directionStringsName[i],
						null,
