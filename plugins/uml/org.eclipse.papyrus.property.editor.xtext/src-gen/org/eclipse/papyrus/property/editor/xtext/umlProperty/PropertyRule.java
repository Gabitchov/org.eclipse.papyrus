 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getIsDerived <em>Is Derived</em>}</li>
 *   <li>{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getName <em>Name</em>}</li>
 ...
 * </p>
 *
 * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getPropertyRule()
 * @model
 * @generated
 */
public interface PropertyRule extends EObject
{
   ...
   * The literals are from the enumeration {@link org.eclipse.papyrus.property.editor.xtext.umlProperty.VisibilityKind}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getPropertyRule_Visibility()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getVisibility <em>Visibility</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getPropertyRule_IsDerived()
   * @model
   * @generated
   */
  String getIsDerived();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getIsDerived <em>Is Derived</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getPropertyRule_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getPropertyRule_Multiplicity()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getMultiplicity <em>Multiplicity</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getPropertyRule_Modifiers()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.PropertyRule#getModifiers <em>Modifiers</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
