 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.QualifiedName#getPath <em>Path</em>}</li>
 *   <li>{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.QualifiedName#getRemaining <em>Remaining</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getQualifiedName()
 * @model
 * @generated
 */
public interface QualifiedName extends EObject
{
   ...
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getQualifiedName_Path()
   * @model
   * @generated
   */
  Namespace getPath();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.QualifiedName#getPath <em>Path</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.papyrus.property.editor.xtext.umlProperty.UmlPropertyPackage#getQualifiedName_Remaining()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.papyrus.property.editor.xtext.umlProperty.QualifiedName#getRemaining <em>Remaining</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
