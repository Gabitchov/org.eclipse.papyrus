 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.impl.StereotypePropertyFacetReferenceImpl#getRepresentedElement_XMI_ID <em>
 * Represented Element XMI ID</em>}</li>
 * <li>{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.impl.StereotypePropertyFacetReferenceImpl#getPropertyQualifiedName <em>
 * Property Qualified Name</em>}</li>
...
public class StereotypePropertyFacetReferenceImpl extends FacetReferenceImpl implements StereotypePropertyFacetReference {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if(baseClass == StereotypePropertyElement.class) {
			switch(derivedFeatureID) {
			case ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE__PROPERTY_QUALIFIED_NAME:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__PROPERTY_QUALIFIED_NAME;
			case ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE__IS_DERIVED:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__IS_DERIVED;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if(baseClass == EObjectFacetRepresentation.class) {
			...
			case ProfileFacetPackage.EOBJECT_FACET_REPRESENTATION__REPRESENTED_ELEMENT_XMI_ID:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE__REPRESENTED_ELEMENT_XMI_ID;
			default:
				return -1;
			}
		}
		if(baseClass == StereotypePropertyElement.class) {
			...
			case ProfileFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__PROPERTY_QUALIFIED_NAME:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE__PROPERTY_QUALIFIED_NAME;
			case ProfileFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__IS_DERIVED:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_REFERENCE__IS_DERIVED;
			default:
				return -1;
			}
		}
