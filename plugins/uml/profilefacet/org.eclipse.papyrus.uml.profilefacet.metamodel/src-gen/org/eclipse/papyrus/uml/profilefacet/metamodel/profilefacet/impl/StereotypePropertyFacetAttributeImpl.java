 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.impl.StereotypePropertyFacetAttributeImpl#getRepresentedElement_XMI_ID <em>
 * Represented Element XMI ID</em>}</li>
 * <li>{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.impl.StereotypePropertyFacetAttributeImpl#getPropertyQualifiedName <em>
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if(baseClass == EObjectFacetRepresentation.class) {
			...
			case ProfileFacetPackage.EOBJECT_FACET_REPRESENTATION__REPRESENTED_ELEMENT_XMI_ID:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_ATTRIBUTE__REPRESENTED_ELEMENT_XMI_ID;
			default:
				return -1;
			}
		}
		if(baseClass == StereotypePropertyElement.class) {
			...
			case ProfileFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__PROPERTY_QUALIFIED_NAME:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_ATTRIBUTE__PROPERTY_QUALIFIED_NAME;
			case ProfileFacetPackage.STEREOTYPE_PROPERTY_ELEMENT__IS_DERIVED:
				return ProfileFacetPackage.STEREOTYPE_PROPERTY_FACET_ATTRIBUTE__IS_DERIVED;
			default:
				return -1;
			}
		}
