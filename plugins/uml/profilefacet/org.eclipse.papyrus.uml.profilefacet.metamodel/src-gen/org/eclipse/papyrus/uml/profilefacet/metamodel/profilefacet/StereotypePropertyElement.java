 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.StereotypePropertyElement#getPropertyQualifiedName <em>Property Qualified
 * Name</em>}</li>
 ...
 * @generated
 */
public interface StereotypePropertyElement extends FacetStructuralFeature, EObjectFacetRepresentation {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.StereotypePropertyElement#getPropertyQualifiedName
	 * <em>Property Qualified Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @param value
	 *        the new value of the '<em>Property Qualified Name</em>' attribute.
	 ...
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * indicates if the property is Derived. This property will probably used by a customization on the header of the columns (to add a '/' to the
	 * name column).
	 * We need it because if we have columns representing a stereotype property and if the concerning profile is not applied on the model, we won' be
	 * able to refind the real
	...
	/**
	 * Sets the value of the '{@link org.eclipse.papyrus.uml.profilefacet.metamodel.profilefacet.StereotypePropertyElement#isIsDerived
	 * <em>Is Derived</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @param value
