...
import org.eclipse.papyrus.tabbedproperties.uml.components.ParameterPropertiesEditionComponent;
...
public class ParameterPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Parameter) && (UMLPackage.eINSTANCE.getParameter() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof Parameter) {
			return new ParameterPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof Parameter) {
			if (ParameterBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ParameterBasePropertiesEditionComponent(eObject, mode);
