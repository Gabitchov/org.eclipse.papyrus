...
public class ConnectionPointReferencePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ConnectionPointReference) {
			return new ConnectionPointReferencePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ConnectionPointReference) {
			if (ConnectionPointReferenceBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ConnectionPointReferenceBasePropertiesEditionComponent(eObject, mode);
