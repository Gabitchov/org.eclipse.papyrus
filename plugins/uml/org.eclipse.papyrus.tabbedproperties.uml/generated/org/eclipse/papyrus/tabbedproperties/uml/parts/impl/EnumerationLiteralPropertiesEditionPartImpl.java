...
public class EnumerationLiteralPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, EnumerationLiteralPropertiesEditionPart {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	private void moveDeployment(Deployment element, int oldIndex, int newIndex) {
		...
		deployment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.deployment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToDeployment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				deployment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.deployment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromDeployment(Deployment element) {
		...
		deployment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.deployment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editDeployment(Deployment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				deployment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.deployment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveSlot(Slot element, int oldIndex, int newIndex) {
		...
		slot.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.slot, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToSlot() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				slot.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.slot, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromSlot(Slot element) {
		...
		slot.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.slot, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editSlot(Slot element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				slot.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.slot, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Classifier", UMLPackage.eINSTANCE.getClassifier()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.classifier,
	...
	private void removeFromClassifier(Classifier element) {
		...
		classifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.classifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClassifier(Classifier element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				classifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(EnumerationLiteralPropertiesEditionPartImpl.this, UMLViewsRepository.EnumerationLiteral.classifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
