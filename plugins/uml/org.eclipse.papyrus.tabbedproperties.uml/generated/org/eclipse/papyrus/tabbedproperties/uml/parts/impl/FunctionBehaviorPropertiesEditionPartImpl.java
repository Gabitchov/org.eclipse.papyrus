...
public class FunctionBehaviorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, FunctionBehaviorPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.FunctionBehaviorPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.FunctionBehavior.name, UMLViewsRepository.SWT_KIND));
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.FunctionBehaviorPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.FunctionBehavior.visibility, UMLViewsRepository.SWT_KIND));
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.clientDependency,
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.elementImport, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromElementImport(ElementImport element) {
		...
		elementImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.elementImport, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editElementImport(ElementImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.elementImport, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.packageImport, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromPackageImport(PackageImport element) {
		...
		packageImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.packageImport, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editPackageImport(PackageImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.packageImport, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedRule, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedRule(Constraint element) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedRule, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedRule(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedRule, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.templateBinding, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromTemplateBinding(TemplateBinding element) {
		...
		templateBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.templateBinding, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editTemplateBinding(TemplateBinding element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.templateBinding, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.generalization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToGeneralization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.generalization, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromGeneralization(Generalization element) {
		...
		generalization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.generalization, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editGeneralization(Generalization element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.generalization, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"GeneralizationSet", UMLPackage.eINSTANCE.getGeneralizationSet()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.powertypeExtent,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	...
	private void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.powertypeExtent, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromPowertypeExtent(GeneralizationSet element) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.powertypeExtent, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editPowertypeExtent(GeneralizationSet element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				powertypeExtent.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.powertypeExtent, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Classifier", UMLPackage.eINSTANCE.getClassifier()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.redefinedClassifier,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	...
	private void removeFromRedefinedClassifier(Classifier element) {
		...
		redefinedClassifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.redefinedClassifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editRedefinedClassifier(Classifier element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedClassifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.redefinedClassifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.substitution, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToSubstitution() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.substitution, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromSubstitution(Substitution element) {
		...
		substitution.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.substitution, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editSubstitution(Substitution element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.substitution, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.collaborationUse, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToCollaborationUse() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.collaborationUse, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromCollaborationUse(CollaborationUse element) {
		...
		collaborationUse.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.collaborationUse, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editCollaborationUse(CollaborationUse element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.collaborationUse, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedUseCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedUseCase() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedUseCase, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedUseCase(UseCase element) {
		...
		ownedUseCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedUseCase, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedUseCase(UseCase element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedUseCase, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"UseCase", UMLPackage.eINSTANCE.getUseCase()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.useCase,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						useCase.refresh();											
					}
	...
	private void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.useCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromUseCase(UseCase element) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.useCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editUseCase(UseCase element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				useCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.useCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedAttribute(Property element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedAttribute, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedAttribute() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedAttribute.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedAttribute, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedAttribute(Property element) {
		...
		ownedAttribute.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedAttribute, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedAttribute(Property element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedAttribute.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedAttribute, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedConnector(Connector element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedConnector, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedConnector() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedConnector.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedConnector, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedConnector(Connector element) {
		...
		ownedConnector.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedConnector, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedConnector(Connector element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedConnector.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedConnector, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedBehavior(Behavior element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedBehavior, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedBehavior(Behavior element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedBehavior.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedBehavior, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveInterfaceRealization(InterfaceRealization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.interfaceRealization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToInterfaceRealization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interfaceRealization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.interfaceRealization, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromInterfaceRealization(InterfaceRealization element) {
		...
		interfaceRealization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.interfaceRealization, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editInterfaceRealization(InterfaceRealization element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interfaceRealization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.interfaceRealization, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedTrigger(Trigger element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedTrigger() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedTrigger, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedTrigger(Trigger element) {
		...
		ownedTrigger.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedTrigger, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedTrigger(Trigger element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedTrigger, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromNestedClassifier(Classifier element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.nestedClassifier, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editNestedClassifier(Classifier element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				nestedClassifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.nestedClassifier, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedOperation(Operation element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedOperation() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedOperation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedOperation, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedOperation(Operation element) {
		...
		ownedOperation.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedOperation, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedOperation(Operation element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedOperation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedOperation, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedReception(Reception element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedReception, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedReception() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedReception.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedReception, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedReception(Reception element) {
		...
		ownedReception.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedReception, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedReception(Reception element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedReception.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedReception, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Behavior", UMLPackage.eINSTANCE.getBehavior()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.redefinedBehavior,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	...
	private void removeFromRedefinedBehavior(Behavior element) {
		...
		redefinedBehavior.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.redefinedBehavior, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editRedefinedBehavior(Behavior element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedBehavior.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.redefinedBehavior, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedParameter(Parameter element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedParameter() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameter, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedParameter(Parameter element) {
		...
		ownedParameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameter, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedParameter(Parameter element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameter, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Constraint", UMLPackage.eINSTANCE.getConstraint()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.precondition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	...
	private void movePrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		precondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromPrecondition(Constraint element) {
		...
		precondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				precondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Constraint", UMLPackage.eINSTANCE.getConstraint()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.postcondition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	...
	private void movePostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		postcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromPostcondition(Constraint element) {
		...
		postcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				postcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedParameterSet(ParameterSet element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedParameterSet() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameterSet.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameterSet, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedParameterSet(ParameterSet element) {
		...
		ownedParameterSet.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameterSet, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedParameterSet(ParameterSet element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameterSet.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FunctionBehaviorPropertiesEditionPartImpl.this, UMLViewsRepository.FunctionBehavior.ownedParameterSet, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
