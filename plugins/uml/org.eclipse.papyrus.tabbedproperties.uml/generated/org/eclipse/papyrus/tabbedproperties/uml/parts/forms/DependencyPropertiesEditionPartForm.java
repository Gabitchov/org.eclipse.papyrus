 ...
 */
public class DependencyPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, DependencyPropertiesEditionPart {
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils
				.createPartLabel(widgetFactory, parent, UMLMessages.DependencyPropertiesEditionPart_NameLabel,
						propertiesEditionComponent.isRequired(UMLViewsRepository.Dependency.name,
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DependencyPropertiesEditionPartForm.this, UMLViewsRepository.Dependency.name,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Dependency.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$

	}

	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.DependencyPropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.Dependency.visibility,
						UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DependencyPropertiesEditionPartForm.this, UMLViewsRepository.Dependency.visibility,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Dependency.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.client = new ReferencesTable<NamedElement>(UMLMessages.DependencyPropertiesEditionPart_ClientLabel,
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											...
											UMLViewsRepository.Dependency.client, PropertiesEditionEvent.COMMIT,
		...
		this.client.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.Dependency.client,
				UMLViewsRepository.FORM_KIND));
	...
	protected void createSupplierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.supplier = new ReferencesTable<NamedElement>(UMLMessages.DependencyPropertiesEditionPart_SupplierLabel,
				new ReferencesTableListener<NamedElement>() {
						...
						TabElementTreeSelectionDialog<NamedElement> dialog = new TabElementTreeSelectionDialog<NamedElement>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											DependencyPropertiesEditionPartForm.this,
											UMLViewsRepository.Dependency.supplier, PropertiesEditionEvent.COMMIT,
											PropertiesEditionEvent.ADD, null, elem));
								}
								supplier.refresh();
							}
		...
		this.supplier.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.Dependency.supplier,
				UMLViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#setName(String
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#initVisibility(EEnum
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#initClient(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#updateClient(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#addFilterClient(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#addBusinessFilterClient(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#initSupplier(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#updateSupplier(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#addFilterSupplier(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.DependencyPropertiesEditionPart#addBusinessFilterSupplier(ViewerFilter
	 *      filter)
	 */
