...
import org.eclipse.papyrus.tabbedproperties.uml.components.TimeObservationBasePropertiesEditionComponent;
import org.eclipse.papyrus.tabbedproperties.uml.components.TimeObservationPropertiesEditionComponent;
 ...
 */
public class TimeObservationPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof TimeObservation) && (UMLPackage.eINSTANCE.getTimeObservation() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof TimeObservation) {
			return new TimeObservationPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof TimeObservation) {
			if (TimeObservationBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new TimeObservationBasePropertiesEditionComponent(eObject, editing_mode);
