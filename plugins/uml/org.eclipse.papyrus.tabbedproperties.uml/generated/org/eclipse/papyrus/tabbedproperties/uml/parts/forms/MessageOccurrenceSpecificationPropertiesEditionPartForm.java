 ...
 */
public class MessageOccurrenceSpecificationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, MessageOccurrenceSpecificationPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_NameLabel, propertiesEditionComponent
						.isRequired(UMLViewsRepository.MessageOccurrenceSpecification.name,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MessageOccurrenceSpecificationPropertiesEditionPartForm.this,
							UMLViewsRepository.MessageOccurrenceSpecification.name, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MessageOccurrenceSpecificationPropertiesEditionPartForm.this,
							UMLViewsRepository.MessageOccurrenceSpecification.visibility,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createCoveredReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.covered.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.covered, UMLViewsRepository.FORM_KIND));
	...
	protected void createGeneralOrderingTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.generalOrdering.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.generalOrdering, UMLViewsRepository.FORM_KIND));
	...
	protected void createToBeforeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.toBefore.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.toBefore, UMLViewsRepository.FORM_KIND));
	...
	protected void createToAfterReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.toAfter.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.toAfter, UMLViewsRepository.FORM_KIND));
