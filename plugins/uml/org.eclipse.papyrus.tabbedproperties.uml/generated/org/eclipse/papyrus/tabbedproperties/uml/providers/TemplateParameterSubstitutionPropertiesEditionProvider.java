...
import org.eclipse.papyrus.tabbedproperties.uml.components.TemplateParameterSubstitutionPropertiesEditionComponent;
 ...
 */
public class TemplateParameterSubstitutionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof TemplateParameterSubstitution) {
			return new TemplateParameterSubstitutionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof TemplateParameterSubstitution) {
			if (TemplateParameterSubstitutionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new TemplateParameterSubstitutionBasePropertiesEditionComponent(eObject, mode);
