...
import org.eclipse.papyrus.tabbedproperties.uml.components.GeneralOrderingPropertiesEditionComponent;
 ...
 */
public class GeneralOrderingPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof GeneralOrdering) && (UMLPackage.eINSTANCE.getGeneralOrdering() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof GeneralOrdering) {
			return new GeneralOrderingPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof GeneralOrdering) {
			if (GeneralOrderingBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new GeneralOrderingBasePropertiesEditionComponent(eObject, mode);
