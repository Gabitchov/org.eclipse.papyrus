...
public class ReadLinkActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ReadLinkActionPropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.ownedComment,
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.ReadLinkActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.ReadLinkAction.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.name,
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.ReadLinkActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(
				UMLViewsRepository.ReadLinkAction.visibility, UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.visibility,
				...
				TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(resourceSet, filters, "Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this,
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.isLeaf,
	...
	protected void moveHandler(ExceptionHandler element, int oldIndex, int newIndex) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.handler,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void moveLocalPrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.localPrecondition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void moveLocalPostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.localPostcondition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void moveEndData(LinkEndData element, int oldIndex, int newIndex) {
		...
		endData.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.endData,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void moveInputValue(InputPin element, int oldIndex, int newIndex) {
		...
		inputValue.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadLinkActionPropertiesEditionPartForm.this, UMLViewsRepository.ReadLinkAction.inputValue,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
