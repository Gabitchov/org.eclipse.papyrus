...
public class GeneralizationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The GeneralizationBasePropertiesEditionComponent sub component
	 */
	protected GeneralizationBasePropertiesEditionComponent generalizationBasePropertiesEditionComponent;
	...
	public GeneralizationPropertiesEditionComponent(EObject generalization, String editing_mode) {
		...
		if(generalization instanceof Generalization) {
			generalizationBasePropertiesEditionComponent = new GeneralizationBasePropertiesEditionComponent(generalization, editing_mode);
			addSubComponent(generalizationBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(generalization, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (GeneralizationPropertiesEditionPart)generalizationBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.Generalization.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (GeneralizationPropertiesEditionPart)propertiesEditionPart;
		}
	}
