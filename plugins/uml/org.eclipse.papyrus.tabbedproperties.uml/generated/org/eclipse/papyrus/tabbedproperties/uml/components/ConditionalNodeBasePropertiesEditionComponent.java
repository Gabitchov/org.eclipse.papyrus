...
public class ConditionalNodeBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ConditionalNodeBasePropertiesEditionComponent(EObject conditionalNode, String mode) {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				...
				if (msg.getFeature() != null && 
						...
						|| ((EStructuralFeature)msg.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getClause())) {
