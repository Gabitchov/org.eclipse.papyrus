 ...
 */
public class TemplateParameterSubstitutionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, TemplateParameterSubstitutionPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.TemplateParameterSubstitution.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createActualReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.actual.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.TemplateParameterSubstitution.actual, UMLViewsRepository.FORM_KIND));
	...
	protected void createOwnedActualTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedActual.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.TemplateParameterSubstitution.ownedActual, UMLViewsRepository.FORM_KIND));
