...
import org.eclipse.papyrus.tabbedproperties.uml.components.ForkNodePropertiesEditionComponent;
 ...
 */
public class ForkNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof ForkNode) && (UMLPackage.eINSTANCE.getForkNode() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ForkNode) {
			return new ForkNodePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ForkNode) {
			if (ForkNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ForkNodeBasePropertiesEditionComponent(eObject, mode);
