		...
		alias.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ElementImportPropertiesEditionPartImpl.this, UMLViewsRepository.ElementImport.alias, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, alias.getText()));
			}
