 ...
 * @generated
 */ 
public class ParameterForm extends AbstractControlsGroup {
	...
	public ParameterForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected ComboList directionForm;
    ...
    public void createDirectChildren() {
		//
		// Start of user code to define combo description for directionForm form
				//TODO: define combo description here
				Object comboDescDirectionForm[] = {
				...
				//End of user code to define combo description for directionForm form

				directionForm = new ComboList(comboDescDirectionForm);
			 	this.add(directionForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the directionForm
     */
    public ComboList getDirectionForm() {
