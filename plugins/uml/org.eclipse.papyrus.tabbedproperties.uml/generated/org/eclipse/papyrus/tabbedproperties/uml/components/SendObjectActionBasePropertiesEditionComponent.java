...
public class SendObjectActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (sendObjectAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (SendObjectActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.SendObjectAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.SendObjectAction.class) {
			...
			SendObjectAction sendObjectAction = (SendObjectAction) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					sendObjectAction.getVisibility());
			basePart.initClientDependency(sendObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInInterruptibleRegion(sendObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart
					.initLocalPostcondition(sendObjectAction, null, UMLPackage.eINSTANCE.getAction_LocalPostcondition());
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (sendObjectAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, sendObjectAction,
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = localPreconditionToMoveFromLocalPrecondition.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = argumentToMoveFromArgument.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, sendObjectAction, UMLPackage.eINSTANCE.getInputPin(),
						moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.SendObjectAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, sendObjectAction, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, sendObjectAction, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.SendObjectAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, sendObjectAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.SendObjectAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, sendObjectAction, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.SendObjectAction.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.handler)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.localPrecondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.localPostcondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.SendObjectAction.argument)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(sendObjectAction);
		else
			return null;
	}
