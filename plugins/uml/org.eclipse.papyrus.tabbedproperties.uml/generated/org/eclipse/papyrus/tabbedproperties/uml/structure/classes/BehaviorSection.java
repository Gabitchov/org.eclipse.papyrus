...
import org.eclipse.papyrus.tabbedproperties.uml.figures.BehaviorFormForm;
...
/**
 * The Behavior property section for the Behavior element
 * 
 ...
 * @generated
 */
public class BehaviorSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private BehaviorFormForm behaviorForm;

	/**
	 * The Behavior to edit 
	 * @generated
	 */
	private Behavior behaviorElement;
	...
	public PropertyEditor createFigure() {
		behaviorForm = new BehaviorFormForm("Behavior Specifications","Behavior is a specification of how its context classifier changes state over time. This specification may be either a definition of possible behavior execution or emergent behavior, or a selective illustration of an interesting subset of possible executions. The latter form is typically used for capturing examples, such as a trace of a particular execution."+
""+
"A behavior owns zero or more parameter sets.");
		return behaviorForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isReentrant of Behavior
		BooleanPropertyChangeListener isReentrantListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,behaviorElement, UMLPackage.eINSTANCE.getBehavior_IsReentrant(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		behaviorForm.getIsReentrant().setPropertyChangeListener(isReentrantListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						behaviorForm.getIsReentrant().setValue(behaviorElement.isReentrant());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.behaviorElement = (Behavior)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Behavior;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		behaviorElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		behaviorElement.eAdapters().remove(modelListener);
