...
public class PartDecompositionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, PartDecompositionPropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.name, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.visibility, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.clientDependency,
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Lifeline", UMLPackage.eINSTANCE.getLifeline()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.covered,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						covered.refresh();
					}
	...
	protected void moveCovered(Lifeline element, int oldIndex, int newIndex) {
		...
		covered.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.covered, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void removeFromCovered(Lifeline element) {
		...
		covered.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.covered, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editCovered(Lifeline element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				covered.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.covered, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveGeneralOrdering(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.generalOrdering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToGeneralOrdering() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalOrdering.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.generalOrdering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromGeneralOrdering(GeneralOrdering element) {
		...
		generalOrdering.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.generalOrdering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editGeneralOrdering(GeneralOrdering element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalOrdering.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.generalOrdering, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveActualGate(Gate element, int oldIndex, int newIndex) {
		...
		actualGate.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.actualGate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToActualGate() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				actualGate.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.actualGate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromActualGate(Gate element) {
		...
		actualGate.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.actualGate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editActualGate(Gate element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				actualGate.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.actualGate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void removeFromArgument(Action element) {
		...
		argument.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.argument, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editArgument(Action element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				argument.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PartDecompositionPropertiesEditionPartForm.this, UMLViewsRepository.PartDecomposition.argument, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addFilterOwnedComment(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addBusinessFilterOwnedComment(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#getClientDependencyTable()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addFilterClientDependency(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addBusinessFilterClientDependency(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#getCoveredTable()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addFilterCovered(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addBusinessFilterCovered(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addFilterGeneralOrdering(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addBusinessFilterGeneralOrdering(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addFilterActualGate(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addBusinessFilterActualGate(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addFilterArgument(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.PartDecompositionPropertiesEditionPart#addBusinessFilterArgument(ViewerFilter filter)
	 */
