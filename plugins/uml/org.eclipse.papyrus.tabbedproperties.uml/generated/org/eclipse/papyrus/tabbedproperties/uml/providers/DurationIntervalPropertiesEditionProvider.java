...
import org.eclipse.papyrus.tabbedproperties.uml.components.DurationIntervalPropertiesEditionComponent;
 ...
 */
public class DurationIntervalPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof DurationInterval) && (UMLPackage.eINSTANCE.getDurationInterval() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof DurationInterval) {
			return new DurationIntervalPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof DurationInterval) {
			if (DurationIntervalBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new DurationIntervalBasePropertiesEditionComponent(eObject, editing_mode);
