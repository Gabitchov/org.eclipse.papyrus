 ...
 */
public class AcceptEventActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, AcceptEventActionPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.AcceptEventActionPropertiesEditionPart_NameLabel,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AcceptEventActionPropertiesEditionPartForm.this, UMLViewsRepository.AcceptEventAction.name,
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								AcceptEventActionPropertiesEditionPartForm.this,
								UMLViewsRepository.AcceptEventAction.name, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.AcceptEventActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent
						.isRequired(UMLViewsRepository.AcceptEventAction.visibility, UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AcceptEventActionPropertiesEditionPartForm.this,
							UMLViewsRepository.AcceptEventAction.visibility, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, UMLMessages.AcceptEventActionPropertiesEditionPart_IsLeafLabel,
				SWT.CHECK);
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AcceptEventActionPropertiesEditionPartForm.this,
							UMLViewsRepository.AcceptEventAction.isLeaf, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.outgoing, UMLViewsRepository.FORM_KIND));
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.incoming, UMLViewsRepository.FORM_KIND));
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.inPartition, UMLViewsRepository.FORM_KIND));
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.inInterruptibleRegion, UMLViewsRepository.FORM_KIND));
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void createHandlerTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.handler, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPreconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.localPrecondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPostconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.localPostcondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsUnmarshallCheckbox(FormToolkit widgetFactory, Composite parent) {
		isUnmarshall = widgetFactory.createButton(parent,
				UMLMessages.AcceptEventActionPropertiesEditionPart_IsUnmarshallLabel, SWT.CHECK);
		isUnmarshall.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AcceptEventActionPropertiesEditionPartForm.this,
							UMLViewsRepository.AcceptEventAction.isUnmarshall, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.isUnmarshall, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createTriggerTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.trigger.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.AcceptEventAction.trigger, UMLViewsRepository.FORM_KIND));
