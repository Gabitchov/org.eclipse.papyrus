...
public class InteractionOperandPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof InteractionOperand) && (UMLPackage.eINSTANCE.getInteractionOperand() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof InteractionOperand) {
			return new InteractionOperandPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof InteractionOperand) {
			if (InteractionOperandBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new InteractionOperandBasePropertiesEditionComponent(eObject, mode);
