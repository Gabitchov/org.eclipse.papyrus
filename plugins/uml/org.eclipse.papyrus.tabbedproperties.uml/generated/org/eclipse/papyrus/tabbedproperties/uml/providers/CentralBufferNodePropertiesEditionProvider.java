...
import org.eclipse.papyrus.tabbedproperties.uml.components.CentralBufferNodePropertiesEditionComponent;
 ...
 */
public class CentralBufferNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof CentralBufferNode) && (UMLPackage.eINSTANCE.getCentralBufferNode() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof CentralBufferNode) {
			return new CentralBufferNodePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof CentralBufferNode) {
			if (CentralBufferNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new CentralBufferNodeBasePropertiesEditionComponent(eObject, editing_mode);
