...
public class MessageOccurrenceSpecificationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public MessageOccurrenceSpecificationBasePropertiesEditionComponent(EObject messageOccurrenceSpecification,
			String editing_mode) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (messageOccurrenceSpecification != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (MessageOccurrenceSpecificationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.MessageOccurrenceSpecification.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.MessageOccurrenceSpecification.class) {
			...
			MessageOccurrenceSpecification messageOccurrenceSpecification = (MessageOccurrenceSpecification) elt;
			// init values
			basePart.initOwnedComment(messageOccurrenceSpecification, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					messageOccurrenceSpecification.getVisibility());
			basePart.initClientDependency(messageOccurrenceSpecification, null, UMLPackage.eINSTANCE
					.getNamedElement_ClientDependency());
			basePart.initCovered(messageOccurrenceSpecification, null, UMLPackage.eINSTANCE
					.getInteractionFragment_Covered());
			basePart.initGeneralOrdering(messageOccurrenceSpecification, null, UMLPackage.eINSTANCE
					.getInteractionFragment_GeneralOrdering());
			basePart.initToBefore(messageOccurrenceSpecification, null, UMLPackage.eINSTANCE
					.getOccurrenceSpecification_ToBefore());
			basePart.initToAfter(messageOccurrenceSpecification, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (messageOccurrenceSpecification != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, messageOccurrenceSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, messageOccurrenceSpecification, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, messageOccurrenceSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, messageOccurrenceSpecification, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, messageOccurrenceSpecification,
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.MessageOccurrenceSpecification.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, messageOccurrenceSpecification,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, messageOccurrenceSpecification,
			...
			if (UMLViewsRepository.MessageOccurrenceSpecification.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, messageOccurrenceSpecification,
			...
			if (UMLViewsRepository.MessageOccurrenceSpecification.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, messageOccurrenceSpecification,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.covered)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.generalOrdering)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.toBefore)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.MessageOccurrenceSpecification.toAfter)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(messageOccurrenceSpecification);
		else
			return null;
	}
