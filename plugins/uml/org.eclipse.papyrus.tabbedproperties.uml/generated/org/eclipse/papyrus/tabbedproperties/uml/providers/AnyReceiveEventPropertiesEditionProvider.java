...
import org.eclipse.papyrus.tabbedproperties.uml.components.AnyReceiveEventPropertiesEditionComponent;
 ...
 */
public class AnyReceiveEventPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof AnyReceiveEvent) && (UMLPackage.eINSTANCE.getAnyReceiveEvent() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof AnyReceiveEvent) {
			return new AnyReceiveEventPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof AnyReceiveEvent) {
			if (AnyReceiveEventBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new AnyReceiveEventBasePropertiesEditionComponent(eObject, mode);
