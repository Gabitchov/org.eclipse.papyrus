...
/**
 * The StructuralFeatureForm form
 *
 *
 * @generated
 */ 
public class StructuralFeatureFormForm extends AbstractControlsGroup {
	...
	public StructuralFeatureFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isReadOnly;
    ...
    public void createDirectChildren() {
		//
		isReadOnly = new LabeledCheckBoxFigure("isReadOnly", "");
		this.add(isReadOnly);
     ...
     */
    public LabeledCheckBoxFigure  getIsReadOnly() {
        return isReadOnly;
    }
