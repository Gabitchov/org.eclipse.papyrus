...
public class FunctionBehaviorBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.FunctionBehavior.class) {
			...
			// body, FunctionBehavior, FunctionBehavior.
			// FIXME NO VALID CASE INTO template public updater(editionElement : PropertiesEditionElement, view : View, pec : PropertiesEditionComponent) in viewCommon.mtl module, with the values :
			// language, FunctionBehavior, FunctionBehavior.
		}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.FunctionBehavior.isLeaf || key == UMLViewsRepository.FunctionBehavior.isAbstract || key == UMLViewsRepository.FunctionBehavior.isActive
