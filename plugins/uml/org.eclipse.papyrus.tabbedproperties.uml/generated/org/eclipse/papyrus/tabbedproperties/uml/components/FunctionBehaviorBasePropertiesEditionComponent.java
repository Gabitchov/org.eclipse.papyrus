...
public class FunctionBehaviorBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (functionBehavior != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (FunctionBehaviorPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.FunctionBehavior.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.FunctionBehavior.class) {
			...
			FunctionBehavior functionBehavior = (FunctionBehavior) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					functionBehavior.getVisibility());
			basePart.initClientDependency(functionBehavior, null, UMLPackage.eINSTANCE
			...
			basePart.initTemplateBinding(functionBehavior, null, UMLPackage.eINSTANCE
			...
			basePart.initRedefinedClassifier(functionBehavior, null, UMLPackage.eINSTANCE
			...
			basePart
					.initCollaborationUse(functionBehavior, null, UMLPackage.eINSTANCE.getClassifier_CollaborationUse());
			...
			basePart.initOwnedAttribute(functionBehavior, null, UMLPackage.eINSTANCE
					.getStructuredClassifier_OwnedAttribute());
			basePart.initOwnedConnector(functionBehavior, null, UMLPackage.eINSTANCE
					.getStructuredClassifier_OwnedConnector());
			basePart.initOwnedBehavior(functionBehavior, null, UMLPackage.eINSTANCE
					.getBehavioredClassifier_OwnedBehavior());
			basePart.initInterfaceRealization(functionBehavior, null, UMLPackage.eINSTANCE
					.getBehavioredClassifier_InterfaceRealization());
			basePart.initOwnedTrigger(functionBehavior, null, UMLPackage.eINSTANCE
			...
			basePart
					.initRedefinedBehavior(functionBehavior, null, UMLPackage.eINSTANCE.getBehavior_RedefinedBehavior());
			...
			basePart
					.initOwnedParameterSet(functionBehavior, null, UMLPackage.eINSTANCE.getBehavior_OwnedParameterSet());
			...
			// viewCommon.mtl module, with the values : body, FunctionBehavior, FunctionBehavior.
			// FIXME NO VALID CASE INTO template public updater(editionElement :
			// PropertiesEditionElement, view : View, pec : PropertiesEditionComponent) in
			// viewCommon.mtl module, with the values : language, FunctionBehavior,
			// FunctionBehavior.
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (functionBehavior != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, functionBehavior,
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getElementImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToMoveFromOwnedRule.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE
			...
			for (Iterator iter = generalizationToMoveFromGeneralization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getGeneralization(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = substitutionToMoveFromSubstitution.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getSubstitution(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = collaborationUseToMoveFromCollaborationUse.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedUseCaseToMoveFromOwnedUseCase.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getUseCase(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedAttributeToMoveFromOwnedAttribute.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getProperty(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedConnectorToMoveFromOwnedConnector.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getConnector(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedBehaviorToMoveFromOwnedBehavior.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getBehavior(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedTriggerToMoveFromOwnedTrigger.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getTrigger(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = nestedClassifierToMoveFromNestedClassifier.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getClassifier(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedOperationToMoveFromOwnedOperation.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getOperation(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getClass_IsActive(),
			...
			for (Iterator iter = ownedReceptionToMoveFromOwnedReception.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getReception(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, functionBehavior,
					UMLPackage.eINSTANCE.getBehavior_IsReentrant(), basePart.getIsReentrant()));
			...
			for (Iterator iter = ownedParameterToMoveFromOwnedParameter.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getParameter(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedParameterSetToMoveFromOwnedParameterSet.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getParameterSet(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE.getOpaqueBehavior_Body(),
					basePart.getBody()));

			cc.append(SetCommand.create(editingDomain, functionBehavior, UMLPackage.eINSTANCE
					.getOpaqueBehavior_Language(), basePart.getLanguage()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.FunctionBehavior.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, functionBehavior, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, functionBehavior, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.FunctionBehavior.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, functionBehavior, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.FunctionBehavior.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, functionBehavior, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.FunctionBehavior.body == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, functionBehavior, UMLPackage.eINSTANCE
						.getOpaqueBehavior_Body(), event.getNewValue()));

			if (UMLViewsRepository.FunctionBehavior.language == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, functionBehavior, UMLPackage.eINSTANCE
						.getOpaqueBehavior_Language(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.FunctionBehavior.isLeaf
				|| key == UMLViewsRepository.FunctionBehavior.isAbstract
				|| key == UMLViewsRepository.FunctionBehavior.isActive
				|| key == UMLViewsRepository.FunctionBehavior.isReentrant;
	}
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.FunctionBehavior.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.elementImport)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.packageImport)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedRule)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.templateBinding)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.isAbstract)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.generalization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.powertypeExtent)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.redefinedClassifier)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.substitution)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.collaborationUse)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedUseCase)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.useCase)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedAttribute)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedConnector)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedBehavior)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.interfaceRealization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedTrigger)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.nestedClassifier)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedOperation)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.isActive)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedReception)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.isReentrant)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.redefinedBehavior)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedParameter)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.precondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.postcondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.ownedParameterSet)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.body)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.FunctionBehavior.language)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.FunctionBehavior.body == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getOpaqueBehavior_Body()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(
						UMLPackage.eINSTANCE.getOpaqueBehavior_Body().getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.FunctionBehavior.language == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getOpaqueBehavior_Language()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getOpaqueBehavior_Language()
						.getEAttributeType(), newValue);
			}
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(functionBehavior);
		else
			return null;
	}
