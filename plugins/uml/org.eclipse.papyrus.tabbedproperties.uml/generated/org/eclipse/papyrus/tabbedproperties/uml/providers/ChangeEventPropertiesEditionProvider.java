...
import org.eclipse.papyrus.tabbedproperties.uml.components.ChangeEventPropertiesEditionComponent;
 ...
 */
public class ChangeEventPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof ChangeEvent) && (UMLPackage.eINSTANCE.getChangeEvent() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof ChangeEvent) {
			return new ChangeEventPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof ChangeEvent) {
			if (ChangeEventBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ChangeEventBasePropertiesEditionComponent(eObject, editing_mode);
