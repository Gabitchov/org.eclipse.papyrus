...
/**
 * The ExtensionForm form
 *
 *
 * @generated
 */ 
public class ExtensionFormForm extends AbstractControlsGroup {
	...
	public ExtensionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isRequired;
    ...
    public void createDirectChildren() {
		//
		isRequired = new LabeledCheckBoxFigure("isRequired", "");
		this.add(isRequired);
     ...
     */
    public LabeledCheckBoxFigure  getIsRequired() {
        return isRequired;
    }
