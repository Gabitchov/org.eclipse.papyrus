...
public class MessagePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MessagePropertiesEditionPart {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createMessageSortEEnumViewer(propertiesGroup);
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.clientDependency,
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}

		// End of user code
	}
	protected void createMessageSortEEnumViewer(Composite parent) {
	 ...
	 * 
	 */
	private void moveArgument(ValueSpecification element, int oldIndex, int newIndex) {
	}	
	 ...
	 * 
	 */
	private void removeFromArgument(ValueSpecification element) {
		...
		argument.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.argument, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	 ...
	 * 
	 */
	private void editArgument(ValueSpecification element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				argument.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessagePropertiesEditionPartImpl.this, UMLViewsRepository.Message.argument, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
