...
public class InterruptibleActivityRegionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof InterruptibleActivityRegion) {
			return new InterruptibleActivityRegionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof InterruptibleActivityRegion) {
			if (InterruptibleActivityRegionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new InterruptibleActivityRegionBasePropertiesEditionComponent(eObject, mode);
