...
public class ReceptionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The ReceptionBasePropertiesEditionComponent sub component
	 */
	protected ReceptionBasePropertiesEditionComponent receptionBasePropertiesEditionComponent;
	 ...
	 *        the EObject to edit
	 */
	public ReceptionPropertiesEditionComponent(EObject reception, String editing_mode) {
		super(editing_mode);
		if(reception instanceof Reception) {
			receptionBasePropertiesEditionComponent = new ReceptionBasePropertiesEditionComponent(reception, editing_mode);
			addSubComponent(receptionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(reception, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (ReceptionPropertiesEditionPart)receptionBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.Reception.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (ReceptionPropertiesEditionPart)propertiesEditionPart;
		}
	}
