...
/**
 * The AddStructuralFeatureValueActionForm form
 *
 *
 * @generated
 */ 
public class AddStructuralFeatureValueActionFormForm extends AbstractControlsGroup {
	...
	public AddStructuralFeatureValueActionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isReplaceAll;
    ...
    public void createDirectChildren() {
		//
		isReplaceAll = new LabeledCheckBoxFigure("isReplaceAll", "");
		this.add(isReplaceAll);
     ...
     */
    public LabeledCheckBoxFigure  getIsReplaceAll() {
        return isReplaceAll;
    }
