...
import org.eclipse.papyrus.tabbedproperties.uml.components.InteractionPropertiesEditionComponent;
 ...
 */
public class InteractionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Interaction) && (UMLPackage.eINSTANCE.getInteraction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Interaction) {
			return new InteractionPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof Interaction) {
			if (InteractionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new InteractionBasePropertiesEditionComponent(eObject, editing_mode);
