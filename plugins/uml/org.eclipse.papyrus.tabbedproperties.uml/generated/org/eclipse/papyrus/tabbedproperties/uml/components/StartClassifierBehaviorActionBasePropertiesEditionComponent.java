...
public class StartClassifierBehaviorActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public StartClassifierBehaviorActionBasePropertiesEditionComponent(EObject startClassifierBehaviorAction,
			String editing_mode) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (startClassifierBehaviorAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (StartClassifierBehaviorActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.StartClassifierBehaviorAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.StartClassifierBehaviorAction.class) {
			...
			StartClassifierBehaviorAction startClassifierBehaviorAction = (StartClassifierBehaviorAction) elt;
			// init values
			basePart.initOwnedComment(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					startClassifierBehaviorAction.getVisibility());
			basePart.initClientDependency(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInPartition(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InPartition());
			basePart.initInInterruptibleRegion(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(startClassifierBehaviorAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (startClassifierBehaviorAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, startClassifierBehaviorAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, startClassifierBehaviorAction, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, startClassifierBehaviorAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, startClassifierBehaviorAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, startClassifierBehaviorAction,
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof StartClassifierBehaviorAction) {
			...
			startClassifierBehaviorActionToUpdate.getInInterruptibleRegions().addAll(
			...
			startClassifierBehaviorActionToUpdate.getLocalPostconditions()
					.addAll(basePart.getLocalPostconditionToAdd());
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.StartClassifierBehaviorAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, startClassifierBehaviorAction,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, startClassifierBehaviorAction,
			...
			if (UMLViewsRepository.StartClassifierBehaviorAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, startClassifierBehaviorAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.StartClassifierBehaviorAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, startClassifierBehaviorAction,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.handler)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.localPrecondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.StartClassifierBehaviorAction.localPostcondition)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(startClassifierBehaviorAction);
		else
			return null;
	}
