...
public class AssociationClassBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				...
				if (msg.getFeature() != null
						&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getAssociation_OwnedEnd() || ((EStructuralFeature) msg.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE
								.getProperty())) {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.AssociationClass.isLeaf || key == UMLViewsRepository.AssociationClass.isAbstract || key == UMLViewsRepository.AssociationClass.isActive
				|| key == UMLViewsRepository.AssociationClass.memberEnd || key == UMLViewsRepository.AssociationClass.isDerived;
	}
