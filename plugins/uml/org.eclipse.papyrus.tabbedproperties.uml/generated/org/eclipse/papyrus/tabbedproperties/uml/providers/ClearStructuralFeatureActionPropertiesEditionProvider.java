...
public class ClearStructuralFeatureActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof ClearStructuralFeatureAction)
				&& (UMLPackage.eINSTANCE.getClearStructuralFeatureAction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof ClearStructuralFeatureAction) {
			return new ClearStructuralFeatureActionPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof ClearStructuralFeatureAction) {
			if (ClearStructuralFeatureActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ClearStructuralFeatureActionBasePropertiesEditionComponent(eObject, editing_mode);
