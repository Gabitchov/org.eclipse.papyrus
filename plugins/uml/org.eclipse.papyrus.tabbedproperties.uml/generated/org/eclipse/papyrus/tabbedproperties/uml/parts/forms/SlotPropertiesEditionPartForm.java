...
public class SlotPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, SlotPropertiesEditionPart {
	...
	protected void removeFromValue(ValueSpecification element) {
		...
		value.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(SlotPropertiesEditionPartForm.this, UMLViewsRepository.Slot.value, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editValue(ValueSpecification element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				value.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(SlotPropertiesEditionPartForm.this, UMLViewsRepository.Slot.value, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
