...
public class ActorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ActorPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedComment, PropertiesEditionEvent.COMMIT,
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedComment, PropertiesEditionEvent.CHANGE,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.name, PropertiesEditionEvent.CHANGE,
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ActorPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent
				.isRequired(UMLViewsRepository.Actor.visibility, UMLViewsRepository.SWT_KIND));
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.clientDependency, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.elementImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.elementImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.packageImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.packageImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedRule, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedRule, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.templateBinding, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.templateBinding,
	...
	private void removeFromTemplateBinding(TemplateBinding element) {
		...
		templateBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.templateBinding, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.generalization, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToGeneralization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.generalization,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromGeneralization(Generalization element) {
		...
		generalization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.generalization, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.powertypeExtent, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void removeFromRedefinedClassifier(Classifier element) {
		...
		redefinedClassifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.redefinedClassifier, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.substitution, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToSubstitution() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.substitution, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.collaborationUse, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToCollaborationUse() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.collaborationUse,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromCollaborationUse(CollaborationUse element) {
		...
		collaborationUse.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.collaborationUse, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedUseCase, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedUseCase() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedUseCase, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.useCase, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void removeFromOwnedBehavior(Behavior element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedBehavior, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveInterfaceRealization(InterfaceRealization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.interfaceRealization, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToInterfaceRealization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interfaceRealization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.interfaceRealization,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromInterfaceRealization(InterfaceRealization element) {
		...
		interfaceRealization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.interfaceRealization, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveOwnedTrigger(Trigger element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedTrigger, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedTrigger() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActorPropertiesEditionPartImpl.this, UMLViewsRepository.Actor.ownedTrigger, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
