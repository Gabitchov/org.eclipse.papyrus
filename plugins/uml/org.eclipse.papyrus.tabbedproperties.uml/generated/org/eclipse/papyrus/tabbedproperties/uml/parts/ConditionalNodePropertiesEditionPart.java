...
public interface ConditionalNodePropertiesEditionPart {
	...
	/**
	 * @return the current clause table
	 */
	...
	/**
	 * @return true if the given element is contained inside the clause table
	 */
	...
	/**
	 * @return true if the given element is contained inside the result table
	 */
