...
public class FinalStatePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, FinalStatePropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.visibility, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getVisibility()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.clientDependency,
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromElementImport(ElementImport element) {
		...
		elementImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editElementImport(ElementImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromPackageImport(PackageImport element) {
		...
		packageImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPackageImport(PackageImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedRule(Constraint element) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedRule(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		...
		isLeaf = widgetFactory.createButton(parent, UMLMessages.FinalStatePropertiesEditionPart_IsLeafLabel, SWT.CHECK);
   		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.isLeaf, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isLeaf.getSelection())));
			}
	...
	protected void moveConnection(ConnectionPointReference element, int oldIndex, int newIndex) {
		...
		connection.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connection, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToConnection() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				connection.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connection, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromConnection(ConnectionPointReference element) {
		...
		connection.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connection, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editConnection(ConnectionPointReference element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				connection.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connection, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveConnectionPoint(Pseudostate element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToConnectionPoint() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				connectionPoint.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromConnectionPoint(Pseudostate element) {
		...
		connectionPoint.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editConnectionPoint(Pseudostate element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				connectionPoint.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveDeferrableTrigger(Trigger element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.deferrableTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToDeferrableTrigger() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				deferrableTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.deferrableTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromDeferrableTrigger(Trigger element) {
		...
		deferrableTrigger.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.deferrableTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editDeferrableTrigger(Trigger element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				deferrableTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.deferrableTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveRegion(Region element, int oldIndex, int newIndex) {
		...
		region.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToRegion() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				region.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromRegion(Region element) {
		...
		region.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRegion(Region element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				region.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(FinalStatePropertiesEditionPartForm.this, UMLViewsRepository.FinalState.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
