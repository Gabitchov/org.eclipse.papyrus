...
public class InformationFlowBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (informationFlow != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (InformationFlowPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.InformationFlow.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.InformationFlow.class) {
			...
			InformationFlow informationFlow = (InformationFlow) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					informationFlow.getVisibility());
			basePart.initClientDependency(informationFlow, null, UMLPackage.eINSTANCE
			...
			basePart.initInformationSource(informationFlow, null, UMLPackage.eINSTANCE
					.getInformationFlow_InformationSource());
			basePart.initInformationTarget(informationFlow, null, UMLPackage.eINSTANCE
					.getInformationFlow_InformationTarget());
			basePart.initRealizingActivityEdge(informationFlow, null, UMLPackage.eINSTANCE
					.getInformationFlow_RealizingActivityEdge());
			basePart.initRealizingConnector(informationFlow, null, UMLPackage.eINSTANCE
					.getInformationFlow_RealizingConnector());
			basePart.initRealizingMessage(informationFlow, null, UMLPackage.eINSTANCE
			...
			basePart.addFilterToRealization(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRealizationTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToConveyed(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getConveyedTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToInformationSource(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getInformationSourceTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToInformationTarget(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getInformationTargetTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToRealizingActivityEdge(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRealizingActivityEdgeTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToRealizingConnector(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRealizingConnectorTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToRealizingMessage(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRealizingMessageTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (informationFlow != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			...
			for (Iterator iter = realizationToAddFromRealization.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_Realization(), iter.next()));
			...
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			// UMLPackage.eINSTANCE.getRelationship(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			...
			for (Iterator iter = conveyedToAddFromConveyed.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_Conveyed(), iter.next()));
			...
			for (Iterator iter = informationSourceToAddFromInformationSource.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_InformationSource(), iter.next()));
			...
			for (Iterator iter = informationSourceToRemoveFromInformationSource.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_InformationSource(), iter.next()));
			// List informationSourceToMoveFromInformationSource =
			// basePart.getInformationSourceToMove();
			// for (Iterator iter = informationSourceToMoveFromInformationSource.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			...
			for (Iterator iter = informationTargetToAddFromInformationTarget.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_InformationTarget(), iter.next()));
			...
			for (Iterator iter = informationTargetToRemoveFromInformationTarget.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_InformationTarget(), iter.next()));
			// List informationTargetToMoveFromInformationTarget =
			// basePart.getInformationTargetToMove();
			// for (Iterator iter = informationTargetToMoveFromInformationTarget.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			...
			for (Iterator iter = realizingActivityEdgeToAddFromRealizingActivityEdge.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_RealizingActivityEdge(), iter.next()));
			...
			for (Iterator iter = realizingActivityEdgeToRemoveFromRealizingActivityEdge.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_RealizingActivityEdge(), iter.next()));
			// List realizingActivityEdgeToMoveFromRealizingActivityEdge =
			// basePart.getRealizingActivityEdgeToMove();
			// for (Iterator iter = realizingActivityEdgeToMoveFromRealizingActivityEdge.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			...
			for (Iterator iter = realizingConnectorToAddFromRealizingConnector.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_RealizingConnector(), iter.next()));
			...
			for (Iterator iter = realizingConnectorToRemoveFromRealizingConnector.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_RealizingConnector(), iter.next()));
			// List realizingConnectorToMoveFromRealizingConnector =
			// basePart.getRealizingConnectorToMove();
			// for (Iterator iter = realizingConnectorToMoveFromRealizingConnector.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			// UMLPackage.eINSTANCE.getConnector(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			...
			for (Iterator iter = realizingMessageToAddFromRealizingMessage.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_RealizingMessage(), iter.next()));
			...
			for (Iterator iter = realizingMessageToRemoveFromRealizingMessage.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, informationFlow, UMLPackage.eINSTANCE
						.getInformationFlow_RealizingMessage(), iter.next()));
			// List realizingMessageToMoveFromRealizingMessage =
			// basePart.getRealizingMessageToMove();
			// for (Iterator iter = realizingMessageToMoveFromRealizingMessage.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, informationFlow,
			// UMLPackage.eINSTANCE.getMessage(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.InformationFlow.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.InformationFlow.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.InformationFlow.realization == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_Realization(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_Realization(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_Realization(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.conveyed == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_Conveyed(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_Conveyed(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_Conveyed(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.informationSource == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_InformationSource(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_InformationSource(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_InformationSource(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.informationTarget == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_InformationTarget(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_InformationTarget(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_InformationTarget(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.realizingActivityEdge == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingActivityEdge(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingActivityEdge(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingActivityEdge(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.realizingConnector == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingConnector(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingConnector(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingConnector(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.InformationFlow.realizingMessage == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingMessage(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingMessage(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, informationFlow, UMLPackage.eINSTANCE
							.getInformationFlow_RealizingMessage(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.InformationFlow.conveyed
				|| key == UMLViewsRepository.InformationFlow.informationSource
				|| key == UMLViewsRepository.InformationFlow.informationTarget;
	}
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.InformationFlow.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.realization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.conveyed)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.informationSource)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.informationTarget)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.realizingActivityEdge)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.realizingConnector)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.InformationFlow.realizingMessage)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(informationFlow);
		else
			return null;
	}
