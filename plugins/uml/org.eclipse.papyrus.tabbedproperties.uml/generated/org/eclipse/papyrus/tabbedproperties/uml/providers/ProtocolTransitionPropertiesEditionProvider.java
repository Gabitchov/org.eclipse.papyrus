...
public class ProtocolTransitionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof ProtocolTransition) && (UMLPackage.eINSTANCE.getProtocolTransition() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ProtocolTransition) {
			return new ProtocolTransitionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ProtocolTransition) {
			if (ProtocolTransitionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ProtocolTransitionBasePropertiesEditionComponent(eObject, mode);
