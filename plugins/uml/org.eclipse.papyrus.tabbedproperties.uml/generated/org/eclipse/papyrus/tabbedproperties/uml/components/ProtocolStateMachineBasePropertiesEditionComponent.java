...
public class ProtocolStateMachineBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ProtocolStateMachineBasePropertiesEditionComponent(EObject protocolStateMachine, String mode) {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				...
				if (msg.getFeature() != null && 
						...
						|| ((EStructuralFeature)msg.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getProtocolConformance())) {
