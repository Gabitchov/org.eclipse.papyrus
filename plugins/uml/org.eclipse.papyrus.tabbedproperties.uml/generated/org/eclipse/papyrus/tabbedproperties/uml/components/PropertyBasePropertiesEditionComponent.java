...
public class PropertyBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Property.isLeaf || key == UMLViewsRepository.Property.isStatic || key == UMLViewsRepository.Property.isOrdered || key == UMLViewsRepository.Property.isUnique
				|| key == UMLViewsRepository.Property.isReadOnly || key == UMLViewsRepository.Property.isDerived || key == UMLViewsRepository.Property.isDerivedUnion
				|| key == UMLViewsRepository.Property.aggregation;
	}
