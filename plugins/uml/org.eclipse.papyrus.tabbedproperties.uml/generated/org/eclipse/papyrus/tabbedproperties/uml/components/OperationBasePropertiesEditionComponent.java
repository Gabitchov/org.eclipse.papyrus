...
public class OperationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getBehavioralFeature_OwnedParameter() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getParameter())) {
						basePart.updateOwnedParameter(operation);
					}
					if (UMLPackage.eINSTANCE.getBehavioralFeature_IsAbstract().equals(msg.getFeature())
							&& basePart != null)
						basePart.setIsAbstract((Boolean) msg.getNewValue());

					if (UMLPackage.eINSTANCE.getBehavioralFeature_Method().equals(msg.getFeature()))
						basePart.updateMethod(operation);
					if (UMLPackage.eINSTANCE.getBehavioralFeature_Concurrency().equals(msg.getFeature())
							&& basePart != null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getBehavioralFeature_OwnedParameterSet() || ((EStructuralFeature) msg.getFeature())
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (operation != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (OperationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Operation.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Operation.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), operation
					.getVisibility());
			...
			basePart.initConcurrency((EEnum) UMLPackage.eINSTANCE.getBehavioralFeature_Concurrency().getEType(),
			...
			basePart.initOwnedParameterSet(operation, null, UMLPackage.eINSTANCE
					.getBehavioralFeature_OwnedParameterSet());
			basePart
					.initTemplateBinding(operation, null, UMLPackage.eINSTANCE.getTemplateableElement_TemplateBinding());
			...
			basePart.addFilterToMethod(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getMethodTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToRaisedException(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRaisedExceptionTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToRedefinedOperation(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRedefinedOperationTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (operation != null) {
			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
			...
			for (Iterator iter = elementImportToAddFromElementImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation,
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getElementImport(),
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToAddFromOwnedRule.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getNamespace_OwnedRule(),
						iter.next()));
			...
			for (Iterator iter = ownedRuleToMoveFromOwnedRule.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));

			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getFeature_IsStatic(), basePart
					.getIsStatic()));
			...
			for (Iterator iter = ownedParameterToAddFromOwnedParameter.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_OwnedParameter(), iter.next()));
			...
			for (Iterator iter = ownedParameterToMoveFromOwnedParameter.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getParameter(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
					.getBehavioralFeature_IsAbstract(), basePart.getIsAbstract()));

			List methodToAddFromMethod = basePart.getMethodToAdd();
			for (Iterator iter = methodToAddFromMethod.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_Method(), iter.next()));
			List methodToRemoveFromMethod = basePart.getMethodToRemove();
			for (Iterator iter = methodToRemoveFromMethod.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_Method(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, operation,
			// UMLPackage.eINSTANCE.getBehavior(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
					.getBehavioralFeature_Concurrency(), basePart.getConcurrency()));
			...
			for (Iterator iter = raisedExceptionToAddFromRaisedException.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_RaisedException(), iter.next()));
			...
			// for (Iterator iter = raisedExceptionToMoveFromRaisedException.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, operation,
			// UMLPackage.eINSTANCE.getType(), moveElement.getElement(), moveElement.getIndex()));
			// }
			...
			for (Iterator iter = ownedParameterSetToAddFromOwnedParameterSet.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_OwnedParameterSet(), iter.next()));
			...
			for (Iterator iter = ownedParameterSetToMoveFromOwnedParameterSet.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getParameterSet(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = templateBindingToMoveFromTemplateBinding.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getTemplateBinding(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getOperation_IsQuery(), basePart
					.getIsQuery()));
			...
			for (Iterator iter = preconditionToAddFromPrecondition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE.getOperation_Precondition(),
						iter.next()));
			...
			for (Iterator iter = preconditionToRemoveFromPrecondition.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getOperation_Precondition(), iter.next()));
			...
			for (Iterator iter = postconditionToAddFromPostcondition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation,
						UMLPackage.eINSTANCE.getOperation_Postcondition(), iter.next()));
			...
			for (Iterator iter = postconditionToRemoveFromPostcondition.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getOperation_Postcondition(), iter.next()));
			...
			for (Iterator iter = redefinedOperationToAddFromRedefinedOperation.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getOperation_RedefinedOperation(), iter.next()));
			...
			for (Iterator iter = redefinedOperationToRemoveFromRedefinedOperation.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, operation, UMLPackage.eINSTANCE
						.getOperation_RedefinedOperation(), iter.next()));
			// List redefinedOperationToMoveFromRedefinedOperation =
			// basePart.getRedefinedOperationToMove();
			// for (Iterator iter = redefinedOperationToMoveFromRedefinedOperation.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, operation,
			// UMLPackage.eINSTANCE.getOperation(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Operation.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Operation.elementImport == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getNamespace_ElementImport(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Operation.ownedParameter == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_OwnedParameter(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation,
							UMLPackage.eINSTANCE.getParameter(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Operation.isAbstract == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_IsAbstract(), event.getNewValue()));

			if (UMLViewsRepository.Operation.method == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_Method(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_Method(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_Method(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Operation.concurrency == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
						.getBehavioralFeature_Concurrency(), event.getNewValue()));

			if (UMLViewsRepository.Operation.raisedException == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_RaisedException(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_RaisedException(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_RaisedException(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Operation.ownedParameterSet == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getBehavioralFeature_OwnedParameterSet(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Operation.isQuery == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
						.getOperation_IsQuery(), event.getNewValue()));

			if (UMLViewsRepository.Operation.precondition == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_Precondition(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_Precondition(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_Precondition(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Operation.postcondition == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_Postcondition(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_Postcondition(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_Postcondition(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Operation.redefinedOperation == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_RedefinedOperation(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_RedefinedOperation(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, operation, UMLPackage.eINSTANCE
							.getOperation_RedefinedOperation(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Operation.isLeaf || key == UMLViewsRepository.Operation.isStatic
				|| key == UMLViewsRepository.Operation.isAbstract || key == UMLViewsRepository.Operation.concurrency
				|| key == UMLViewsRepository.Operation.isQuery;
	}
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.Operation.isAbstract == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getBehavioralFeature_IsAbstract()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getBehavioralFeature_IsAbstract()
						.getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.Operation.concurrency == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getBehavioralFeature_Concurrency()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getBehavioralFeature_Concurrency()
						.getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.Operation.isQuery == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getOperation_IsQuery()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getOperation_IsQuery().getEAttributeType(),
						newValue);
			}
