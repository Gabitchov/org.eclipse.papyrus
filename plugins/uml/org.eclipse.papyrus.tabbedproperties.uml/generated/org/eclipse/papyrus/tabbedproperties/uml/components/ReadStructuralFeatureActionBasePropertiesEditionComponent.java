...
public class ReadStructuralFeatureActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ReadStructuralFeatureActionBasePropertiesEditionComponent(EObject readStructuralFeatureAction, String mode) {
		...
		if (PathedPropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(mode)) {
			...
			if (UMLViewsRepository.ReadStructuralFeatureAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.ReadStructuralFeatureAction.inInterruptibleRegion == event.getAffectedEditor()) {
				...
				if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE.getActivityNode_InInterruptibleRegion(), event.getNewValue(), event.getNewIndex()));
			}
