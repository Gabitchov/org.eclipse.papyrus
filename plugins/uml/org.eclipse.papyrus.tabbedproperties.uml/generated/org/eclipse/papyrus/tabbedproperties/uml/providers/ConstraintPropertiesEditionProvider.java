...
import org.eclipse.papyrus.tabbedproperties.uml.components.ConstraintBasePropertiesEditionComponent;
import org.eclipse.papyrus.tabbedproperties.uml.components.ConstraintPropertiesEditionComponent;
 ...
 */
public class ConstraintPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Constraint) && (UMLPackage.eINSTANCE.getConstraint() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Constraint) {
			return new ConstraintPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof Constraint) {
			if (ConstraintBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ConstraintBasePropertiesEditionComponent(eObject, editing_mode);
