...
public interface ReplyActionPropertiesEditionPart {
	...
	/**
	 * @return the replyValue to add
	 */
	public List getReplyValueToAdd();

	/**
	 * @return the replyValue to remove
	 */
	public List getReplyValueToRemove();

	/**
	 * @return the replyValue to move
	 */
	public List getReplyValueToMove();

	/**
	 * @return the replyValue to edit
	 */
	public Map getReplyValueToEdit();

	/**
	 * @return the current replyValue table
	 */
	...
	/**
	 * Update the replyValue
	 * @param newValue the replyValue to update
	 */
	public void updateReplyValue(EObject newValue);

	/**
	 * Adds the given filter to the replyValue edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the replyValue table
	 */
