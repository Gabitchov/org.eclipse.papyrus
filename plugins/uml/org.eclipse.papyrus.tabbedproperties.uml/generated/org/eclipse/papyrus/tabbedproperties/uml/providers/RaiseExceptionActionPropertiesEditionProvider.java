...
import org.eclipse.papyrus.tabbedproperties.uml.components.RaiseExceptionActionPropertiesEditionComponent;
 ...
 */
public class RaiseExceptionActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof RaiseExceptionAction) && (UMLPackage.eINSTANCE.getRaiseExceptionAction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof RaiseExceptionAction) {
			return new RaiseExceptionActionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof RaiseExceptionAction) {
			if (RaiseExceptionActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new RaiseExceptionActionBasePropertiesEditionComponent(eObject, mode);
