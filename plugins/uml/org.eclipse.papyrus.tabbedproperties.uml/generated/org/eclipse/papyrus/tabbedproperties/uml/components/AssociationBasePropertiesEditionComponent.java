...
public class AssociationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Association.isLeaf || key == UMLViewsRepository.Association.isAbstract || key == UMLViewsRepository.Association.memberEnd
				|| key == UMLViewsRepository.Association.isDerived;
	}
