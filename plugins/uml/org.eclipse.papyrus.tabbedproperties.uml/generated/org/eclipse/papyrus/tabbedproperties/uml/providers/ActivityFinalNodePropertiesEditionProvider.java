...
import org.eclipse.papyrus.tabbedproperties.uml.components.ActivityFinalNodePropertiesEditionComponent;
 ...
 */
public class ActivityFinalNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ActivityFinalNode) {
			return new ActivityFinalNodePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ActivityFinalNode) {
			if (ActivityFinalNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ActivityFinalNodeBasePropertiesEditionComponent(eObject, mode);
