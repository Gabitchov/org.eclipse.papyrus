...
public class UnmarshallActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, UnmarshallActionPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.UnmarshallActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.UnmarshallAction.name, UMLViewsRepository.FORM_KIND));
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.UnmarshallActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.UnmarshallAction.visibility, UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.visibility, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getVisibility()));
			}
			
		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {	
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.clientDependency,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, UMLMessages.UnmarshallActionPropertiesEditionPart_IsLeafLabel, SWT.CHECK);
   		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.isLeaf, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isLeaf.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {	
				...
				"ActivityEdge", UMLPackage.eINSTANCE.getActivityEdge()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.outgoing,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						outgoing.refresh();												
					}
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.outgoing, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.outgoing, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOutgoing(ActivityEdge element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				outgoing.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.outgoing, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {	
				...
				"ActivityEdge", UMLPackage.eINSTANCE.getActivityEdge()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.incoming,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						incoming.refresh();												
					}
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.incoming, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.incoming, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editIncoming(ActivityEdge element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				incoming.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.incoming, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {	
				...
				"ActivityPartition", UMLPackage.eINSTANCE.getActivityPartition()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inPartition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						inPartition.refresh();												
					}
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.inPartition, UMLViewsRepository.FORM_KIND));
	...
	protected void moveInPartition(ActivityPartition element, int oldIndex, int newIndex) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inPartition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromInPartition(ActivityPartition element) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inPartition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editInPartition(ActivityPartition element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				inPartition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inPartition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {	
				...
				"InterruptibleActivityRegion", UMLPackage.eINSTANCE.getInterruptibleActivityRegion()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inInterruptibleRegion,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.inInterruptibleRegion, UMLViewsRepository.FORM_KIND));
	...
	protected void moveInInterruptibleRegion(InterruptibleActivityRegion element, int oldIndex, int newIndex) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inInterruptibleRegion, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inInterruptibleRegion, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				inInterruptibleRegion.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.inInterruptibleRegion, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {	
				...
				"ActivityNode", UMLPackage.eINSTANCE.getActivityNode()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.redefinedNode,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.redefinedNode, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRedefinedNode(ActivityNode element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedNode.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.redefinedNode, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createHandlerTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.handler, UMLViewsRepository.FORM_KIND));
	...
	protected void moveHandler(ExceptionHandler element, int oldIndex, int newIndex) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.handler, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToHandler() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.handler, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromHandler(ExceptionHandler element) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.handler, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editHandler(ExceptionHandler element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.handler, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createLocalPreconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.localPrecondition, UMLViewsRepository.FORM_KIND));
	...
	protected void moveLocalPrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPrecondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToLocalPrecondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPrecondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromLocalPrecondition(Constraint element) {
		...
		localPrecondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPrecondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editLocalPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPrecondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createLocalPostconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.localPostcondition, UMLViewsRepository.FORM_KIND));
	...
	protected void moveLocalPostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPostcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToLocalPostcondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPostcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromLocalPostcondition(Constraint element) {
		...
		localPostcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPostcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editLocalPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.localPostcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createResultTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.result.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.UnmarshallAction.result, UMLViewsRepository.FORM_KIND));
	...
	protected void moveResult(OutputPin element, int oldIndex, int newIndex) {
		...
		result.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.result, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToResult() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				result.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.result, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromResult(OutputPin element) {
		...
		result.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.result, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editResult(OutputPin element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				result.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(UnmarshallActionPropertiesEditionPartForm.this, UMLViewsRepository.UnmarshallAction.result, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOwnedCommentToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOwnedCommentToRemove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOwnedCommentToEdit()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOwnedCommentToMove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOwnedCommentTable()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getName()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getVisibility()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getClientDependencyToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getClientDependencyToRemove()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getIsLeaf()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOutgoingToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getOutgoingToRemove()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getIncomingToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getIncomingToRemove()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getInPartitionToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getInPartitionToRemove()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getInInterruptibleRegionToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getInInterruptibleRegionToRemove()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getRedefinedNodeToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getRedefinedNodeToRemove()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getHandlerToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getHandlerToRemove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getHandlerToEdit()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getHandlerToMove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getHandlerTable()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPreconditionToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPreconditionToRemove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPreconditionToEdit()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPreconditionToMove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPreconditionTable()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPostconditionToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPostconditionToRemove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPostconditionToEdit()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPostconditionToMove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getLocalPostconditionTable()
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getResultToAdd()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getResultToRemove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getResultToEdit()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getResultToMove()
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UnmarshallActionPropertiesEditionPart#getResultTable()
	 */
