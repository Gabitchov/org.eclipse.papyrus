...
public class DeploymentBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					DeploymentBasePropertiesEditionComponent.this.dispose();
				else {
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getDeployment_Configuration() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getDeploymentSpecification())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (deployment != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (DeploymentPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Deployment.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.Deployment.class)
			this.basePart = (DeploymentPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Deployment.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), deployment
					.getVisibility());
			...
			basePart.addFilterToDeployedArtifact(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getDeployedArtifactTable().contains(element));
					return false;
				}
			...
			// End of user code
			basePart.addFilterToConfiguration(new ViewerFilter() {
				 ...
				 */
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					return (element instanceof String && element.equals("")) || (element instanceof DeploymentSpecification); //$NON-NLS-1$ 

				}

			});
			// Start of user code for additional businessfilters for configuration
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (deployment != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, deployment,
			...
			for (Iterator iter = supplierToAddFromSupplier.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getDependency_Supplier(),
						iter.next()));
			...
			for (Iterator iter = supplierToRemoveFromSupplier.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, deployment,
						UMLPackage.eINSTANCE.getDependency_Supplier(), iter.next()));
			...
			for (Iterator iter = clientToAddFromClient.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getDependency_Client(),
						iter.next()));
			List clientToRemoveFromClient = basePart.getClientToRemove();
			for (Iterator iter = clientToRemoveFromClient.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE.getDependency_Client(),
						iter.next()));
			...
			// moveElement.getIndex()));
			// }
			List deployedArtifactToAddFromDeployedArtifact = basePart.getDeployedArtifactToAdd();
			for (Iterator iter = deployedArtifactToAddFromDeployedArtifact.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE
						.getDeployment_DeployedArtifact(), iter.next()));
			List deployedArtifactToRemoveFromDeployedArtifact = basePart.getDeployedArtifactToRemove();
			for (Iterator iter = deployedArtifactToRemoveFromDeployedArtifact.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE
						.getDeployment_DeployedArtifact(), iter.next()));
			// List deployedArtifactToMoveFromDeployedArtifact =
			// basePart.getDeployedArtifactToMove();
			// for (Iterator iter = deployedArtifactToMoveFromDeployedArtifact.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, deployment,
			// UMLPackage.eINSTANCE.getDeployedArtifact(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			List configurationToAddFromConfiguration = basePart.getConfigurationToAdd();
			for (Iterator iter = configurationToAddFromConfiguration.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE
						.getDeployment_Configuration(), iter.next()));
			Map configurationToRefreshFromConfiguration = basePart.getConfigurationToEdit();
			for (Iterator iter = configurationToRefreshFromConfiguration.keySet().iterator(); iter.hasNext();) {

				// Start of user code for configuration reference refreshment from configuration

				DeploymentSpecification nextElement = (DeploymentSpecification) iter.next();
				DeploymentSpecification configuration = (DeploymentSpecification) configurationToRefreshFromConfiguration
						.get(nextElement);

				// End of user code

			}
			List configurationToRemoveFromConfiguration = basePart.getConfigurationToRemove();
			for (Iterator iter = configurationToRemoveFromConfiguration.iterator(); iter.hasNext();)
				cc.append(DeleteCommand.create(editingDomain, iter.next()));
			List configurationToMoveFromConfiguration = basePart.getConfigurationToMove();
			for (Iterator iter = configurationToMoveFromConfiguration.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deployment, UMLPackage.eINSTANCE
						.getDeploymentSpecification(), moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Deployment.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Deployment.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Deployment.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Deployment.deployedArtifact == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getDeployment_DeployedArtifact(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getDeployment_DeployedArtifact(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getDeployment_DeployedArtifact(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Deployment.configuration == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getDeployment_Configuration(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deployment, UMLPackage.eINSTANCE
							.getDeploymentSpecification(), event.getNewValue(), event.getNewIndex()));
			}
