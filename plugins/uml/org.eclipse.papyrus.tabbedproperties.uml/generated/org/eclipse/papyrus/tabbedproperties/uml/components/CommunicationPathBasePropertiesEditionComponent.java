...
public class CommunicationPathBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.CommunicationPath.isLeaf || key == UMLViewsRepository.CommunicationPath.isAbstract || key == UMLViewsRepository.CommunicationPath.memberEnd
