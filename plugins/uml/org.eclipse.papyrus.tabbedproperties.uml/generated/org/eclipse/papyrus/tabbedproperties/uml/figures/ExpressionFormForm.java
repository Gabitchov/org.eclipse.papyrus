...
/**
 * The ExpressionForm form
 *
 *
 * @generated
 */ 
public class ExpressionFormForm extends AbstractControlsGroup {
	...
	public ExpressionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected InputTextControls symbol;
	protected AdvancedReferencedTable operand;
    ...
    public void createDirectChildren() {
		//
		symbol = new InputTextControls("Symbol", "");
		 this.add(symbol);
     
		//
		operand = new AdvancedReferencedTable("operand",new org.eclipse.papyrus.tabbedproperties.core.filters.ValueSpecificationFilter(),backContext);
		this.add(operand);
     ...
     * @return the symbol
     */
    public InputTextControls getSymbol() {
        return symbol;
    }
...
/**
     * @return the operand
     */
    public AdvancedReferencedTable getOperand() {
        return operand;
    }
