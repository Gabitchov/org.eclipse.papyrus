...
public class ParameterSetPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ParameterSetPropertiesEditionPart {
	...
	protected ReferencesTable<? extends EObject> condition;
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ParameterSetPropertiesEditionPartImpl.this, UMLViewsRepository.ParameterSet.ownedComment,
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ParameterSetPropertiesEditionPartImpl.this, UMLViewsRepository.ParameterSet.clientDependency,
	...
	protected void createParameterAdvancedReferencesTable(Composite parent) {
		this.parameter = new ReferencesTable<Parameter>(UMLMessages.ParameterSetPropertiesEditionPart_ParameterLabel, new ReferencesTableListener<Parameter>() {
			public void handleAdd() {
				...
				"Parameter", UMLPackage.eINSTANCE.getParameter(), current.eResource()) {
	...
	protected void removeFromParameter(Parameter element) {
		...
		parameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				ParameterSetPropertiesEditionPartImpl.this, UMLViewsRepository.ParameterSet.parameter,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	 ...
	 * 
	 */
	protected void moveCondition(Constraint element, int oldIndex, int newIndex) {
	...
	protected void addToCondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				condition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						ParameterSetPropertiesEditionPartImpl.this, UMLViewsRepository.ParameterSet.condition,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	 ...
	 * 
	 */
	protected void removeFromCondition(Constraint element) {
	 ...
	 * 
	 */
	protected void editCondition(Constraint element) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ParameterSetPropertiesEditionPart#isContainedInOwnedCommentTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ParameterSetPropertiesEditionPart#isContainedInClientDependencyTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ParameterSetPropertiesEditionPart#isContainedInParameterTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ParameterSetPropertiesEditionPart#isContainedInConditionTable(EObject element)
	 */
	public boolean isContainedInConditionTable(EObject element) {
		return conditionEditUtil.contains(element);
	}
