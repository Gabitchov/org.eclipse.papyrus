...
public class CallOperationActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (callOperationAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (CallOperationActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.CallOperationAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.CallOperationAction.class) {
			...
			CallOperationAction callOperationAction = (CallOperationAction) elt;
			// init values
			...
			basePart.initClientDependency(callOperationAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInInterruptibleRegion(callOperationAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(callOperationAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(callOperationAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (callOperationAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, callOperationAction,
					UMLPackage.eINSTANCE.getNamedElement_Name(), basePart.getName()));

			cc.append(SetCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, callOperationAction,
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = localPreconditionToMoveFromLocalPrecondition.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = argumentToMoveFromArgument.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE.getInputPin(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = resultToMoveFromResult.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, callOperationAction, UMLPackage.eINSTANCE.getOutputPin(),
						moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.CallOperationAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, callOperationAction, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, callOperationAction, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.CallOperationAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, callOperationAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.CallOperationAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, callOperationAction, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.CallOperationAction.isLeaf
				|| key == UMLViewsRepository.CallOperationAction.isSynchronous;
	}
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.CallOperationAction.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.handler)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.localPrecondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.localPostcondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.argument)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.isSynchronous)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.CallOperationAction.result)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(callOperationAction);
		else
			return null;
	}
