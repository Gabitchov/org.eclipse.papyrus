...
/**
 * The DestroyObjectAction form
 *
 *
 * @generated
 */ 
public class DestroyObjectActionForm extends AbstractControlsGroup {
	...
	public DestroyObjectActionForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected LabeledCheckBoxFigure isDestroyLinksForm;
	protected LabeledCheckBoxFigure isDestroyOwnedObjectsForm;
    ...
    public void createDirectChildren() {
		...
		isDestroyLinksForm = new LabeledCheckBoxFigure("isDestroyLinks", "");
		hbox.add(isDestroyLinksForm);
		isDestroyOwnedObjectsForm = new LabeledCheckBoxFigure("isDestroyOwnedObjects", "");
		hbox.add(isDestroyOwnedObjectsForm);
     ...
     public Composite createLocalControls(Composite parent) {
       ...
       //RowLayout rowLayout = new RowLayout();
        ...
        return composite;
 	    ...
 	    /**
     * @return the isDestroyLinksForm
     */
    public LabeledCheckBoxFigure  getIsDestroyLinksForm() {
        return isDestroyLinksForm;
    }
 	
 	    /**
     * @return the isDestroyOwnedObjectsForm
     */
    public LabeledCheckBoxFigure  getIsDestroyOwnedObjectsForm() {
        return isDestroyOwnedObjectsForm;
    }
