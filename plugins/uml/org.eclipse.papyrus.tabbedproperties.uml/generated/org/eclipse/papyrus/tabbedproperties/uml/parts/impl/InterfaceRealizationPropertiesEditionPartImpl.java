...
public class InterfaceRealizationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, InterfaceRealizationPropertiesEditionPart {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
				...
				"NamedElement", UMLPackage.eINSTANCE.getNamedElement()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.client,
	...
	private void removeFromClient(NamedElement element) {
		...
		client.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.client, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClient(NamedElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				client.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.client, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"NamedElement", UMLPackage.eINSTANCE.getNamedElement()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.supplier,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						supplier.refresh();											
					}
	...
	private void removeFromSupplier(NamedElement element) {
		...
		supplier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.supplier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editSupplier(NamedElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				supplier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.supplier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
