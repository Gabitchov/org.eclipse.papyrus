...
public class InterfaceRealizationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, InterfaceRealizationPropertiesEditionPart {
	...
	private void removeFromClient(NamedElement element) {
		...
		client.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.client, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClient(NamedElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				client.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.client, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromSupplier(NamedElement element) {
		...
		supplier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.supplier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editSupplier(NamedElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				supplier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InterfaceRealizationPropertiesEditionPartImpl.this, UMLViewsRepository.InterfaceRealization.supplier, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
