...
import org.eclipse.papyrus.tabbedproperties.uml.components.RealizationBasePropertiesEditionComponent;
import org.eclipse.papyrus.tabbedproperties.uml.components.RealizationPropertiesEditionComponent;
 ...
 */
public class RealizationPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Realization) && (UMLPackage.eINSTANCE.getRealization() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Realization) {
			return new RealizationPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof Realization) {
			if (RealizationBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new RealizationBasePropertiesEditionComponent(eObject, editing_mode);
