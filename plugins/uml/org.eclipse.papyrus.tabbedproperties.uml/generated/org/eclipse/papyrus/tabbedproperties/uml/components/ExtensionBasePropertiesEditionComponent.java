...
public class ExtensionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Extension.isLeaf || key == UMLViewsRepository.Extension.isAbstract || key == UMLViewsRepository.Extension.memberEnd
				|| key == UMLViewsRepository.Extension.isDerived;
	}
