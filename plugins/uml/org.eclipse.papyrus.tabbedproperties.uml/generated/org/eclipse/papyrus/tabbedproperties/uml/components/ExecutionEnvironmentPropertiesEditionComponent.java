...
public class ExecutionEnvironmentPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public ExecutionEnvironmentPropertiesEditionComponent(EObject executionEnvironment, String editing_mode) {
		...
		if (executionEnvironment instanceof ExecutionEnvironment) {
			executionEnvironmentBasePropertiesEditionComponent = new ExecutionEnvironmentBasePropertiesEditionComponent(
					executionEnvironment, editing_mode);
			addSubComponent(executionEnvironmentBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(executionEnvironment,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ExecutionEnvironmentPropertiesEditionPart) executionEnvironmentBasePropertiesEditionComponent
