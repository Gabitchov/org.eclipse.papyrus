...
/**
 * The ContinuationForm form
 *
 *
 * @generated
 */ 
public class ContinuationFormForm extends AbstractControlsGroup {
	...
	public ContinuationFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure setting;
    ...
    public void createDirectChildren() {
		//
		setting = new LabeledCheckBoxFigure("setting", "");
		this.add(setting);
     ...
     * @return the setting
     */
    public LabeledCheckBoxFigure  getSetting() {
        return setting;
    }
