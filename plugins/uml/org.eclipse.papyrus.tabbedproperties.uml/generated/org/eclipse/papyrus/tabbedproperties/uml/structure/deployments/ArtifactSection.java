...
/**
 * The Artifact property section for the Artifact element
 * 
 ...
 * @generated
 */
public class ArtifactSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private InputTextControls artifact;

	/**
	 * The Artifact to edit 
	 * @generated
	 */
	private Artifact artifactElement;
	...
	public PropertyEditor createFigure() {
		artifact = new InputTextControls("fileName","An artifact is the specification of a physical piece of information that is used or produced by a software development process, or by deployment and operation of a system. Examples of artifacts include model files, source files, scripts, and binary executable files, a table in a database system, a development deliverable, or a word-processing document, a mail message."+
""+
"An artifact is the source of a deployment to a node.");
		return artifact;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature fileName of Artifact
		PropertyChangeListener<String> fileNameFormListener = new PropertyChangeListener<String>(){
		   public void propertyChanged(PropertyEditor editor, java.lang.String newValue) {
				SetValueCommand command = new SetValueCommand(editingDomain, artifactElement, UMLPackage.eINSTANCE.getArtifact_FileName(), newValue);
			editingDomain.getCommandStack().execute(command);
			}
		};

		artifact.setPropertyChangeListener(fileNameFormListener);
	...
	public void refresh() {
		super.refresh();
							...
							artifact.setValue(artifactElement.getFileName());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.artifactElement = (Artifact)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Artifact;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		artifactElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		artifactElement.eAdapters().remove(modelListener);
