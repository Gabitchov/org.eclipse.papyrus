...
import org.eclipse.papyrus.tabbedproperties.uml.components.JoinNodePropertiesEditionComponent;
 ...
 */
public class JoinNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof JoinNode) {
			return new JoinNodePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof JoinNode) {
			if (JoinNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new JoinNodeBasePropertiesEditionComponent(eObject, mode);
