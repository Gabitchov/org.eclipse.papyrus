...
public class ExecutionOccurrenceSpecificationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ExecutionOccurrenceSpecificationPropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.visibility, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getVisibility()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.clientDependency,
				...
				"Lifeline", UMLPackage.eINSTANCE.getLifeline()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.covered,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						covered.refresh();												
					}
	...
	protected void moveCovered(Lifeline element, int oldIndex, int newIndex) {
		...
		covered.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.covered, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromCovered(Lifeline element) {
		...
		covered.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.covered, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editCovered(Lifeline element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				covered.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.covered, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveGeneralOrdering(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.generalOrdering, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
				...
				"GeneralOrdering", UMLPackage.eINSTANCE.getGeneralOrdering()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toBefore,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						toBefore.refresh();												
					}
	...
	protected void moveToBefore(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		toBefore.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toBefore, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromToBefore(GeneralOrdering element) {
		...
		toBefore.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toBefore, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editToBefore(GeneralOrdering element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				toBefore.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toBefore, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"GeneralOrdering", UMLPackage.eINSTANCE.getGeneralOrdering()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toAfter,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						toAfter.refresh();												
					}
	...
	protected void moveToAfter(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		toAfter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toAfter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromToAfter(GeneralOrdering element) {
		...
		toAfter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toAfter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editToAfter(GeneralOrdering element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				toAfter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ExecutionOccurrenceSpecificationPropertiesEditionPartForm.this, UMLViewsRepository.ExecutionOccurrenceSpecification.toAfter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
