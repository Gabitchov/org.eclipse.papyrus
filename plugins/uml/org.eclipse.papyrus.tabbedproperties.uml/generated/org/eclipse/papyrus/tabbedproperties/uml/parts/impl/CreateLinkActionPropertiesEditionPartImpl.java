 ...
 */
public class CreateLinkActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, CreateLinkActionPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		this.ownedComment = new ReferencesTable<Comment>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_OwnedCommentLabel,
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CreateLinkActionPropertiesEditionPart_NameLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.CreateLinkAction.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CreateLinkActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkAction.name,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CreateLinkActionPropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.CreateLinkAction.visibility,
						UMLViewsRepository.SWT_KIND));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
		this.clientDependency = new ReferencesTable<Dependency>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_ClientDependencyLabel,
						...
						TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											CreateLinkActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkAction.clientDependency,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void createIsLeafCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.isLeaf, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createOutgoingAdvancedReferencesTable(Composite parent) {
		this.outgoing = new ReferencesTable<ActivityEdge>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_OutgoingLabel,
						...
						TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											CreateLinkActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkAction.outgoing,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								outgoing.refresh();
							}
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.outgoing, UMLViewsRepository.SWT_KIND));
	...
	protected void createIncomingAdvancedReferencesTable(Composite parent) {
		this.incoming = new ReferencesTable<ActivityEdge>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_IncomingLabel,
				new ReferencesTableListener<ActivityEdge>() {
						...
						TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											CreateLinkActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkAction.incoming,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								incoming.refresh();
							}
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.incoming, UMLViewsRepository.SWT_KIND));
	...
	protected void createInPartitionAdvancedReferencesTable(Composite parent) {
		this.inPartition = new ReferencesTable<ActivityPartition>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_InPartitionLabel,
						...
						TabElementTreeSelectionDialog<ActivityPartition> dialog = new TabElementTreeSelectionDialog<ActivityPartition>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											CreateLinkActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkAction.inPartition,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								inPartition.refresh();
							}
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.inPartition, UMLViewsRepository.SWT_KIND));
	...
	protected void createInInterruptibleRegionAdvancedReferencesTable(Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable<InterruptibleActivityRegion>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_InInterruptibleRegionLabel,
						...
						TabElementTreeSelectionDialog<InterruptibleActivityRegion> dialog = new TabElementTreeSelectionDialog<InterruptibleActivityRegion>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											CreateLinkActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkAction.inInterruptibleRegion,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.inInterruptibleRegion, UMLViewsRepository.SWT_KIND));
	...
	protected void createRedefinedNodeAdvancedReferencesTable(Composite parent) {
		this.redefinedNode = new ReferencesTable<ActivityNode>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_RedefinedNodeLabel,
						...
						TabElementTreeSelectionDialog<ActivityNode> dialog = new TabElementTreeSelectionDialog<ActivityNode>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											CreateLinkActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkAction.redefinedNode,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.redefinedNode, UMLViewsRepository.SWT_KIND));
	...
	protected void createHandlerAdvancedTableComposition(Composite parent) {
		this.handler = new ReferencesTable<ExceptionHandler>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_HandlerLabel,
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.CreateLinkAction.handler,
				UMLViewsRepository.SWT_KIND));
	...
	protected void createLocalPreconditionAdvancedTableComposition(Composite parent) {
		this.localPrecondition = new ReferencesTable<Constraint>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_LocalPreconditionLabel,
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.localPrecondition, UMLViewsRepository.SWT_KIND));
	...
	protected void createLocalPostconditionAdvancedTableComposition(Composite parent) {
		this.localPostcondition = new ReferencesTable<Constraint>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_LocalPostconditionLabel,
				new ReferencesTableListener<Constraint>() {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.localPostcondition, UMLViewsRepository.SWT_KIND));
	...
	protected void createEndDataAdvancedTableComposition(Composite parent) {
		this.endData = new ReferencesTable<LinkEndData>(UMLMessages.CreateLinkActionPropertiesEditionPart_EndDataLabel,
		...
		this.endData.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.CreateLinkAction.endData,
				UMLViewsRepository.SWT_KIND));
	...
	protected void createInputValueAdvancedTableComposition(Composite parent) {
		this.inputValue = new ReferencesTable<InputPin>(
				UMLMessages.CreateLinkActionPropertiesEditionPart_InputValueLabel,
		...
		this.inputValue.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CreateLinkAction.inputValue, UMLViewsRepository.SWT_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initOwnedComment(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateOwnedComment(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterOwnedComment(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterOwnedComment(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#setName(String
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initVisibility(EEnum
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initClientDependency(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateClientDependency(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#setIsLeaf(Boolean
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initOutgoing(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateOutgoing(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterOutgoing(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterOutgoing(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initIncoming(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateIncoming(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterIncoming(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterIncoming(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initInPartition(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateInPartition(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterInPartition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterInPartition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initInInterruptibleRegion(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateInInterruptibleRegion(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterInInterruptibleRegion(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initRedefinedNode(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateRedefinedNode(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterRedefinedNode(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterRedefinedNode(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initHandler(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateHandler(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterHandler(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterHandler(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initLocalPrecondition(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateLocalPrecondition(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterLocalPrecondition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initLocalPostcondition(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateLocalPostcondition(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterLocalPostcondition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initEndData(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateEndData(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterEndData(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterEndData(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#initInputValue(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#updateInputValue(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addFilterInputValue(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CreateLinkActionPropertiesEditionPart#addBusinessFilterInputValue(ViewerFilter
	 *      filter)
	 */
