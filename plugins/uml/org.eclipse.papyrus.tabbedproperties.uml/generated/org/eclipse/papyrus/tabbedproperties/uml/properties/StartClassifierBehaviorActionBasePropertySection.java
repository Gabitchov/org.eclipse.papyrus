...
public class StartClassifierBehaviorActionBasePropertySection extends AbstractPropertySection implements IFilter {
		...
		if (editingDomain != null && newEObject != null && newEObject != eObject) {
			...
			if (eObject != null) {
				...
				this.propertiesEditionComponent = provider.getPropertiesEditionComponent(eObject,
						...
						StartClassifierBehaviorActionBasePropertiesEditionComponent.BASE_PART);
				if (this.propertiesEditionComponent != null) {
					...
					this.editionPart = propertiesEditionComponent.getPropertiesEditionPart(1,
							StartClassifierBehaviorActionBasePropertiesEditionComponent.BASE_PART); //$NON-NLS-1$
					if (editionPart instanceof IFormPropertiesEditionPart) {
						...
						propertiesEditionComponent.initPart(propertiesEditionComponent
								.translatePart(StartClassifierBehaviorActionBasePropertiesEditionComponent.BASE_PART),
								1, eObject);
					}
				}
			}
	...
	public boolean select(Object toTest) {
		...
		return eObjectToTest != null
				&& eObjectToTest.eClass() == UMLPackage.eINSTANCE.getStartClassifierBehaviorAction();
	}
