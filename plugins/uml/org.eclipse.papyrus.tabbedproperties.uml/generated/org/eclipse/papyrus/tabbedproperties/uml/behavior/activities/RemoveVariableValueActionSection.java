...
import org.eclipse.papyrus.tabbedproperties.uml.figures.RemoveVariableValueActionFormForm;
...
/**
 * The RemoveVariableValueAction property section for the RemoveVariableValueAction element
 * 
 *
 * @generated
 */
public class RemoveVariableValueActionSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private RemoveVariableValueActionFormForm removeVariableValueActionForm;

	/**
	 * The RemoveVariableValueAction to edit 
	 * @generated
	 */
	private RemoveVariableValueAction removeVariableValueActionElement;
	 ...
	 * @generated
	 */
	public RemoveVariableValueActionSection() {
	...
	public PropertyEditor createFigure() {
		removeVariableValueActionForm = new RemoveVariableValueActionFormForm("RemoveVariableValueAction","A remove variable value action is a write variable action that removes values from variables.");
		return removeVariableValueActionForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isRemoveDuplicates of RemoveVariableValueAction
		BooleanPropertyChangeListener isRemoveDuplicatesListener = new BooleanPropertyChangeListener(){
			...
			SetValueCommand command = new SetValueCommand(editingDomain,removeVariableValueActionElement, UMLPackage.eINSTANCE.getRemoveVariableValueAction_IsRemoveDuplicates(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		removeVariableValueActionForm.getIsRemoveDuplicates().setPropertyChangeListener(isRemoveDuplicatesListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						removeVariableValueActionForm.getIsRemoveDuplicates().setValue(removeVariableValueActionElement.isRemoveDuplicates());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.removeVariableValueActionElement = (RemoveVariableValueAction)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof RemoveVariableValueAction;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		removeVariableValueActionElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		removeVariableValueActionElement.eAdapters().remove(modelListener);
	...
	public void dispose() {
		// stop listening
		if(removeVariableValueActionElement!=null){
		removeVariableValueActionElement.eAdapters().remove(modelListener);}
		if(removeVariableValueActionForm!=null){
		removeVariableValueActionForm.dispose();
		}
		super.dispose();
	}
