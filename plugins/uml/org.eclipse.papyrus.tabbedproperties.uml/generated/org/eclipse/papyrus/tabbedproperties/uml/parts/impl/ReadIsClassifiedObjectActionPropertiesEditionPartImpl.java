...
public class ReadIsClassifiedObjectActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ReadIsClassifiedObjectActionPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
				UMLViewsRepository.ReadIsClassifiedObjectAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ReadIsClassifiedObjectActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(
				UMLViewsRepository.ReadIsClassifiedObjectAction.name, UMLViewsRepository.SWT_KIND));
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ReadIsClassifiedObjectActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(
				UMLViewsRepository.ReadIsClassifiedObjectAction.visibility, UMLViewsRepository.SWT_KIND));
	...
	private void addToHandler() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.handler, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromHandler(ExceptionHandler element) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
				UMLViewsRepository.ReadIsClassifiedObjectAction.handler, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editHandler(ExceptionHandler element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.handler, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void addToLocalPrecondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromLocalPrecondition(Constraint element) {
		...
		localPrecondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
				UMLViewsRepository.ReadIsClassifiedObjectAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editLocalPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void addToLocalPostcondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromLocalPostcondition(Constraint element) {
		...
		localPostcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
				UMLViewsRepository.ReadIsClassifiedObjectAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editLocalPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ReadIsClassifiedObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.ReadIsClassifiedObjectAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
