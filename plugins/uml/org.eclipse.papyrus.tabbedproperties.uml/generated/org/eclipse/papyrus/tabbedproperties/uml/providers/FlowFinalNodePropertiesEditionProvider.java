...
import org.eclipse.papyrus.tabbedproperties.uml.components.FlowFinalNodePropertiesEditionComponent;
 ...
 */
public class FlowFinalNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof FlowFinalNode) && (UMLPackage.eINSTANCE.getFlowFinalNode() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof FlowFinalNode) {
			return new FlowFinalNodePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof FlowFinalNode) {
			if (FlowFinalNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new FlowFinalNodeBasePropertiesEditionComponent(eObject, mode);
