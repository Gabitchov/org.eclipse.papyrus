 ...
 */
public class ClausePropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, ClausePropertiesEditionPart {
	...
	protected void createPredecessorClauseReferencesTable(FormToolkit widgetFactory, Composite parent) {
						...
						TabElementTreeSelectionDialog<Clause> dialog = new TabElementTreeSelectionDialog<Clause>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											ClausePropertiesEditionPartForm.this,
		...
		this.predecessorClause.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Clause.predecessorClause, UMLViewsRepository.FORM_KIND));
	...
	protected void createSuccessorClauseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.successorClause.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Clause.successorClause, UMLViewsRepository.FORM_KIND));
