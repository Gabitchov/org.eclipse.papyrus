...
public class ClausePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, ClausePropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.ownedComment, PropertiesEditionEvent.COMMIT,
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.ownedComment,
	...
	protected void removeFromTest(ExecutableNode element) {
		...
		test.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.test, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void removeFromBody(ExecutableNode element) {
		...
		body.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.body, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void movePredecessorClause(Clause element, int oldIndex, int newIndex) {
		...
		predecessorClause.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.predecessorClause, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void moveSuccessorClause(Clause element, int oldIndex, int newIndex) {
		...
		successorClause.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.successorClause, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void moveBodyOutput(OutputPin element, int oldIndex, int newIndex) {
		...
		bodyOutput.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ClausePropertiesEditionPartForm.this, UMLViewsRepository.Clause.bodyOutput, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
