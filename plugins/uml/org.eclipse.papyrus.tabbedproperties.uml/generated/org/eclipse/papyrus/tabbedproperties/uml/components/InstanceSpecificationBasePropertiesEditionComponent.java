...
public class InstanceSpecificationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (instanceSpecification != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (InstanceSpecificationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.InstanceSpecification.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.InstanceSpecification.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					instanceSpecification.getVisibility());
			basePart.initDeployment(instanceSpecification, null, UMLPackage.eINSTANCE.getDeploymentTarget_Deployment());
			basePart.initClassifier(instanceSpecification, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (instanceSpecification != null) {
			cc.append(SetCommand.create(editingDomain, instanceSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = deploymentToAddFromDeployment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, instanceSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = deploymentToMoveFromDeployment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, instanceSpecification,
						UMLPackage.eINSTANCE.getDeployment(), moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = classifierToRemoveFromClassifier.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, instanceSpecification, UMLPackage.eINSTANCE
						.getInstanceSpecification_Classifier(), iter.next()));
			...
			for (Iterator iter = slotToMoveFromSlot.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, instanceSpecification, UMLPackage.eINSTANCE.getSlot(),
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.InstanceSpecification.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, instanceSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.InstanceSpecification.deployment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, instanceSpecification, UMLPackage.eINSTANCE
							.getDeploymentTarget_Deployment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, instanceSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.InstanceSpecification.classifier == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, instanceSpecification, UMLPackage.eINSTANCE
							.getInstanceSpecification_Classifier(), event.getNewValue()));
