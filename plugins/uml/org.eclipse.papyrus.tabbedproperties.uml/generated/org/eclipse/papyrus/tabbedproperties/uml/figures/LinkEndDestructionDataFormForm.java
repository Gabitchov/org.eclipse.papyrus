...
/**
 * The LinkEndDestructionDataForm form
 *
 *
 * @generated
 */ 
public class LinkEndDestructionDataFormForm extends AbstractControlsGroup {
	...
	public LinkEndDestructionDataFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isDestroyDuplicates;
    ...
    public void createDirectChildren() {
		//
		isDestroyDuplicates = new LabeledCheckBoxFigure("isDestroyDuplicates", "");
		this.add(isDestroyDuplicates);
     ...
     */
    public LabeledCheckBoxFigure  getIsDestroyDuplicates() {
