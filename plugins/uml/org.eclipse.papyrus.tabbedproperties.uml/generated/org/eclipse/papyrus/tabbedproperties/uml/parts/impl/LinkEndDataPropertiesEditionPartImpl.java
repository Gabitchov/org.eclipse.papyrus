...
public class LinkEndDataPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LinkEndDataPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LinkEndDataPropertiesEditionPartImpl.this, UMLViewsRepository.LinkEndData.ownedComment,
	...
	private void moveQualifier(QualifierValue element, int oldIndex, int newIndex) {
		...
		qualifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LinkEndDataPropertiesEditionPartImpl.this, UMLViewsRepository.LinkEndData.qualifier, PropertiesEditionEvent.COMMIT,
	...
	private void addToQualifier() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				qualifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LinkEndDataPropertiesEditionPartImpl.this, UMLViewsRepository.LinkEndData.qualifier,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromQualifier(QualifierValue element) {
		...
		qualifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LinkEndDataPropertiesEditionPartImpl.this, UMLViewsRepository.LinkEndData.qualifier, PropertiesEditionEvent.CHANGE,
