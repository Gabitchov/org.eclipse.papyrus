...
public class ParameterBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Parameter.isOrdered || key == UMLViewsRepository.Parameter.isUnique || key == UMLViewsRepository.Parameter.direction
				|| key == UMLViewsRepository.Parameter.isException || key == UMLViewsRepository.Parameter.isStream;
	}
