...
public class TriggerPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, TriggerPropertiesEditionPart {
	...
	protected ReferencesTable<? extends EObject> port;
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TriggerPropertiesEditionPartForm.this, UMLViewsRepository.Trigger.ownedComment,
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TriggerPropertiesEditionPartForm.this, UMLViewsRepository.Trigger.clientDependency,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void removeFromPort(Port element) {
		...
		port.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TriggerPropertiesEditionPartForm.this, UMLViewsRepository.Trigger.port, PropertiesEditionEvent.COMMIT,
	...
	protected void editPort(Port element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				port.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TriggerPropertiesEditionPartForm.this, UMLViewsRepository.Trigger.port,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement,
						propertiesEditionObject));
			}
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TriggerPropertiesEditionPart#isContainedInOwnedCommentTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TriggerPropertiesEditionPart#isContainedInClientDependencyTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.TriggerPropertiesEditionPart#isContainedInPortTable(EObject element)
	 */
	public boolean isContainedInPortTable(EObject element) {
		return portEditUtil.contains(element);
	}
