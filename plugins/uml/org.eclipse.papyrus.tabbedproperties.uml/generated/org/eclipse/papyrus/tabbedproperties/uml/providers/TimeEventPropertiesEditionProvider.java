...
import org.eclipse.papyrus.tabbedproperties.uml.components.TimeEventBasePropertiesEditionComponent;
import org.eclipse.papyrus.tabbedproperties.uml.components.TimeEventPropertiesEditionComponent;
 ...
 */
public class TimeEventPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof TimeEvent) && (UMLPackage.eINSTANCE.getTimeEvent() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof TimeEvent) {
			return new TimeEventPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof TimeEvent) {
			if (TimeEventBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new TimeEventBasePropertiesEditionComponent(eObject, mode);
