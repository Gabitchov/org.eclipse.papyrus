...
public interface StereotypePropertiesEditionPart {
	...
	/**
	 * @return the icon to add
	 */
	public List getIconToAdd();

	/**
	 * @return the icon to remove
	 */
	public List getIconToRemove();

	/**
	 * @return the icon to move
	 */
	public List getIconToMove();

	/**
	 * @return the icon to edit
	 */
	public Map getIconToEdit();

	/**
	 * @return the current icon table
	 */
	...
	/**
	 * Update the icon
	 * @param newValue the icon to update
	 */
	public void updateIcon(EObject newValue);

	/**
	 * Adds the given filter to the icon edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the icon table
	 */
