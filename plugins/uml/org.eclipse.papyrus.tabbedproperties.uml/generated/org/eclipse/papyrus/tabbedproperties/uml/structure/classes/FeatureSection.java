...
import org.eclipse.papyrus.tabbedproperties.uml.figures.FeatureFormForm;
...
/**
 * The Feature property section for the Feature element
 * 
 * A feature declares a behavioral or structural characteristic of instances of classifiers.
 *
 * @generated
 */
public class FeatureSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private FeatureFormForm featureForm;
	...
	public PropertyEditor createFigure() {
		featureForm = new FeatureFormForm("Feature Specifications","A feature declares a behavioral or structural characteristic of instances of classifiers.");
		return featureForm;
	}
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isStatic of Feature
		BooleanPropertyChangeListener isStaticListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,featureElement, UMLPackage.eINSTANCE.getFeature_IsStatic(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		featureForm.getIsStatic().setPropertyChangeListener(isStaticListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						featureForm.getIsStatic().setValue(featureElement.isStatic());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.featureElement = (Feature)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Feature;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		featureElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		featureElement.eAdapters().remove(modelListener);
