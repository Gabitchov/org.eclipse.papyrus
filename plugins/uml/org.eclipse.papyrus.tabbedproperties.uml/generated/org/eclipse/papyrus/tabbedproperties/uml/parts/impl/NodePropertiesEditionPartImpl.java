...
public class NodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, NodePropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedComment, PropertiesEditionEvent.COMMIT,
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedComment, PropertiesEditionEvent.CHANGE,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.name, PropertiesEditionEvent.CHANGE,
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.clientDependency, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.elementImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.elementImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.packageImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.packageImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedRule, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedRule, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.templateBinding, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.templateBinding, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.generalization, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToGeneralization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.generalization, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.powertypeExtent, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void removeFromRedefinedClassifier(Classifier element) {
		...
		redefinedClassifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.redefinedClassifier, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.substitution, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToSubstitution() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.substitution, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.collaborationUse, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToCollaborationUse() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.collaborationUse,
	...
	private void removeFromCollaborationUse(CollaborationUse element) {
		...
		collaborationUse.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.collaborationUse, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedUseCase, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedUseCase() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedUseCase, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.useCase, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void moveOwnedAttribute(Property element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedAttribute, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedAttribute() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedAttribute.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedAttribute, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedConnector(Connector element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedConnector, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedConnector() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedConnector.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedConnector, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedBehavior(Behavior element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedBehavior, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveInterfaceRealization(InterfaceRealization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.interfaceRealization, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToInterfaceRealization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interfaceRealization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.interfaceRealization,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromInterfaceRealization(InterfaceRealization element) {
		...
		interfaceRealization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.interfaceRealization, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveOwnedTrigger(Trigger element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedTrigger, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedTrigger() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedTrigger, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromNestedClassifier(Classifier element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.nestedClassifier, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editNestedClassifier(Classifier element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				nestedClassifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.nestedClassifier,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedOperation(Operation element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedOperation, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedOperation() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedOperation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedOperation, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedReception(Reception element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedReception, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedReception() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedReception.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.ownedReception, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveDeployment(Deployment element, int oldIndex, int newIndex) {
		...
		deployment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.deployment, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToDeployment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				deployment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.deployment, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveNestedNode(Node element, int oldIndex, int newIndex) {
		...
		nestedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.nestedNode, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToNestedNode() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				nestedNode.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(NodePropertiesEditionPartImpl.this, UMLViewsRepository.Node.nestedNode, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
