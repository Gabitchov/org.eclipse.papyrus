...
public class CollaborationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public CollaborationBasePropertiesEditionComponent(EObject collaboration, String mode) {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (collaboration != null) {
			...
			List collaborationRoleToAdd = basePart.getCollaborationRoleToAdd();
			for (Iterator iter = collaborationRoleToAdd.iterator(); iter.hasNext();)
			...
			List collaborationRoleToRemove = basePart.getCollaborationRoleToRemove();
			for (Iterator iter = collaborationRoleToRemove.iterator(); iter.hasNext();)
			...
			//List collaborationRoleToMove = basePart.getCollaborationRoleToMove();
			//for (Iterator iter = collaborationRoleToMove.iterator(); iter.hasNext();){
			//	MoveElement moveElement = (MoveElement)iter.next();
	...
	public String getHelpContent(String key, int kind) {
			...
			if (key == UMLViewsRepository.Collaboration.collaborationRole)
				return "References connectable elements (possibly owned by other classifiers) which represent roles that instances may play in this collaboration."; //$NON-NLS-1$
