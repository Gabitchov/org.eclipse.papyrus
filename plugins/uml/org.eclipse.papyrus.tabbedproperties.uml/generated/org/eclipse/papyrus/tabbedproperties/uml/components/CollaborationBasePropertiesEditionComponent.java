...
public class CollaborationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (collaboration != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (CollaborationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Collaboration.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Collaboration.class) {
			...
			Collaboration collaboration = (Collaboration) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), collaboration
					.getVisibility());
			...
			basePart.initTemplateBinding(collaboration, null, UMLPackage.eINSTANCE
			...
			basePart.initRedefinedClassifier(collaboration, null, UMLPackage.eINSTANCE
			...
			basePart.initOwnedBehavior(collaboration, null, UMLPackage.eINSTANCE
					.getBehavioredClassifier_OwnedBehavior());
			basePart.initInterfaceRealization(collaboration, null, UMLPackage.eINSTANCE
			...
			basePart.initOwnedAttribute(collaboration, null, UMLPackage.eINSTANCE
					.getStructuredClassifier_OwnedAttribute());
			basePart.initOwnedConnector(collaboration, null, UMLPackage.eINSTANCE
					.getStructuredClassifier_OwnedConnector());
			basePart.initCollaborationRole(collaboration, null, UMLPackage.eINSTANCE
			...
			basePart.addFilterToCollaborationRole(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getCollaborationRoleTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (collaboration != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, collaboration,
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, collaboration,
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getElementImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToAddFromOwnedRule.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, collaboration,
						UMLPackage.eINSTANCE.getNamespace_OwnedRule(), iter.next()));
			...
			for (Iterator iter = ownedRuleToMoveFromOwnedRule.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE
			...
			for (Iterator iter = templateBindingToMoveFromTemplateBinding.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getTemplateBinding(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getClassifier_IsAbstract(),
			...
			for (Iterator iter = generalizationToMoveFromGeneralization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getGeneralization(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = substitutionToMoveFromSubstitution.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getSubstitution(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = collaborationUseToMoveFromCollaborationUse.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getCollaborationUse(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedUseCaseToMoveFromOwnedUseCase.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getUseCase(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			List useCaseToAddFromUseCase = basePart.getUseCaseToAdd();
			for (Iterator iter = useCaseToAddFromUseCase.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getClassifier_UseCase(),
						iter.next()));
			...
			for (Iterator iter = ownedBehaviorToMoveFromOwnedBehavior.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getBehavior(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = interfaceRealizationToMoveFromInterfaceRealization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedTriggerToMoveFromOwnedTrigger.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getTrigger(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedAttributeToMoveFromOwnedAttribute.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getProperty(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedConnectorToMoveFromOwnedConnector.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE.getConnector(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = collaborationRoleToAddFromCollaborationRole.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE
						.getCollaboration_CollaborationRole(), iter.next()));
			...
			for (Iterator iter = collaborationRoleToRemoveFromCollaborationRole.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, collaboration, UMLPackage.eINSTANCE
						.getCollaboration_CollaborationRole(), iter.next()));
			// List collaborationRoleToMoveFromCollaborationRole =
			// basePart.getCollaborationRoleToMove();
			// for (Iterator iter = collaborationRoleToMoveFromCollaborationRole.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, collaboration,
			// UMLPackage.eINSTANCE.getConnectableElement(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Collaboration.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Collaboration.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Collaboration.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.Collaboration.collaborationRole == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
							.getCollaboration_CollaborationRole(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
							.getCollaboration_CollaborationRole(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, collaboration, UMLPackage.eINSTANCE
							.getCollaboration_CollaborationRole(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.Collaboration.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.elementImport)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.packageImport)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.ownedRule)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.templateBinding)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.isAbstract)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.generalization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.powertypeExtent)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.redefinedClassifier)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.substitution)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.collaborationUse)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.ownedUseCase)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.useCase)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.ownedBehavior)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.interfaceRealization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.ownedTrigger)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.ownedAttribute)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.ownedConnector)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Collaboration.collaborationRole)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(collaboration);
		else
			return null;
	}
