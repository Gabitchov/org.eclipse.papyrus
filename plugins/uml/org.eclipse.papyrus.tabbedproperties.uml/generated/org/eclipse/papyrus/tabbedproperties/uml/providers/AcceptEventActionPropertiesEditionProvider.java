...
import org.eclipse.papyrus.tabbedproperties.uml.components.AcceptEventActionBasePropertiesEditionComponent;
import org.eclipse.papyrus.tabbedproperties.uml.components.AcceptEventActionPropertiesEditionComponent;
 ...
 */
public class AcceptEventActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof AcceptEventAction) && (UMLPackage.eINSTANCE.getAcceptEventAction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof AcceptEventAction) {
			return new AcceptEventActionPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof AcceptEventAction) {
			if (AcceptEventActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new AcceptEventActionBasePropertiesEditionComponent(eObject, editing_mode);
