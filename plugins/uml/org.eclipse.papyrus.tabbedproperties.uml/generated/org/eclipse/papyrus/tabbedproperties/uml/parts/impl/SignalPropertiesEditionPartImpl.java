...
public class SignalPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SignalPropertiesEditionPart {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.name, PropertiesEditionEvent.CHANGE,
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.SignalPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.Signal.visibility,
	...
	private void moveOwnedAttribute(Property element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedAttribute, PropertiesEditionEvent.COMMIT,
	...
	private void addToOwnedAttribute() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedAttribute.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedAttribute,
	...
	private void removeFromOwnedAttribute(Property element) {
		...
		ownedAttribute.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedAttribute, PropertiesEditionEvent.CHANGE,
	...
	private void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.useCase, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedUseCase, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedUseCase() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedUseCase,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedUseCase(UseCase element) {
		...
		ownedUseCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedUseCase, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.collaborationUse, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToCollaborationUse() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.collaborationUse,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromCollaborationUse(CollaborationUse element) {
		...
		collaborationUse.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.collaborationUse, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.substitution, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToSubstitution() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.substitution,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromSubstitution(Substitution element) {
		...
		substitution.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.substitution, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void removeFromRedefinedClassifier(Classifier element) {
		...
		redefinedClassifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.redefinedClassifier, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.powertypeExtent, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.templateBinding, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.templateBinding,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromTemplateBinding(TemplateBinding element) {
		...
		templateBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.templateBinding, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.generalization, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToGeneralization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.generalization,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromGeneralization(Generalization element) {
		...
		generalization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.generalization, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedRule, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.ownedRule, PropertiesEditionEvent.CHANGE,
	...
	private void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.packageImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.packageImport,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromPackageImport(PackageImport element) {
		...
		packageImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.packageImport, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.elementImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.elementImport,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromElementImport(ElementImport element) {
		...
		elementImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SignalPropertiesEditionPartImpl.this, UMLViewsRepository.Signal.elementImport, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
