...
public class ClassifierTemplateParameterPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ClassifierTemplateParameter) {
			return new ClassifierTemplateParameterPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ClassifierTemplateParameter) {
			if (ClassifierTemplateParameterBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ClassifierTemplateParameterBasePropertiesEditionComponent(eObject, mode);
