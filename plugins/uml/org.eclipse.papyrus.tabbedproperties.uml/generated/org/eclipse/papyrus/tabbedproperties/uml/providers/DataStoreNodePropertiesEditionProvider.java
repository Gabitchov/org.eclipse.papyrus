...
import org.eclipse.papyrus.tabbedproperties.uml.components.DataStoreNodePropertiesEditionComponent;
 ...
 */
public class DataStoreNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof DataStoreNode) && (UMLPackage.eINSTANCE.getDataStoreNode() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof DataStoreNode) {
			return new DataStoreNodePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof DataStoreNode) {
			if (DataStoreNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new DataStoreNodeBasePropertiesEditionComponent(eObject, mode);
