...
public class MessageOccurrenceSpecificationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, MessageOccurrenceSpecificationPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.clientDependency,
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
				...
				"Lifeline", UMLPackage.eINSTANCE.getLifeline()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.covered,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						covered.refresh();											
					}
	...
	private void moveCovered(Lifeline element, int oldIndex, int newIndex) {
		...
		covered.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.covered, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromCovered(Lifeline element) {
		...
		covered.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.covered, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editCovered(Lifeline element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				covered.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.covered, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveGeneralOrdering(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.generalOrdering, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromGeneralOrdering(GeneralOrdering element) {
		...
		generalOrdering.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.generalOrdering, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
				...
				"GeneralOrdering", UMLPackage.eINSTANCE.getGeneralOrdering()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toBefore,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						toBefore.refresh();											
					}
	...
	private void moveToBefore(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		toBefore.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toBefore, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromToBefore(GeneralOrdering element) {
		...
		toBefore.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toBefore, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editToBefore(GeneralOrdering element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				toBefore.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toBefore, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"GeneralOrdering", UMLPackage.eINSTANCE.getGeneralOrdering()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toAfter,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						toAfter.refresh();											
					}
	...
	private void moveToAfter(GeneralOrdering element, int oldIndex, int newIndex) {
		...
		toAfter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toAfter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromToAfter(GeneralOrdering element) {
		...
		toAfter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toAfter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editToAfter(GeneralOrdering element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				toAfter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(MessageOccurrenceSpecificationPropertiesEditionPartImpl.this, UMLViewsRepository.MessageOccurrenceSpecification.toAfter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
