...
public class OperationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, OperationPropertiesEditionPart {
	...
	private EMFEnumViewer concurrency;
	...
	private ReferencesTable<?> raisedException;
	private EMFListEditUtil methodEditUtil;
	private ReferencesTable<?> method;
	...
	private ReferencesTable<?> redefinedOperation;
	...
	protected void createGeneralGroup(FormToolkit widgetFactory, final Composite view) {
		...
		createConcurrencyEEnumViewer(widgetFactory, generalGroup);
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.visibility, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getVisibility()));
			}
	...
	protected void createConcurrencyEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		...
		concurrency = new EMFEnumViewer(parent);
		...
		concurrency.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.concurrency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getConcurrency()));
			}
		...
		isAbstract = widgetFactory.createButton(parent, UMLMessages.OperationPropertiesEditionPart_IsAbstractLabel, SWT.CHECK);
   		isAbstract.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.isAbstract, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isAbstract.getSelection())));
			}
	...
	protected void createIsStaticCheckbox(FormToolkit widgetFactory, Composite parent) {
		isStatic = widgetFactory.createButton(parent, UMLMessages.OperationPropertiesEditionPart_IsStaticLabel, SWT.CHECK);
   		isStatic.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.isStatic, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isStatic.getSelection())));
			}
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, UMLMessages.OperationPropertiesEditionPart_IsLeafLabel, SWT.CHECK);
   		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.isLeaf, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isLeaf.getSelection())));
			}
	...
	protected void createIsQueryCheckbox(FormToolkit widgetFactory, Composite parent) {
		isQuery = widgetFactory.createButton(parent, UMLMessages.OperationPropertiesEditionPart_IsQueryLabel, SWT.CHECK);
   		isQuery.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.isQuery, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isQuery.getSelection())));
			}
	...
	protected void moveOwnedParameter(Parameter element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedParameter() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedParameter(Parameter element) {
		...
		ownedParameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedParameter(Parameter element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createRaisedExceptionReferencesTable(FormToolkit widgetFactory, Composite parent) {	
		this.raisedException = new ReferencesTable<Type>(UMLMessages.OperationPropertiesEditionPart_RaisedExceptionLabel, new ReferencesTableListener<Type>() {
			public void handleAdd() {				
				ViewerFilter raisedExceptionFilter = new EObjectFilter(UMLPackage.eINSTANCE.getType());
				ViewerFilter viewerFilter = new ViewerFilter() {					
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						if (element instanceof EObject)
							return (!raisedExceptionEditUtil.contains((EObject)element));
						return false;				
					}
				};				
				ViewerFilter[] filters = { raisedExceptionFilter, viewerFilter };		
				TabElementTreeSelectionDialog<Type> dialog = new TabElementTreeSelectionDialog<Type>(resourceSet, filters, 
				"Type", UMLPackage.eINSTANCE.getType()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.raisedException,
	...
	protected void removeFromRaisedException(Type element) {
		...
		raisedException.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.raisedException, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRaisedException(Type element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				raisedException.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.raisedException, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createMethodReferencesTable(FormToolkit widgetFactory, Composite parent) {	
		this.method = new ReferencesTable<Behavior>(UMLMessages.OperationPropertiesEditionPart_MethodLabel, new ReferencesTableListener<Behavior>() {
			public void handleAdd() {				
				ViewerFilter methodFilter = new EObjectFilter(UMLPackage.eINSTANCE.getBehavior());
				ViewerFilter viewerFilter = new ViewerFilter() {					
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						if (element instanceof EObject)
							return (!methodEditUtil.contains((EObject)element));
						return false;				
					}
				};				
				ViewerFilter[] filters = { methodFilter, viewerFilter };		
				...
				"Behavior", UMLPackage.eINSTANCE.getBehavior()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.method,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						method.refresh();												
					}
	...
	protected void removeFromMethod(Behavior element) {
		...
		method.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.method, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editMethod(Behavior element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				method.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.method, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromTemplateBinding(TemplateBinding element) {
		...
		templateBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editTemplateBinding(TemplateBinding element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedParameterSet(ParameterSet element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedParameterSet() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameterSet.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedParameterSet(ParameterSet element) {
		...
		ownedParameterSet.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedParameterSet(ParameterSet element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameterSet.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Constraint", UMLPackage.eINSTANCE.getConstraint()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.precondition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void movePrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		precondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromPrecondition(Constraint element) {
		...
		precondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				precondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Constraint", UMLPackage.eINSTANCE.getConstraint()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.postcondition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void movePostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		postcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromPostcondition(Constraint element) {
		...
		postcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				postcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createRedefinedOperationReferencesTable(FormToolkit widgetFactory, Composite parent) {	
		this.redefinedOperation = new ReferencesTable<Operation>(UMLMessages.OperationPropertiesEditionPart_RedefinedOperationLabel, new ReferencesTableListener<Operation>() {
			public void handleAdd() {				
				ViewerFilter redefinedOperationFilter = new EObjectFilter(UMLPackage.eINSTANCE.getOperation());
				ViewerFilter viewerFilter = new ViewerFilter() {					
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						if (element instanceof EObject)
							return (!redefinedOperationEditUtil.contains((EObject)element));
						return false;				
					}
				};				
				ViewerFilter[] filters = { redefinedOperationFilter, viewerFilter };		
				TabElementTreeSelectionDialog<Operation> dialog = new TabElementTreeSelectionDialog<Operation>(resourceSet, filters, 
				"Operation", UMLPackage.eINSTANCE.getOperation()) {
					@Override
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							EObject elem = (EObject) iter.next();
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.redefinedOperation,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
			...
			public void handleEdit(Operation element) { editRedefinedOperation(element); }
			public void handleMove(Operation element, int oldIndex, int newIndex) { moveRedefinedOperation(element, oldIndex, newIndex); }
			public void handleRemove(Operation element) { removeFromRedefinedOperation(element); }
	...
	protected void moveRedefinedOperation(Operation element, int oldIndex, int newIndex) {
		...
		redefinedOperation.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.redefinedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromRedefinedOperation(Operation element) {
		...
		redefinedOperation.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.redefinedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRedefinedOperation(Operation element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedOperation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.redefinedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedRule(Constraint element) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedRule(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromPackageImport(PackageImport element) {
		...
		packageImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPackageImport(PackageImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromElementImport(ElementImport element) {
		...
		elementImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editElementImport(ElementImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(OperationPropertiesEditionPartForm.this, UMLViewsRepository.Operation.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
...
/**
	...
	public void initConcurrency(EEnum eenum, Enumerator current) {
		...
		concurrency.setSelection(new StructuredSelection(current));
	}
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initOwnedParameter(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initRaisedException(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initMethod(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initTemplateBinding(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initOwnedParameterSet(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initPrecondition(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initPostcondition(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initRedefinedOperation(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initOwnedRule(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initPackageImport(EObject current, EReference containingFeature, EReference feature)
	 */
...
/**
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.OperationPropertiesEditionPart#initElementImport(EObject current, EReference containingFeature, EReference feature)
	 */
