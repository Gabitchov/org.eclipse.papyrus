...
public class BehaviorExecutionSpecificationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public BehaviorExecutionSpecificationBasePropertiesEditionComponent(EObject behaviorExecutionSpecification,
			String editing_mode) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (behaviorExecutionSpecification != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (BehaviorExecutionSpecificationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.BehaviorExecutionSpecification.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.BehaviorExecutionSpecification.class) {
			...
			// init values
			basePart.initOwnedComment(behaviorExecutionSpecification, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					behaviorExecutionSpecification.getVisibility());
			basePart.initClientDependency(behaviorExecutionSpecification, null, UMLPackage.eINSTANCE
					.getNamedElement_ClientDependency());
			basePart.initCovered(behaviorExecutionSpecification, null, UMLPackage.eINSTANCE
					.getInteractionFragment_Covered());
			basePart.initGeneralOrdering(behaviorExecutionSpecification, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (behaviorExecutionSpecification != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, behaviorExecutionSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, behaviorExecutionSpecification, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, behaviorExecutionSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, behaviorExecutionSpecification, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, behaviorExecutionSpecification,
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.BehaviorExecutionSpecification.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, behaviorExecutionSpecification,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, behaviorExecutionSpecification,
			...
			if (UMLViewsRepository.BehaviorExecutionSpecification.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, behaviorExecutionSpecification,
			...
			if (UMLViewsRepository.BehaviorExecutionSpecification.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, behaviorExecutionSpecification,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
