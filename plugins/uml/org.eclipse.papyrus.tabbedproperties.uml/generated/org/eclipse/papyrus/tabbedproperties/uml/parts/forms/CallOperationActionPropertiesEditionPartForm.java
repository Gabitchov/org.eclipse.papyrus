 ...
 */
public class CallOperationActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, CallOperationActionPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.CallOperationActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CallOperationActionPropertiesEditionPartForm.this,
							UMLViewsRepository.CallOperationAction.name, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$

	}

	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.CallOperationActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent
						.isRequired(UMLViewsRepository.CallOperationAction.visibility, UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CallOperationActionPropertiesEditionPartForm.this,
							UMLViewsRepository.CallOperationAction.visibility, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent, UMLMessages.CallOperationActionPropertiesEditionPart_IsLeafLabel,
				SWT.CHECK);
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CallOperationActionPropertiesEditionPartForm.this,
							UMLViewsRepository.CallOperationAction.isLeaf, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.outgoing, UMLViewsRepository.FORM_KIND));
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.incoming, UMLViewsRepository.FORM_KIND));
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.inPartition, UMLViewsRepository.FORM_KIND));
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.inInterruptibleRegion, UMLViewsRepository.FORM_KIND));
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void createHandlerTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.handler, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPreconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.localPrecondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPostconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.localPostcondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createArgumentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.argument.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.argument, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsSynchronousCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronous = widgetFactory.createButton(parent,
				UMLMessages.CallOperationActionPropertiesEditionPart_IsSynchronousLabel, SWT.CHECK);
		isSynchronous.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CallOperationActionPropertiesEditionPartForm.this,
							UMLViewsRepository.CallOperationAction.isSynchronous, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.isSynchronous, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createResultTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.result.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CallOperationAction.result, UMLViewsRepository.FORM_KIND));
