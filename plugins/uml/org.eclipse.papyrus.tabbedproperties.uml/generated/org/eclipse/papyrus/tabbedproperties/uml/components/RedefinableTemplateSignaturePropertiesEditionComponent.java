...
public class RedefinableTemplateSignaturePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 *            the EObject to edit
	 */
	public RedefinableTemplateSignaturePropertiesEditionComponent(EObject redefinableTemplateSignature,
			String editing_mode) {
		super(editing_mode);
		if (redefinableTemplateSignature instanceof RedefinableTemplateSignature) {
			redefinableTemplateSignatureBasePropertiesEditionComponent = new RedefinableTemplateSignatureBasePropertiesEditionComponent(
					redefinableTemplateSignature, editing_mode);
			addSubComponent(redefinableTemplateSignatureBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(redefinableTemplateSignature,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (RedefinableTemplateSignaturePropertiesEditionPart) redefinableTemplateSignatureBasePropertiesEditionComponent
