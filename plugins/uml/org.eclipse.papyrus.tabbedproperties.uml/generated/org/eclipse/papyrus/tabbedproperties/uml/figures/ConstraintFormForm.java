...
/**
 * The ConstraintForm form
 *
 *
 * @generated
 */ 
public class ConstraintFormForm extends AbstractControlsGroup {
	...
	public ConstraintFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected AdvancedReferencedTable constrainedElement;

	protected AdvancedReferencedEForm specification;
    ...
    public void createDirectChildren() {
		...
		constrainedElement = new AdvancedReferencedTable("ConstrainedElement",new org.eclipse.papyrus.tabbedproperties.core.filters.NamedElementFilter(),backContext);
		hbox.add(constrainedElement);
		specification = new AdvancedReferencedEForm("Specification",new org.eclipse.papyrus.tabbedproperties.core.filters.NamedElementFilter(),backContext);
		hbox.add(specification);
...
/**
     ...
     */
    public AdvancedReferencedTable getConstrainedElement() {
 ...
 /**
     ...
     */
    public AdvancedReferencedEForm getSpecification() {
