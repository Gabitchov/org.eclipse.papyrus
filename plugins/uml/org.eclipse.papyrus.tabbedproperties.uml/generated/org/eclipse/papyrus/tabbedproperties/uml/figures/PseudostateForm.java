...
/**
 * The Pseudostate form
 *
 *
 * @generated
 */
public class PseudostateForm extends LabeledPropertyEditor {

	protected ComboList pseudoStatekindForm;
	...
	/**
	 * Creates a new PseudostateForm.
	 * @param label the label of the editor
	 * @generated 
	 */
    public PseudostateForm(String label, String description) {
    ...
    public ControlWrapper createRightEditor(Composite parent, TabbedPropertySheetPage aTabbedPropertySheetPage) {
		// Start of user code to define combo description for pseudoStatekindForm form
				//TODO: define combo description here
				Object comboDescPseudoStatekindForm[] = {
				...
				//End of user code to define combo description for pseudoStatekindForm form

				pseudoStatekindForm = new ComboList(comboDescPseudoStatekindForm);
			 	
		return pseudoStatekindForm;
    }
    ...
    public void setPropertyChangeListener(PropertyChangeListener listener) {
    	...
    	if (pseudoStatekindForm != null)
    	    pseudoStatekindForm.setPropertyChangeListener(listener);
    }
    ...
    public void setValue(Object value) {
		if (pseudoStatekindForm != null) {
			pseudoStatekindForm.setSelected(value);
		}
    }

    /**
     * @return the pseudoStatekindForm
     */
    public ComboList getPseudoStatekindForm() {
        return pseudoStatekindForm;
    }
}