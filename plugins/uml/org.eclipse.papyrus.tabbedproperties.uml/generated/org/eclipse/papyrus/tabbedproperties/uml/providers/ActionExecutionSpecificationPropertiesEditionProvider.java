...
public class ActionExecutionSpecificationPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ActionExecutionSpecification) {
			return new ActionExecutionSpecificationPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ActionExecutionSpecification) {
			if (ActionExecutionSpecificationBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ActionExecutionSpecificationBasePropertiesEditionComponent(eObject, mode);
