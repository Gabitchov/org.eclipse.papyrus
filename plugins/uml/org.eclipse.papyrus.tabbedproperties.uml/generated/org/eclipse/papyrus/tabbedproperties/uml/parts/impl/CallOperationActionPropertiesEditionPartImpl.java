...
public class CallOperationActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CallOperationActionPropertiesEditionPart {
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOutgoing(ActivityEdge element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				outgoing.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editIncoming(ActivityEdge element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				incoming.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromInPartition(ActivityPartition element) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editInPartition(ActivityPartition element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				inPartition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				inInterruptibleRegion.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.redefinedNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editRedefinedNode(ActivityNode element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedNode.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.redefinedNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void addToHandler() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.handler, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromHandler(ExceptionHandler element) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.handler, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editHandler(ExceptionHandler element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.handler, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void addToLocalPrecondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromLocalPrecondition(Constraint element) {
		...
		localPrecondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editLocalPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void addToLocalPostcondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromLocalPostcondition(Constraint element) {
		...
		localPostcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editLocalPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void addToArgument() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				argument.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.argument, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromArgument(InputPin element) {
		...
		argument.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.argument, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editArgument(InputPin element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				argument.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.argument, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void addToResult() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				result.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.result, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromResult(OutputPin element) {
		...
		result.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.result, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editResult(OutputPin element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				result.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CallOperationActionPropertiesEditionPartImpl.this, UMLViewsRepository.CallOperationAction.result, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CallOperationActionPropertiesEditionPart#addBusinessFilterClientDependency(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CallOperationActionPropertiesEditionPart#addFilterInInterruptibleRegion(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CallOperationActionPropertiesEditionPart#addBusinessFilterInInterruptibleRegion(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CallOperationActionPropertiesEditionPart#addBusinessFilterRedefinedNode(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CallOperationActionPropertiesEditionPart#addBusinessFilterLocalPrecondition(ViewerFilter filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.CallOperationActionPropertiesEditionPart#addBusinessFilterLocalPostcondition(ViewerFilter filter)
	 */
