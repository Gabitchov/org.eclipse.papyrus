...
/**
 * The AddVariableValueActionForm form
 *
 *
 * @generated
 */ 
public class AddVariableValueActionFormForm extends AbstractControlsGroup {
	...
	public AddVariableValueActionFormForm(String label, String description){
		this.label=label;
