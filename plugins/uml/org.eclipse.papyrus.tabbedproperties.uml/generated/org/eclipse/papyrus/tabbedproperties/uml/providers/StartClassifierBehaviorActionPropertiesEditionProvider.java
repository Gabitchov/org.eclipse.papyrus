...
public class StartClassifierBehaviorActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof StartClassifierBehaviorAction) {
			return new StartClassifierBehaviorActionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof StartClassifierBehaviorAction) {
			if (StartClassifierBehaviorActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new StartClassifierBehaviorActionBasePropertiesEditionComponent(eObject, mode);
