...
public class InterruptibleActivityRegionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, InterruptibleActivityRegionPropertiesEditionPart {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createInterruptingEdgeReferencesTable(propertiesGroup);
   	}
	/**
	 * @param container
	 */
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"ActivityNode", UMLPackage.eINSTANCE.getActivityNode()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.node,
	...
	private void removeFromNode(ActivityNode element) {
		...
		node.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.node, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editNode(ActivityNode element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				node.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.node, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}

		// End of user code
	}
	protected void createInterruptingEdgeReferencesTable(Composite parent) {
				...
				"ActivityEdge", UMLPackage.eINSTANCE.getActivityEdge()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.interruptingEdge,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	...
	private void removeFromInterruptingEdge(ActivityEdge element) {
		...
		interruptingEdge.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.interruptingEdge, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editInterruptingEdge(ActivityEdge element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interruptingEdge.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(InterruptibleActivityRegionPropertiesEditionPartImpl.this, UMLViewsRepository.InterruptibleActivityRegion.interruptingEdge, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
