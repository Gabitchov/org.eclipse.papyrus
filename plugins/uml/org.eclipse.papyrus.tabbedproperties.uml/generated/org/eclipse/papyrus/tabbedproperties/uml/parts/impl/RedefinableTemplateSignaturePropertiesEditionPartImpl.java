...
public class RedefinableTemplateSignaturePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RedefinableTemplateSignaturePropertiesEditionPart {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createGeneralHBox1HBox(Composite parent) {	
		...
		//create sub figures
				createParameterReferencesTable(generalHBox1HBox);
				createOwnedParameterTableComposition(generalHBox1HBox);
				createExtendedSignatureReferencesTable(generalHBox1HBox);
				...
				"TemplateParameter", UMLPackage.eINSTANCE.getTemplateParameter()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.parameter,
	...
	private void moveParameter(TemplateParameter element, int oldIndex, int newIndex) {
		...
		parameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.parameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromParameter(TemplateParameter element) {
		...
		parameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.parameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void moveOwnedParameter(TemplateParameter element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromOwnedParameter(TemplateParameter element) {
		...
		ownedParameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.ownedParameter, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createExtendedSignatureReferencesTable(Composite parent) {
				...
				"RedefinableTemplateSignature", UMLPackage.eINSTANCE.getRedefinableTemplateSignature()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.extendedSignature,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
	 ...
	 * 
	 */
	private void moveExtendedSignature(RedefinableTemplateSignature element, int oldIndex, int newIndex) {
		...
		extendedSignature.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.extendedSignature, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	 ...
	 * 
	 */
	private void removeFromExtendedSignature(RedefinableTemplateSignature element) {
		...
		extendedSignature.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(RedefinableTemplateSignaturePropertiesEditionPartImpl.this, UMLViewsRepository.RedefinableTemplateSignature.extendedSignature, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	 ...
	 * 
	 */
	private void editExtendedSignature(RedefinableTemplateSignature element) {
