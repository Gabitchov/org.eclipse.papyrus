...
import org.eclipse.papyrus.tabbedproperties.uml.components.ClearVariableActionPropertiesEditionComponent;
 ...
 */
public class ClearVariableActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof ClearVariableAction) && (UMLPackage.eINSTANCE.getClearVariableAction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof ClearVariableAction) {
			return new ClearVariableActionPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof ClearVariableAction) {
			if (ClearVariableActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ClearVariableActionBasePropertiesEditionComponent(eObject, editing_mode);
