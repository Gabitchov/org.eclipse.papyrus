...
public class AcceptCallActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof AcceptCallAction) && (UMLPackage.eINSTANCE.getAcceptCallAction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof AcceptCallAction) {
			return new AcceptCallActionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof AcceptCallAction) {
			if (AcceptCallActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new AcceptCallActionBasePropertiesEditionComponent(eObject, mode);
