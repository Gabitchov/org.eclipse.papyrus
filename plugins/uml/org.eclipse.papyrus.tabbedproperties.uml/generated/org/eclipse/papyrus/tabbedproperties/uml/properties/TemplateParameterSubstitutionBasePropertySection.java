...
public class TemplateParameterSubstitutionBasePropertySection extends AbstractPropertySection implements IFilter {
		...
		if (editingDomain != null && newEObject != null && newEObject != eObject) {
			...
			if (eObject != null) {
				...
				this.propertiesEditionComponent = provider.getPropertiesEditionComponent(eObject,
						...
						TemplateParameterSubstitutionBasePropertiesEditionComponent.BASE_PART);
				if (this.propertiesEditionComponent != null) {
					...
					this.editionPart = propertiesEditionComponent.getPropertiesEditionPart(1,
							TemplateParameterSubstitutionBasePropertiesEditionComponent.BASE_PART); //$NON-NLS-1$
					if (editionPart instanceof IFormPropertiesEditionPart) {
						...
						propertiesEditionComponent.initPart(propertiesEditionComponent
								.translatePart(TemplateParameterSubstitutionBasePropertiesEditionComponent.BASE_PART),
								1, eObject);
					}
				}
			}
	...
	public boolean select(Object toTest) {
		...
		return eObjectToTest != null
				&& eObjectToTest.eClass() == UMLPackage.eINSTANCE.getTemplateParameterSubstitution();
	}
