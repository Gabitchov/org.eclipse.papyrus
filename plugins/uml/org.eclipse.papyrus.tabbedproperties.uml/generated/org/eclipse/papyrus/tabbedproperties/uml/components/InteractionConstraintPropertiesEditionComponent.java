...
public class InteractionConstraintPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public InteractionConstraintPropertiesEditionComponent(EObject interactionConstraint, String editing_mode) {
		...
		if (interactionConstraint instanceof InteractionConstraint) {
			interactionConstraintBasePropertiesEditionComponent = new InteractionConstraintBasePropertiesEditionComponent(
					interactionConstraint, editing_mode);
			addSubComponent(interactionConstraintBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(interactionConstraint,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (InteractionConstraintPropertiesEditionPart) interactionConstraintBasePropertiesEditionComponent
