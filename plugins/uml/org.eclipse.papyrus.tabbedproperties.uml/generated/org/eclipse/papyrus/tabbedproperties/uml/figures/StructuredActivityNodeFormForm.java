...
/**
 * The StructuredActivityNodeForm form
 *
 *
 * @generated
 */ 
public class StructuredActivityNodeFormForm extends AbstractControlsGroup {
	...
	public StructuredActivityNodeFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure mustIsolate;
    ...
    public void createDirectChildren() {
		//
		mustIsolate = new LabeledCheckBoxFigure("mustIsolate", "");
		this.add(mustIsolate);
     ...
     */
    public LabeledCheckBoxFigure  getMustIsolate() {
        return mustIsolate;
    }
