 ...
 */
public class LinkEndDestructionDataPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, LinkEndDestructionDataPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.LinkEndDestructionData.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createQualifierTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.qualifier.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.LinkEndDestructionData.qualifier, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsDestroyDuplicatesCheckbox(FormToolkit widgetFactory, Composite parent) {
		isDestroyDuplicates = widgetFactory.createButton(parent,
				UMLMessages.LinkEndDestructionDataPropertiesEditionPart_IsDestroyDuplicatesLabel, SWT.CHECK);
		isDestroyDuplicates.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							LinkEndDestructionDataPropertiesEditionPartForm.this,
							UMLViewsRepository.LinkEndDestructionData.isDestroyDuplicates,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(
									isDestroyDuplicates.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.LinkEndDestructionData.isDestroyDuplicates, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
