...
public class CollaborationUsePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CollaborationUsePropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.ownedComment,
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CollaborationUsePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.CollaborationUse.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.name,
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CollaborationUsePropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.CollaborationUse.visibility,
				UMLViewsRepository.SWT_KIND));
				...
				TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(resourceSet, filters, "Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this,
	...
	private void moveRoleBinding(Dependency element, int oldIndex, int newIndex) {
		...
		roleBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.roleBinding,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
