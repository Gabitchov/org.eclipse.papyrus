...
public class CollaborationUsePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CollaborationUsePropertiesEditionPart {
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createRoleBindingAdvancedTableComposition(propertiesGroup);
	}
	/**
	 * @param container
	 */
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.ownedComment, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.name, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.clientDependency,
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	 ...
	 * @param container
	 */
	protected void createRoleBindingAdvancedTableComposition(Composite parent) {
	...
	private void moveRoleBinding(Dependency element, int oldIndex, int newIndex) {
		...
		roleBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.roleBinding, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToRoleBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				roleBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.roleBinding, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromRoleBinding(Dependency element) {
		...
		// Start of user code removeFromRoleBinding() method body

		EObject editedElement = roleBindingEditUtil.foundCorrespondingEObject(element);
		roleBindingEditUtil.removeElement(element);
		roleBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.roleBinding, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editRoleBinding(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				roleBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.roleBinding, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
