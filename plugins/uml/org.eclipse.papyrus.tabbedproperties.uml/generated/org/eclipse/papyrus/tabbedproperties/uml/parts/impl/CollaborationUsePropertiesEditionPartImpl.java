...
public class CollaborationUsePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CollaborationUsePropertiesEditionPart {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CollaborationUsePropertiesEditionPartImpl.this,
						UMLViewsRepository.CollaborationUse.ownedComment, PropertiesEditionEvent.CHANGE,
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.ownedComment,
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.clientDependency,
	...
	protected void addToRoleBinding() {
		...
		if(editionPolicy != null) {
			...
			if(propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CollaborationUsePropertiesEditionPartImpl.this,
						UMLViewsRepository.CollaborationUse.roleBinding, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromRoleBinding(Dependency element) {
		...
		roleBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CollaborationUsePropertiesEditionPartImpl.this, UMLViewsRepository.CollaborationUse.roleBinding,
				PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
