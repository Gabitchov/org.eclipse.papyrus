...
public class UsagePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, UsagePropertiesEditionPart {
	...
	protected void removeFromClient(NamedElement element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				UsagePropertiesEditionPartForm.this, UMLViewsRepository.Usage.client, PropertiesEditionEvent.COMMIT,
	...
	protected void editClient(NamedElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				client.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						UsagePropertiesEditionPartForm.this, UMLViewsRepository.Usage.client,
	...
	protected void removeFromSupplier(NamedElement element) {
		...
		supplier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				UsagePropertiesEditionPartForm.this, UMLViewsRepository.Usage.supplier, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editSupplier(NamedElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				supplier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						UsagePropertiesEditionPartForm.this, UMLViewsRepository.Usage.supplier,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement,
						propertiesEditionObject));
			}
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UsagePropertiesEditionPart#isContainedInClientTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.UsagePropertiesEditionPart#isContainedInSupplierTable(EObject element)
	 */
