 ...
 */
public class CommunicationPathPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, CommunicationPathPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.ownedComment,
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.ownedComment, PropertiesEditionEvent.CHANGE,
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CommunicationPathPropertiesEditionPart_NameLabel,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.name,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CommunicationPathPropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.CommunicationPath.visibility,
						UMLViewsRepository.SWT_KIND));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.clientDependency,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createElementImportAdvancedTableComposition(Composite parent) {
		...
		this.elementImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.elementImport, UMLViewsRepository.SWT_KIND));
	...
	private void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.elementImport,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.elementImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createPackageImportAdvancedTableComposition(Composite parent) {
		...
		this.packageImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.packageImport, UMLViewsRepository.SWT_KIND));
	...
	private void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.packageImport,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.packageImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createOwnedRuleAdvancedTableComposition(Composite parent) {
		...
		this.ownedRule.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.ownedRule, UMLViewsRepository.SWT_KIND));
	...
	private void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.ownedRule,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.ownedRule, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createIsLeafCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.isLeaf, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createTemplateBindingAdvancedTableComposition(Composite parent) {
		...
		this.templateBinding.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.templateBinding, UMLViewsRepository.SWT_KIND));
	...
	private void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.templateBinding,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.templateBinding, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createIsAbstractCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.isAbstract, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createGeneralizationAdvancedTableComposition(Composite parent) {
		...
		this.generalization.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.generalization, UMLViewsRepository.SWT_KIND));
	...
	private void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.generalization,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToGeneralization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.generalization, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createPowertypeExtentAdvancedReferencesTable(Composite parent) {
		...
		this.powertypeExtent.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.powertypeExtent, UMLViewsRepository.SWT_KIND));
	...
	private void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.powertypeExtent,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createRedefinedClassifierAdvancedReferencesTable(Composite parent) {
		...
		this.redefinedClassifier.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.redefinedClassifier, UMLViewsRepository.SWT_KIND));
	...
	protected void createSubstitutionAdvancedTableComposition(Composite parent) {
		...
		this.substitution.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.substitution, UMLViewsRepository.SWT_KIND));
	...
	private void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.substitution,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToSubstitution() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.substitution, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createCollaborationUseAdvancedTableComposition(Composite parent) {
		...
		this.collaborationUse.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.collaborationUse, UMLViewsRepository.SWT_KIND));
	...
	private void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.collaborationUse,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToCollaborationUse() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.collaborationUse, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createOwnedUseCaseAdvancedTableComposition(Composite parent) {
		...
		this.ownedUseCase.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.ownedUseCase, UMLViewsRepository.SWT_KIND));
	...
	private void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.ownedUseCase,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void addToOwnedUseCase() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						CommunicationPathPropertiesEditionPartImpl.this,
						UMLViewsRepository.CommunicationPath.ownedUseCase, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void createUseCaseAdvancedReferencesTable(Composite parent) {
		...
		this.useCase.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.useCase, UMLViewsRepository.SWT_KIND));
	...
	private void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.useCase,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createOwnedEndAdvancedTableComposition(Composite parent) {
		...
		this.ownedEnd.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.ownedEnd, UMLViewsRepository.SWT_KIND));
	...
	private void moveOwnedEnd(Property element, int oldIndex, int newIndex) {
		...
		ownedEnd.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.ownedEnd,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createMemberEndAdvancedReferencesTable(Composite parent) {
		...
		this.memberEnd.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.memberEnd, UMLViewsRepository.SWT_KIND));
	...
	private void moveMemberEnd(Property element, int oldIndex, int newIndex) {
		...
		memberEnd.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				CommunicationPathPropertiesEditionPartImpl.this, UMLViewsRepository.CommunicationPath.memberEnd,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createIsDerivedCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.isDerived, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createNavigableOwnedEndAdvancedReferencesTable(Composite parent) {
		...
		this.navigableOwnedEnd.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.CommunicationPath.navigableOwnedEnd, UMLViewsRepository.SWT_KIND));
