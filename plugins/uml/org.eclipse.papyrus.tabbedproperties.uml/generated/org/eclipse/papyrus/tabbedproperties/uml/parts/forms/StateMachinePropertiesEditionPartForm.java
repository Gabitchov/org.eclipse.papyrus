...
public class StateMachinePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, StateMachinePropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.name, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.visibility, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, getVisibility()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.clientDependency,
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromElementImport(ElementImport element) {
		...
		elementImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editElementImport(ElementImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.elementImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromPackageImport(PackageImport element) {
		...
		packageImport.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPackageImport(PackageImport element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.packageImport, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedRule(Constraint element) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedRule(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedRule, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		...
		isLeaf = widgetFactory.createButton(parent, UMLMessages.StateMachinePropertiesEditionPart_IsLeafLabel, SWT.CHECK);
   		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.isLeaf, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isLeaf.getSelection())));
			}
	...
	protected void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromTemplateBinding(TemplateBinding element) {
		...
		templateBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editTemplateBinding(TemplateBinding element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.templateBinding, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, UMLMessages.StateMachinePropertiesEditionPart_IsAbstractLabel, SWT.CHECK);
   		isAbstract.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.isAbstract, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isAbstract.getSelection())));
			}
	...
	protected void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.generalization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToGeneralization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.generalization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromGeneralization(Generalization element) {
		...
		generalization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.generalization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editGeneralization(Generalization element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				generalization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.generalization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"GeneralizationSet", UMLPackage.eINSTANCE.getGeneralizationSet()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.powertypeExtent,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.powertypeExtent, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromPowertypeExtent(GeneralizationSet element) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.powertypeExtent, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPowertypeExtent(GeneralizationSet element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				powertypeExtent.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.powertypeExtent, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Classifier", UMLPackage.eINSTANCE.getClassifier()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.redefinedClassifier,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void removeFromRedefinedClassifier(Classifier element) {
		...
		redefinedClassifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.redefinedClassifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRedefinedClassifier(Classifier element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedClassifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.redefinedClassifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.substitution, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToSubstitution() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.substitution, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromSubstitution(Substitution element) {
		...
		substitution.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.substitution, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editSubstitution(Substitution element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				substitution.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.substitution, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.collaborationUse, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToCollaborationUse() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.collaborationUse, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromCollaborationUse(CollaborationUse element) {
		...
		collaborationUse.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.collaborationUse, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editCollaborationUse(CollaborationUse element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				collaborationUse.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.collaborationUse, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedUseCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedUseCase() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedUseCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedUseCase(UseCase element) {
		...
		ownedUseCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedUseCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedUseCase(UseCase element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedUseCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedUseCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"UseCase", UMLPackage.eINSTANCE.getUseCase()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.useCase,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
						useCase.refresh();												
					}
	...
	protected void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.useCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromUseCase(UseCase element) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.useCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editUseCase(UseCase element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				useCase.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.useCase, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedAttribute(Property element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedAttribute, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedAttribute() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedAttribute.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedAttribute, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedAttribute(Property element) {
		...
		ownedAttribute.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedAttribute, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedAttribute(Property element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedAttribute.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedAttribute, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedConnector(Connector element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedConnector, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedConnector() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedConnector.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedConnector, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedConnector(Connector element) {
		...
		ownedConnector.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedConnector, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedConnector(Connector element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedConnector.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedConnector, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedBehavior(Behavior element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedBehavior, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedBehavior(Behavior element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedBehavior.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedBehavior, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveInterfaceRealization(InterfaceRealization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.interfaceRealization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToInterfaceRealization() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interfaceRealization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.interfaceRealization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromInterfaceRealization(InterfaceRealization element) {
		...
		interfaceRealization.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.interfaceRealization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editInterfaceRealization(InterfaceRealization element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				interfaceRealization.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.interfaceRealization, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedTrigger(Trigger element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedTrigger() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedTrigger(Trigger element) {
		...
		ownedTrigger.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedTrigger(Trigger element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedTrigger.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedTrigger, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void removeFromNestedClassifier(Classifier element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.nestedClassifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editNestedClassifier(Classifier element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				nestedClassifier.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.nestedClassifier, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedOperation(Operation element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedOperation() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedOperation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedOperation(Operation element) {
		...
		ownedOperation.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedOperation(Operation element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedOperation.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedOperation, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createIsActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		isActive = widgetFactory.createButton(parent, UMLMessages.StateMachinePropertiesEditionPart_IsActiveLabel, SWT.CHECK);
   		isActive.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.isActive, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isActive.getSelection())));
			}
	...
	protected void moveOwnedReception(Reception element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedReception, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedReception() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedReception.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedReception, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedReception(Reception element) {
		...
		ownedReception.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedReception, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedReception(Reception element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedReception.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedReception, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createIsReentrantCheckbox(FormToolkit widgetFactory, Composite parent) {
		isReentrant = widgetFactory.createButton(parent, UMLMessages.StateMachinePropertiesEditionPart_IsReentrantLabel, SWT.CHECK);
   		isReentrant.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.isReentrant, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, null, new Boolean(isReentrant.getSelection())));
			}
				...
				"Behavior", UMLPackage.eINSTANCE.getBehavior()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.redefinedBehavior,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void removeFromRedefinedBehavior(Behavior element) {
		...
		redefinedBehavior.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.redefinedBehavior, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRedefinedBehavior(Behavior element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedBehavior.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.redefinedBehavior, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedParameter(Parameter element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedParameter() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedParameter(Parameter element) {
		...
		ownedParameter.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedParameter(Parameter element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameter.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameter, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Constraint", UMLPackage.eINSTANCE.getConstraint()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.precondition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void movePrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		precondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromPrecondition(Constraint element) {
		...
		precondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				precondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.precondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"Constraint", UMLPackage.eINSTANCE.getConstraint()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.postcondition,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void movePostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		postcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromPostcondition(Constraint element) {
		...
		postcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				postcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.postcondition, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveOwnedParameterSet(ParameterSet element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToOwnedParameterSet() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameterSet.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromOwnedParameterSet(ParameterSet element) {
		...
		ownedParameterSet.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editOwnedParameterSet(ParameterSet element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedParameterSet.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.ownedParameterSet, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveRegion(Region element, int oldIndex, int newIndex) {
		...
		region.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToRegion() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				region.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromRegion(Region element) {
		...
		region.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editRegion(Region element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				region.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.region, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"State", UMLPackage.eINSTANCE.getState()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.submachineState,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void moveSubmachineState(State element, int oldIndex, int newIndex) {
		...
		submachineState.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.submachineState, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromSubmachineState(State element) {
		...
		submachineState.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.submachineState, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editSubmachineState(State element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				submachineState.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.submachineState, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void moveConnectionPoint(Pseudostate element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	protected void addToConnectionPoint() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				connectionPoint.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	protected void removeFromConnectionPoint(Pseudostate element) {
		...
		connectionPoint.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editConnectionPoint(Pseudostate element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				connectionPoint.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.connectionPoint, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				"StateMachine", UMLPackage.eINSTANCE.getStateMachine()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.extendedStateMachine,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));
						}
	...
	protected void moveExtendedStateMachine(StateMachine element, int oldIndex, int newIndex) {
		...
		extendedStateMachine.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.extendedStateMachine, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void removeFromExtendedStateMachine(StateMachine element) {
		...
		extendedStateMachine.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.extendedStateMachine, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void editExtendedStateMachine(StateMachine element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				extendedStateMachine.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(StateMachinePropertiesEditionPartForm.this, UMLViewsRepository.StateMachine.extendedStateMachine, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
