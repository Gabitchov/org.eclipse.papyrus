...
public class InitialNodePropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, InitialNodePropertiesEditionPart {
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this, UMLViewsRepository.InitialNode.ownedComment,
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.InitialNodePropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.InitialNode.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this, UMLViewsRepository.InitialNode.name,
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.InitialNodePropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.InitialNode.visibility,
				UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this, UMLViewsRepository.InitialNode.visibility,
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this, UMLViewsRepository.InitialNode.isLeaf,
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this, UMLViewsRepository.InitialNode.outgoing, PropertiesEditionEvent.COMMIT,
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this, UMLViewsRepository.InitialNode.incoming, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable<InterruptibleActivityRegion>(UMLMessages.InitialNodePropertiesEditionPart_InInterruptibleRegionLabel,
						...
						TabElementTreeSelectionDialog<InterruptibleActivityRegion> dialog = new TabElementTreeSelectionDialog<InterruptibleActivityRegion>(resourceSet, filters,
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InitialNodePropertiesEditionPartForm.this,
											UMLViewsRepository.InitialNode.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
