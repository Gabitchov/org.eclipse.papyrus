...
public class SendObjectActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, SendObjectActionPropertiesEditionPart {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						...
						UMLViewsRepository.SendObjectAction.ownedComment, PropertiesEditionEvent.COMMIT,
	...
	protected void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.ownedComment,
	...
	protected void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.clientDependency,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this,
						UMLViewsRepository.SendObjectAction.clientDependency, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.outgoing,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.incoming,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void removeFromInPartition(ActivityPartition element) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.inPartition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editInPartition(ActivityPartition element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this,
						UMLViewsRepository.SendObjectAction.inPartition, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this,
				UMLViewsRepository.SendObjectAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT,
	...
	protected void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.redefinedNode,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void editRedefinedNode(ActivityNode element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this,
						UMLViewsRepository.SendObjectAction.redefinedNode, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void addToHandler() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				handler.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.handler,
	...
	protected void addToLocalPrecondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this,
						UMLViewsRepository.SendObjectAction.localPrecondition, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromLocalPrecondition(Constraint element) {
		...
		localPrecondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.localPrecondition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void addToLocalPostcondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this,
						UMLViewsRepository.SendObjectAction.localPostcondition, PropertiesEditionEvent.COMMIT,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	...
	protected void removeFromLocalPostcondition(Constraint element) {
		...
		localPostcondition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.localPostcondition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
		// End of user code
	...
	protected void addToArgument() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				argument.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						SendObjectActionPropertiesEditionPartForm.this, UMLViewsRepository.SendObjectAction.argument,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
		// End of user code
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInOwnedCommentTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInClientDependencyTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInOutgoingTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInIncomingTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInInPartitionTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInInInterruptibleRegionTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInRedefinedNodeTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInHandlerTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInLocalPreconditionTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInLocalPostconditionTable(EObject element)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.SendObjectActionPropertiesEditionPart#isContainedInArgumentTable(EObject element)
	 */
