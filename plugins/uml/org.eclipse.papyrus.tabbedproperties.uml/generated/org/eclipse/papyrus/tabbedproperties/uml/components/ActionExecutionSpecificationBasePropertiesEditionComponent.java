...
public class ActionExecutionSpecificationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ActionExecutionSpecificationBasePropertiesEditionComponent(EObject actionExecutionSpecification,
			String editing_mode) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (actionExecutionSpecification != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ActionExecutionSpecificationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ActionExecutionSpecification.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ActionExecutionSpecification.class) {
			...
			ActionExecutionSpecification actionExecutionSpecification = (ActionExecutionSpecification) elt;
			// init values
			basePart.initOwnedComment(actionExecutionSpecification, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					actionExecutionSpecification.getVisibility());
			basePart.initClientDependency(actionExecutionSpecification, null, UMLPackage.eINSTANCE
					.getNamedElement_ClientDependency());
			basePart.initCovered(actionExecutionSpecification, null, UMLPackage.eINSTANCE
					.getInteractionFragment_Covered());
			basePart.initGeneralOrdering(actionExecutionSpecification, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (actionExecutionSpecification != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, actionExecutionSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, actionExecutionSpecification, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, actionExecutionSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, actionExecutionSpecification, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, actionExecutionSpecification,
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ActionExecutionSpecification.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, actionExecutionSpecification,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, actionExecutionSpecification,
			...
			if (UMLViewsRepository.ActionExecutionSpecification.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, actionExecutionSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ActionExecutionSpecification.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, actionExecutionSpecification,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.ActionExecutionSpecification.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ActionExecutionSpecification.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ActionExecutionSpecification.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ActionExecutionSpecification.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ActionExecutionSpecification.covered)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ActionExecutionSpecification.generalOrdering)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(actionExecutionSpecification);
		else
			return null;
	}
