 ...
 */
public class RealizationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The RealizationBasePropertiesEditionComponent sub component
	 */
	protected RealizationBasePropertiesEditionComponent realizationBasePropertiesEditionComponent;
	...
	public RealizationPropertiesEditionComponent(EObject realization, String editing_mode) {
		...
		if(realization instanceof Realization) {
			realizationBasePropertiesEditionComponent = new RealizationBasePropertiesEditionComponent(realization, editing_mode);
			addSubComponent(realizationBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(realization, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (RealizationPropertiesEditionPart)realizationBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.Realization.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (RealizationPropertiesEditionPart)propertiesEditionPart;
		}
	}
