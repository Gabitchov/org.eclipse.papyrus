...
import org.eclipse.papyrus.tabbedproperties.uml.components.SendOperationEventPropertiesEditionComponent;
 ...
 */
public class SendOperationEventPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof SendOperationEvent) {
			return new SendOperationEventPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof SendOperationEvent) {
			if (SendOperationEventBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new SendOperationEventBasePropertiesEditionComponent(eObject, mode);
