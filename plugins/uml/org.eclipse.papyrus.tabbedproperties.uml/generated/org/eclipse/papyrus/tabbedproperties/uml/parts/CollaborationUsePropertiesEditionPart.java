...
public interface CollaborationUsePropertiesEditionPart {
	...
	/**
	 * @return the roleBinding to add
	 */
	public List getRoleBindingToAdd();

	/**
	 * @return the roleBinding to remove
	 */
	public List getRoleBindingToRemove();

	/**
	 * @return the roleBinding to move
	 */
	public List getRoleBindingToMove();

	/**
	 * @return the roleBinding to edit
	 */
	public Map getRoleBindingToEdit();

	/**
	 * @return the current roleBinding table
	 */
	public List getRoleBindingTable();

	/**
	 * Init the roleBinding
	 * @param current the current value
	 * @param containgFeature the feature where to navigate if necessary
	 * @param feature the feature to manage
	 */
	 ...
	 * @param newValue the roleBinding to update
	 */
	public void updateRoleBinding(EObject newValue);

	/**
	 * Adds the given filter to the roleBinding edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the roleBinding table
	 */
