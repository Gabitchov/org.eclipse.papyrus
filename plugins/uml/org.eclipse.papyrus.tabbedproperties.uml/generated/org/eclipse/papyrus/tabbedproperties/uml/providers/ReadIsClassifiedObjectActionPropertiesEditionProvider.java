...
public class ReadIsClassifiedObjectActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof ReadIsClassifiedObjectAction) {
			return new ReadIsClassifiedObjectActionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof ReadIsClassifiedObjectAction) {
			if (ReadIsClassifiedObjectActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new ReadIsClassifiedObjectActionBasePropertiesEditionComponent(eObject, mode);
