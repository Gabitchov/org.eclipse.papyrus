...
public class PinBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Pin.isLeaf || key == UMLViewsRepository.Pin.ordering || key == UMLViewsRepository.Pin.isControlType || key == UMLViewsRepository.Pin.isOrdered
