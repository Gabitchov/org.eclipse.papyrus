...
public class DurationIntervalBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public DurationIntervalBasePropertiesEditionComponent(EObject durationInterval, String mode) {
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (durationInterval != null) {
			...
			cc.append(SetCommand.create(editingDomain, durationInterval, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart.getName()));
			...
			//	MoveElement moveElement = (MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, durationInterval, UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(), moveElement.getIndex()));
			//}
