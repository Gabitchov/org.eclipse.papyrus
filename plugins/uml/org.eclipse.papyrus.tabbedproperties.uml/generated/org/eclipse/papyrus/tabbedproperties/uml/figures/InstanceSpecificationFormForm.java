...
/**
 * The InstanceSpecificationForm form
 *
 *
 * @generated
 */ 
public class InstanceSpecificationFormForm extends AbstractControlsGroup {
	...
	public InstanceSpecificationFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	
	protected AdvancedReferencedTable classifier;

	protected AdvancedReferencedTable slot;
    ...
    public void createDirectChildren() {
		...
		classifier = new AdvancedReferencedTable("Classifier",new org.eclipse.papyrus.tabbedproperties.core.filters.ClassifierFilter(),backContext);
		hbox.add(classifier);
		slot = new AdvancedReferencedTable("Slot",new org.eclipse.papyrus.tabbedproperties.core.filters.SlotFilter(),backContext);
		hbox.add(slot);
...
/**
     ...
     */
    public AdvancedReferencedTable getClassifier() {
        return classifier;
    }
...
/**
     * @return the slot
     */
    public AdvancedReferencedTable getSlot() {
        return slot;
    }
