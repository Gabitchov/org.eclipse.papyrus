...
public class ConsiderIgnoreFragmentBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ConsiderIgnoreFragmentBasePropertiesEditionComponent(EObject considerIgnoreFragment, String mode) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (considerIgnoreFragment != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ConsiderIgnoreFragmentPropertiesEditionPart)provider.getPropertiesEditionPart(UMLViewsRepository.ConsiderIgnoreFragment.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ConsiderIgnoreFragment.class) {
			...
			basePart.initClientDependency(considerIgnoreFragment, null, UMLPackage.eINSTANCE.getNamedElement_ClientDependency());				
			basePart.initCovered(considerIgnoreFragment, null, UMLPackage.eINSTANCE.getInteractionFragment_Covered());				
			basePart.initGeneralOrdering(considerIgnoreFragment, null, UMLPackage.eINSTANCE.getInteractionFragment_GeneralOrdering());				
			...
			basePart.initCfragmentGate(considerIgnoreFragment, null, UMLPackage.eINSTANCE.getCombinedFragment_CfragmentGate());				
			basePart.initMessage(considerIgnoreFragment, null, UMLPackage.eINSTANCE.getConsiderIgnoreFragment_Message());				
		}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (considerIgnoreFragment != null) {
			...
			for (Iterator iter = ownedCommentToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getElement_OwnedComment(), iter.next()));
			...
			for (Iterator iter = ownedCommentToMove.iterator(); iter.hasNext();){
				...
				cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart.getName()));
			cc.append(SetCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_Visibility(), basePart.getVisibility()));
			List clientDependencyToAdd = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemove = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemove.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), iter.next()));
			//List clientDependencyToMove = basePart.getClientDependencyToMove();
			//for (Iterator iter = clientDependencyToMove.iterator(); iter.hasNext();){
			//	MoveElement moveElement = (MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(), moveElement.getIndex()));
			//}
			List coveredToAdd = basePart.getCoveredToAdd();
			for (Iterator iter = coveredToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_Covered(), iter.next()));
			List coveredToRemove = basePart.getCoveredToRemove();
			for (Iterator iter = coveredToRemove.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_Covered(), iter.next()));
			//List coveredToMove = basePart.getCoveredToMove();
			//for (Iterator iter = coveredToMove.iterator(); iter.hasNext();){
			//	MoveElement moveElement = (MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getLifeline(), moveElement.getElement(), moveElement.getIndex()));
			//}
			List generalOrderingToAdd = basePart.getGeneralOrderingToAdd();
			for (Iterator iter = generalOrderingToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_GeneralOrdering(), iter.next()));
			...
			for (Iterator iter = generalOrderingToMove.iterator(); iter.hasNext();){
				MoveElement moveElement = (MoveElement)iter.next();
				cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getGeneralOrdering(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getCombinedFragment_InteractionOperator(), basePart.getInteractionOperator()));
			List operandToAdd = basePart.getOperandToAdd();
			for (Iterator iter = operandToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getCombinedFragment_Operand(), iter.next()));
			...
			for (Iterator iter = operandToMove.iterator(); iter.hasNext();){
				MoveElement moveElement = (MoveElement)iter.next();
				cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionOperand(), moveElement.getElement(), moveElement.getIndex()));
			}
			List cfragmentGateToAdd = basePart.getCfragmentGateToAdd();
			for (Iterator iter = cfragmentGateToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getCombinedFragment_CfragmentGate(), iter.next()));
			...
			for (Iterator iter = cfragmentGateToMove.iterator(); iter.hasNext();){
				MoveElement moveElement = (MoveElement)iter.next();
				cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getGate(), moveElement.getElement(), moveElement.getIndex()));
			}
			List messageToAdd = basePart.getMessageToAdd();
			for (Iterator iter = messageToAdd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getConsiderIgnoreFragment_Message(), iter.next()));
			List messageToRemove = basePart.getMessageToRemove();
			for (Iterator iter = messageToRemove.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getConsiderIgnoreFragment_Message(), iter.next()));
			//List messageToMove = basePart.getMessageToMove();
			//for (Iterator iter = messageToMove.iterator(); iter.hasNext();){
			//	MoveElement moveElement = (MoveElement)iter.next();
			//	cc.append(MoveCommand.create(editingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement(), moveElement.getElement(), moveElement.getIndex()));
			//}
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof ConsiderIgnoreFragment) {
			...
			considerIgnoreFragmentToUpdate.setInteractionOperator((InteractionOperatorKind)basePart.getInteractionOperator());
		...
		if (PathedPropertiesEditionEvent.COMMIT == event.getState() && IPropertiesEditionComponent.LIVE_MODE.equals(mode)) {
			...
			if (UMLViewsRepository.ConsiderIgnoreFragment.ownedComment == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
					...
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ConsiderIgnoreFragment.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_Name(), event.getNewValue()));	

			if (UMLViewsRepository.ConsiderIgnoreFragment.visibility == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_Visibility(), event.getNewValue()));
			...
			if (UMLViewsRepository.ConsiderIgnoreFragment.clientDependency == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PathedPropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ConsiderIgnoreFragment.covered == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_Covered(), event.getNewValue()));
				if (PathedPropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_Covered(), event.getNewValue()));
				if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_Covered(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ConsiderIgnoreFragment.generalOrdering == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionFragment_GeneralOrdering(), event.getNewValue()));
				else if (PathedPropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getGeneralOrdering(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ConsiderIgnoreFragment.interactionOperator == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getCombinedFragment_InteractionOperator(), event.getNewValue()));
			...
			if (UMLViewsRepository.ConsiderIgnoreFragment.operand == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getCombinedFragment_Operand(), event.getNewValue()));
				else if (PathedPropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getInteractionOperand(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ConsiderIgnoreFragment.cfragmentGate == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getCombinedFragment_CfragmentGate(), event.getNewValue()));
				else if (PathedPropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getGate(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ConsiderIgnoreFragment.message == event.getAffectedEditor()) {
				if (PathedPropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getConsiderIgnoreFragment_Message(), event.getNewValue()));
				if (PathedPropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getConsiderIgnoreFragment_Message(), event.getNewValue()));
				if (PathedPropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, considerIgnoreFragment, UMLPackage.eINSTANCE.getConsiderIgnoreFragment_Message(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ConsiderIgnoreFragment.interactionOperator || key == UMLViewsRepository.ConsiderIgnoreFragment.operand;
	}
	...
	public String getHelpContent(String key, int kind) {
			...
			if (key == UMLViewsRepository.ConsiderIgnoreFragment.message)
				return "The set of messages that apply to this fragment"; //$NON-NLS-1$
