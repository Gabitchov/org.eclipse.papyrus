...
public class CreateLinkObjectActionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, CreateLinkObjectActionPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.ownedComment,
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.ownedComment, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CreateLinkObjectActionPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.CreateLinkObjectAction.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.name,
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.CreateLinkObjectActionPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(
				UMLViewsRepository.CreateLinkObjectAction.visibility, UMLViewsRepository.SWT_KIND));
				...
				TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(resourceSet, filters, "Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
									UMLViewsRepository.CreateLinkObjectAction.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
	...
	private void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.clientDependency, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(resourceSet, filters, "ActivityEdge", UMLPackage.eINSTANCE.getActivityEdge()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
									UMLViewsRepository.CreateLinkObjectAction.outgoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						outgoing.refresh();
					}
				...
				TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(resourceSet, filters, "ActivityEdge", UMLPackage.eINSTANCE.getActivityEdge()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
									UMLViewsRepository.CreateLinkObjectAction.incoming, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						incoming.refresh();
					}
				...
				TabElementTreeSelectionDialog<ActivityPartition> dialog = new TabElementTreeSelectionDialog<ActivityPartition>(resourceSet, filters, "ActivityPartition", UMLPackage.eINSTANCE
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
									UMLViewsRepository.CreateLinkObjectAction.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
						inPartition.refresh();
					}
	...
	private void editInPartition(ActivityPartition element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				inPartition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.inPartition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	protected void createInInterruptibleRegionReferencesTable(Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable<InterruptibleActivityRegion>(UMLMessages.CreateLinkObjectActionPropertiesEditionPart_InInterruptibleRegionLabel,
						...
						TabElementTreeSelectionDialog<InterruptibleActivityRegion> dialog = new TabElementTreeSelectionDialog<InterruptibleActivityRegion>(resourceSet, filters,
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
											UMLViewsRepository.CreateLinkObjectAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
	...
	private void moveInInterruptibleRegion(InterruptibleActivityRegion element, int oldIndex, int newIndex) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
				UMLViewsRepository.CreateLinkObjectAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	private void removeFromInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
				UMLViewsRepository.CreateLinkObjectAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editInInterruptibleRegion(InterruptibleActivityRegion element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				inInterruptibleRegion.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.inInterruptibleRegion, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
				...
				TabElementTreeSelectionDialog<ActivityNode> dialog = new TabElementTreeSelectionDialog<ActivityNode>(resourceSet, filters, "ActivityNode", UMLPackage.eINSTANCE.getActivityNode()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
									UMLViewsRepository.CreateLinkObjectAction.redefinedNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
						}
	...
	private void editRedefinedNode(ActivityNode element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				redefinedNode.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.redefinedNode, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveHandler(ExceptionHandler element, int oldIndex, int newIndex) {
		...
		handler.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.handler,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void moveLocalPrecondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.localPrecondition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToLocalPrecondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void editLocalPrecondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPrecondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.localPrecondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveLocalPostcondition(Constraint element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.localPostcondition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToLocalPostcondition() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void editLocalPostcondition(Constraint element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				localPostcondition.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this,
						UMLViewsRepository.CreateLinkObjectAction.localPostcondition, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveEndData(LinkEndData element, int oldIndex, int newIndex) {
		...
		endData.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.endData,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void moveInputValue(InputPin element, int oldIndex, int newIndex) {
		...
		inputValue.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(CreateLinkObjectActionPropertiesEditionPartImpl.this, UMLViewsRepository.CreateLinkObjectAction.inputValue,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
