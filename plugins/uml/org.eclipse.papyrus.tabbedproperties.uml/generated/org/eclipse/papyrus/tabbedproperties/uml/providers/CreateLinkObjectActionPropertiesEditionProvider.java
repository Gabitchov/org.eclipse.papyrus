...
import org.eclipse.papyrus.tabbedproperties.uml.components.CreateLinkObjectActionPropertiesEditionComponent;
 ...
 */
public class CreateLinkObjectActionPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof CreateLinkObjectAction) && (UMLPackage.eINSTANCE.getCreateLinkObjectAction() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof CreateLinkObjectAction) {
			return new CreateLinkObjectActionPropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof CreateLinkObjectAction) {
			if (CreateLinkObjectActionBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new CreateLinkObjectActionBasePropertiesEditionComponent(eObject, mode);
