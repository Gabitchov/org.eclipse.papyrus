...
public class ModelPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ModelPropertiesEditionPart {
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.name, PropertiesEditionEvent.CHANGE,
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ModelPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent
				.isRequired(UMLViewsRepository.Model.visibility, UMLViewsRepository.SWT_KIND));
	...
	protected void createViewpointText(Composite parent) {
		...
		viewpoint.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.viewpoint, PropertiesEditionEvent.CHANGE,
	...
	private void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.templateBinding, PropertiesEditionEvent.COMMIT,
	...
	private void addToTemplateBinding() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				templateBinding.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.templateBinding,
	...
	private void removeFromTemplateBinding(TemplateBinding element) {
		...
		templateBinding.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.templateBinding, PropertiesEditionEvent.CHANGE,
	...
	private void movePackageMerge(PackageMerge element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.packageMerge, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToPackageMerge() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageMerge.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.packageMerge, PropertiesEditionEvent.CHANGE,
	...
	private void removeFromPackagedElement(PackageableElement element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.packagedElement, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editPackagedElement(PackageableElement element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packagedElement.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.packagedElement,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
	...
	private void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.elementImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToElementImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				elementImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.elementImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.packageImport, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToPackageImport() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				packageImport.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.packageImport, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.ownedRule, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	private void addToOwnedRule() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedRule.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ModelPropertiesEditionPartImpl.this, UMLViewsRepository.Model.ownedRule, PropertiesEditionEvent.CHANGE,
						PropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
