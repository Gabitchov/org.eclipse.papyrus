...
public class ActionInputPinBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ActionInputPin.isLeaf || key == UMLViewsRepository.ActionInputPin.ordering || key == UMLViewsRepository.ActionInputPin.isControlType
				|| key == UMLViewsRepository.ActionInputPin.isOrdered || key == UMLViewsRepository.ActionInputPin.isUnique || key == UMLViewsRepository.ActionInputPin.isControl;
	}
