...
public class ActionInputPinBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (actionInputPin != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ActionInputPinPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ActionInputPin.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ActionInputPin.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					actionInputPin.getVisibility());
			basePart
					.initClientDependency(actionInputPin, null, UMLPackage.eINSTANCE.getNamedElement_ClientDependency());
			...
			basePart.initInInterruptibleRegion(actionInputPin, null, UMLPackage.eINSTANCE
			...
			basePart.initOrdering((EEnum) UMLPackage.eINSTANCE.getObjectNode_Ordering().getEType(), actionInputPin
					.getOrdering());
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (actionInputPin != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, actionInputPin,
			...
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE.getObjectNode_Ordering(),
					basePart.getOrdering()));

			cc.append(SetCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE
					.getObjectNode_IsControlType(), basePart.getIsControlType()));

			List inStateToAddFromInState = basePart.getInStateToAdd();
			for (Iterator iter = inStateToAddFromInState.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, actionInputPin,
						UMLPackage.eINSTANCE.getObjectNode_InState(), iter.next()));
			...
			for (Iterator iter = inStateToRemoveFromInState.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE
						.getObjectNode_InState(), iter.next()));
			...
			cc.append(SetCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE
					.getMultiplicityElement_IsUnique(), basePart.getIsUnique()));

			cc.append(SetCommand.create(editingDomain, actionInputPin, UMLPackage.eINSTANCE.getPin_IsControl(),
					basePart.getIsControl()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ActionInputPin.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, actionInputPin, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, actionInputPin, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ActionInputPin.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, actionInputPin, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ActionInputPin.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, actionInputPin, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.ActionInputPin.isControl == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, actionInputPin, UMLPackage.eINSTANCE
						.getPin_IsControl(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ActionInputPin.isLeaf || key == UMLViewsRepository.ActionInputPin.ordering
				|| key == UMLViewsRepository.ActionInputPin.isControlType
				|| key == UMLViewsRepository.ActionInputPin.isOrdered
				|| key == UMLViewsRepository.ActionInputPin.isUnique
				|| key == UMLViewsRepository.ActionInputPin.isControl;
	}
