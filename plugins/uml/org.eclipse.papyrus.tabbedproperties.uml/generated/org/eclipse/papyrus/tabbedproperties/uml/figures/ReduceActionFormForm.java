...
/**
 * The ReduceActionForm form
 *
 *
 * @generated
 */ 
public class ReduceActionFormForm extends AbstractControlsGroup {
	...
	public ReduceActionFormForm(String label, String description){
		this.label=label;
		this.description=description;
	}

	protected LabeledCheckBoxFigure isOrdered;
    ...
    public void createDirectChildren() {
		//
		isOrdered = new LabeledCheckBoxFigure("isOrdered", "");
		this.add(isOrdered);
     ...
     */
    public LabeledCheckBoxFigure  getIsOrdered() {
        return isOrdered;
    }
