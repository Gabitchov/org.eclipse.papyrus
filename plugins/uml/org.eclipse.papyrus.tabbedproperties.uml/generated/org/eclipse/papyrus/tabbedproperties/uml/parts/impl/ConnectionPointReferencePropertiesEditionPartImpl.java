...
public class ConnectionPointReferencePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ConnectionPointReferencePropertiesEditionPart {
	...
	private ReferencesTable<?> entry;
	private EMFListEditUtil exitEditUtil;
	private ReferencesTable<?> exit;
	...
	protected void createPropertiesGroup(Composite parent) {
		...
		createEntryReferencesTable(propertiesGroup);
		createExitReferencesTable(propertiesGroup);
   	}
	/**
	 * @param container
	 */
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.ownedComment, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.ADD, null, propertiesEditionObject));
			}
		}
	...
	private void removeFromOwnedComment(Comment element) {
		...
		ownedComment.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editOwnedComment(Comment element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				ownedComment.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.ownedComment, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.name, PathedPropertiesEditionEvent.CHANGE, PathedPropertiesEditionEvent.SET, null, name.getText()));
			}
				...
				"Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.clientDependency,
	...
	private void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	...
	private void removeFromClientDependency(Dependency element) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editClientDependency(Dependency element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				clientDependency.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.clientDependency, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}

		// End of user code
	}
	protected void createEntryReferencesTable(Composite parent) {
		this.entry = new ReferencesTable<Pseudostate>(UMLMessages.ConnectionPointReferencePropertiesEditionPart_EntryLabel, new ReferencesTableListener<Pseudostate>() {
			public void handleAdd() {				
				ViewerFilter entryFilter = new EObjectFilter(UMLPackage.eINSTANCE.getPseudostate());
				ViewerFilter viewerFilter = new ViewerFilter() {					
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						if (element instanceof EObject)
							return (!entryEditUtil.contains((EObject)element));
						return false;					
					}
				};				
				ViewerFilter[] filters = { entryFilter, viewerFilter };		
				TabElementTreeSelectionDialog<Pseudostate> dialog = new TabElementTreeSelectionDialog<Pseudostate>(resourceSet, filters,
				"Pseudostate", UMLPackage.eINSTANCE.getPseudostate()) {
					...
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.entry,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						entry.refresh();											
					}
	 ...
	 * 
	 */
	private void moveEntry(Pseudostate element, int oldIndex, int newIndex) {
				
		EObject editedElement = entryEditUtil.foundCorrespondingEObject(element);
		entryEditUtil.moveElement(element, oldIndex, newIndex);
		entry.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.entry, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	 ...
	 * 
	 */
	private void removeFromEntry(Pseudostate element) {
		...
		entry.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.entry, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editEntry(Pseudostate element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				entry.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.entry, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}

		// End of user code
	}
	protected void createExitReferencesTable(Composite parent) {
		this.exit = new ReferencesTable<Pseudostate>(UMLMessages.ConnectionPointReferencePropertiesEditionPart_ExitLabel, new ReferencesTableListener<Pseudostate>() {
			public void handleAdd() {				
				ViewerFilter exitFilter = new EObjectFilter(UMLPackage.eINSTANCE.getPseudostate());
				ViewerFilter viewerFilter = new ViewerFilter() {					
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						if (element instanceof EObject)
							return (!exitEditUtil.contains((EObject)element));
						return false;					
					}
				};				
				ViewerFilter[] filters = { exitFilter, viewerFilter };		
				TabElementTreeSelectionDialog<Pseudostate> dialog = new TabElementTreeSelectionDialog<Pseudostate>(resourceSet, filters,
				"Pseudostate", UMLPackage.eINSTANCE.getPseudostate()) {
					@Override
					public void process(IStructuredSelection selection) {						
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.exit,
								PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.ADD, null, elem));	
						}
						exit.refresh();											
					}
	 ...
	 * 
	 */
	private void moveExit(Pseudostate element, int oldIndex, int newIndex) {
				
		EObject editedElement = exitEditUtil.foundCorrespondingEObject(element);
		exitEditUtil.moveElement(element, oldIndex, newIndex);
		exit.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.exit, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.MOVE, editedElement, newIndex));	
	 ...
	 * 
	 */
	private void removeFromExit(Pseudostate element) {
		...
		exit.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.exit, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.REMOVE, null, editedElement));
	...
	private void editExit(Pseudostate element) {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				exit.refresh();
				propertiesEditionComponent.firePropertiesChanged(new PathedPropertiesEditionEvent(ConnectionPointReferencePropertiesEditionPartImpl.this, UMLViewsRepository.ConnectionPointReference.exit, PathedPropertiesEditionEvent.COMMIT, PathedPropertiesEditionEvent.SET, editedElement, propertiesEditionObject));
			}
		}
...
/**
	...
	public void setMessageForEntry (String msg, int msgLevel) {
	
	}
	
	public void unsetMessageForEntry () {
...
/**
	...
	public void setMessageForExit (String msg, int msgLevel) {
	
	}
	
	public void unsetMessageForExit () {
