...
public interface InteractionPropertiesEditionPart {
	...
	/**
	 * @return the lifeline to add
	 */
	public List getLifelineToAdd();

	/**
	 * @return the lifeline to remove
	 */
	public List getLifelineToRemove();

	/**
	 * @return the lifeline to move
	 */
	public List getLifelineToMove();

	/**
	 * @return the lifeline to edit
	 */
	public Map getLifelineToEdit();

	/**
	 * @return the current lifeline table
	 */
	...
	/**
	 * Update the lifeline
	 * @param newValue the lifeline to update
	 */
	public void updateLifeline(EObject newValue);

	/**
	 * Adds the given filter to the lifeline edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the lifeline table
	 */
	...
	/**
	 * @return the action to edit
	 */
	public Map getActionToEdit();

	/**
	 * @return the current action table
	 */
	...
	/**
	 * Update the action
	 * @param newValue the action to update
	 */
	...
	/**
	 * @return true if the given element is contained inside the action table
	 */
	...
	/**
	 * @return the formalGate to add
	 */
	public List getFormalGateToAdd();

	/**
	 * @return the formalGate to remove
	 */
	public List getFormalGateToRemove();

	/**
	 * @return the formalGate to move
	 */
	public List getFormalGateToMove();

	/**
	 * @return the formalGate to edit
	 */
	public Map getFormalGateToEdit();

	/**
	 * @return the current formalGate table
	 */
	...
	/**
	 * Update the formalGate
	 * @param newValue the formalGate to update
	 */
	public void updateFormalGate(EObject newValue);

	/**
	 * Adds the given filter to the formalGate edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the formalGate table
	 */
