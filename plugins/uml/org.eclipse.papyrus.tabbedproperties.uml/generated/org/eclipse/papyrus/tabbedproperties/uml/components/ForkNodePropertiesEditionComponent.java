 ...
 */
public class ForkNodePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The ForkNodeBasePropertiesEditionComponent sub component
	 */
	protected ForkNodeBasePropertiesEditionComponent forkNodeBasePropertiesEditionComponent;
	...
	public ForkNodePropertiesEditionComponent(EObject forkNode, String editing_mode) {
		...
		if(forkNode instanceof ForkNode) {
			forkNodeBasePropertiesEditionComponent = new ForkNodeBasePropertiesEditionComponent(forkNode, editing_mode);
			addSubComponent(forkNodeBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(forkNode, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if("Base".equals(key)) {
			basePart = (ForkNodePropertiesEditionPart)forkNodeBasePropertiesEditionComponent.getPropertiesEditionPart(kind, key);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(UMLViewsRepository.ForkNode.class == key) {
			super.setPropertiesEditionPart(key, kind, propertiesEditionPart);
			basePart = (ForkNodePropertiesEditionPart)propertiesEditionPart;
		}
	}
