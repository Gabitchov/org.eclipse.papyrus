...
public class RealizationPropertiesEditionPartForm extends CompositePropertiesEditionPart implements IFormPropertiesEditionPart, RealizationPropertiesEditionPart {
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.RealizationPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.Realization.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealizationPropertiesEditionPartForm.this, UMLViewsRepository.Realization.name,
	...
	protected void createVisibilityEEnumViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.RealizationPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.Realization.visibility,
				UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealizationPropertiesEditionPartForm.this, UMLViewsRepository.Realization.visibility,
	...
	protected void removeFromClient(NamedElement element) {
		...
		client.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealizationPropertiesEditionPartForm.this, UMLViewsRepository.Realization.client, PropertiesEditionEvent.COMMIT,
	...
	protected void removeFromSupplier(NamedElement element) {
		...
		supplier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RealizationPropertiesEditionPartForm.this, UMLViewsRepository.Realization.supplier, PropertiesEditionEvent.COMMIT,
				PropertiesEditionEvent.REMOVE, null, editedElement));
