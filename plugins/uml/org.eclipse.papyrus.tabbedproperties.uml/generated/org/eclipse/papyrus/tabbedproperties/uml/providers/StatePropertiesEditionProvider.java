...
import org.eclipse.papyrus.tabbedproperties.uml.components.StatePropertiesEditionComponent;
 ...
 */
public class StatePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof State) && (UMLPackage.eINSTANCE.getState() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof State) {
			return new StatePropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof State) {
			if (StateBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new StateBasePropertiesEditionComponent(eObject, editing_mode);
