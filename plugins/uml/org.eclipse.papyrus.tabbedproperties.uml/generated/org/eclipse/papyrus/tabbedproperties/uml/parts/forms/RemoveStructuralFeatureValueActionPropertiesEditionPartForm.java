 ...
 */
public class RemoveStructuralFeatureValueActionPropertiesEditionPartForm extends CompositePropertiesEditionPart
		implements IFormPropertiesEditionPart, RemoveStructuralFeatureValueActionPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.RemoveStructuralFeatureValueActionPropertiesEditionPart_NameLabel,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RemoveStructuralFeatureValueActionPropertiesEditionPartForm.this,
							UMLViewsRepository.RemoveStructuralFeatureValueAction.name, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, name.getText()));
			}
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								RemoveStructuralFeatureValueActionPropertiesEditionPartForm.this,
								UMLViewsRepository.RemoveStructuralFeatureValueAction.name,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RemoveStructuralFeatureValueActionPropertiesEditionPartForm.this,
							UMLViewsRepository.RemoveStructuralFeatureValueAction.visibility,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent,
				UMLMessages.RemoveStructuralFeatureValueActionPropertiesEditionPart_IsLeafLabel, SWT.CHECK);
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RemoveStructuralFeatureValueActionPropertiesEditionPartForm.this,
							UMLViewsRepository.RemoveStructuralFeatureValueAction.isLeaf,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.outgoing, UMLViewsRepository.FORM_KIND));
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.incoming, UMLViewsRepository.FORM_KIND));
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.inPartition, UMLViewsRepository.FORM_KIND));
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void createHandlerTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.handler, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPreconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.RemoveStructuralFeatureValueAction.localPrecondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsRemoveDuplicatesCheckbox(FormToolkit widgetFactory, Composite parent) {
		isRemoveDuplicates = widgetFactory.createButton(parent,
				UMLMessages.RemoveStructuralFeatureValueActionPropertiesEditionPart_IsRemoveDuplicatesLabel, SWT.CHECK);
		isRemoveDuplicates.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RemoveStructuralFeatureValueActionPropertiesEditionPartForm.this,
							UMLViewsRepository.RemoveStructuralFeatureValueAction.isRemoveDuplicates,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(
									isRemoveDuplicates.getSelection())));
			}
