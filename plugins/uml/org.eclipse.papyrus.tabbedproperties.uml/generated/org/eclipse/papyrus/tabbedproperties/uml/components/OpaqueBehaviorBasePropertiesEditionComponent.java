...
public class OpaqueBehaviorBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.OpaqueBehavior.class) {
			...
			// body, OpaqueBehavior, OpaqueBehavior.
			// FIXME NO VALID CASE INTO template public updater(editionElement : PropertiesEditionElement, view : View, pec : PropertiesEditionComponent) in viewCommon.mtl module, with the values :
			// language, OpaqueBehavior, OpaqueBehavior.
		}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.OpaqueBehavior.isLeaf || key == UMLViewsRepository.OpaqueBehavior.isAbstract || key == UMLViewsRepository.OpaqueBehavior.isActive
