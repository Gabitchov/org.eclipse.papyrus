...
import org.eclipse.papyrus.tabbedproperties.uml.components.LoopNodePropertiesEditionComponent;
 ...
 */
public class LoopNodePropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof LoopNode) && (UMLPackage.eINSTANCE.getLoopNode() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode) {
		if (eObject instanceof LoopNode) {
			return new LoopNodePropertiesEditionComponent(eObject, mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String mode, String part) {
		if (eObject instanceof LoopNode) {
			if (LoopNodeBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new LoopNodeBasePropertiesEditionComponent(eObject, mode);
