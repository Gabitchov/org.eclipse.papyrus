...
import org.eclipse.papyrus.tabbedproperties.uml.figures.PinFormForm;
...
/**
 * The Pin property section for the Pin element
 * 
 *
 * @generated
 */
public class PinSection extends AbstractEnhancedPropertySection implements IFilter {

	/**
	 * The section's form
	 * @generated 
	 */
	private PinFormForm pinForm;

	/**
	 * The Pin to edit 
	 * @generated
	 */
	private Pin pinElement;
	...
	public PropertyEditor createFigure() {
		pinForm = new PinFormForm("Pin","A pin is a typed element and multiplicity element that provides values to actions and accept result values from them."+
""+
"A pin is an object node for inputs and outputs to actions.");
	...
	public void initializeFigure()
	{
		...
		//listener for a simple feature isControl of Pin
		BooleanPropertyChangeListener isControlListener = new BooleanPropertyChangeListener(){
			public void propertyChanged(PropertyEditor editor, boolean newValue) {
			SetValueCommand command = new SetValueCommand(editingDomain,pinElement, UMLPackage.eINSTANCE.getPin_IsControl(),newValue);		
			editingDomain.getCommandStack().execute(command);
			}
		};

		pinForm.getIsControl().setPropertyChangeListener(isControlListener);
	...
	public void refresh() {
		super.refresh();
														   						...
														   						pinForm.getIsControl().setValue(pinElement.isControl());
	...
	public void setInput(IWorkbenchPart part, ISelection selection) {
    	...
    	this.pinElement = (Pin)getBusinessElement(input);
	...
	public boolean select(Object toTest) {
		return getBusinessElement(toTest) instanceof Pin;
	}
	...
	public void aboutToBeShown() {
		...
		// Listen to the model
		pinElement.eAdapters().add(modelListener);
	}
	...
	public void aboutToBeHidden() {
		// Stop listening
		pinElement.eAdapters().remove(modelListener);
