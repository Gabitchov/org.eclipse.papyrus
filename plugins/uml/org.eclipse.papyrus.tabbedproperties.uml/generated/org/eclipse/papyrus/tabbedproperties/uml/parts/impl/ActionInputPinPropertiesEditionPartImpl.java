...
public class ActionInputPinPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ActionInputPinPropertiesEditionPart {
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UMLViewsRepository.ActionInputPin.ownedComment,
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ActionInputPinPropertiesEditionPart_NameLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.ActionInputPin.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this, UMLViewsRepository.ActionInputPin.name,
	...
	protected void createVisibilityEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ActionInputPinPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.ActionInputPin.visibility,
				UMLViewsRepository.SWT_KIND));
				...
				TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(resourceSet, filters, "Dependency", UMLPackage.eINSTANCE.getDependency()) {
					...
					public void process(IStructuredSelection selection) {
						for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
							...
							propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActionInputPinPropertiesEditionPartImpl.this,
	...
	protected void createOrderingEEnumViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ActionInputPinPropertiesEditionPart_OrderingLabel, propertiesEditionComponent.isRequired(UMLViewsRepository.ActionInputPin.ordering,
				UMLViewsRepository.SWT_KIND));
