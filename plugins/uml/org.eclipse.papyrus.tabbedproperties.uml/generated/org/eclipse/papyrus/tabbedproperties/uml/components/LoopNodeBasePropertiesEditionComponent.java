...
public class LoopNodeBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getStructuredActivityNode_Variable() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getVariable())) {
						basePart.updateVariable(loopNode);
					}
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getStructuredActivityNode_Edge() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getActivityEdge())) {
						basePart.updateEdge(loopNode);
					}
					if (UMLPackage.eINSTANCE.getStructuredActivityNode_MustIsolate().equals(msg.getFeature())
							&& basePart != null)
						basePart.setMustIsolate((Boolean) msg.getNewValue());

					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getStructuredActivityNode_Node() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getActivityNode())) {
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getLoopNode_Result() || ((EStructuralFeature) msg
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getLoopNode_LoopVariableInput() || ((EStructuralFeature) msg.getFeature())
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (loopNode != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (LoopNodePropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.LoopNode.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.LoopNode.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), loopNode
					.getVisibility());
			...
			basePart.initInInterruptibleRegion(loopNode, null, UMLPackage.eINSTANCE
			...
			basePart.addFilterToBodyPart(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getBodyPartTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToSetupPart(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getSetupPartTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToTest(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getTestTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToLoopVariable(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getLoopVariableTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToBodyOutput(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getBodyOutputTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (loopNode != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, loopNode,
			// UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));
			...
			for (Iterator iter = outgoingToAddFromOutgoing.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getActivityNode_Outgoing(),
						iter.next()));
			...
			for (Iterator iter = outgoingToRemoveFromOutgoing.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode,
			...
			for (Iterator iter = incomingToAddFromIncoming.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getActivityNode_Incoming(),
						iter.next()));
			...
			for (Iterator iter = inPartitionToAddFromInPartition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode,
			...
			for (Iterator iter = handlerToAddFromHandler.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getExecutableNode_Handler(),
						iter.next()));
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getExceptionHandler(),
			...
			for (Iterator iter = localPreconditionToAddFromLocalPrecondition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode,
						UMLPackage.eINSTANCE.getAction_LocalPrecondition(), iter.next()));
			...
			for (Iterator iter = localPreconditionToMoveFromLocalPrecondition.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getConstraint(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = elementImportToAddFromElementImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getNamespace_ElementImport(),
						iter.next()));
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getElementImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = packageImportToAddFromPackageImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getNamespace_PackageImport(),
						iter.next()));
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToAddFromOwnedRule.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getNamespace_OwnedRule(),
						iter.next()));
			...
			for (Iterator iter = variableToAddFromVariable.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
						.getStructuredActivityNode_Variable(), iter.next()));
			...
			for (Iterator iter = variableToMoveFromVariable.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getVariable(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			List edgeToAddFromEdge = basePart.getEdgeToAdd();
			for (Iterator iter = edgeToAddFromEdge.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
						.getStructuredActivityNode_Edge(), iter.next()));
			...
			for (Iterator iter = edgeToMoveFromEdge.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getActivityEdge(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
					.getStructuredActivityNode_MustIsolate(), basePart.getMustIsolate()));

			List nodeToAddFromNode = basePart.getNodeToAdd();
			for (Iterator iter = nodeToAddFromNode.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
						.getStructuredActivityNode_Node(), iter.next()));
			...
			for (Iterator iter = nodeToMoveFromNode.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getActivityNode(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_IsTestedFirst(),
					basePart.getIsTestedFirst()));
			...
			for (Iterator iter = bodyPartToAddFromBodyPart.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_BodyPart(), iter
						.next()));
			...
			for (Iterator iter = bodyPartToRemoveFromBodyPart.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_BodyPart(),
						iter.next()));
			...
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, loopNode,
			// UMLPackage.eINSTANCE.getExecutableNode(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			...
			for (Iterator iter = setupPartToAddFromSetupPart.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_SetupPart(), iter
						.next()));
			...
			for (Iterator iter = setupPartToRemoveFromSetupPart.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_SetupPart(),
						iter.next()));
			...
			for (Iterator iter = testToAddFromTest.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_Test(), iter
						.next()));
			List testToRemoveFromTest = basePart.getTestToRemove();
			for (Iterator iter = testToRemoveFromTest.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_Test(), iter
						.next()));
			...
			for (Iterator iter = resultToAddFromResult.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_Result(), iter
						.next()));
			...
			for (Iterator iter = resultToMoveFromResult.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getOutputPin(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = loopVariableToAddFromLoopVariable.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_LoopVariable(),
						iter.next()));
			...
			for (Iterator iter = loopVariableToRemoveFromLoopVariable.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode,
						UMLPackage.eINSTANCE.getLoopNode_LoopVariable(), iter.next()));
			...
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, loopNode,
			// UMLPackage.eINSTANCE.getOutputPin(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			...
			for (Iterator iter = bodyOutputToAddFromBodyOutput.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_BodyOutput(),
						iter.next()));
			...
			for (Iterator iter = bodyOutputToRemoveFromBodyOutput.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getLoopNode_BodyOutput(),
						iter.next()));
			...
			for (Iterator iter = loopVariableInputToAddFromLoopVariableInput.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE
						.getLoopNode_LoopVariableInput(), iter.next()));
			...
			for (Iterator iter = loopVariableInputToRefreshFromLoopVariableInput.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for loopVariableInput reference refreshment from
				// loopVariableInput

				InputPin nextElement = (InputPin) iter.next();
				InputPin loopVariableInput = (InputPin) loopVariableInputToRefreshFromLoopVariableInput
						.get(nextElement);
			...
			for (Iterator iter = loopVariableInputToMoveFromLoopVariableInput.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, loopNode, UMLPackage.eINSTANCE.getInputPin(), moveElement
						.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.LoopNode.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.LoopNode.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.LoopNode.localPrecondition == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, loopNode,
			...
			if (UMLViewsRepository.LoopNode.variable == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getStructuredActivityNode_Variable(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE.getVariable(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.edge == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getStructuredActivityNode_Edge(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.LoopNode.mustIsolate == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
						.getStructuredActivityNode_MustIsolate(), event.getNewValue()));
			...
			if (UMLViewsRepository.LoopNode.node == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getStructuredActivityNode_Node(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.LoopNode.isTestedFirst == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
						.getLoopNode_IsTestedFirst(), event.getNewValue()));

			if (UMLViewsRepository.LoopNode.bodyPart == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_BodyPart(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_BodyPart(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_BodyPart(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.setupPart == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_SetupPart(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_SetupPart(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_SetupPart(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.test == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_Test(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_Test(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_Test(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.result == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_Result(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE.getOutputPin(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.loopVariable == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_LoopVariable(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_LoopVariable(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_LoopVariable(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.bodyOutput == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_BodyOutput(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_BodyOutput(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_BodyOutput(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LoopNode.loopVariableInput == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE
							.getLoopNode_LoopVariableInput(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, loopNode, UMLPackage.eINSTANCE.getInputPin(),
							event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.LoopNode.isLeaf || key == UMLViewsRepository.LoopNode.mustIsolate
				|| key == UMLViewsRepository.LoopNode.isTestedFirst;
	}
		...
		try {
			...
			if (UMLViewsRepository.LoopNode.mustIsolate == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE
						.getStructuredActivityNode_MustIsolate().getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getStructuredActivityNode_MustIsolate()
						.getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.LoopNode.isTestedFirst == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getLoopNode_IsTestedFirst()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getLoopNode_IsTestedFirst()
						.getEAttributeType(), newValue);
			}
