...
public class ReadLinkObjectEndActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public ReadLinkObjectEndActionPropertiesEditionComponent(EObject readLinkObjectEndAction, String editing_mode) {
		...
		if (readLinkObjectEndAction instanceof ReadLinkObjectEndAction) {
			readLinkObjectEndActionBasePropertiesEditionComponent = new ReadLinkObjectEndActionBasePropertiesEditionComponent(
					readLinkObjectEndAction, editing_mode);
			addSubComponent(readLinkObjectEndActionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(readLinkObjectEndAction,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ReadLinkObjectEndActionPropertiesEditionPart) readLinkObjectEndActionBasePropertiesEditionComponent
