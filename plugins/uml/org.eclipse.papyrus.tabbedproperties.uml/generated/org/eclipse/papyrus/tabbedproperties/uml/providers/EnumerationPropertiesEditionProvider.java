...
import org.eclipse.papyrus.tabbedproperties.uml.components.EnumerationPropertiesEditionComponent;
 ...
 */
public class EnumerationPropertiesEditionProvider implements IPropertiesEditionProvider {
	...
	public boolean provides(EObject eObject) {
		return (eObject instanceof Enumeration) && (UMLPackage.eINSTANCE.getEnumeration() == eObject.eClass());
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode) {
		if (eObject instanceof Enumeration) {
			return new EnumerationPropertiesEditionComponent(eObject, editing_mode);
		}
		return null;
	}
	...
	public IPropertiesEditionComponent getPropertiesEditionComponent(EObject eObject, String editing_mode, String part) {
		if (eObject instanceof Enumeration) {
			if (EnumerationBasePropertiesEditionComponent.BASE_PART.equals(part))
				return new EnumerationBasePropertiesEditionComponent(eObject, editing_mode);
