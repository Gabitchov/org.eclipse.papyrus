...
public class AlfSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == AlfPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case AlfPackage.CLEAR_ASSOC_EXPRESSION:
				if(context == grammarAccess.getClearAssocExpressionRule() ||
				   context == grammarAccess.getLinkOperationExpressionRule() ||
				   context == grammarAccess.getSuffixExpressionRule()) {
					sequence_ClearAssocExpression(context, (ClearAssocExpression) semanticObject); 
					return; 
				}
				else break;
			...
			case AlfPackage.CREATE_OR_DESTROY_LINK_OPERATION_EXPRESSION:
				if(context == grammarAccess.getCreateOrDestroyLinkOperationExpressionRule() ||
				   context == grammarAccess.getLinkOperationExpressionRule() ||
				   context == grammarAccess.getSuffixExpressionRule()) {
					sequence_CreateOrDestroyLinkOperationExpression(context, (CreateOrDestroyLinkOperationExpression) semanticObject); 
					return; 
				}
				else break;
	 ...
	 *     end=Expression
	 */
	protected void sequence_ClearAssocExpression(EObject context, ClearAssocExpression semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, AlfPackage.Literals.CLEAR_ASSOC_EXPRESSION__END) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlfPackage.Literals.CLEAR_ASSOC_EXPRESSION__END));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getClearAssocExpressionAccess().getEndExpressionParserRuleCall_3_0(), semanticObject.getEnd());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_CreateOrDestroyLinkOperationExpression(EObject context, CreateOrDestroyLinkOperationExpression semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, AlfPackage.Literals.CREATE_OR_DESTROY_LINK_OPERATION_EXPRESSION__KIND) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlfPackage.Literals.CREATE_OR_DESTROY_LINK_OPERATION_EXPRESSION__KIND));
			if(transientValues.isValueTransient(semanticObject, AlfPackage.Literals.CREATE_OR_DESTROY_LINK_OPERATION_EXPRESSION__TUPLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, AlfPackage.Literals.CREATE_OR_DESTROY_LINK_OPERATION_EXPRESSION__TUPLE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getCreateOrDestroyLinkOperationExpressionAccess().getKindLinkOperationKindEnumRuleCall_1_0(), semanticObject.getKind());
		feeder.accept(grammarAccess.getCreateOrDestroyLinkOperationExpressionAccess().getTupleLinkOperationTupleParserRuleCall_2_0(), semanticObject.getTuple());
		feeder.finish();
	}
