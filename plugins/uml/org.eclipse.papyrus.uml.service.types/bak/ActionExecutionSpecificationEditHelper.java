 ...
 * 
 */
public class ActionExecutionSpecificationEditHelper extends DefaultUMLHelper {

	protected ICommand getDestroyElementCommand(DestroyElementRequest req) {

		ActionExecutionSpecification l = (ActionExecutionSpecification)req.getElementToDestroy();
		...
		ddrCommand = CompositeCommand.compose(ddrCommand, ddr.getDestroyDependentCommand(l.getStart()));
		ddrCommand = CompositeCommand.compose(ddrCommand, ddr.getDestroyDependentCommand(l.getFinish()));
