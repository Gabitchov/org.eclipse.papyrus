 ...
 * 
 */
public class DefaultUMLHelper extends AbstractEditHelper {

	//	protected ICommand getDestroyDependentsCommand(DestroyDependentsRequest req) {
	//
	//		if((req.getClientContext() != null) && (req.getContainer() != null)) {
	//			IElementType et = ElementTypeRegistry.getInstance().getElementType(req.getContainer(), req.getClientContext());
	//			return et.getEditCommand(req);
	//		}
	//		return null;
	//	}
	...
	//
	//		// Role
	//		if((UMLPackage.eINSTANCE.getCollaboration_CollaborationRole() == req.getContainingFeature()) || (UMLPackage.eINSTANCE.getLifeline_CoveredBy() == req.getContainingFeature())) {
	//
