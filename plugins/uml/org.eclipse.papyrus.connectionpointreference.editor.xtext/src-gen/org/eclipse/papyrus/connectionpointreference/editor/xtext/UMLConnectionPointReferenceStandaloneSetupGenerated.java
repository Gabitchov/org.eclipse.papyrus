...
public class UMLConnectionPointReferenceStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.papyrus.connectionpointreference.editor.xtext.UMLConnectionPointReferenceRuntimeModule());
	}
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/papyrus/connectionpointreference/editor/xtext/UMLConnectionPointReference")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/papyrus/connectionpointreference/editor/xtext/UMLConnectionPointReference", org.eclipse.papyrus.connectionpointreference.editor.xtext.uMLConnectionPointReference.UMLConnectionPointReferencePackage.eINSTANCE);
	}
