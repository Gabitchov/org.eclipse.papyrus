...
public class UmlParameterActivator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		try {
			...
			injectors.put("org.eclipse.papyrus.parameter.editor.xtext.UmlParameter", Guice.createInjector(
				Modules.override(Modules.override(getRuntimeModule("org.eclipse.papyrus.parameter.editor.xtext.UmlParameter")).with(getUiModule("org.eclipse.papyrus.parameter.editor.xtext.UmlParameter"))).with(getSharedStateModule())
			));
