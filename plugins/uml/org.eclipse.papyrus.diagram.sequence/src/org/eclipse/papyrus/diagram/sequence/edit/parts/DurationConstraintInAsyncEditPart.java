 ...
 * @generated
 */
public class DurationConstraintInAsyncEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationConstraintInAsyncEditPart.VISUAL_ID), new Point(1, -13));
	}

	/**
	 * @generated
	 */
	public DurationConstraintInAsyncEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Message_4004, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationConstraintInAsyncEditPart.VISUAL_ID));
		}
		return parser;
	}
