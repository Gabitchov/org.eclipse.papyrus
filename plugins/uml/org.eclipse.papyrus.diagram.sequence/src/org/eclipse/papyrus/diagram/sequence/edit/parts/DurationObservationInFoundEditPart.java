 ...
 * @generated
 */
public class DurationObservationInFoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationObservationInFoundEditPart.VISUAL_ID), new Point(1, -13));
	}

	/**
	 * @generated
	 */
	public DurationObservationInFoundEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Message_4009, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationObservationInFoundEditPart.VISUAL_ID));
		}
		return parser;
	}
