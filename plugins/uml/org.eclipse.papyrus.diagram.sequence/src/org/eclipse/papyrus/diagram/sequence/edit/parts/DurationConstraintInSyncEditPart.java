 ...
 * @generated
 */
public class DurationConstraintInSyncEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationConstraintInSyncEditPart.VISUAL_ID), new Point(1, -13));
	}

	/**
	 * @generated
	 */
	public DurationConstraintInSyncEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Message_4003, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationConstraintInSyncEditPart.VISUAL_ID));
		}
		return parser;
	}
