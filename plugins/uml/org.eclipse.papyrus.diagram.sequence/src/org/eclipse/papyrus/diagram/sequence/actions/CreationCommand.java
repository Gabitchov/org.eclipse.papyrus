...
/**
 * Define a command to create a new Sequence Diagram.
 * 
 * @author <a href="mailto:jerome.benois@obeo.fr">Jerome Benois</a>
 */
public class CreationCommand extends CreateGmfSequenceDiagramCommandHandler implements ICreationCommand {
