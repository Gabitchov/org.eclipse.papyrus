 ...
 * @generated
 */
public class DurationObservationInReplyEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationObservationInReplyEditPart.VISUAL_ID), new Point(1, -13));
	}

	/**
	 * @generated
	 */
	public DurationObservationInReplyEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.Message_4005, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.sequence.edit.parts.DurationObservationInReplyEditPart.VISUAL_ID));
		}
		return parser;
	}
