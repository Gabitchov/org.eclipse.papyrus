 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.uml.standard.impl.RefineImpl#getBase_Abstraction <em>Base
 * Abstraction</em>}</li>
 * </ul>
 * </p>
 * 
...
public class RefineImpl extends EObjectImpl implements Refine {
		...
		if (base_Abstraction != null && base_Abstraction.eIsProxy()) {
			...
			if (base_Abstraction != oldBase_Abstraction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StandardPackage.REFINE__BASE_ABSTRACTION,
	...
	public void setBase_Abstraction(Abstraction newBase_Abstraction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StandardPackage.REFINE__BASE_ABSTRACTION,
					oldBase_Abstraction, base_Abstraction));
	}
