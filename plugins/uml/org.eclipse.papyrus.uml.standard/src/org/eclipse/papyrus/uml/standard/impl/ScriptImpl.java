 ...
 * <ul>
 * <li>{@link org.eclipse.papyrus.uml.standard.impl.ScriptImpl#getBase_Artifact <em>Base Artifact
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class ScriptImpl extends EObjectImpl implements Script {
		...
		if (base_Artifact != null && base_Artifact.eIsProxy()) {
			...
			if (base_Artifact != oldBase_Artifact) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StandardPackage.SCRIPT__BASE_ARTIFACT,
	...
	public void setBase_Artifact(Artifact newBase_Artifact) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StandardPackage.SCRIPT__BASE_ARTIFACT,
					oldBase_Artifact, base_Artifact));
	}
