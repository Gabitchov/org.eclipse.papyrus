 ...
 * @generated
 */
public class EnumerationCNPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public EnumerationCNPreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_EnumerationCN");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ProfileDiagramEditPart.MODEL_ID + "_EnumerationCN";
