...
public class ConstraintCNPreferencePage extends AbstractPapyrusNodePreferencePage {
	 ...
	 * @generated
	 */
	public ConstraintCNPreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_ConstraintCN");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ProfileDiagramEditPart.MODEL_ID + "_ConstraintCN";
