 ...
 * @generated
 */
public class DataTypeOperationPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public DataTypeOperationPreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_DataTypeOperation");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ProfileDiagramEditPart.MODEL_ID + "_DataTypeOperation";
