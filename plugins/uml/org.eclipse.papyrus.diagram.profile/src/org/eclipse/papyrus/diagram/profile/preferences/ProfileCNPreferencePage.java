 ...
 * @generated
 */
public class ProfileCNPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public ProfileCNPreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_ProfileCN");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ProfileDiagramEditPart.MODEL_ID + "_ProfileCN";
