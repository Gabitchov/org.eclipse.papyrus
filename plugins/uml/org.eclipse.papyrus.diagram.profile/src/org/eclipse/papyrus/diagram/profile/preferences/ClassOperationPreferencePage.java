...
public class ClassOperationPreferencePage extends AbstractPapyrusNodePreferencePage {
	 ...
	 * @generated
	 */
	public ClassOperationPreferencePage() {
		super();
		setPreferenceKey(ProfileDiagramEditPart.MODEL_ID + "_ClassOperation");
	}
	...
	public static void initDefaults(IPreferenceStore store) {
		...
		String key = ProfileDiagramEditPart.MODEL_ID + "_ClassOperation";
