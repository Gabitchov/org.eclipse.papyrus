 ...
 **/
public class ControlFlowHandler extends UMLHandler implements IHandler {

	/**
	 ** The Class ReplyActionCreateCommand in charge to create a element Reply
	 **/
	protected Command getCommand() throws ExecutionException {
		CreateElementRequest request = new CreateElementRequest(UMLElementTypes.CONTROLFLOW);
