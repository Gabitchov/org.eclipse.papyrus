...
import org.eclipse.papyrus.diagram.deployment.edit.policies.CommunicationPathItemSemanticEditPolicy;
...
public class CommunicationPathEditPart extends UMLConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if(childEditPart instanceof CommunicationPathAppliedStereotypeEditPart) {
			((CommunicationPathAppliedStereotypeEditPart)childEditPart).setLabel(getPrimaryShape().getAppliedStereotypeAssociationLabel());
			return true;
		}
		return false;
	}
