	...
	public PaletteCustomizerDialog getCustomizerDialog() {
		if(customizerDialog == null) {
			try {
				...
				Class<PaletteCustomizerDialog> advancedCustomizerDialogClass = Activator.getDefault().getBundle().loadClass("org.eclipse.papyrus.diagram.common.palette.customization.dialog.PapyrusPaletteCustomizerDialog");
