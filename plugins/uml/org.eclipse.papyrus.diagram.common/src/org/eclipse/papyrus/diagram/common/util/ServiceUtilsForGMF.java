...
public class ServiceUtilsForGMF extends AbstractServiceUtils<IDiagramEditDomain> {
	 ...
	 * Throw an exception if the ServiceRegistry can't be found.
	 * <br>
	 ...
	 *
	 * @param domain The domain associated to an EditPart.
	 * @return
	 * @throws ServiceException If an error occurs
	 * @throws ServiceNotFoundException If the ServiceRegistry can't be found from the domain
	 */
	@Override
