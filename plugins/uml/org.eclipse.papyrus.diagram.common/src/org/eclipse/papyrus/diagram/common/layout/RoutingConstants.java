...
public class RoutingConstants {
	...
	public static final String ROUTING_HORIZONTALLY_BY_LEFT = "org.eclipse.papyrus.diagram.common.routing_horizontally_by_left"; //$NON-NLS-1$

	/** id for the vertical routing moving the right anchor */
	public static final String ROUTING_HORIZONTALLY_BY_RIGHT = "org.eclipse.papyrus.diagram.common.routing_horizontally_by_right"; //$NON-NLS-1$

	/** id for the vertical routing moving the top anchor */
	public static final String ROUTING_VERTICALLY_BY_TOP = "org.eclipse.papyrus.diagram.common.routing_vertically_by_top"; //$NON-NLS-1$

	/** id for the vertical routing moving the bottom anchor */
	public static final String ROUTING_VERTICALLY_BY_BOTTOM = "org.eclipse.papyrus.diagram.common.routing_vertically_by_bottom"; //$NON-NLS-1$
	...
	public static final String ROUTING_VERTICALLY_BY_TOP_ACTION = "org.eclipse.papyrus.diagram.common.routing_vertically_by_top_action"; //$NON-NLS-1$

	/** id for the vertical routing moving the bottom anchor for popup menu */
	public static final String ROUTING_VERTICALLY_BY_BOTTOM_ACTION = "org.eclipse.papyrus.diagram.common.routing_vertically_by_bottom_action"; //$NON-NLS-1$
