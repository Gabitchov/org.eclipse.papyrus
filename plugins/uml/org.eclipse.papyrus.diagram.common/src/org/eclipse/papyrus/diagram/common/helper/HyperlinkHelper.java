...
/**
 * The Class HyperlinkHelper, contains all methods to manipulate information about hyperlinks in a model
 */
public class HyperlinkHelper {
	 ...
	 * @param object the object where it is attached the information
	 * @param localization the localization of the document
	 * @param tooltipText the tooltip text
	 * 
	 * @return the adds the hyper link command
	 */
	public static RecordingCommand getAddHyperLinkDocumentCommand(TransactionalEditingDomain domain, EModelElement object,
			String tooltipText, String localization) {
	 ...
	 * 
	 * @param domain the domain to execute the command
	 * @param object the object where it is attached the information
	...
	public static RecordingCommand getAddHyperLinkWebCommand(TransactionalEditingDomain domain, EModelElement object,
		...
		return new CreateHyperLinkWebCommand(domain, object, tooltiptext,
				link);
	}
	 ...
	 */
	public static RecordingCommand getAddHyperLinkDiagamCommand(TransactionalEditingDomain domain, EModelElement object,
			String tooltiptext,String diagramName, EModelElement diagram) {
	 ...
	 * 
	 * @param domain the domain to execute the command
	 * @param object the object where was attached the information
	 * @param localization the localization or link 
	 * 
	 ...
	 * 
	 * @param domain the domain to execute the commmand
	 * @param object the object where the information is attached
	 * @param diagram the diagram to remove
	 * 
	 * @return the removes the hyperlink diagram command
	 */
	public static RecordingCommand getRemoveHyperlinkDiagramCommand(TransactionalEditingDomain domain, EModelElement object,
			EModelElement diagram) {
	 ...
	 * 
	 * @param object the object where we look for information
	...
	/**
	 * Gets the empty all hyper link command.
	 *  to clean all hyperlinks
	 * @param domain the domain to execute the command
	 * @param object the object where is attached information
	 * 
