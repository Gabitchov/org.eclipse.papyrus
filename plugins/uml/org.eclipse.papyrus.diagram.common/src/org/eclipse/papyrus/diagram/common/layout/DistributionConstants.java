...
public class DistributionConstants {
	...
	public static final String DISTRIBUTE_H_CONTAINER = "org.eclipse.papyrus.diagram.common.distribute_horizontally"; //$NON-NLS-1$

	/** id for the horizontal distribution between nodes */
	public static final String DISTRIBUTE_H_NODES = "org.eclipse.papyrus.diagram.common.distribute_horizontally_between_nodes"; //$NON-NLS-1$

	/** id for the vertical distribution in the parent container */
	public static final String DISTRIBUTE_V_CONTAINER = "org.eclipse.papyrus.diagram.common.distribute_vertically"; //$NON-NLS-1$

	/** id for the vertical distribution between nodes */
	public static final String DISTRIBUTE_V_NODES = "org.eclipse.papyrus.diagram.common.distribute_vertically_between_nodes"; //$NON-NLS-1$

	/** id for the horizontal distribution in container action */
	public static final String ACTION_DISTRIBUTE_H_CONTAINER = "org.eclipse.papyrus.diagram.common.distribute_horizontally_action"; //$NON-NLS-1$

	/** id for the horizontal distribution between nodes action */
	public static final String ACTION_DISTRIBUTE_H_NODES = "org.eclipse.papyrus.diagram.common.distribute_horizontally_between_nodes_action"; //$NON-NLS-1$

	/** id for the vertical distribution in container action */
	public static final String ACTION_DISTRIBUTE_V_CONTAINER = "org.eclipse.papyrus.diagram.common.distribute_vertically_action"; //$NON-NLS-1$

	/** id for the vertical distribution between nodes action */
	public static final String ACTION_DISTRIBUTE_V_NODES = "org.eclipse.papyrus.diagram.common.distribute_vertically_between_nodes_action"; //$NON-NLS-1$
