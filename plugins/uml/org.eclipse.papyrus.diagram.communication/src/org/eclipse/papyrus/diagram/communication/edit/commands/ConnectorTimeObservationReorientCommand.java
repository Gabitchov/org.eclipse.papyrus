...
public class ConnectorTimeObservationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistTimeObservationEvent_4013(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistTimeObservationEvent_4013(getOldSource(), getNewTarget());
	}
