 ...
 * <ul>
 *   <li>{@link org.eclipse.papyrus.collaborationuse.editor.xtext.umlCollaborationUse.impl.TypeRuleImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.eclipse.papyrus.collaborationuse.editor.xtext.umlCollaborationUse.impl.TypeRuleImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeRuleImpl extends MinimalEObjectImpl.Container implements TypeRule
{
  ...
  public NotificationChain basicSetPath(QualifiedName newPath, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UmlCollaborationUsePackage.TYPE_RULE__PATH, oldPath, newPath);
  ...
  public void setPath(QualifiedName newPath)
  {
    if (newPath != path)
    {
      ...
      if (path != null)
        msgs = ((InternalEObject)path).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UmlCollaborationUsePackage.TYPE_RULE__PATH, null, msgs);
      if (newPath != null)
        msgs = ((InternalEObject)newPath).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UmlCollaborationUsePackage.TYPE_RULE__PATH, null, msgs);
      msgs = basicSetPath(newPath, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlCollaborationUsePackage.TYPE_RULE__PATH, newPath, newPath));
  }
  ...
  public Collaboration getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlCollaborationUsePackage.TYPE_RULE__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(Collaboration newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmlCollaborationUsePackage.TYPE_RULE__TYPE, oldType, type));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmlCollaborationUsePackage.TYPE_RULE__PATH:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmlCollaborationUsePackage.TYPE_RULE__PATH:
        return getPath();
      case UmlCollaborationUsePackage.TYPE_RULE__TYPE:
