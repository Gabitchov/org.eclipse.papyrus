...
public interface UmlCollaborationUsePackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference '{@link org.eclipse.papyrus.collaborationuse.editor.xtext.umlCollaborationUse.TypeRule#getPath <em>Path</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Path</em>'.
   * @see org.eclipse.papyrus.collaborationuse.editor.xtext.umlCollaborationUse.TypeRule#getPath()
   * @see #getTypeRule()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the reference '{@link org.eclipse.papyrus.collaborationuse.editor.xtext.umlCollaborationUse.TypeRule#getType <em>Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Type</em>'.
   * @see org.eclipse.papyrus.collaborationuse.editor.xtext.umlCollaborationUse.TypeRule#getType()
   * @see #getTypeRule()
   * @generated
   */
