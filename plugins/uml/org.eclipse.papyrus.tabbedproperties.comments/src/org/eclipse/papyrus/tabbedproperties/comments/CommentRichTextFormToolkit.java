...
public class CommentRichTextFormToolkit {
	 ...
	 * @return a new <code>IRichText</code> instance
	 */
	public static CommentRichTextEditor createRichTextEditor(FormToolkit toolkit, Composite parent, String text,
			Comment comment, int style, IEditorSite editorSite) {
		CommentRichTextEditor richTextEditor = new CommentRichTextEditor(parent, toolkit.getBorderStyle() | style
				| toolkit.getOrientation(), null, comment, null, editorSite);
