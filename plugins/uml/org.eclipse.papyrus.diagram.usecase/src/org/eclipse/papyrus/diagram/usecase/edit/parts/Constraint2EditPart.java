...
import org.eclipse.papyrus.diagram.usecase.edit.policies.Constraint2ItemSemanticEditPolicy;
...
ShapeNodeEditPart {
	...
	public List/* <org.eclipse.gmf.runtime.emf.type.core.IElementType> */getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof org.eclipse.papyrus.diagram.usecase.edit.parts.Constraint2EditPart) {
			types.add(UMLElementTypes.ConstraintConstrainedElement_4012);
		}
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("Constraint",
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("Constraint",
