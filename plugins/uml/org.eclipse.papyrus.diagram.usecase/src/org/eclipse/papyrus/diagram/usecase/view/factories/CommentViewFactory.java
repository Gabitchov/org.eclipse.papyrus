...
public class CommentViewFactory extends AbstractShapeViewFactory {
	...
	protected void initializeFromPreferences(View view) {
		...
		NodeViewInitializer viewInitializer = new NodeViewInitializer(view,
				store);
		viewInitializer
				.initFillColor(IPapyrusPreferencesConstant.COMMENT_2010_PREF_FILL_COLOR);
		viewInitializer
				.initFont(IPapyrusPreferencesConstant.COMMENT_2010_PREF_FONT);
		viewInitializer
				.initFontColor(IPapyrusPreferencesConstant.COMMENT_2010_PREF_FONT_COLOR);
		viewInitializer
				.initLineColor(IPapyrusPreferencesConstant.COMMENT_2010_PREF_LINE_COLOR);
