		...
		try {
			Object value_0 = UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getUseCase()).evaluate(
							instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
		...
		try {
			Object value_0 = UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getComponent()).evaluate(
							instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
		...
		try {
			Object value_0 = UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getPackage()).evaluate(
							instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
		...
		try {
			Object value_0 = UMLOCLFactory
					.getExpression(
							...
							UMLPackage.eINSTANCE.getExtensionPoint()).evaluate(
							instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
