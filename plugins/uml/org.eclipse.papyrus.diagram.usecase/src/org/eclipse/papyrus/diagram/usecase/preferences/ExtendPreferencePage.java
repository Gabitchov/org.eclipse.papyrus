...
public class ExtendPreferencePage extends AbstractPapyrusLinkPreferencePage {
	...
	protected String getJumpLinkReversePreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_JUMPLINK_REVERSE;
	}
	...
	protected String getJumpLinkStatusPreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_JUMPLINK_STATUS;
	}
	...
	protected String getJumpLinkTypePreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_JUMPLINK_TYPE;
	}
	...
	protected String getRoutingDistancePolicyPreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_ROUTING_DISTANCE_POLICY;
	}
	...
	protected String getRoutingObstructionPolicyPreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_ROUTING_OBSTRUCTION_POLICY;
	}
	...
	protected String getRoutingStylePreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_ROUTING_STYLE;
	}
	...
	protected String getSmoothnessPreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_SMOOTHNESS;
	}
	...
	protected String getFontPreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_FONT;
	}
	...
	protected String getLineColorPreferenceName() {
		return IPapyrusPreferencesConstant.EXTEND_PREF_LINE_COLOR;
	}
