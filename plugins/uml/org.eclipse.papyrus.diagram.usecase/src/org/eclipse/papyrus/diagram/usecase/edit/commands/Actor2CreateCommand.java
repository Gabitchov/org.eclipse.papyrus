 ...
 * @generated
 */
public class Actor2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Actor2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Actor2CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Actor2CreateCommand(req, eObject);
	}
