...
public class UseCasePointsInRectangleCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getUseCaseExtensionpoints_7010SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater.getUseCaseExtensionpoints_7010SemanticChildren((View)getHost().getModel());
