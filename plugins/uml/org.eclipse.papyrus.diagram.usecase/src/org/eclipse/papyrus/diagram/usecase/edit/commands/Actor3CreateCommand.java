 ...
 * @generated
 */
public class Actor3CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Actor3CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Actor3CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Actor3CreateCommand(req, eObject);
	}
