...
public class UseCasePreferencePage extends AbstractPapyrusNodePreferencePage {
	...
	protected String getFillColorPreferenceName() {
		return IPapyrusPreferencesConstant.USECASE_PREF_FILL_COLOR;
	}
	...
	protected String getGradientColorPreferenceName() {
		return IPapyrusPreferencesConstant.USECASE_PREF_GRADIENT_COLOR;
	}
	...
	protected String getFillPolicyPreferenceName() {
		return IPapyrusPreferencesConstant.USECASE_PREF_GRADIENT_POLICY;
	}
	...
	protected String getFontColorPreferenceName() {
		return IPapyrusPreferencesConstant.USECASE_PREF_FONT_COLOR;
	}
	...
	protected String getFontPreferenceName() {
		return IPapyrusPreferencesConstant.USECASE_PREF_FONT;
	}
	...
	protected String getLineColorPreferenceName() {
		return IPapyrusPreferencesConstant.USECASE_PREF_LINE_COLOR;
	}
