...
public class FileItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addBase_ArtifactPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_File_base_Artifact_feature"), getString(
				"_UI_PropertyDescriptor_description", "_UI_File_base_Artifact_feature", "_UI_File_type"),
				StandardPackage.Literals.FILE__BASE_ARTIFACT, true, false, true, null, null, null));
	}
