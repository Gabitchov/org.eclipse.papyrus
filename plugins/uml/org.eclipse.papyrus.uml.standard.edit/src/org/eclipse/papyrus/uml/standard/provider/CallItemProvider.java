...
public class CallItemProvider extends ResourceEObjectItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addBase_UsagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
				...
				getResourceLocator(),
				getString("_UI_Call_base_Usage_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Call_base_Usage_feature", "_UI_Call_type"),
				StandardPackage.Literals.CALL__BASE_USAGE,
				true,
				false,
				true,
				null,
