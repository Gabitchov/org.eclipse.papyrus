...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.uml.standard.Framework} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class FrameworkItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addBase_PackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory)
				.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Framework_base_Package_feature"),
				getString("_UI_PropertyDescriptor_description", "_UI_Framework_base_Package_feature",
				"_UI_Framework_type"), StandardPackage.Literals.FRAMEWORK__BASE_PACKAGE, true, false, true,
				null, null, null));
	}

	/**
	 * This returns Framework.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
