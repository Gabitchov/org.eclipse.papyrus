...
public class UmlTransitionActivator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		INSTANCE = this;
		try {
			registerInjectorFor("org.eclipse.papyrus.uml.textedit.transition.xtext.UmlTransition");
	...
	protected Module getRuntimeModule(String grammar) {
		if ("org.eclipse.papyrus.uml.textedit.transition.xtext.UmlTransition".equals(grammar)) {
