...
public class UmlMessageActivator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		INSTANCE = this;
		try {
			registerInjectorFor("org.eclipse.papyrus.uml.textedit.message.xtext.UmlMessage");
	...
	protected Module getRuntimeModule(String grammar) {
		if ("org.eclipse.papyrus.uml.textedit.message.xtext.UmlMessage".equals(grammar)) {
