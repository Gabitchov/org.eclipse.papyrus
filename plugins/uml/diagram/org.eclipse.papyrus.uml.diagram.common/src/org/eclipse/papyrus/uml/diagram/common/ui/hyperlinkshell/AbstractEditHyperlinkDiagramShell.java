...
public class AbstractEditHyperlinkDiagramShell {
	...
	protected void createEditHyperlinkShell() {
		...
		// DiagramLogolabel.setImage(new Image(Display.getCurrent(),
		// "C:/Tessier/PROTOTYPE/papyrusII/DEVELOPMENT/GalileoM6/org.eclipse.papyrus.uml.diagram.common/icons/obj16/Clause.gif"));

		DiagramLogolabel.setImage(AbstractUIPlugin.imageDescriptorFromPlugin("org.eclipse.papyrus.uml.diagram.common", "/icons/obj16/Clause.gif").createImage());
