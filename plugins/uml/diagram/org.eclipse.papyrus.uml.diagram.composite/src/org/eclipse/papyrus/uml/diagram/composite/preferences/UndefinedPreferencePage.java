 ...
 * @generated
 */
public class UndefinedPreferencePage extends AbstractPapyrusNodePreferencePage {

	/**
	 * @generated
	 */
	public UndefinedPreferencePage() {
		super();
		setPreferenceKey(CompositeStructureDiagramEditPart.MODEL_ID + "_Undefined");
	}
