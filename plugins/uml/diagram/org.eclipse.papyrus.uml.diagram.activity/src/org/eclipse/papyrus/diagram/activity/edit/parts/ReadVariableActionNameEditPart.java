 ...
 * @generated
 */
public class ReadVariableActionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ReadVariableAction_3097, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ReadVariableActionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
