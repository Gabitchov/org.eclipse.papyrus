...

{
	...
	public IParser getParser() {
		if(this.parser == null) {
			this.parser = UMLParserProvider.getParser(UMLElementTypes.DestructionOccurrenceSpecification_27, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.timing.edit.parts.DestructionOccurrenceSpecificationAppliedStereotypeEditPart.VISUAL_ID));
		}
		return this.parser;
	}
				...
				if(Window.OK == dialog.open()) {
					...
					final RecordingCommand command = new RecordingCommand(domain, "Edit Label") {
						...
						protected void doExecute() {
							DestructionOccurrenceSpecificationAppliedStereotypeEditPart.this.configuration.postEditAction(resolveSemanticElement(), ((ILabelEditorDialog)finalDialog).getValue());
