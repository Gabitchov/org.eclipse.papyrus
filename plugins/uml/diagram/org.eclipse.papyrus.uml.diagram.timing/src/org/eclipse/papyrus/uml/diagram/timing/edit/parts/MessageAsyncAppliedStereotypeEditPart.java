...

{
	...
	public IParser getParser() {
		if(this.parser == null) {
			this.parser = UMLParserProvider.getParser(UMLElementTypes.Message_4, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.timing.edit.parts.MessageAsyncAppliedStereotypeEditPart.VISUAL_ID));
		}
		return this.parser;
	}
				...
				if(Window.OK == dialog.open()) {
					...
					final RecordingCommand command = new RecordingCommand(domain, "Edit Label") {
						...
						protected void doExecute() {
							MessageAsyncAppliedStereotypeEditPart.this.configuration.postEditAction(resolveSemanticElement(), ((ILabelEditorDialog)finalDialog).getValue());
