	...
	public void init_Interface_2003(Interface instance) {
		try {
			Object value_0 = UMLOCLFactory.getExpression(2,
					UMLPackage.eINSTANCE.getInterface(), null).evaluate(
					instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
	...
	public void init_Port_3069(Port instance) {
		try {
			Object value_0 = UMLOCLFactory.getExpression(1,
					UMLPackage.eINSTANCE.getPort(), null).evaluate(instance);
			instance.setName((String) value_0);
	...
	public void init_Usage_4001(Usage instance) {
		try {
			Object value_0 = UMLOCLFactory.getExpression(3,
					UMLPackage.eINSTANCE.getUsage(), null).evaluate(instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
					"Element initialization failed", e); //$NON-NLS-1$						
	...
	public void init_InterfaceRealization_4006(InterfaceRealization instance) {
		try {
			Object value_0 = UMLOCLFactory.getExpression(4,
					UMLPackage.eINSTANCE.getInterfaceRealization(), null)
					.evaluate(instance);
			instance.setName((String) value_0);
		} catch (RuntimeException e) {
			UMLDiagramEditorPlugin.getInstance().logError(
