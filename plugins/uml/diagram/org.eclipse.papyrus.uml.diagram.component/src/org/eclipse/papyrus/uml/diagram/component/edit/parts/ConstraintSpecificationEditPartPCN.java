 ...
 * @generated
 */
public class ConstraintSpecificationEditPartPCN extends
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Constraint_3075,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.component.edit.parts.ConstraintSpecificationEditPartPCN.VISUAL_ID));
		}
		return parser;
	}
