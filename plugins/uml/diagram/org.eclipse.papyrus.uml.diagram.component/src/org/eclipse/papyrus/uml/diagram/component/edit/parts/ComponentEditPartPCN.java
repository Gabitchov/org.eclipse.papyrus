...
public class ComponentEditPartPCN extends CompositeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComponentItemSemanticEditPolicyPCN());
		...
		// new
		// org.eclipse.papyrus.uml.diagram.component.edit.policies.ComponentCanonicalEditPolicyPCN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentCompositeCompartmentEditPartPCN) {
			...
			pane.add(((ComponentCompositeCompartmentEditPartPCN) childEditPart)
					.getFigure());
			return true;
		}
		...
		if (childEditPart instanceof PortEditPart) {
			IBorderItemLocator locator = new PortPositionLocator(
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentCompositeCompartmentEditPartPCN) {
			IFigure pane = getPrimaryShape().getCompositeCompartmentFigure();
			pane.remove(((ComponentCompositeCompartmentEditPartPCN) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof PortEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(ComponentNameEditPartPCN.VISUAL_ID));
	}
