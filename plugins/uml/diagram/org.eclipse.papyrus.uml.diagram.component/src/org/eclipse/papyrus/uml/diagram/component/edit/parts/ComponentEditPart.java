 ...
 */
public class ComponentEditPart extends CompositeEditPart implements
		IPapyrusEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		// new
		// org.eclipse.papyrus.uml.diagram.component.edit.policies.ComponentCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentCompositeCompartmentEditPart) {
			...
			pane.add(((ComponentCompositeCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentCompositeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCompositeCompartmentFigure();
			pane.remove(((ComponentCompositeCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof PortEditPart) {
