...
public class UMLOCLFactory {
	...
	private static UMLOCLFactory getInstance() {
		UMLOCLFactory instance = UMLDiagramEditorPlugin.getInstance()
				.getUMLOCLFactory();
		if (instance == null) {
			UMLDiagramEditorPlugin.getInstance().setUMLOCLFactory(
	 ...
	 * @generated
	 */
	public static UMLAbstractExpression getExpression(int index,
