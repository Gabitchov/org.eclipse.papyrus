...
public class ComponentEditPartCN extends CompositeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		// new
		// org.eclipse.papyrus.uml.diagram.component.edit.policies.ComponentCanonicalEditPolicyCN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentCompositeCompartmentEditPartCN) {
			...
			pane.add(((ComponentCompositeCompartmentEditPartCN) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentCompositeCompartmentEditPartCN) {
			IFigure pane = getPrimaryShape().getCompositeCompartmentFigure();
			pane.remove(((ComponentCompositeCompartmentEditPartCN) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof PortEditPart) {
