 ...
 * @generated
 */
public class ComponentNameEditPart extends PapyrusCompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.component.edit.parts.ComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
