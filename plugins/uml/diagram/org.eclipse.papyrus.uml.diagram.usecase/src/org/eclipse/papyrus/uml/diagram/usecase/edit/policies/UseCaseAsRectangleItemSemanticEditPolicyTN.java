 ...
 * @generated
 */
public class UseCaseAsRectangleItemSemanticEditPolicyTN extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (UMLElementTypes.Include_4008 == req.getElementType()) {
			return getGEFWrapper(new IncludeCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
		if (UMLElementTypes.Extend_4009 == req.getElementType()) {
			return getGEFWrapper(new ExtendCreateCommand(req, req.getSource(),
					req.getTarget()));
		}
