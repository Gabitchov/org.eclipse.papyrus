 ...
 * @generated
 */
public class SubjectClassNameEditPartTN extends PapyrusCompartmentEditPart
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Class_2020,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.SubjectClassNameEditPartTN.VISUAL_ID));
		}
		return parser;
	}
