 ...
 * @generated
 */
public class PackageImportAppliedStereotypeEditPart extends
		PapyrusLabelEditPart implements ITextAwareEditPart, ILabelRoleProvider {
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.PackageImportAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, -20));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new UseCaseDiagramEditPart.LinkLabelDragPolicy());
	}
