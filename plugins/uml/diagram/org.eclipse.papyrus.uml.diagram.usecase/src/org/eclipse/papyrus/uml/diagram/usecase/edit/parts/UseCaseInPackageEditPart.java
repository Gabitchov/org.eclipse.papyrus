 ...
 */
public class UseCaseInPackageEditPart extends ShapeNodeEditPart implements
		IPapyrusEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UseCaseInPackageItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UseCaseInPackageNameEditPart) {
			((UseCaseInPackageNameEditPart) childEditPart)
		...
		if (childEditPart instanceof UseCasePointsInPackageEditPart) {
			...
			pane.add(((UseCasePointsInPackageEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UseCasePointsInPackageEditPart) {
			IFigure pane = getPrimaryShape().getUseCaseFigure_contents();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((UseCasePointsInPackageEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
