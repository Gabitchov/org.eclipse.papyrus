 ...
 * @generated
 */
public class ConstraintInComponentNameEditPart extends
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Constraint_3017,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.ConstraintInComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
