 ...
 * @generated
 */
public class ConstraintInPackageEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ConstraintInPackageItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ConstraintInPackageNameEditPart) {
			((ConstraintInPackageNameEditPart) childEditPart)
