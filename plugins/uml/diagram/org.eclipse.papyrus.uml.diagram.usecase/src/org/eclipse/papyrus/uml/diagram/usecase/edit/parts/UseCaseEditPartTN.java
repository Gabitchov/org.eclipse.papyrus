 ...
 */
public class UseCaseEditPartTN extends ShapeNodeEditPart implements
		IPapyrusEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UseCaseItemSemanticEditPolicyTN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UseCaseNameEditPartTN) {
			((UseCaseNameEditPartTN) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(UseCaseNameEditPartTN.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == UMLElementTypes.ExtensionPoint_3007) {
				return getChildBySemanticHint(UMLVisualIDRegistry
						.getType(UseCasePointsEditPartTN.VISUAL_ID));
			}
		}
