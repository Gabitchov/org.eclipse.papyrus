 ...
 * @generated
 */
public class PackageNameEditPartTN extends PapyrusCompartmentEditPart implements
		ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.PackageNameEditPartTN.VISUAL_ID));
		}
		return parser;
	}
