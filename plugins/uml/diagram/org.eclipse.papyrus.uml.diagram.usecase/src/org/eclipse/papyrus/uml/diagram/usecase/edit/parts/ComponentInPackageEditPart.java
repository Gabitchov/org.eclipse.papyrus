 ...
 */
public class ComponentInPackageEditPart extends ShapeNodeEditPart implements
		IPapyrusEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComponentInPackageItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComponentInPackageNameEditPart) {
			((ComponentInPackageNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getUseCaseSubjectFigure_name());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ComponentUsecases3EditPart) {
			IFigure pane = getPrimaryShape().getUseCaseSubjectFigure_contents();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((ComponentUsecases3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public class UseCaseSubjectFigure extends AbstractSubjectFigure {
		...
		public UseCaseSubjectFigure() {
			...
			stereotypeHelper = new StereotypeFigureHelper(
	 ...
	 * @generated
	 */
	static final Font FUSECASESUBJECTFIGURE_NAME_FONT = new Font(
