...
public class UseCaseAsRectangleEditPartTN extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new UseCaseAsRectangleItemSemanticEditPolicyTN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof UseCaseAsRectangleNameEditPartTN) {
			((UseCaseAsRectangleNameEditPartTN) childEditPart)
					.setLabel(getPrimaryShape().getUseCaseAsClassFigure_name());
			return true;
		}
		...
		if (childEditPart instanceof UseCasePointsInRectangleEditPart) {
			...
			pane.add(((UseCasePointsInRectangleEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof UseCasePointsInRectangleEditPart) {
			IFigure pane = getPrimaryShape().getUseCaseAsClass_points();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((UseCasePointsInRectangleEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	 ...
	 * @generated
	 */
	static final Font FUSECASEASCLASSFIGURE_NAME_FONT = new Font(
