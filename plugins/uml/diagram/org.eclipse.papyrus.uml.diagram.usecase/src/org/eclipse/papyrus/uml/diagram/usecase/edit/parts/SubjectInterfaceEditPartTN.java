 ...
 * @generated
 */
public class SubjectInterfaceEditPartTN extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof SubjectInterfaceNameEditPartTN) {
			((SubjectInterfaceNameEditPartTN)childEditPart).setLabel(getPrimaryShape().getUseCaseSubjectFigure_name());
			return true;
		}
