...
public class SubjectInterfaceEditPartTN extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectInterfaceItemSemanticEditPolicyTN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubjectInterfaceNameEditPartTN) {
			((SubjectInterfaceNameEditPartTN) childEditPart)
		...
		if (childEditPart instanceof SubjectInterfaceUsecasesEditPart) {
			...
			pane.add(((SubjectInterfaceUsecasesEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SubjectInterfaceUsecasesEditPart) {
			IFigure pane = getPrimaryShape().getUseCasesContainerFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((SubjectInterfaceUsecasesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
