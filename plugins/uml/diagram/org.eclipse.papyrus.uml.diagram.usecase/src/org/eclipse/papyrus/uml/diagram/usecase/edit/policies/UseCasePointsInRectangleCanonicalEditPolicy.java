 ...
 * @generated
 */
public class UseCasePointsInRectangleCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ExtensionPointInRectangleEditPart.VISUAL_ID == UMLVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getUseCasePoints_7010SemanticChildren((View) getHost()
						.getModel());
