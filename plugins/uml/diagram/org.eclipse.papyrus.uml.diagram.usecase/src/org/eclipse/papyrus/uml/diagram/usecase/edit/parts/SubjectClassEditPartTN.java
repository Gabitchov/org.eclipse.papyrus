 ...
 * @generated
 */
public class SubjectClassEditPartTN extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof SubjectClassNameEditPartTN) {
			((SubjectClassNameEditPartTN)childEditPart).setLabel(getPrimaryShape().getUseCaseSubjectFigure_name());
			return true;
		}
