...
public class PackageEditPartTN extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PackageItemSemanticEditPolicyTN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PackageNameEditPartTN) {
			((PackageNameEditPartTN) childEditPart).setLabel(getPrimaryShape()
					.getNameLabel());
			return true;
		}
	...
	protected NodeFigure createNodePlate() {
		...
		IPreferenceStore store = UMLDiagramEditorPlugin.getInstance()
				.getPreferenceStore();
		String preferrenceContantWitdh = PreferenceInitializerForElementHelper
				.getpreferenceKey(getNotationView(), prefElementId,
						PreferenceConstantHelper.WIDTH);
		String preferrenceContantHeight = PreferenceInitializerForElementHelper
				.getpreferenceKey(getNotationView(), prefElementId,
						PreferenceConstantHelper.HEIGHT);
		DefaultSizeNodeFigure result = new PackageNodePlateFigure(
				store.getInt(preferrenceContantWitdh),
				store.getInt(preferrenceContantHeight));
		return result;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(PackageNameEditPartTN.VISUAL_ID));
	}
