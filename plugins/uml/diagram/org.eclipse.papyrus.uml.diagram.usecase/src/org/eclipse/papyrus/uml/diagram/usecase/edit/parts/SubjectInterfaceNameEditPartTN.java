 ...
 * @generated
 */
public class SubjectInterfaceNameEditPartTN extends PapyrusCompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new UseCaseDiagramEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.Interface_2021,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.SubjectInterfaceNameEditPartTN.VISUAL_ID));
		}
		return parser;
	}
