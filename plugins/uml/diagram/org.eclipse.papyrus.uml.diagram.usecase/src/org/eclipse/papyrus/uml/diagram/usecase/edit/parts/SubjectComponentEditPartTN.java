...
public class SubjectComponentEditPartTN extends NamedElementEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SubjectComponentItemSemanticEditPolicyTN());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubjectComponentNameEditPartTN) {
			((SubjectComponentNameEditPartTN) childEditPart)
		...
		if (childEditPart instanceof SubjectComponentUsecasesEditPart) {
			...
			pane.add(((SubjectComponentUsecasesEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SubjectComponentUsecasesEditPart) {
			IFigure pane = getPrimaryShape().getUseCasesContainerFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((SubjectComponentUsecasesEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
