...
public class IncludeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public IncludeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return UMLBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateInclude_4008(getContainer(), getSource(), getTarget());
	}
