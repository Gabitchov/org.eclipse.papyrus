 ...
 * @generated
 */
public class UseCaseAsRectangleNameEditPartTN extends
		PapyrusCompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							...
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.uml.diagram.usecase.edit.parts.UseCaseAsRectangleNameEditPartTN.VISUAL_ID));
		}
		return parser;
	}
