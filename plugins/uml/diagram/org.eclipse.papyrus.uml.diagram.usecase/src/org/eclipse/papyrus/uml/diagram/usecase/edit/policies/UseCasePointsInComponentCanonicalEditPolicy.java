 ...
 * @generated
 */
public class UseCasePointsInComponentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	private boolean isMyDiagramElement(View view) {
		return ExtensionPointEditPart.VISUAL_ID == UMLVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<UMLNodeDescriptor> childDescriptors = UMLDiagramUpdater
				.getUseCasePoints_7012SemanticChildren((View) getHost()
						.getModel());
