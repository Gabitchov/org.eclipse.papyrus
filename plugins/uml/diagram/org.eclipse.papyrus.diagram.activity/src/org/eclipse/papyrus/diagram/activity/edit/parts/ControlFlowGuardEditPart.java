 ...
 * @generated
 */
public class ControlFlowGuardEditPart extends LabelEditPart implements ITextAwareEditPart, ILabelRoleProvider {
	...
	public IParser getParser() {
		if(parser == null) {
			parser = UMLParserProvider.getParser(UMLElementTypes.ControlFlow_4004, getParserElement(), UMLVisualIDRegistry.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ControlFlowGuardEditPart.VISUAL_ID));
		}
		return parser;
	}
