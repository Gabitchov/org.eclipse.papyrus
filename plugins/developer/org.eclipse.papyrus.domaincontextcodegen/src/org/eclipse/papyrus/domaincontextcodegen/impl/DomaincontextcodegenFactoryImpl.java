...
public class DomaincontextcodegenFactoryImpl extends EFactoryImpl implements DomaincontextcodegenFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DomaincontextcodegenPackage.DOMAIN_CONTEXT: return createDomainContext();
			case DomaincontextcodegenPackage.ELEMENT_TYPE: return createElementType();
			case DomaincontextcodegenPackage.ADVICE_BINDING: return createAdviceBinding();
			case DomaincontextcodegenPackage.BINDING: return createBinding();
			default:
