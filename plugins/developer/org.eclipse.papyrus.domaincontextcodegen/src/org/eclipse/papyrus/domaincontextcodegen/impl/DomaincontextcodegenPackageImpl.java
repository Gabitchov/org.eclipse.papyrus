...
public class DomaincontextcodegenPackageImpl extends EPackageImpl implements DomaincontextcodegenPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link DomaincontextcodegenPackage#eINSTANCE} when that field is accessed.
	...
	public static DomaincontextcodegenPackage init() {
		if (isInited) return (DomaincontextcodegenPackage)EPackage.Registry.INSTANCE.getEPackage(DomaincontextcodegenPackage.eNS_URI);
	...
	public EReference getDomainContext_Metamodel() {
		return (EReference)domainContextEClass.getEStructuralFeatures().get(2);
	}
	...
	public EAttribute getDomainContext_ElementTypeIDPrefix() {
		return (EAttribute)domainContextEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getDomainContext_ProjectName() {
	...
	public void createPackageContents() {
		...
		createEAttribute(domainContextEClass, DOMAIN_CONTEXT__PROJECT_NAME);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDomainContext_ProjectName(), ecorePackage.getEString(), "projectName", null, 1, 1, DomainContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDomainContext_ElementTypes(), this.getElementType(), null, "elementTypes", null, 0, -1, DomainContext.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
