...
public class GenerateTypes {
	...
	public void doGenerate(IProgressMonitor monitor) throws IOException {
		...
		org.eclipse.papyrus.domaincontextcodegen.GenerateTypes gen0 = new org.eclipse.papyrus.domaincontextcodegen.GenerateTypes(modelURI, targetFolder, arguments);
		gen0.doGenerate(BasicMonitor.toMonitor(monitor));
