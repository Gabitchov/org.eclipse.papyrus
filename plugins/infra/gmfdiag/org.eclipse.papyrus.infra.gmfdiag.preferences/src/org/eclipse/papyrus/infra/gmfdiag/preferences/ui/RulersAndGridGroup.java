...
public class RulersAndGridGroup extends AbstractGroup {
	...
	private void addGridFields(Composite parent) {
		...
		gridInFront = new BooleanFieldEditor(getPreferenceConstant(PreferencesConstantsHelper.GRID_ORDER), org.eclipse.papyrus.infra.gmfdiag.preferences.messages.Messages.RulersAndGridGroup_GridInFront, group);
	...
	private void addGridStyle(final Composite parent) {
		...
		this.gridStyle = new ComboFieldEditor(getPreferenceConstant(PreferencesConstantsHelper.GRID_LINE_STYLE), org.eclipse.papyrus.infra.gmfdiag.preferences.messages.Messages.RulersAndGridGroup_GridStyle, composite, ComboFieldEditor.INT_TYPE_INDEXED, false, 0, 0, true);
	...
	private void addGridColor(final Composite parent) {
		...
		label.setText(org.eclipse.papyrus.infra.gmfdiag.preferences.messages.Messages.RulersAndGridGroup_GridColor);
