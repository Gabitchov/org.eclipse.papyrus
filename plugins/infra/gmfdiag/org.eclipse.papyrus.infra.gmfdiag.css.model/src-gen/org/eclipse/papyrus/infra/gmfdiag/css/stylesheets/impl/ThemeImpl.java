...
public class ThemeImpl extends EObjectImpl implements Theme {
	...
	/**
	 * The cached value of the '{@link #getStylesheets() <em>Stylesheets</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getStylesheets()
	...
	public EList<StyleSheet> getStylesheets() {
		if(stylesheets == null) {
			stylesheets = new EObjectResolvingEList<StyleSheet>(StyleSheet.class, this, StylesheetsPackage.THEME__STYLESHEETS);
		}
		return stylesheets;
	}
