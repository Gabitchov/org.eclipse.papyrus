...
public class PreferencesConstantsHelper {
	 ...
	 */
	public static final int SHOW_RULER = LOCATION_Y + 1;

	/**
	 * A preference to diplay or not the grid
	 */

	public static final int SHOW_GRID = SHOW_RULER + 1;

	/**
	 * A preference to change the ruler unit
	 */

	public static final int RULER_UNITS = SHOW_GRID + 1;
	 ...
	 */
	public static final int SNAP_TO_SHAPE = SNAP_TO_GRID + 1;

	/**
	 * A preference to change the grid color
	 */
	public static final int GRID_COLOR = SNAP_TO_SHAPE + 1;

	/**
	 * A preference to change the grid spacing
	 */
	public static final int GRID_SPACING = GRID_COLOR + 1;
	...
	public static String getConstant(String elementName, int preferenceType) {
		...
		case LOCATION_Y:
			...
			break;
		case SHOW_RULER:
			sb.append(SHOW_RULER_CONSTANT);
			break;
		case SHOW_GRID:
			sb.append(SHOW_GRID_CONSTANT);
			break;
		case RULER_UNITS:
		...
		case SNAP_TO_GRID:
			...
			break;
		case SNAP_TO_SHAPE:
			sb.append(SNAP_TO_SHAPE_CONSTANT);
			break;
		case GRID_COLOR:
			sb.append(GRID_COLOR_CONSTANT);
			break;
		case GRID_SPACING:
