 ...
 *
 */
public abstract class AbstractShapeCompartmentEditPartProvider extends RestrictedAbstractEditPartProvider {
	...
	/** Default constructor 
	 * <P> Implementation classes should set the diagram type  there </P> 
	 */
