...
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.BackgroundColorAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.FontNameAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.FontSizeAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.FontStyleAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.ForegroundColorAction;
...
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.RemoveFormatAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.SetupTestAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.SpellCheckAction;
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.StrikeThroughAction;
 ...
 * @author Mickael ADAM
 */
public class RichTextEditor extends AbstractValueEditor {

	/**
	 * The value for editing this editor's value
	 */
	...
	protected void init(Composite parent) {
		try {
			form = new ViewForm(parent, SWT.BORDER);
			form.marginHeight = 0;
			form.marginWidth = 0;
	...
	/**
	 * Gets the find replace action.
	 *
	 * @return the find replace action
	 */
	...
	/**
	 * Sets the find replace action.
	 *
	 * @param findReplaceAction
	 *        the new find replace action
	 */
