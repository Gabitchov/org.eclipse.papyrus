...
import org.eclipse.papyrus.infra.widgets.editors.richtext.actions.ComboContributionItem;
...
public class RichTextToolBar implements IRichTextToolBar {
	...
	/**
	 * @see org.eclipse.papyrus.infra.widgets.editors.richtext.IRichTextToolBar#addButton(org.eclipse.swt.widgets.Button)
	 * 
	 * @param button
	 */
	 ...
	 *        the action to add
	 */
	public void addAction(final org.eclipse.papyrus.infra.widgets.editors.richtext.actions.RichTextComboAction item) {
		if(item != null) {
			item.init();
			toolbarMgrCombo.add(item);
			toolbarMgrCombo.update(true);
	...
	/**
	 * @see org.eclipse.papyrus.infra.widgets.editors.richtext.IRichTextToolBar#addAction(org.eclipse.papyrus.infra.widgets.editors.richtext.actions.RichTextButtonAction)
	 * 
	 * @param item
	 */
