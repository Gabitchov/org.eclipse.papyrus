	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ParametricqueryPackage.PARAMETRIC_QUERY: {
				...
				if (result == null) result = caseModelQuery(parametricQuery);
			...
			case ParametricqueryPackage.STRING_ARGUMENT: {
				...
				if (result == null) result = caseArgument(stringArgument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ParametricqueryPackage.ESTRUCTURAL_FEATURE_ARGUMENT: {
				...
				if (result == null) result = caseArgument(eStructuralFeatureArgument);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
