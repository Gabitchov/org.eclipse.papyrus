...
public class AdditionalContentsUtils {
	...
	public static final String ADDITIONAL_CONTENTS_FACET_SET_DOCUMENTATION = Messages.AdditionalContentsUtils_AdditionalContentsUtils_AdditionContentsEPackageDocumentation;
