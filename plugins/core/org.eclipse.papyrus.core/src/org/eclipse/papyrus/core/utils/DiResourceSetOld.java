 ...
 */
public class DiResourceSetOld extends ResourceSetImpl {
	...
	public static IFile getRelatedDiFile(IFile file) {
		...
		if(DI_FILE_EXTENSION.equalsIgnoreCase(file.getFileExtension())) {
			...
			IPath diPath = file.getFullPath().removeFileExtension().addFileExtension(DiResourceSetOld.DI_FILE_EXTENSION);
