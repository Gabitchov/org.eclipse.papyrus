...
import org.eclipse.papyrus.modelexplorer.commands.SelectAndValidateModelCommand;
...
public class SelectAndValidateModelHandler extends AbstractCommandHandler {
	...
	protected Command getCommand() {
		...
		return new org.eclipse.papyrus.commands.wrappers.GMFtoEMFCommandWrapper(new SelectAndValidateModelCommand(getSelectedElement()));
	}
}
