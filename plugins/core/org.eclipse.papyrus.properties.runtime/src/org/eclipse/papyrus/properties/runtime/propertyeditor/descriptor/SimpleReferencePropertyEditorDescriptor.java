...
public class SimpleReferencePropertyEditorDescriptor extends PropertyEditorDescriptor {
	 ...
	 */
	public SimpleReferencePropertyEditorDescriptor(String editorId, String label) {
	 ...
	 */
	public SimpleReferencePropertyEditorDescriptor(String editorId, String label, int labelPosition, ImageDescriptor imageDescriptor) {
