...
/**
 * Interface that should be implemented by PageEditor used with GefMultiPageEditorPart. Editor implementing this interface can participate in the SelectionSynchronizer mechanism.
 * 
 * @author dumoulin
 * 
 */
