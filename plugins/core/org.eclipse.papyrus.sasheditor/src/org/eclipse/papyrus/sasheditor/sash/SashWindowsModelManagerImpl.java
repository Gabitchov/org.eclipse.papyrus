...
public abstract class SashWindowsModelManagerImpl<T> implements ISashWindowsModelManager<T> {
	...
	/**
	 * Fire the specified event to all listeners. Fire an event indicating that a folder has been inserted on the side of the specified
	 * relativeFolder.
	 * 
	 */
	...
	/**
	 * Ask the model to move the specified tab inside the same folder. No events should be thrown until the complete move is perform. This method is
	 * called by the the SashTileContainer when the user
	 * have drag a tab in a correct place. The SashTileContainer has not change is presentation yet. This will be done when the corresponding event
	 * will occur.
	 * 
	 * @param nodeModel
	 *        The external model representing a folder.
	...
	/**
	 * Ask the model to move the specified tab to the specified destination. No events should be thrown until the complete move is perform. This
	 * method is called by the the SashTileContainer when the
	 * user have drag a tab in a correct place. The SashTileContainer has not change is presentation yet. This will be done when the corresponding
	 * event will occur.
	 * 
	 * @param nodeModel
	 *        The external model representing a folder.
