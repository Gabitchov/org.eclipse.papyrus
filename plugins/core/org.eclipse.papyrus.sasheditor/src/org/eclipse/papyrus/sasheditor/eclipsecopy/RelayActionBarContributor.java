...
/**
 * An ActionBarContributor keeping track of the currently ActiveNestedEditor. Calls to
 * {@link #setActivePage(IEditorPart)} are propagated to the
 * {@link EditorActionBarContributor#setActiveEditor(IEditorPart)} of the activeEditor.
 * 
