...
/**
 * Copy of org.eclipse.ui.part.MultiPageEditorPart. Change if to be suitable has a sash leaf. A
 * multi-page editor is an editor with multiple pages, each of which may contain an editor or an
 * arbitrary SWT control.
 * <p>
 * This class is intented to separate folder stuff into 2 classes. Subclasses must implement the
 * following methods:
 * <ul>
...
public abstract class AbstractTabFolderPart extends AbstractPanelPart {
	...
	/**
	 * Returns the index of the currently active page of this folder, or -1 if there is no active
	 * page.
	 * <p>
	 * Subclasses should not override this method
	 * </p>
	 ...
	 * {@link AbstractTabFolderPart#createPageContainer(Composite)} to deactivate the active inner
	 ...
	 * {@link AbstractTabFolderPart#pageChange(int)}.
	 * </p>
	 * <p>
	...
	/**
	 * Return true if the specified index is valid. The index should be between 0 and pageCount. If
