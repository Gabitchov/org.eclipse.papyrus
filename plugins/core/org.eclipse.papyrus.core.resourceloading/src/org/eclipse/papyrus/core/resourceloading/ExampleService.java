...
public class ExampleService implements IService {
	...
	public void startService() throws ServiceException {
		...
		final HistoryModel historyModel = HistoryUtils.getHistoryModel(servicesRegistry);
		final ControledResource root = historyFactory.eINSTANCE.createControledResource();
		
		TransactionalEditingDomain editingDomain = EditorUtils.getTransactionalEditingDomain(servicesRegistry);
