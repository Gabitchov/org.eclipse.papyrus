...
public class StringCombo extends AbstractPropertyEditor {
	 ...
	 */
	protected org.eclipse.papyrus.widgets.editors.StringCombo createStringCombo(Composite parent, int style) {
		return new org.eclipse.papyrus.widgets.editors.StringCombo(parent, style);
	}
