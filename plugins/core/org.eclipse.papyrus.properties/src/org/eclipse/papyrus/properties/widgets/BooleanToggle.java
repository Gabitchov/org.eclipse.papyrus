...
public class BooleanToggle extends AbstractPropertyEditor {
	 ...
	 */
	protected org.eclipse.papyrus.widgets.editors.BooleanToggle createBooleanToggle(Composite parent, int style) {
		return new org.eclipse.papyrus.widgets.editors.BooleanToggle(parent, style);
	}
