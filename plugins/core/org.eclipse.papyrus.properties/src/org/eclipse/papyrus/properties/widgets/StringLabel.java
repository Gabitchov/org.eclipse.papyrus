...
public class StringLabel extends AbstractPropertyEditor {
	 ...
	 */
	protected org.eclipse.papyrus.widgets.editors.StringLabel createStringLabel(Composite parent, int style) {
		return new org.eclipse.papyrus.widgets.editors.StringLabel(parent, style);
	}
