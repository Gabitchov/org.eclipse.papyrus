...
import org.eclipse.papyrus.outline.Activator;
import org.eclipse.papyrus.outline.Messages;
...
public class CreateDiagramAction extends Action {
	...
	public CreateDiagramAction(EObject selectedObject, Resource diagramResource, String diagramType, PreferencesHint preferencesHint) {
		...
		setImageDescriptor(org.eclipse.papyrus.outline.Activator.getImageDescriptor("icons/etool16/add.gif")); //$NON-NLS-1$
	}
	 ...
	 */
	public void run() {
		InputDialog dialog = new InputDialog(Activator.getDefault().getWorkbench().getDisplay().getActiveShell(), Messages.CreateDiagramAction_DialogCreateNewDiagram,
				Messages.CreateDiagramAction_DialogDiagramName, Messages.CreateDiagramAction_DialogDefaultDiagramName, null);
