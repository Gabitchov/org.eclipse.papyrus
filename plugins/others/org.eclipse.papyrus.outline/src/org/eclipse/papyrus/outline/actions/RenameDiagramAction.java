...
public class RenameDiagramAction extends Action {
	...
	public void run() {
		...
		if (editingDomain != null) {
			...
			// Input name
			InputDialog dialog = new InputDialog(Activator.getDefault().getWorkbench().getDisplay().getActiveShell(), Messages.RenameDiagramAction_RenameExistingDiagram,
					Messages.RenameDiagramAction_NewName, diagram.getName(), null);
