...
/**
 * This action creates a new child for a given domain element. <br>
 * 
...
public class CreateChildAction extends Action {
	 ...
	 */
	public CreateChildAction(TransactionalEditingDomain domain, EObject selectedObject, Object desc) {
		super();
	...
	/**
	 * Creates the EMF command that creates the child
	 * 
	 * @param object
	 *            the parent EObject
	...
	protected EMFCommandOperation createActionCommand(EObject object) {
		...
		if (object != null) {
			if (editingDomain != null) {
				cmd = CreateChildCommand.create(editingDomain, object, descriptor, collec);
			}
		}
