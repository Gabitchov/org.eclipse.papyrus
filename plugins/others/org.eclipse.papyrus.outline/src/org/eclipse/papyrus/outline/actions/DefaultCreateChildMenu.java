 ...
 */
public class DefaultCreateChildMenu extends MenuManager {

	/**
	 * Constructor
	 */
	public DefaultCreateChildMenu(EObject selectedObject) {
		super("Create child");
		...
		// Populate all the "Create Child" actions
	...
	protected Collection<IAction> generateCreateActions(
		...
		Collection<?> descriptors = editingDomain.getNewChildDescriptors(
				selectedObject, null);
		if (descriptors != null) {
			for (Object object : descriptors) {
				actions.add(new CreateChildAction(editingDomain,
