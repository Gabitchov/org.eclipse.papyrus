...
public class ProfileDefinitionDialog extends TitleAreaDialog {
	 ...
	 * @param composite The parent composite to contain the comment area
	 */
	 ...
	 * @param composite The parent composite to contain the version area
	 */
	 ...
	 * @param e the selection event that triggers this behavior
	 */
