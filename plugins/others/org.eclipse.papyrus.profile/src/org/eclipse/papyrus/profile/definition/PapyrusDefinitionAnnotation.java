...
/**
 * Class that defines various information about a profile definition (author, version, etc.)
 */
public class PapyrusDefinitionAnnotation {
	 ...
	 * @param comment the comment associated to this definition
	 * @param copyright the copyright of this definition
	 * @param date the date this definition was generated
	 * @param the author responsible of this definition
	 */
	...
	/**
	 * Return the PapyrusDefinitionAnnotation corresponding to the given EAnnotation
	...
	public static PapyrusDefinitionAnnotation parseEAnnotation(EAnnotation annotation) {
		...
		return new PapyrusDefinitionAnnotation(version,
