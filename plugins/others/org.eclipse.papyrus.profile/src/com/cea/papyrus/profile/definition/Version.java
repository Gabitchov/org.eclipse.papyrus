package com.cea.papyrus.profile.definition;
...
public class Version {
	 ...
	 * @param major the major version value (should be positive)
	 * @param minor the minor version value (should be positive)
	 * @param micro the micro version value (should be positive)
	 */
	 ...
	 * @param value the string representing the version
	 */
	 ...
	 * @param micro the new micro value
	 */
