package com.cea.papyrus.profile.ui.views;
...
import com.cea.papyrus.profile.ui.panels.DefaultPanel;
import com.cea.papyrus.profile.ui.panels.ProfilePanel;
		...
		if ((currentTarget != null) && (currentTarget instanceof Element)) {
			...
			if(!panel.isDisposed()) {	
				...
				if (currentTarget instanceof Package) {
					panel = new ProfilePanel(this.parent, 0);
					panel.createContent();
