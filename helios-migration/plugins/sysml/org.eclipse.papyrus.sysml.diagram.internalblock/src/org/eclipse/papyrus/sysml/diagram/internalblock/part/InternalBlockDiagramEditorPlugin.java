 ...
 * @generated
 */
public class InternalBlockDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.eclipse.papyrus.sysml.diagram.internalblock"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static InternalBlockDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	public InternalBlockDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static InternalBlockDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, InternalBlockDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, InternalBlockDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
