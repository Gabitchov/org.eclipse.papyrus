...
import org.eclipse.papyrus.diagram.usecase.edit.policies.Constraint3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Constraint3EditPart extends
...
ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Constraint3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Constraint3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if(childEditPart instanceof ConstraintName3EditPart) {
			((ConstraintName3EditPart)childEditPart).setLabel(getPrimaryShape().getCornerBentContentLabel());
			return true;
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ConstraintName3EditPart.VISUAL_ID));
	}
