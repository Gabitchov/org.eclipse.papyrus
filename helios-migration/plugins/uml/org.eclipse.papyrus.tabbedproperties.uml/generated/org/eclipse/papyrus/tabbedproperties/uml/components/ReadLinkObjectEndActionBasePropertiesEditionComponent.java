...
public class ReadLinkObjectEndActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ReadLinkObjectEndActionBasePropertiesEditionComponent(EObject readLinkObjectEndAction, String editing_mode) {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if(basePart == null)
					ReadLinkObjectEndActionBasePropertiesEditionComponent.this.dispose();
				else {
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if(key == UMLViewsRepository.ReadLinkObjectEndAction.class)
			this.basePart = (ReadLinkObjectEndActionPropertiesEditionPart)propertiesEditionPart;
	}
	...
	public Diagnostic validate() {
		...
		if(IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			validate = Diagnostician.INSTANCE.validate(readLinkObjectEndAction);
