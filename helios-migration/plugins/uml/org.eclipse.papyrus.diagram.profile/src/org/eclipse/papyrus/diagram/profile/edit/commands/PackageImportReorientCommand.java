...
public class PackageImportReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistPackageImport_1065(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Namespace container = (Namespace)getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistPackageImport_1065(container, source, getNewTarget());
	}
