...
public class ElementImportReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistElementImport_1064(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Namespace container = (Namespace)getLink().eContainer();
		return UMLBaseItemSemanticEditPolicy.LinkConstraints.canExistElementImport_1064(container, source, getNewTarget());
	}
