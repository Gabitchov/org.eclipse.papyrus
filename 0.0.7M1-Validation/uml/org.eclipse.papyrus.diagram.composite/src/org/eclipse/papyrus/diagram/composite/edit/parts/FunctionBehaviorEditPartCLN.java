 ...
 * @generated
 */
public class FunctionBehaviorEditPartCLN extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UMLParserProvider
					.getParser(
							UMLElementTypes.FunctionBehavior_3107,
							getParserElement(),
							UMLVisualIDRegistry
									.getType(org.eclipse.papyrus.diagram.composite.edit.parts.FunctionBehaviorEditPartCLN.VISUAL_ID));
		}
		return parser;
	}
