...
import org.eclipse.papyrus.diagram.composite.edit.policies.InterfaceCompartmentItemSemanticEditPolicy;
...
public class InterfaceCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	public String getCompartmentName() {
		return Messages.InterfaceCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InterfaceCompartmentItemSemanticEditPolicy());
