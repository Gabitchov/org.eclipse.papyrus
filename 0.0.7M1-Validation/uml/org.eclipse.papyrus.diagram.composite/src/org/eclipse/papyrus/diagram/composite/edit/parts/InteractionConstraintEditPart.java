...
ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InteractionConstraintNameEditPart) {
			((InteractionConstraintNameEditPart) childEditPart).setLabel(getPrimaryShape().getCommentContentLabel());
			return true;
		}
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("InteractionConstraint",
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("InteractionConstraint",
