...
ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InformationItemNameEditPart) {
			((InformationItemNameEditPart) childEditPart).setLabel(getPrimaryShape().getNamedElementNameLabel());
			return true;
		}
	...
	public Object getPreferredValue(EStructuralFeature feature) {
		...
		if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()
			...
			if (feature == NotationPackage.eINSTANCE.getLineStyle_LineColor()) {
				prefColor = PreferenceConstantHelper.getElementConstant("InformationItem",
			...
			String prefGradient = PreferenceConstantHelper.getElementConstant("InformationItem",
