 ...
 * @generated
 */
public class ZigZagLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.diagram.activity.edit.parts.ZigZagLabelEditPart.VISUAL_ID),
				new Point(0, -5));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new UMLParserProvider.HintAdapter(
					UMLElementTypes.ExceptionHandler_3004, getParserElement(),
					parserHint);
	 ...
	 * @generated
	 */
	static final Font THIS_FONT = new Font(Display.getCurrent(), "SANS", 9,
			SWT.NORMAL);
