...
/**
 * The Class UMLActivityDiagramForMultiEditor.
 */
...
//		ServicesRegistry servicesRegistry = EditorUtils.getServiceRegistry();
	 ...
	 *            the context
	 */
	public UMLActivityDiagramForMultiEditor(Object diagram, IEditorContext context) {
	 ...
	 *            the context
	 */
	public UMLActivityDiagramForMultiEditor(Diagram diagram, GmfEditorContext context) {
		super();
		this.diagram = diagram;
