 ...
 * @generated
 */
public class CreateObjectActionCreateCommand extends CreateElementCommand {
	...
	/**
	 * Modified to return the nearest <ActivityPartition>.
	 * 
	 * @generated NOT
	 */
	@Override
	protected EObject getElementToEdit() {
		...
		// fjcano : we have to return te nearest ActivityPartition.
	...
	/**
	 * Modified to initialize the <CreateObjectAction> with a result pin.
	 * 
	 * @generated NOT
	 */
	@Override
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			ElementInitializers.init_CreateObjectAction_2022(newElement);
			...
			// fjcano : initialize a new result pin
			if (diagram != null) {
				MultiDiagramUtil.AddEAnnotationReferenceToDiagram(diagram, newElement.createResult("Result", null));
			} else {
				MultiDiagramUtil.addEAnnotationReferenceToDiagram(UMLDiagramEditorPlugin.getInstance(), newElement.createResult("Result", null));
			}
		}
