...
public class SendSignalActionEditPart extends AbstractBorderedShapeEditPart
	...
	public class SendSignalActionNodeFigure extends DefaultSizeNodeFigure
		...
		public SendSignalActionNodeFigure(int width, int height) {
			super(width, height);
		}
		...
		public PointList getPolygonPoints() {
			...
			polygonList.addPoint(r.x + (int) (r.width * 0.85), r.y);
			polygonList.addPoint(r.x + r.width, r.y + r.height / 2);
			polygonList.addPoint(r.x + (int) (r.width * 0.85), r.y + r.height);
	...
	public class SendSignalActionFigure extends Shape {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureSendSignalActionFigure_stereotypes;

		/**
		 * @generated
		 */
		private WrappingLabel fFigureSendSignalActionFigure_name;
		...
		public WrappingLabel getFigureSendSignalActionFigure_stereotypes() {
			return fFigureSendSignalActionFigure_stereotypes;
		}
