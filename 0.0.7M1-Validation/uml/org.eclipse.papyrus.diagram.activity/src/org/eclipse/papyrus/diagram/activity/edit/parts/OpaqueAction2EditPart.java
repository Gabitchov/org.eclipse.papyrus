...
import org.eclipse.papyrus.diagram.activity.edit.policies.OpaqueAction2CanonicalEditPolicy;
import org.eclipse.papyrus.diagram.activity.edit.policies.OpaqueAction2ItemSemanticEditPolicy;
...
public class OpaqueAction2EditPart extends AbstractBorderedShapeEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OpaqueAction2ItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OpaqueAction2CanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OpaqueActionName3EditPart) {
			((OpaqueActionName3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureActionBaseFigure_name());
			return true;
		}
		if (childEditPart instanceof OpaqueActionName4EditPart) {
			((OpaqueActionName4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureActionBaseFigure_stereotypes());
			return true;
		}
		if (childEditPart instanceof OutputPin2EditPart) {
			IBorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.EAST);
			getBorderedFigure().getBorderItemContainer().add(
					((OutputPin2EditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof ValuePin2EditPart) {
			...
			getBorderedFigure().getBorderItemContainer().add(
					((ValuePin2EditPart) childEditPart).getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof InputPin4EditPart) {
			IBorderItemLocator locator = new BorderItemLocator(getMainFigure(),
					PositionConstants.WEST);
			getBorderedFigure().getBorderItemContainer().add(
					((InputPin4EditPart) childEditPart).getFigure(), locator);
			return true;
		}
		return false;
	}
	...
	/**
	 * Modified to remove the pins from the BorderItemContainer figure
	 * 
	 * @generated NOT
	 */
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof OutputPin2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((OutputPin2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ValuePin2EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((ValuePin2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof InputPin4EditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((InputPin4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	/**
	 * Modified to return a BorderItemContainer for pins
	 * 
	 * @generated NOT
	 */
	@Override
