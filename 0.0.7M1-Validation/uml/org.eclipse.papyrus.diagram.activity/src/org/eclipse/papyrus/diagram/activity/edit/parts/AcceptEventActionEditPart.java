 ...
 * @generated
 */
public class AcceptEventActionEditPart extends AbstractBorderedShapeEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AcceptEventActionCanonicalEditPolicy());
	...
	protected NodeFigure createNodePlate() {
		AcceptEventActionNodeFigure result = new AcceptEventActionNodeFigure(
	 ...
	 * @NOT-generated
	 */
	public class AcceptEventActionNodeFigure extends DefaultSizeNodeFigure
			implements IPolygonAnchorableFigure {

		public AcceptEventActionNodeFigure(Dimension defSize) {
			super(defSize.width, defSize.height);
		}

		public AcceptEventActionNodeFigure(int width, int height) {
			super(width, height);
		}
