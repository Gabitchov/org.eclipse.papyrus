...
public class OpaqueAction2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public OpaqueAction2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static OpaqueAction2CreateCommand create(CreateElementRequest req, EObject eObject) {
		return new OpaqueAction2CreateCommand(req, eObject);
	}
	...
	/**
	 * Modified to return <Activity> EClass.
	 * 
	 * @generated NOT
	 */
	@Override
	 ...
	 * @return
	 */
	protected boolean addActionToActivityPartition(Action newAction) {
		if (newAction == null) {
			return false;
		}
