...
/**
 * The listener interface for receiving downElement events.
 * The class that is interested in processing a downElement
...
public class DownElementListener implements MouseListener {
	 ...
	 * 
	 * @param atableViewer the a table viewer
	...
	public void mouseUp(MouseEvent e) {
		if( tableviewer.getTable().getSelection().length!=0){
			...
			if((elementList.indexOf(block[block.length-1]))==elementList.size()-1){return;}
