...
public class ReclassifyObjectActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (UMLPackage.eINSTANCE.getReclassifyObjectAction_IsReplaceAll().equals(msg.getFeature())
							&& basePart != null)
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (reclassifyObjectAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ReclassifyObjectActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ReclassifyObjectAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ReclassifyObjectAction.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					reclassifyObjectAction.getVisibility());
			basePart.initClientDependency(reclassifyObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInInterruptibleRegion(reclassifyObjectAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(reclassifyObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(reclassifyObjectAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(reclassifyObjectAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPostcondition());
			basePart.setIsReplaceAll(reclassifyObjectAction.isReplaceAll());

			basePart.initOldClassifier(reclassifyObjectAction, null, UMLPackage.eINSTANCE
					.getReclassifyObjectAction_OldClassifier());
			basePart.initNewClassifier(reclassifyObjectAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (reclassifyObjectAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, reclassifyObjectAction,
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
			...
			cc.append(SetCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
					.getReclassifyObjectAction_IsReplaceAll(), basePart.getIsReplaceAll()));
			...
			for (Iterator iter = oldClassifierToAddFromOldClassifier.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
						.getReclassifyObjectAction_OldClassifier(), iter.next()));
			...
			// for (Iterator iter = oldClassifierToMoveFromOldClassifier.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, reclassifyObjectAction,
			...
			for (Iterator iter = newClassifierToAddFromNewClassifier.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
						.getReclassifyObjectAction_NewClassifier(), iter.next()));
			...
			// for (Iterator iter = newClassifierToMoveFromNewClassifier.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, reclassifyObjectAction,
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ReclassifyObjectAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ReclassifyObjectAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ReclassifyObjectAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.ReclassifyObjectAction.isReplaceAll == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
						.getReclassifyObjectAction_IsReplaceAll(), event.getNewValue()));

			if (UMLViewsRepository.ReclassifyObjectAction.oldClassifier == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getReclassifyObjectAction_OldClassifier(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getReclassifyObjectAction_OldClassifier(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getReclassifyObjectAction_OldClassifier(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ReclassifyObjectAction.newClassifier == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getReclassifyObjectAction_NewClassifier(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getReclassifyObjectAction_NewClassifier(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, reclassifyObjectAction, UMLPackage.eINSTANCE
							.getReclassifyObjectAction_NewClassifier(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ReclassifyObjectAction.isLeaf
				|| key == UMLViewsRepository.ReclassifyObjectAction.isReplaceAll;
	}
		...
		try {
			...
			if (UMLViewsRepository.ReclassifyObjectAction.isReplaceAll == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE
						.getReclassifyObjectAction_IsReplaceAll().getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getReclassifyObjectAction_IsReplaceAll()
						.getEAttributeType(), newValue);
			}
