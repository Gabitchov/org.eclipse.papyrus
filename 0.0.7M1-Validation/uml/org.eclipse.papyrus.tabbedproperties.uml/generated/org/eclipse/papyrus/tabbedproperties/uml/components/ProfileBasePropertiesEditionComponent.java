...
public class ProfileBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					ProfileBasePropertiesEditionComponent.this.dispose();
				else {
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getPackage_ProfileApplication() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getProfileApplication())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (profile != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ProfilePropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Profile.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.Profile.class)
			this.basePart = (ProfilePropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Profile.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), profile
					.getVisibility());
			...
			// End of user code
			basePart.addFilterToProfileApplication(new ViewerFilter() {
				 ...
				 */
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					return (element instanceof String && element.equals("")) || (element instanceof ProfileApplication); //$NON-NLS-1$ 

				}

			});
			// Start of user code for additional businessfilters for profileApplication
			...
			basePart.addFilterToMetaclassReference(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getMetaclassReferenceTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToMetamodelReference(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getMetamodelReferenceTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (profile != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, profile,
			...
			for (Iterator iter = elementImportToAddFromElementImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getNamespace_ElementImport(),
						iter.next()));
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getElementImport(),
			...
			for (Iterator iter = packageImportToAddFromPackageImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getNamespace_PackageImport(),
						iter.next()));
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToAddFromOwnedRule.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getNamespace_OwnedRule(), iter
						.next()));
			...
			for (Iterator iter = ownedRuleToMoveFromOwnedRule.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getConstraint(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = templateBindingToMoveFromTemplateBinding.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getTemplateBinding(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = packageMergeToAddFromPackageMerge.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getPackage_PackageMerge(),
						iter.next()));
			...
			for (Iterator iter = packageMergeToMoveFromPackageMerge.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getPackageMerge(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = packagedElementToAddFromPackagedElement.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getPackage_PackagedElement(),
						iter.next()));
			...
			for (Iterator iter = packagedElementToMoveFromPackagedElement.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getPackageableElement(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			List profileApplicationToAddFromProfileApplication = basePart.getProfileApplicationToAdd();
			for (Iterator iter = profileApplicationToAddFromProfileApplication.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getPackage_ProfileApplication(), iter.next()));
			Map profileApplicationToRefreshFromProfileApplication = basePart.getProfileApplicationToEdit();
			for (Iterator iter = profileApplicationToRefreshFromProfileApplication.keySet().iterator(); iter.hasNext();) {

				// Start of user code for profileApplication reference refreshment from
				// profileApplication

				ProfileApplication nextElement = (ProfileApplication) iter.next();
				ProfileApplication profileApplication = (ProfileApplication) profileApplicationToRefreshFromProfileApplication
						.get(nextElement);

				// End of user code

			}
			List profileApplicationToRemoveFromProfileApplication = basePart.getProfileApplicationToRemove();
			for (Iterator iter = profileApplicationToRemoveFromProfileApplication.iterator(); iter.hasNext();)
				cc.append(DeleteCommand.create(editingDomain, iter.next()));
			List profileApplicationToMoveFromProfileApplication = basePart.getProfileApplicationToMove();
			for (Iterator iter = profileApplicationToMoveFromProfileApplication.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE.getProfileApplication(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			List metaclassReferenceToAddFromMetaclassReference = basePart.getMetaclassReferenceToAdd();
			for (Iterator iter = metaclassReferenceToAddFromMetaclassReference.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getProfile_MetaclassReference(), iter.next()));
			List metaclassReferenceToRemoveFromMetaclassReference = basePart.getMetaclassReferenceToRemove();
			for (Iterator iter = metaclassReferenceToRemoveFromMetaclassReference.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getProfile_MetaclassReference(), iter.next()));
			// List metaclassReferenceToMoveFromMetaclassReference =
			// basePart.getMetaclassReferenceToMove();
			// for (Iterator iter = metaclassReferenceToMoveFromMetaclassReference.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, profile,
			// UMLPackage.eINSTANCE.getElementImport(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			List metamodelReferenceToAddFromMetamodelReference = basePart.getMetamodelReferenceToAdd();
			for (Iterator iter = metamodelReferenceToAddFromMetamodelReference.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getProfile_MetamodelReference(), iter.next()));
			List metamodelReferenceToRemoveFromMetamodelReference = basePart.getMetamodelReferenceToRemove();
			for (Iterator iter = metamodelReferenceToRemoveFromMetamodelReference.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, profile, UMLPackage.eINSTANCE
						.getProfile_MetamodelReference(), iter.next()));
			// List metamodelReferenceToMoveFromMetamodelReference =
			// basePart.getMetamodelReferenceToMove();
			// for (Iterator iter = metamodelReferenceToMoveFromMetamodelReference.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, profile,
			// UMLPackage.eINSTANCE.getPackageImport(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Profile.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Profile.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Profile.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Profile.ownedRule == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE.getConstraint(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.Profile.packageMerge == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getPackageMerge(), event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.Profile.profileApplication == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getPackage_ProfileApplication(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfileApplication(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Profile.metaclassReference == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfile_MetaclassReference(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfile_MetaclassReference(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfile_MetaclassReference(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Profile.metamodelReference == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfile_MetamodelReference(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfile_MetamodelReference(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, profile, UMLPackage.eINSTANCE
							.getProfile_MetamodelReference(), event.getNewValue(), event.getNewIndex()));
			}
