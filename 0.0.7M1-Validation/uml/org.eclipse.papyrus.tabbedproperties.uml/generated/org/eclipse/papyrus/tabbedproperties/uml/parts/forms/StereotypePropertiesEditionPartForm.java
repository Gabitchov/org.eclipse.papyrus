 ...
 */
public class StereotypePropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, StereotypePropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedComment = new ReferencesTable<Comment>(UMLMessages.StereotypePropertiesEditionPart_OwnedCommentLabel,
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedComment,
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils
				.createPartLabel(widgetFactory, parent, UMLMessages.StereotypePropertiesEditionPart_NameLabel,
						propertiesEditionComponent.isRequired(UMLViewsRepository.Stereotype.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.name,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$

	}

	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.StereotypePropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.Stereotype.visibility,
						UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.visibility,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable<Dependency>(
				UMLMessages.StereotypePropertiesEditionPart_ClientDependencyLabel,
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											...
											UMLViewsRepository.Stereotype.clientDependency,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.clientDependency,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createElementImportTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.elementImport = new ReferencesTable<ElementImport>(
				UMLMessages.StereotypePropertiesEditionPart_ElementImportLabel,
		...
		this.elementImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.elementImport, UMLViewsRepository.FORM_KIND));
	...
	protected void moveElementImport(ElementImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.elementImport,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createPackageImportTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.packageImport = new ReferencesTable<PackageImport>(
				UMLMessages.StereotypePropertiesEditionPart_PackageImportLabel,
		...
		this.packageImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.packageImport, UMLViewsRepository.FORM_KIND));
	...
	protected void movePackageImport(PackageImport element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.packageImport,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createOwnedRuleTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedRule = new ReferencesTable<Constraint>(UMLMessages.StereotypePropertiesEditionPart_OwnedRuleLabel,
		...
		this.ownedRule.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.Stereotype.ownedRule,
				UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedRule(Constraint element, int oldIndex, int newIndex) {
		...
		ownedRule.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedRule,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.isLeaf,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createTemplateBindingTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.templateBinding = new ReferencesTable<TemplateBinding>(
				UMLMessages.StereotypePropertiesEditionPart_TemplateBindingLabel,
		...
		this.templateBinding.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.templateBinding, UMLViewsRepository.FORM_KIND));
	...
	protected void moveTemplateBinding(TemplateBinding element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.templateBinding,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createIsAbstractCheckbox(FormToolkit widgetFactory, Composite parent) {
		isAbstract = widgetFactory.createButton(parent, UMLMessages.StereotypePropertiesEditionPart_IsAbstractLabel,
				SWT.CHECK);
		isAbstract.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.isAbstract,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.isAbstract, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createGeneralizationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.generalization = new ReferencesTable<Generalization>(
				UMLMessages.StereotypePropertiesEditionPart_GeneralizationLabel,
		...
		this.generalization.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.generalization, UMLViewsRepository.FORM_KIND));
	...
	protected void moveGeneralization(Generalization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.generalization,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createPowertypeExtentReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.powertypeExtent = new ReferencesTable<GeneralizationSet>(
				UMLMessages.StereotypePropertiesEditionPart_PowertypeExtentLabel,
						...
						TabElementTreeSelectionDialog<GeneralizationSet> dialog = new TabElementTreeSelectionDialog<GeneralizationSet>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											StereotypePropertiesEditionPartForm.this,
											UMLViewsRepository.Stereotype.powertypeExtent,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
		...
		this.powertypeExtent.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.powertypeExtent, UMLViewsRepository.FORM_KIND));
	...
	protected void movePowertypeExtent(GeneralizationSet element, int oldIndex, int newIndex) {
		...
		powertypeExtent.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.powertypeExtent,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createRedefinedClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedClassifier = new ReferencesTable<Classifier>(
				UMLMessages.StereotypePropertiesEditionPart_RedefinedClassifierLabel,
						...
						TabElementTreeSelectionDialog<Classifier> dialog = new TabElementTreeSelectionDialog<Classifier>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											StereotypePropertiesEditionPartForm.this,
											UMLViewsRepository.Stereotype.redefinedClassifier,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
		...
		this.redefinedClassifier.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.redefinedClassifier, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromRedefinedClassifier(Classifier element) {
		...
		redefinedClassifier.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.redefinedClassifier,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createSubstitutionTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.substitution = new ReferencesTable<Substitution>(
				UMLMessages.StereotypePropertiesEditionPart_SubstitutionLabel,
		...
		this.substitution.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.substitution, UMLViewsRepository.FORM_KIND));
	...
	protected void moveSubstitution(Substitution element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.substitution,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createCollaborationUseTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.collaborationUse = new ReferencesTable<CollaborationUse>(
				UMLMessages.StereotypePropertiesEditionPart_CollaborationUseLabel,
		...
		this.collaborationUse.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.collaborationUse, UMLViewsRepository.FORM_KIND));
	...
	protected void moveCollaborationUse(CollaborationUse element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.collaborationUse,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createOwnedUseCaseTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedUseCase = new ReferencesTable<UseCase>(UMLMessages.StereotypePropertiesEditionPart_OwnedUseCaseLabel,
		...
		this.ownedUseCase.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedUseCase, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedUseCase,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createUseCaseReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.useCase = new ReferencesTable<UseCase>(UMLMessages.StereotypePropertiesEditionPart_UseCaseLabel,
				new ReferencesTableListener<UseCase>() {
						...
						TabElementTreeSelectionDialog<UseCase> dialog = new TabElementTreeSelectionDialog<UseCase>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											StereotypePropertiesEditionPartForm.this,
											UMLViewsRepository.Stereotype.useCase, PropertiesEditionEvent.COMMIT,
		...
		this.useCase.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.Stereotype.useCase,
				UMLViewsRepository.FORM_KIND));
	...
	protected void moveUseCase(UseCase element, int oldIndex, int newIndex) {
		...
		useCase.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.useCase,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createOwnedAttributeTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedAttribute = new ReferencesTable<Property>(
				UMLMessages.StereotypePropertiesEditionPart_OwnedAttributeLabel,
		...
		this.ownedAttribute.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedAttribute, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedAttribute(Property element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedAttribute,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createOwnedConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedConnector = new ReferencesTable<Connector>(
				UMLMessages.StereotypePropertiesEditionPart_OwnedConnectorLabel,
		...
		this.ownedConnector.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedConnector, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedConnector(Connector element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedConnector,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createOwnedBehaviorTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedBehavior = new ReferencesTable<Behavior>(
				UMLMessages.StereotypePropertiesEditionPart_OwnedBehaviorLabel,
		...
		this.ownedBehavior.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedBehavior, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromOwnedBehavior(Behavior element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedBehavior,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createInterfaceRealizationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.interfaceRealization = new ReferencesTable<InterfaceRealization>(
				UMLMessages.StereotypePropertiesEditionPart_InterfaceRealizationLabel,
		...
		this.interfaceRealization.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.interfaceRealization, UMLViewsRepository.FORM_KIND));
	...
	protected void moveInterfaceRealization(InterfaceRealization element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.interfaceRealization,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createOwnedTriggerTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedTrigger = new ReferencesTable<Trigger>(UMLMessages.StereotypePropertiesEditionPart_OwnedTriggerLabel,
		...
		this.ownedTrigger.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedTrigger, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedTrigger(Trigger element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedTrigger,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createNestedClassifierTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.nestedClassifier = new ReferencesTable<Classifier>(
				UMLMessages.StereotypePropertiesEditionPart_NestedClassifierLabel,
				new ReferencesTableListener<Classifier>() {
		...
		this.nestedClassifier.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.nestedClassifier, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromNestedClassifier(Classifier element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.nestedClassifier,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createOwnedOperationTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedOperation = new ReferencesTable<Operation>(
				UMLMessages.StereotypePropertiesEditionPart_OwnedOperationLabel,
		...
		this.ownedOperation.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedOperation, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedOperation(Operation element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedOperation,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createIsActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		isActive = widgetFactory.createButton(parent, UMLMessages.StereotypePropertiesEditionPart_IsActiveLabel,
				SWT.CHECK);
		isActive.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.isActive,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.isActive, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOwnedReceptionTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedReception = new ReferencesTable<Reception>(
				UMLMessages.StereotypePropertiesEditionPart_OwnedReceptionLabel,
		...
		this.ownedReception.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Stereotype.ownedReception, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedReception(Reception element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.ownedReception,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	...
	protected void createIconTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.icon = new ReferencesTable<Image>(UMLMessages.StereotypePropertiesEditionPart_IconLabel,
				new ReferencesTableListener<Image>() {
		...
		this.icon.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.Stereotype.icon,
				UMLViewsRepository.FORM_KIND));
	...
	protected void moveIcon(Image element, int oldIndex, int newIndex) {
		...
		icon.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				StereotypePropertiesEditionPartForm.this, UMLViewsRepository.Stereotype.icon,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedComment(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedComment(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedComment(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedComment(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#setName(String
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initVisibility(EEnum
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initClientDependency(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateClientDependency(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initElementImport(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateElementImport(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterElementImport(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterElementImport(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initPackageImport(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updatePackageImport(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterPackageImport(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterPackageImport(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedRule(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedRule(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedRule(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedRule(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#setIsLeaf(Boolean
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initTemplateBinding(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateTemplateBinding(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterTemplateBinding(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterTemplateBinding(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#setIsAbstract(Boolean
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initGeneralization(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateGeneralization(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterGeneralization(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterGeneralization(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initPowertypeExtent(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updatePowertypeExtent(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterPowertypeExtent(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterPowertypeExtent(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initRedefinedClassifier(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateRedefinedClassifier(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterRedefinedClassifier(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterRedefinedClassifier(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initSubstitution(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateSubstitution(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterSubstitution(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterSubstitution(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initCollaborationUse(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateCollaborationUse(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterCollaborationUse(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterCollaborationUse(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedUseCase(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedUseCase(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedUseCase(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedUseCase(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initUseCase(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateUseCase(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterUseCase(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterUseCase(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedAttribute(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedAttribute(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedAttribute(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedAttribute(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedConnector(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedConnector(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedConnector(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedConnector(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedBehavior(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedBehavior(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedBehavior(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedBehavior(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initInterfaceRealization(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateInterfaceRealization(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterInterfaceRealization(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterInterfaceRealization(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedTrigger(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedTrigger(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedTrigger(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedTrigger(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initNestedClassifier(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateNestedClassifier(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterNestedClassifier(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterNestedClassifier(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedOperation(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedOperation(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedOperation(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedOperation(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#setIsActive(Boolean
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initOwnedReception(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateOwnedReception(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterOwnedReception(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterOwnedReception(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#initIcon(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#updateIcon(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addFilterIcon(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.StereotypePropertiesEditionPart#addBusinessFilterIcon(ViewerFilter
	 *      filter)
	 */
