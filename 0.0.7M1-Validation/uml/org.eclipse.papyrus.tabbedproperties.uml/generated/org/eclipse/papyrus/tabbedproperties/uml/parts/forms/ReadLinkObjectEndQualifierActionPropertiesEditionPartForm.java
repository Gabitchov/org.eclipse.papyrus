 ...
 */
public class ReadLinkObjectEndQualifierActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, ReadLinkObjectEndQualifierActionPropertiesEditionPart {
	...
	protected void createPropertiesGroup(FormToolkit widgetFactory, final Composite view) {
		Section propertiesSection = widgetFactory.createSection(view, Section.TITLE_BAR | Section.TWISTIE
				| Section.EXPANDED);
		propertiesSection
				.setText(UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedComment = new ReferencesTable<Comment>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_OwnedCommentLabel,
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_NameLabel, propertiesEditionComponent
						.isRequired(UMLViewsRepository.ReadLinkObjectEndQualifierAction.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReadLinkObjectEndQualifierAction.name, PropertiesEditionEvent.CHANGE,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReadLinkObjectEndQualifierAction.name, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, name.getText()));
			}
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
								UMLViewsRepository.ReadLinkObjectEndQualifierAction.name,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$

	}

	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.ReadLinkObjectEndQualifierAction.visibility,
						UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReadLinkObjectEndQualifierAction.visibility,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable<Dependency>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_ClientDependencyLabel,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent,
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_IsLeafLabel, SWT.CHECK);
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReadLinkObjectEndQualifierAction.isLeaf, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable<ActivityEdge>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_OutgoingLabel,
						...
						TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
											UMLViewsRepository.ReadLinkObjectEndQualifierAction.outgoing,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								outgoing.refresh();
							}
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.outgoing, UMLViewsRepository.FORM_KIND));
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable<ActivityEdge>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_IncomingLabel,
				new ReferencesTableListener<ActivityEdge>() {
						...
						TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
											UMLViewsRepository.ReadLinkObjectEndQualifierAction.incoming,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								incoming.refresh();
							}
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.incoming, UMLViewsRepository.FORM_KIND));
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable<ActivityPartition>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_InPartitionLabel,
						...
						TabElementTreeSelectionDialog<ActivityPartition> dialog = new TabElementTreeSelectionDialog<ActivityPartition>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											ReadLinkObjectEndQualifierActionPropertiesEditionPartForm.this,
											UMLViewsRepository.ReadLinkObjectEndQualifierAction.inPartition,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								inPartition.refresh();
							}
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.inPartition, UMLViewsRepository.FORM_KIND));
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable<InterruptibleActivityRegion>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_InInterruptibleRegionLabel,
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent
				.getHelpContent(UMLViewsRepository.ReadLinkObjectEndQualifierAction.inInterruptibleRegion,
						UMLViewsRepository.FORM_KIND));
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable<ActivityNode>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_RedefinedNodeLabel,
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void createHandlerTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.handler = new ReferencesTable<ExceptionHandler>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_HandlerLabel,
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.handler, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPreconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.localPrecondition = new ReferencesTable<Constraint>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_LocalPreconditionLabel,
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.localPrecondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPostconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.localPostcondition = new ReferencesTable<Constraint>(
				UMLMessages.ReadLinkObjectEndQualifierActionPropertiesEditionPart_LocalPostconditionLabel,
				new ReferencesTableListener<Constraint>() {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReadLinkObjectEndQualifierAction.localPostcondition, UMLViewsRepository.FORM_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initOwnedComment(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#updateOwnedComment(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#setName(String
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initVisibility(EEnum
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initClientDependency(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#setIsLeaf(Boolean
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initOutgoing(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#updateOutgoing(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initIncoming(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#updateIncoming(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initInPartition(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#updateInPartition(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initRedefinedNode(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#updateRedefinedNode(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#initHandler(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#updateHandler(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.ReadLinkObjectEndQualifierActionPropertiesEditionPart#addFilterHandler(ViewerFilter
	 *      filter)
	 */
