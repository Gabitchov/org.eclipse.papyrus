...
public class ActivityBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getActivity_Variable() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getVariable())) {
						basePart.updateVariable(activity);
					}
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getActivity_Node() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getActivityNode())) {
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getActivity_Edge() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getActivityEdge())) {
					...
					if (UMLPackage.eINSTANCE.getActivity_IsSingleExecution().equals(msg.getFeature())
							&& basePart != null)
						basePart.setIsSingleExecution((Boolean) msg.getNewValue());

					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getActivity_Group() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getActivityGroup())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (activity != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ActivityPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Activity.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Activity.class) {
			...
			Activity activity = (Activity) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), activity
					.getVisibility());
			...
			basePart.initInterfaceRealization(activity, null, UMLPackage.eINSTANCE
			...
			basePart.addFilterToPartition(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getPartitionTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (activity != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, activity,
			...
			for (Iterator iter = elementImportToAddFromElementImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getNamespace_ElementImport(),
						iter.next()));
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getElementImport(),
			...
			for (Iterator iter = packageImportToAddFromPackageImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getNamespace_PackageImport(),
						iter.next()));
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToAddFromOwnedRule.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getNamespace_OwnedRule(),
						iter.next()));
			...
			for (Iterator iter = ownedRuleToMoveFromOwnedRule.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getConstraint(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));
			...
			for (Iterator iter = templateBindingToMoveFromTemplateBinding.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getTemplateBinding(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClassifier_IsAbstract(),
			...
			for (Iterator iter = generalizationToMoveFromGeneralization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getGeneralization(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = substitutionToAddFromSubstitution.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClassifier_Substitution(),
						iter.next()));
			...
			for (Iterator iter = substitutionToMoveFromSubstitution.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getSubstitution(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = collaborationUseToMoveFromCollaborationUse.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getCollaborationUse(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedUseCaseToAddFromOwnedUseCase.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClassifier_OwnedUseCase(),
						iter.next()));
			...
			for (Iterator iter = ownedUseCaseToMoveFromOwnedUseCase.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getUseCase(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			List useCaseToAddFromUseCase = basePart.getUseCaseToAdd();
			for (Iterator iter = useCaseToAddFromUseCase.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClassifier_UseCase(), iter
						.next()));
			...
			for (Iterator iter = useCaseToRemoveFromUseCase.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClassifier_UseCase(),
						iter.next()));
			...
			for (Iterator iter = ownedAttributeToMoveFromOwnedAttribute.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getProperty(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedConnectorToMoveFromOwnedConnector.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getConnector(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedBehaviorToMoveFromOwnedBehavior.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getBehavior(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = interfaceRealizationToMoveFromInterfaceRealization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getInterfaceRealization(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedTriggerToMoveFromOwnedTrigger.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getTrigger(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = nestedClassifierToAddFromNestedClassifier.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClass_NestedClassifier(),
						iter.next()));
			...
			for (Iterator iter = nestedClassifierToMoveFromNestedClassifier.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClassifier(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedOperationToAddFromOwnedOperation.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClass_OwnedOperation(),
						iter.next()));
			...
			for (Iterator iter = ownedOperationToMoveFromOwnedOperation.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getOperation(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClass_IsActive(), basePart
					.getIsActive()));
			...
			for (Iterator iter = ownedReceptionToAddFromOwnedReception.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getClass_OwnedReception(),
						iter.next()));
			...
			for (Iterator iter = ownedReceptionToMoveFromOwnedReception.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getReception(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getBehavior_IsReentrant(),
					basePart.getIsReentrant()));
			...
			for (Iterator iter = ownedParameterToAddFromOwnedParameter.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getBehavior_OwnedParameter(),
						iter.next()));
			...
			for (Iterator iter = ownedParameterToMoveFromOwnedParameter.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getParameter(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = preconditionToAddFromPrecondition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getBehavior_Precondition(),
						iter.next()));
			...
			for (Iterator iter = preconditionToRemoveFromPrecondition.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, activity,
						UMLPackage.eINSTANCE.getBehavior_Precondition(), iter.next()));
			...
			for (Iterator iter = postconditionToAddFromPostcondition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getBehavior_Postcondition(),
						iter.next()));
			...
			for (Iterator iter = ownedParameterSetToMoveFromOwnedParameterSet.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getParameterSet(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = variableToAddFromVariable.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_Variable(), iter
						.next()));
			...
			for (Iterator iter = variableToRefreshFromVariable.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for variable reference refreshment from variable
			...
			for (Iterator iter = variableToMoveFromVariable.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getVariable(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			List nodeToAddFromNode = basePart.getNodeToAdd();
			for (Iterator iter = nodeToAddFromNode.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_Node(), iter
						.next()));
			Map nodeToRefreshFromNode = basePart.getNodeToEdit();
			for (Iterator iter = nodeToRefreshFromNode.keySet().iterator(); iter.hasNext();) {

				// Start of user code for node reference refreshment from node
			...
			for (Iterator iter = nodeToMoveFromNode.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivityNode(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_IsReadOnly(),
					basePart.getIsReadOnly()));

			List edgeToAddFromEdge = basePart.getEdgeToAdd();
			for (Iterator iter = edgeToAddFromEdge.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_Edge(), iter
						.next()));
			Map edgeToRefreshFromEdge = basePart.getEdgeToEdit();
			for (Iterator iter = edgeToRefreshFromEdge.keySet().iterator(); iter.hasNext();) {

				// Start of user code for edge reference refreshment from edge
			...
			for (Iterator iter = edgeToMoveFromEdge.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivityEdge(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = partitionToAddFromPartition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_Partition(), iter
						.next()));
			...
			for (Iterator iter = partitionToRemoveFromPartition.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_Partition(),
						iter.next()));
			...
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_IsSingleExecution(),
					basePart.getIsSingleExecution()));

			List groupToAddFromGroup = basePart.getGroupToAdd();
			for (Iterator iter = groupToAddFromGroup.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivity_Group(), iter
						.next()));
			...
			for (Iterator iter = groupToRefreshFromGroup.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for group reference refreshment from group
			...
			for (Iterator iter = groupToMoveFromGroup.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activity, UMLPackage.eINSTANCE.getActivityGroup(),
						moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Activity.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Activity.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Activity.ownedRule == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity,
			...
			if (UMLViewsRepository.Activity.ownedUseCase == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getUseCase(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.Activity.ownedAttribute == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getProperty(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.ownedConnector == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getConnector(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.ownedBehavior == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getBehavior(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.Activity.ownedTrigger == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getTrigger(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.nestedClassifier == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity,
							UMLPackage.eINSTANCE.getClassifier(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.ownedOperation == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getOperation(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.isActive == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getClass_IsActive(),
						event.getNewValue()));
			...
			if (UMLViewsRepository.Activity.ownedReception == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getReception(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.Activity.ownedParameter == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getParameter(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.Activity.variable == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Variable(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE.getVariable(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.node == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Node(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivityNode(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.isReadOnly == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
						.getActivity_IsReadOnly(), event.getNewValue()));
			...
			if (UMLViewsRepository.Activity.edge == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Edge(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivityEdge(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.partition == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Partition(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Partition(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Partition(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Activity.isSingleExecution == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
						.getActivity_IsSingleExecution(), event.getNewValue()));
			...
			if (UMLViewsRepository.Activity.group == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					// Start of user code for group live update command
					// TODO: Complete the activity update command
					// End of user code

				} else if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivity_Group(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activity, UMLPackage.eINSTANCE
							.getActivityGroup(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Activity.isLeaf || key == UMLViewsRepository.Activity.isAbstract
				|| key == UMLViewsRepository.Activity.isActive || key == UMLViewsRepository.Activity.isReentrant
				|| key == UMLViewsRepository.Activity.isReadOnly
				|| key == UMLViewsRepository.Activity.isSingleExecution;
	}
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.Activity.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.elementImport)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.packageImport)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedRule)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.templateBinding)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.isAbstract)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.generalization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.powertypeExtent)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.redefinedClassifier)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.substitution)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.collaborationUse)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedUseCase)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.useCase)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedAttribute)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedConnector)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedBehavior)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.interfaceRealization)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedTrigger)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.nestedClassifier)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedOperation)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.isActive)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedReception)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.isReentrant)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.redefinedBehavior)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedParameter)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.precondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.postcondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.ownedParameterSet)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.variable)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.node)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.isReadOnly)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.edge)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.partition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.isSingleExecution)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.Activity.group)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.Activity.isReadOnly == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getActivity_IsReadOnly()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(
						UMLPackage.eINSTANCE.getActivity_IsReadOnly().getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.Activity.isSingleExecution == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getActivity_IsSingleExecution()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getActivity_IsSingleExecution()
						.getEAttributeType(), newValue);
			}
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(activity);
		else
			return null;
	}
