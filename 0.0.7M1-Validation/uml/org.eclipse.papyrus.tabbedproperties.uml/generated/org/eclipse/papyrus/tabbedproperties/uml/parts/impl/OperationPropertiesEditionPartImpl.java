 ...
 */
public class OperationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, OperationPropertiesEditionPart {
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.OperationPropertiesEditionPart_NameLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.Operation.name, UMLViewsRepository.SWT_KIND));
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OperationPropertiesEditionPartImpl.this, UMLViewsRepository.Operation.name,
							PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}

		});

		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.Operation.name,
				UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.OperationPropertiesEditionPart_VisibilityLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createConcurrencyEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.OperationPropertiesEditionPart_ConcurrencyLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.concurrency, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsAbstractCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.isAbstract, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsStaticCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.isStatic, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsLeafCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.isLeaf, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createIsQueryCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.isQuery, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOwnedParameterAdvancedTableComposition(Composite parent) {
		...
		this.ownedParameter.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.ownedParameter, UMLViewsRepository.SWT_KIND));
	...
	protected void createRaisedExceptionAdvancedReferencesTable(Composite parent) {
						...
						TabElementTreeSelectionDialog<Type> dialog = new TabElementTreeSelectionDialog<Type>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											OperationPropertiesEditionPartImpl.this,
		...
		this.raisedException.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.raisedException, UMLViewsRepository.SWT_KIND));
	...
	protected void createTemplateBindingAdvancedTableComposition(Composite parent) {
		...
		this.templateBinding.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.templateBinding, UMLViewsRepository.SWT_KIND));
	...
	protected void createOwnedParameterSetAdvancedTableComposition(Composite parent) {
		...
		this.ownedParameterSet.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.ownedParameterSet, UMLViewsRepository.SWT_KIND));
	...
	protected void createPreconditionAdvancedReferencesTable(Composite parent) {
		...
		this.precondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.precondition, UMLViewsRepository.SWT_KIND));
	...
	protected void createPostconditionAdvancedReferencesTable(Composite parent) {
		...
		this.postcondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.postcondition, UMLViewsRepository.SWT_KIND));
	...
	protected void createRedefinedOperationAdvancedReferencesTable(Composite parent) {
		...
		this.redefinedOperation.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.redefinedOperation, UMLViewsRepository.SWT_KIND));
	...
	protected void createPackageImportAdvancedTableComposition(Composite parent) {
		...
		this.packageImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.packageImport, UMLViewsRepository.SWT_KIND));
	...
	protected void createElementImportAdvancedTableComposition(Composite parent) {
		...
		this.elementImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Operation.elementImport, UMLViewsRepository.SWT_KIND));
