 ...
 */
public class ReclassifyObjectActionPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, ReclassifyObjectActionPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.ReclassifyObjectActionPropertiesEditionPart_NameLabel, propertiesEditionComponent
						.isRequired(UMLViewsRepository.ReclassifyObjectAction.name, UMLViewsRepository.FORM_KIND));
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReclassifyObjectActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReclassifyObjectAction.name, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils
				.createPartLabel(widgetFactory, parent,
						UMLMessages.ReclassifyObjectActionPropertiesEditionPart_VisibilityLabel,
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReclassifyObjectActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReclassifyObjectAction.visibility, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		isLeaf = widgetFactory.createButton(parent,
				UMLMessages.ReclassifyObjectActionPropertiesEditionPart_IsLeafLabel, SWT.CHECK);
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReclassifyObjectActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReclassifyObjectAction.isLeaf, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.outgoing, UMLViewsRepository.FORM_KIND));
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.incoming, UMLViewsRepository.FORM_KIND));
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.inPartition, UMLViewsRepository.FORM_KIND));
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.inInterruptibleRegion, UMLViewsRepository.FORM_KIND));
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void createHandlerTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.handler.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.handler, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPreconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPrecondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.localPrecondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createLocalPostconditionTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.localPostcondition.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.localPostcondition, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsReplaceAllCheckbox(FormToolkit widgetFactory, Composite parent) {
		isReplaceAll = widgetFactory.createButton(parent,
				UMLMessages.ReclassifyObjectActionPropertiesEditionPart_IsReplaceAllLabel, SWT.CHECK);
		isReplaceAll.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ReclassifyObjectActionPropertiesEditionPartForm.this,
							UMLViewsRepository.ReclassifyObjectAction.isReplaceAll, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.isReplaceAll, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createOldClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.oldClassifier.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.oldClassifier, UMLViewsRepository.FORM_KIND));
	...
	protected void createNewClassifierReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.newClassifier.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ReclassifyObjectAction.newClassifier, UMLViewsRepository.FORM_KIND));
