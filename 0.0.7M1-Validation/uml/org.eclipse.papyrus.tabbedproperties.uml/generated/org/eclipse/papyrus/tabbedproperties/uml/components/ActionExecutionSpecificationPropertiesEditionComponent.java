...
public class ActionExecutionSpecificationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 *            the EObject to edit
	 */
	public ActionExecutionSpecificationPropertiesEditionComponent(EObject actionExecutionSpecification,
			String editing_mode) {
		super(editing_mode);
		if (actionExecutionSpecification instanceof ActionExecutionSpecification) {
			actionExecutionSpecificationBasePropertiesEditionComponent = new ActionExecutionSpecificationBasePropertiesEditionComponent(
					actionExecutionSpecification, editing_mode);
			addSubComponent(actionExecutionSpecificationBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(actionExecutionSpecification,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ActionExecutionSpecificationPropertiesEditionPart) actionExecutionSpecificationBasePropertiesEditionComponent
