...
public class RemoveStructuralFeatureValueActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 *            the EObject to edit
	 */
	public RemoveStructuralFeatureValueActionPropertiesEditionComponent(EObject removeStructuralFeatureValueAction,
			String editing_mode) {
		super(editing_mode);
		if (removeStructuralFeatureValueAction instanceof RemoveStructuralFeatureValueAction) {
			removeStructuralFeatureValueActionBasePropertiesEditionComponent = new RemoveStructuralFeatureValueActionBasePropertiesEditionComponent(
					removeStructuralFeatureValueAction, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (RemoveStructuralFeatureValueActionPropertiesEditionPart) removeStructuralFeatureValueActionBasePropertiesEditionComponent
