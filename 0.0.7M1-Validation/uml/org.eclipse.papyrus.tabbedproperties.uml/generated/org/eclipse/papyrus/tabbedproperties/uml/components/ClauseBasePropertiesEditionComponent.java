	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (clause != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ClausePropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Clause.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Clause.class) {
			...
			basePart.addFilterToBody(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getBodyTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToPredecessorClause(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getPredecessorClauseTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToSuccessorClause(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getSuccessorClauseTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (clause != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getElement_OwnedComment(), iter
						.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getComment(), moveElement
			...
			for (Iterator iter = testToRemoveFromTest.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_Test(), iter
						.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, clause,
			...
			for (Iterator iter = bodyToRemoveFromBody.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_Body(), iter
						.next()));
			...
			for (Iterator iter = predecessorClauseToAddFromPredecessorClause.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_PredecessorClause(),
						iter.next()));
			...
			for (Iterator iter = predecessorClauseToRemoveFromPredecessorClause.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE
						.getClause_PredecessorClause(), iter.next()));
			// List predecessorClauseToMoveFromPredecessorClause =
			// basePart.getPredecessorClauseToMove();
			// for (Iterator iter = predecessorClauseToMoveFromPredecessorClause.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause(),
			...
			for (Iterator iter = successorClauseToAddFromSuccessorClause.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_SuccessorClause(),
						iter.next()));
			...
			for (Iterator iter = successorClauseToRemoveFromSuccessorClause.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_SuccessorClause(),
						iter.next()));
			// List successorClauseToMoveFromSuccessorClause = basePart.getSuccessorClauseToMove();
			// for (Iterator iter = successorClauseToMoveFromSuccessorClause.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause(),
			...
			for (Iterator iter = bodyOutputToAddFromBodyOutput.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_BodyOutput(), iter
						.next()));
			...
			for (Iterator iter = bodyOutputToRemoveFromBodyOutput.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clause, UMLPackage.eINSTANCE.getClause_BodyOutput(), iter
						.next()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Clause.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Clause.test == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE.getClause_Test(),
							event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_Test(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE.getClause_Test(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Clause.body == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE.getClause_Body(),
							event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_Body(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE.getClause_Body(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Clause.predecessorClause == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_PredecessorClause(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_PredecessorClause(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_PredecessorClause(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Clause.successorClause == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_SuccessorClause(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_SuccessorClause(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_SuccessorClause(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Clause.bodyOutput == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_BodyOutput(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_BodyOutput(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clause, UMLPackage.eINSTANCE
							.getClause_BodyOutput(), event.getNewValue(), event.getNewIndex()));
			}
