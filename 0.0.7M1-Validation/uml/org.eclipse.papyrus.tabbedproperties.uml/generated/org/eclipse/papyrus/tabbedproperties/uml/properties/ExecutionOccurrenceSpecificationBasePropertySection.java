...
public class ExecutionOccurrenceSpecificationBasePropertySection extends AbstractPropertySection implements IFilter {
			...
			if (eObject != null) {
				...
				if (this.propertiesEditionComponent != null) {
					...
					this.editionPart = propertiesEditionComponent.getPropertiesEditionPart(1,
							ExecutionOccurrenceSpecificationBasePropertiesEditionComponent.BASE_PART); //$NON-NLS-1$
					if (editionPart instanceof IFormPropertiesEditionPart) {
						...
						propertiesEditionComponent
								.initPart(
										propertiesEditionComponent
												.translatePart(ExecutionOccurrenceSpecificationBasePropertiesEditionComponent.BASE_PART),
										1, eObject);
					}
				}
			}
	...
	public boolean select(Object toTest) {
		...
		return eObjectToTest != null
				&& eObjectToTest.eClass() == UMLPackage.eINSTANCE.getExecutionOccurrenceSpecification();
	}
