...
public class UseCaseBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getUseCase_Include() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getInclude())) {
						basePart.updateInclude(useCase);
					}
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getUseCase_Extend() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getExtend())) {
						basePart.updateExtend(useCase);
					}
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getUseCase_ExtensionPoint() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getExtensionPoint())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (useCase != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (UseCasePropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.UseCase.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.UseCase.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), useCase
					.getVisibility());
			...
			basePart.initInterfaceRealization(useCase, null, UMLPackage.eINSTANCE
			...
			basePart.addFilterToSubject(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getSubjectTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (useCase != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, useCase,
			...
			for (Iterator iter = elementImportToAddFromElementImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getNamespace_ElementImport(),
						iter.next()));
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getElementImport(),
			...
			for (Iterator iter = packageImportToAddFromPackageImport.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getNamespace_PackageImport(),
						iter.next()));
			...
			for (Iterator iter = packageImportToMoveFromPackageImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getPackageImport(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedRuleToAddFromOwnedRule.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getNamespace_OwnedRule(), iter
						.next()));
			...
			for (Iterator iter = ownedRuleToMoveFromOwnedRule.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getConstraint(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));
			...
			for (Iterator iter = templateBindingToMoveFromTemplateBinding.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getTemplateBinding(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getClassifier_IsAbstract(),
			...
			for (Iterator iter = generalizationToAddFromGeneralization.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase,
						UMLPackage.eINSTANCE.getClassifier_Generalization(), iter.next()));
			...
			for (Iterator iter = generalizationToMoveFromGeneralization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getGeneralization(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = substitutionToAddFromSubstitution.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getClassifier_Substitution(),
						iter.next()));
			...
			for (Iterator iter = substitutionToMoveFromSubstitution.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getSubstitution(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = collaborationUseToMoveFromCollaborationUse.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getCollaborationUse(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedUseCaseToAddFromOwnedUseCase.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getClassifier_OwnedUseCase(),
						iter.next()));
			...
			for (Iterator iter = ownedUseCaseToMoveFromOwnedUseCase.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getUseCase(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			List useCaseToAddFromUseCase = basePart.getUseCaseToAdd();
			for (Iterator iter = useCaseToAddFromUseCase.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getClassifier_UseCase(), iter
						.next()));
			...
			for (Iterator iter = useCaseToRemoveFromUseCase.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getClassifier_UseCase(),
						iter.next()));
			...
			for (Iterator iter = ownedBehaviorToMoveFromOwnedBehavior.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getBehavior(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = interfaceRealizationToMoveFromInterfaceRealization.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getInterfaceRealization(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedTriggerToMoveFromOwnedTrigger.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getTrigger(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			List includeToAddFromInclude = basePart.getIncludeToAdd();
			for (Iterator iter = includeToAddFromInclude.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getUseCase_Include(), iter
						.next()));
			...
			for (Iterator iter = includeToRefreshFromInclude.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for include reference refreshment from include
			...
			for (Iterator iter = includeToMoveFromInclude.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getInclude(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			List extendToAddFromExtend = basePart.getExtendToAdd();
			for (Iterator iter = extendToAddFromExtend.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getUseCase_Extend(), iter
						.next()));
			...
			for (Iterator iter = extendToRefreshFromExtend.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for extend reference refreshment from extend
			...
			for (Iterator iter = extendToMoveFromExtend.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getExtend(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = extensionPointToAddFromExtensionPoint.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getUseCase_ExtensionPoint(),
						iter.next()));
			...
			for (Iterator iter = extensionPointToRefreshFromExtensionPoint.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for extensionPoint reference refreshment from extensionPoint

				ExtensionPoint nextElement = (ExtensionPoint) iter.next();
				ExtensionPoint extensionPoint = (ExtensionPoint) extensionPointToRefreshFromExtensionPoint
						.get(nextElement);
			...
			for (Iterator iter = extensionPointToMoveFromExtensionPoint.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getExtensionPoint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			List subjectToAddFromSubject = basePart.getSubjectToAdd();
			for (Iterator iter = subjectToAddFromSubject.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getUseCase_Subject(), iter
						.next()));
			...
			for (Iterator iter = subjectToRemoveFromSubject.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, useCase, UMLPackage.eINSTANCE.getUseCase_Subject(), iter
						.next()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.UseCase.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.UseCase.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.UseCase.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.UseCase.ownedRule == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getConstraint(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.UseCase.ownedUseCase == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getUseCase(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.UseCase.ownedBehavior == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getBehavior(),
							event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.UseCase.ownedTrigger == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getTrigger(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.UseCase.include == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getUseCase_Include(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getInclude(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.UseCase.extend == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getUseCase_Extend(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE.getExtend(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.UseCase.extensionPoint == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getUseCase_ExtensionPoint(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getExtensionPoint(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.UseCase.subject == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getUseCase_Subject(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getUseCase_Subject(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, useCase, UMLPackage.eINSTANCE
							.getUseCase_Subject(), event.getNewValue(), event.getNewIndex()));
			}
