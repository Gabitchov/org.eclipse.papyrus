...
public class OccurrenceSpecificationPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public OccurrenceSpecificationPropertiesEditionComponent(EObject occurrenceSpecification, String editing_mode) {
		...
		if (occurrenceSpecification instanceof OccurrenceSpecification) {
			occurrenceSpecificationBasePropertiesEditionComponent = new OccurrenceSpecificationBasePropertiesEditionComponent(
					occurrenceSpecification, editing_mode);
			addSubComponent(occurrenceSpecificationBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(occurrenceSpecification,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (OccurrenceSpecificationPropertiesEditionPart) occurrenceSpecificationBasePropertiesEditionComponent
