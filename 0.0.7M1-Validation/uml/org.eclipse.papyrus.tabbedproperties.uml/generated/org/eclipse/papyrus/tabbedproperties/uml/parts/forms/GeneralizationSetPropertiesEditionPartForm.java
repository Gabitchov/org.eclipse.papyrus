 ...
 */
public class GeneralizationSetPropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, GeneralizationSetPropertiesEditionPart {
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.GeneralizationSetPropertiesEditionPart_NameLabel,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralizationSetPropertiesEditionPartForm.this, UMLViewsRepository.GeneralizationSet.name,
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								GeneralizationSetPropertiesEditionPartForm.this,
								UMLViewsRepository.GeneralizationSet.name, PropertiesEditionEvent.COMMIT,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent,
				UMLMessages.GeneralizationSetPropertiesEditionPart_VisibilityLabel, propertiesEditionComponent
						.isRequired(UMLViewsRepository.GeneralizationSet.visibility, UMLViewsRepository.FORM_KIND));
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralizationSetPropertiesEditionPartForm.this,
							UMLViewsRepository.GeneralizationSet.visibility, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void createIsCoveringCheckbox(FormToolkit widgetFactory, Composite parent) {
		isCovering = widgetFactory.createButton(parent,
				UMLMessages.GeneralizationSetPropertiesEditionPart_IsCoveringLabel, SWT.CHECK);
		isCovering.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralizationSetPropertiesEditionPartForm.this,
							UMLViewsRepository.GeneralizationSet.isCovering, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(isCovering.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.isCovering, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	protected void createIsDisjointCheckbox(FormToolkit widgetFactory, Composite parent) {
		isDisjoint = widgetFactory.createButton(parent,
				UMLMessages.GeneralizationSetPropertiesEditionPart_IsDisjointLabel, SWT.CHECK);
		isDisjoint.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralizationSetPropertiesEditionPartForm.this,
							UMLViewsRepository.GeneralizationSet.isDisjoint, PropertiesEditionEvent.COMMIT,
							PropertiesEditionEvent.SET, null, new Boolean(isDisjoint.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.isDisjoint, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createGeneralizationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		...
		this.generalization.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.GeneralizationSet.generalization, UMLViewsRepository.FORM_KIND));
