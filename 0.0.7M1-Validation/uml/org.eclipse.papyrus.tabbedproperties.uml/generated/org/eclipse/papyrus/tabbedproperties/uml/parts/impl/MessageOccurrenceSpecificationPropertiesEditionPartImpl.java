 ...
 */
public class MessageOccurrenceSpecificationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, MessageOccurrenceSpecificationPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		this.ownedComment = new ReferencesTable<Comment>(
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_OwnedCommentLabel,
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	private void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
	...
	protected void addToOwnedComment() {
		...
		if (editionPolicy != null) {
			...
			if (propertiesEditionObject != null) {
				...
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
						UMLViewsRepository.MessageOccurrenceSpecification.ownedComment, PropertiesEditionEvent.CHANGE,
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_NameLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.MessageOccurrenceSpecification.name,
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
							UMLViewsRepository.MessageOccurrenceSpecification.name, PropertiesEditionEvent.CHANGE,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent,
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.MessageOccurrenceSpecification.visibility,
						UMLViewsRepository.SWT_KIND));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
		this.clientDependency = new ReferencesTable<Dependency>(
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_ClientDependencyLabel,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void createCoveredAdvancedReferencesTable(Composite parent) {
		this.covered = new ReferencesTable<Lifeline>(
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_CoveredLabel,
						...
						TabElementTreeSelectionDialog<Lifeline> dialog = new TabElementTreeSelectionDialog<Lifeline>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
											UMLViewsRepository.MessageOccurrenceSpecification.covered,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								covered.refresh();
							}
		...
		this.covered.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.covered, UMLViewsRepository.SWT_KIND));
	...
	protected void createGeneralOrderingAdvancedTableComposition(Composite parent) {
		this.generalOrdering = new ReferencesTable<GeneralOrdering>(
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_GeneralOrderingLabel,
		...
		this.generalOrdering.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.generalOrdering, UMLViewsRepository.SWT_KIND));
	...
	private void removeFromGeneralOrdering(GeneralOrdering element) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
				UMLViewsRepository.MessageOccurrenceSpecification.generalOrdering, PropertiesEditionEvent.CHANGE,
				PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createToBeforeAdvancedReferencesTable(Composite parent) {
		this.toBefore = new ReferencesTable<GeneralOrdering>(
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_ToBeforeLabel,
				new ReferencesTableListener<GeneralOrdering>() {
						...
						TabElementTreeSelectionDialog<GeneralOrdering> dialog = new TabElementTreeSelectionDialog<GeneralOrdering>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
											UMLViewsRepository.MessageOccurrenceSpecification.toBefore,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								toBefore.refresh();
							}
		...
		this.toBefore.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.toBefore, UMLViewsRepository.SWT_KIND));
	...
	protected void createToAfterAdvancedReferencesTable(Composite parent) {
		this.toAfter = new ReferencesTable<GeneralOrdering>(
				UMLMessages.MessageOccurrenceSpecificationPropertiesEditionPart_ToAfterLabel,
				new ReferencesTableListener<GeneralOrdering>() {
						...
						TabElementTreeSelectionDialog<GeneralOrdering> dialog = new TabElementTreeSelectionDialog<GeneralOrdering>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											MessageOccurrenceSpecificationPropertiesEditionPartImpl.this,
											UMLViewsRepository.MessageOccurrenceSpecification.toAfter,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
								toAfter.refresh();
							}
		...
		this.toAfter.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.MessageOccurrenceSpecification.toAfter, UMLViewsRepository.SWT_KIND));
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initOwnedComment(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#updateOwnedComment(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#setName(String
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initVisibility(EEnum
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initClientDependency(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initCovered(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#updateCovered(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#addFilterCovered(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initGeneralOrdering(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#updateGeneralOrdering(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initToBefore(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#updateToBefore(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#addFilterToBefore(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#initToAfter(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#updateToAfter(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.MessageOccurrenceSpecificationPropertiesEditionPart#addFilterToAfter(ViewerFilter
	 *      filter)
	 */
