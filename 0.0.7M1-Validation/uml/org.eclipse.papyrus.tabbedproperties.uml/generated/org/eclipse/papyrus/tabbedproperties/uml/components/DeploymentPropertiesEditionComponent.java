...
public class DeploymentPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public DeploymentPropertiesEditionComponent(EObject deployment, String editing_mode) {
		...
		if (deployment instanceof Deployment) {
			deploymentBasePropertiesEditionComponent = new DeploymentBasePropertiesEditionComponent(deployment,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (DeploymentPropertiesEditionPart) deploymentBasePropertiesEditionComponent
