 ...
 */
public class BehaviorExecutionSpecificationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, BehaviorExecutionSpecificationPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.BehaviorExecutionSpecification.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.BehaviorExecutionSpecificationPropertiesEditionPart_NameLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.BehaviorExecutionSpecification.name,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.BehaviorExecutionSpecification.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createVisibilityEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.BehaviorExecutionSpecification.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.BehaviorExecutionSpecification.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void createCoveredAdvancedReferencesTable(Composite parent) {
		...
		this.covered.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.BehaviorExecutionSpecification.covered, UMLViewsRepository.SWT_KIND));
	...
	protected void createGeneralOrderingAdvancedTableComposition(Composite parent) {
		...
		this.generalOrdering.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.BehaviorExecutionSpecification.generalOrdering, UMLViewsRepository.SWT_KIND));
