...
public class JoinNodeBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (UMLPackage.eINSTANCE.getJoinNode_IsCombineDuplicate().equals(msg.getFeature())
							&& basePart != null)
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (joinNode != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (JoinNodePropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.JoinNode.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.JoinNode.class) {
			...
			JoinNode joinNode = (JoinNode) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), joinNode
					.getVisibility());
			...
			basePart.initInInterruptibleRegion(joinNode, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (joinNode != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, joinNode,
			// UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));
			...
			for (Iterator iter = outgoingToAddFromOutgoing.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getActivityNode_Outgoing(),
						iter.next()));
			...
			for (Iterator iter = outgoingToRemoveFromOutgoing.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, joinNode,
			...
			for (Iterator iter = incomingToAddFromIncoming.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getActivityNode_Incoming(),
						iter.next()));
			...
			for (Iterator iter = inPartitionToAddFromInPartition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, joinNode,
			...
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, joinNode, UMLPackage.eINSTANCE.getJoinNode_IsCombineDuplicate(),
					basePart.getIsCombineDuplicate()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.JoinNode.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, joinNode, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, joinNode, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.JoinNode.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, joinNode, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.JoinNode.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, joinNode, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, joinNode, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.JoinNode.isCombineDuplicate == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, joinNode, UMLPackage.eINSTANCE
						.getJoinNode_IsCombineDuplicate(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.JoinNode.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.JoinNode.isCombineDuplicate)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.JoinNode.isCombineDuplicate == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getJoinNode_IsCombineDuplicate()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getJoinNode_IsCombineDuplicate()
						.getEAttributeType(), newValue);
			}
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(joinNode);
		else
			return null;
	}
