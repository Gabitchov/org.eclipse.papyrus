...
public class ClearVariableActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (clearVariableAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ClearVariableActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ClearVariableAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ClearVariableAction.class) {
			...
			ClearVariableAction clearVariableAction = (ClearVariableAction) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					clearVariableAction.getVisibility());
			basePart.initClientDependency(clearVariableAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInInterruptibleRegion(clearVariableAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(clearVariableAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(clearVariableAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (clearVariableAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, clearVariableAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, clearVariableAction, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, clearVariableAction,
					UMLPackage.eINSTANCE.getNamedElement_Name(), basePart.getName()));

			cc.append(SetCommand.create(editingDomain, clearVariableAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clearVariableAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, clearVariableAction,
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, clearVariableAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = localPreconditionToMoveFromLocalPrecondition.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, clearVariableAction, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ClearVariableAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, clearVariableAction, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clearVariableAction, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ClearVariableAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, clearVariableAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ClearVariableAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clearVariableAction, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.ClearVariableAction.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.handler)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.localPrecondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ClearVariableAction.localPostcondition)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(clearVariableAction);
		else
			return null;
	}
