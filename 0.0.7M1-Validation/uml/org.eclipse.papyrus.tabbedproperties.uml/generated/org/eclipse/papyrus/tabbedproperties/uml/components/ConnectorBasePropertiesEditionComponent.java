...
public class ConnectorBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE.getConnector_End() || ((EStructuralFeature) msg
									.getFeature()).getEContainingClass() == UMLPackage.eINSTANCE.getConnectorEnd())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (connector != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ConnectorPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.Connector.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.Connector.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), connector
					.getVisibility());
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (connector != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getNamedElement_Name(), basePart
					.getName()));

			cc.append(SetCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, connector, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, connector, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, connector,
			// UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));

			cc.append(SetCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getFeature_IsStatic(), basePart
					.getIsStatic()));
			...
			for (Iterator iter = redefinedConnectorToAddFromRedefinedConnector.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, connector, UMLPackage.eINSTANCE
						.getConnector_RedefinedConnector(), iter.next()));
			...
			for (Iterator iter = redefinedConnectorToRemoveFromRedefinedConnector.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, connector, UMLPackage.eINSTANCE
						.getConnector_RedefinedConnector(), iter.next()));
			// List redefinedConnectorToMoveFromRedefinedConnector =
			// basePart.getRedefinedConnectorToMove();
			// for (Iterator iter = redefinedConnectorToMoveFromRedefinedConnector.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, connector,
			...
			for (Iterator iter = endToAddFromEnd.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getConnector_End(), iter
						.next()));
			...
			for (Iterator iter = endToMoveFromEnd.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getConnectorEnd(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getConnector_Kind(), basePart
					.getKind()));
			...
			for (Iterator iter = contractToAddFromContract.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getConnector_Contract(),
						iter.next()));
			...
			for (Iterator iter = contractToRemoveFromContract.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, connector, UMLPackage.eINSTANCE.getConnector_Contract(),
						iter.next()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.Connector.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Connector.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Connector.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.Connector.redefinedConnector == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_RedefinedConnector(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_RedefinedConnector(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_RedefinedConnector(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Connector.end == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_End(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnectorEnd(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.Connector.kind == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, connector,
						UMLPackage.eINSTANCE.getConnector_Kind(), event.getNewValue()));

			if (UMLViewsRepository.Connector.contract == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_Contract(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_Contract(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, connector, UMLPackage.eINSTANCE
							.getConnector_Contract(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.Connector.isLeaf || key == UMLViewsRepository.Connector.isStatic
				|| key == UMLViewsRepository.Connector.end;
	}
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.Connector.kind == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getConnector_Kind()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getConnector_Kind().getEAttributeType(),
						newValue);
			}
