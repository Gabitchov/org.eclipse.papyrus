...
public class ReadStructuralFeatureActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ReadStructuralFeatureActionBasePropertiesEditionComponent(EObject readStructuralFeatureAction,
			String editing_mode) {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					ReadStructuralFeatureActionBasePropertiesEditionComponent.this.dispose();
				else {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (readStructuralFeatureAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ReadStructuralFeatureActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ReadStructuralFeatureAction.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.ReadStructuralFeatureAction.class)
			this.basePart = (ReadStructuralFeatureActionPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ReadStructuralFeatureAction.class) {
			...
			// init values
			basePart
					.initOwnedComment(readStructuralFeatureAction, null, UMLPackage.eINSTANCE.getElement_OwnedComment());
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					readStructuralFeatureAction.getVisibility());
			basePart.initClientDependency(readStructuralFeatureAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInPartition(readStructuralFeatureAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InPartition());
			basePart.initInInterruptibleRegion(readStructuralFeatureAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(readStructuralFeatureAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(readStructuralFeatureAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(readStructuralFeatureAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (readStructuralFeatureAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, readStructuralFeatureAction,
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof ReadStructuralFeatureAction) {
			...
			readStructuralFeatureActionToUpdate.getInInterruptibleRegions().addAll(
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ReadStructuralFeatureAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, readStructuralFeatureAction,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, readStructuralFeatureAction,
			...
			if (UMLViewsRepository.ReadStructuralFeatureAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, readStructuralFeatureAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ReadStructuralFeatureAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, readStructuralFeatureAction,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
