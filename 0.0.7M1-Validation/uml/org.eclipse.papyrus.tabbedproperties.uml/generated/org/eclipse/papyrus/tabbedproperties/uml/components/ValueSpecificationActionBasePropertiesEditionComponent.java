...
public class ValueSpecificationActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (valueSpecificationAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ValueSpecificationActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ValueSpecificationAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ValueSpecificationAction.class) {
			...
			ValueSpecificationAction valueSpecificationAction = (ValueSpecificationAction) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					valueSpecificationAction.getVisibility());
			basePart.initClientDependency(valueSpecificationAction, null, UMLPackage.eINSTANCE
			...
			basePart
					.initInPartition(valueSpecificationAction, null, UMLPackage.eINSTANCE.getActivityNode_InPartition());
			basePart.initInInterruptibleRegion(valueSpecificationAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(valueSpecificationAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(valueSpecificationAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(valueSpecificationAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (valueSpecificationAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, valueSpecificationAction,
						UMLPackage.eINSTANCE.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof ValueSpecificationAction) {
			...
			valueSpecificationActionToUpdate.getInInterruptibleRegions().addAll(
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ValueSpecificationAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ValueSpecificationAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, valueSpecificationAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ValueSpecificationAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, valueSpecificationAction,
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.ValueSpecificationAction.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.handler)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.localPrecondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ValueSpecificationAction.localPostcondition)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(valueSpecificationAction);
		else
			return null;
	}
