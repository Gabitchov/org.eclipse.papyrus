...
public class ReadIsClassifiedObjectActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ReadIsClassifiedObjectActionBasePropertiesEditionComponent(EObject readIsClassifiedObjectAction,
			String editing_mode) {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					ReadIsClassifiedObjectActionBasePropertiesEditionComponent.this.dispose();
				else {
					...
					if (UMLPackage.eINSTANCE.getReadIsClassifiedObjectAction_IsDirect().equals(msg.getFeature())
							&& basePart != null)
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (readIsClassifiedObjectAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ReadIsClassifiedObjectActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ReadIsClassifiedObjectAction.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.ReadIsClassifiedObjectAction.class)
			this.basePart = (ReadIsClassifiedObjectActionPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ReadIsClassifiedObjectAction.class) {
			...
			// init values
			basePart.initOwnedComment(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					readIsClassifiedObjectAction.getVisibility());
			basePart.initClientDependency(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInPartition(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InPartition());
			basePart.initInInterruptibleRegion(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(readIsClassifiedObjectAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (readIsClassifiedObjectAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, readIsClassifiedObjectAction,
			...
			cc.append(SetCommand.create(editingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
					.getReadIsClassifiedObjectAction_IsDirect(), basePart.getIsDirect()));
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof ReadIsClassifiedObjectAction) {
			...
			readIsClassifiedObjectActionToUpdate.getInInterruptibleRegions().addAll(
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ReadIsClassifiedObjectAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, readIsClassifiedObjectAction,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, readIsClassifiedObjectAction,
			...
			if (UMLViewsRepository.ReadIsClassifiedObjectAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ReadIsClassifiedObjectAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, readIsClassifiedObjectAction,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.ReadIsClassifiedObjectAction.isDirect == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, readIsClassifiedObjectAction, UMLPackage.eINSTANCE
						.getReadIsClassifiedObjectAction_IsDirect(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ReadIsClassifiedObjectAction.isLeaf
				|| key == UMLViewsRepository.ReadIsClassifiedObjectAction.isDirect;
	}
		...
		try {
			...
			if (UMLViewsRepository.ReadIsClassifiedObjectAction.isDirect == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE
						.getReadIsClassifiedObjectAction_IsDirect().getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getReadIsClassifiedObjectAction_IsDirect()
						.getEAttributeType(), newValue);
			}
