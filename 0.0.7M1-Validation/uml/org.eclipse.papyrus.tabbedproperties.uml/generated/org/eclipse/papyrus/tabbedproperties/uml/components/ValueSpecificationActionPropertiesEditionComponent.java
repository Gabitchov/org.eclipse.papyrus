...
public class ValueSpecificationActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public ValueSpecificationActionPropertiesEditionComponent(EObject valueSpecificationAction, String editing_mode) {
		...
		if (valueSpecificationAction instanceof ValueSpecificationAction) {
			valueSpecificationActionBasePropertiesEditionComponent = new ValueSpecificationActionBasePropertiesEditionComponent(
					valueSpecificationAction, editing_mode);
			addSubComponent(valueSpecificationActionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(valueSpecificationAction,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ValueSpecificationActionPropertiesEditionPart) valueSpecificationActionBasePropertiesEditionComponent
