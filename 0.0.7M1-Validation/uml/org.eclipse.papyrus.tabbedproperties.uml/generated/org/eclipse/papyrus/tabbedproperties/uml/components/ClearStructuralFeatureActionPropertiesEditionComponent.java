...
public class ClearStructuralFeatureActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 *            the EObject to edit
	 */
	public ClearStructuralFeatureActionPropertiesEditionComponent(EObject clearStructuralFeatureAction,
			String editing_mode) {
		super(editing_mode);
		if (clearStructuralFeatureAction instanceof ClearStructuralFeatureAction) {
			clearStructuralFeatureActionBasePropertiesEditionComponent = new ClearStructuralFeatureActionBasePropertiesEditionComponent(
					clearStructuralFeatureAction, editing_mode);
			addSubComponent(clearStructuralFeatureActionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(clearStructuralFeatureAction,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ClearStructuralFeatureActionPropertiesEditionPart) clearStructuralFeatureActionBasePropertiesEditionComponent
