 ...
 */
public class GeneralizationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, GeneralizationPropertiesEditionPart {
	...
	protected void createIsSubstitutableCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Generalization.isSubstitutable, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createGeneralizationSetAdvancedReferencesTable(Composite parent) {
		...
		this.generalizationSet.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.Generalization.generalizationSet, UMLViewsRepository.SWT_KIND));
