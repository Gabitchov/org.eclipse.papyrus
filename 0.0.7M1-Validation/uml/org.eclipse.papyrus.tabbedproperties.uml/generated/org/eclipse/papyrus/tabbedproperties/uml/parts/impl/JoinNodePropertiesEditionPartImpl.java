 ...
 */
public class JoinNodePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, JoinNodePropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.JoinNodePropertiesEditionPart_NameLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.JoinNode.name, UMLViewsRepository.SWT_KIND));
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartImpl.this, UMLViewsRepository.JoinNode.name,
							PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, name.getText()));
			}

		});

		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.JoinNode.name,
				UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.JoinNodePropertiesEditionPart_VisibilityLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
						...
						TabElementTreeSelectionDialog<Dependency> dialog = new TabElementTreeSelectionDialog<Dependency>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											JoinNodePropertiesEditionPartImpl.this,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void createIsLeafCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UMLViewsRepository.JoinNode.isLeaf,
				UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createInInterruptibleRegionAdvancedReferencesTable(Composite parent) {
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.inInterruptibleRegion, UMLViewsRepository.SWT_KIND));
	...
	protected void createRedefinedNodeAdvancedReferencesTable(Composite parent) {
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.redefinedNode, UMLViewsRepository.SWT_KIND));
	...
	protected void createIsCombineDuplicateCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.isCombineDuplicate, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
