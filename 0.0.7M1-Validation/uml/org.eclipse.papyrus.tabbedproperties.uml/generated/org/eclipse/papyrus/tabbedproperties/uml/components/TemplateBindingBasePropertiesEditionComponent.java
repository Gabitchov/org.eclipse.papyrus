 ...
 */
public class TemplateBindingBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
				...
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getTemplateBinding_ParameterSubstitution() || ((EStructuralFeature) msg
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return UMLViewsRepository.TemplateBinding.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (templateBinding != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (TemplateBindingPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.TemplateBinding.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.TemplateBinding.class) {
			...
			// init values
			basePart.initParameterSubstitution(templateBinding, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (templateBinding != null) {
			...
			for (Iterator iter = parameterSubstitutionToAddFromParameterSubstitution.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, templateBinding, UMLPackage.eINSTANCE
						.getTemplateBinding_ParameterSubstitution(), iter.next()));
			Map parameterSubstitutionToRefreshFromParameterSubstitution = basePart.getParameterSubstitutionToEdit();
			for (Iterator iter = parameterSubstitutionToRefreshFromParameterSubstitution.keySet().iterator(); iter
					.hasNext();) {

				// Start of user code for parameterSubstitution reference refreshment from
				// parameterSubstitution

				TemplateParameterSubstitution nextElement = (TemplateParameterSubstitution) iter.next();
				TemplateParameterSubstitution parameterSubstitution = (TemplateParameterSubstitution) parameterSubstitutionToRefreshFromParameterSubstitution
						.get(nextElement);
			...
			for (Iterator iter = parameterSubstitutionToMoveFromParameterSubstitution.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, templateBinding, UMLPackage.eINSTANCE
						.getTemplateParameterSubstitution(), moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.TemplateBinding.parameterSubstitution == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, templateBinding, UMLPackage.eINSTANCE
							.getTemplateBinding_ParameterSubstitution(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, templateBinding, UMLPackage.eINSTANCE
							.getTemplateParameterSubstitution(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public void dispose() {
		if (semanticAdapter != null)
			templateBinding.eAdapters().remove(semanticAdapter);
	}
