...
public class CreateLinkObjectActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public CreateLinkObjectActionPropertiesEditionComponent(EObject createLinkObjectAction, String editing_mode) {
		...
		if (createLinkObjectAction instanceof CreateLinkObjectAction) {
			createLinkObjectActionBasePropertiesEditionComponent = new CreateLinkObjectActionBasePropertiesEditionComponent(
					createLinkObjectAction, editing_mode);
			addSubComponent(createLinkObjectActionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(createLinkObjectAction,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (CreateLinkObjectActionPropertiesEditionPart) createLinkObjectActionBasePropertiesEditionComponent
