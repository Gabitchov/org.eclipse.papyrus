...
public class ParameterPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public ParameterPropertiesEditionComponent(EObject parameter, String editing_mode) {
		...
		if (parameter instanceof Parameter) {
			parameterBasePropertiesEditionComponent = new ParameterBasePropertiesEditionComponent(parameter,
					editing_mode);
			addSubComponent(parameterBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(parameter, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ParameterPropertiesEditionPart) parameterBasePropertiesEditionComponent
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (UMLViewsRepository.Parameter.class == key) {
