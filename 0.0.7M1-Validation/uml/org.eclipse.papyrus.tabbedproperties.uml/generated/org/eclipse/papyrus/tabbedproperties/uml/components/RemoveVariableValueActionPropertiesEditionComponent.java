...
public class RemoveVariableValueActionPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public RemoveVariableValueActionPropertiesEditionComponent(EObject removeVariableValueAction, String editing_mode) {
		...
		if (removeVariableValueAction instanceof RemoveVariableValueAction) {
			removeVariableValueActionBasePropertiesEditionComponent = new RemoveVariableValueActionBasePropertiesEditionComponent(
					removeVariableValueAction, editing_mode);
			addSubComponent(removeVariableValueActionBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(removeVariableValueAction,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (RemoveVariableValueActionPropertiesEditionPart) removeVariableValueActionBasePropertiesEditionComponent
