...
public class EnumerationLiteralBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getInstanceSpecification_Slot() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getSlot())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (enumerationLiteral != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (EnumerationLiteralPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.EnumerationLiteral.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.EnumerationLiteral.class) {
			...
			EnumerationLiteral enumerationLiteral = (EnumerationLiteral) elt;
			// init values
			...
			basePart.initClassifier(enumerationLiteral, null, UMLPackage.eINSTANCE
			...
			basePart.addFilterToClassifier(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getClassifierTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (enumerationLiteral != null) {
			cc.append(SetCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE
			...
			for (Iterator iter = deploymentToAddFromDeployment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE
			...
			for (Iterator iter = deploymentToMoveFromDeployment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE.getDeployment(),
			...
			for (Iterator iter = classifierToAddFromClassifier.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE
						.getInstanceSpecification_Classifier(), iter.next()));
			...
			for (Iterator iter = classifierToRemoveFromClassifier.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE
						.getInstanceSpecification_Classifier(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, enumerationLiteral,
			...
			for (Iterator iter = slotToMoveFromSlot.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, enumerationLiteral, UMLPackage.eINSTANCE.getSlot(),
						moveElement.getElement(), moveElement.getIndex()));
			}
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.EnumerationLiteral.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.EnumerationLiteral.deployment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
							.getDeploymentTarget_Deployment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.EnumerationLiteral.classifier == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
							.getInstanceSpecification_Classifier(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
							.getInstanceSpecification_Classifier(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
							.getInstanceSpecification_Classifier(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.EnumerationLiteral.slot == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
							.getInstanceSpecification_Slot(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, enumerationLiteral, UMLPackage.eINSTANCE
							.getSlot(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.EnumerationLiteral.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.EnumerationLiteral.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.EnumerationLiteral.deployment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.EnumerationLiteral.classifier)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.EnumerationLiteral.slot)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(enumerationLiteral);
		else
			return null;
	}
