...
public class CentralBufferNodePropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	/**
	 * The CentralBufferNodeBasePropertiesEditionComponent sub component
	 */
	protected CentralBufferNodeBasePropertiesEditionComponent centralBufferNodeBasePropertiesEditionComponent;
	...
	public CentralBufferNodePropertiesEditionComponent(EObject centralBufferNode, String editing_mode) {
		...
		if (centralBufferNode instanceof CentralBufferNode) {
			centralBufferNodeBasePropertiesEditionComponent = new CentralBufferNodeBasePropertiesEditionComponent(
					centralBufferNode, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (CentralBufferNodePropertiesEditionPart) centralBufferNodeBasePropertiesEditionComponent
