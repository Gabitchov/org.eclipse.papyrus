...
public class ReadVariableActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (readVariableAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ReadVariableActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ReadVariableAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ReadVariableAction.class) {
			...
			ReadVariableAction readVariableAction = (ReadVariableAction) elt;
			// init values
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					readVariableAction.getVisibility());
			basePart.initClientDependency(readVariableAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInInterruptibleRegion(readVariableAction, null, UMLPackage.eINSTANCE
			...
			basePart
					.initLocalPrecondition(readVariableAction, null, UMLPackage.eINSTANCE.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(readVariableAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (readVariableAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, readVariableAction,
			...
			for (Iterator iter = handlerToMoveFromHandler.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = localPreconditionToMoveFromLocalPrecondition.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, readVariableAction, UMLPackage.eINSTANCE.getConstraint(),
						moveElement.getElement(), moveElement.getIndex()));
			}
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ReadVariableAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, readVariableAction, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, readVariableAction, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ReadVariableAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, readVariableAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ReadVariableAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, readVariableAction, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.ReadVariableAction.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.name)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.visibility)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.clientDependency)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.isLeaf)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.outgoing)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.incoming)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.inPartition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.inInterruptibleRegion)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.redefinedNode)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.handler)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.localPrecondition)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.ReadVariableAction.localPostcondition)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(readVariableAction);
		else
			return null;
	}
