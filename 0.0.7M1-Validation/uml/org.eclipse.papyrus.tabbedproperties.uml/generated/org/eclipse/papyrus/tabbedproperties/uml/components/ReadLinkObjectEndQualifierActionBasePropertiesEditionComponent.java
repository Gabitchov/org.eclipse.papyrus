...
public class ReadLinkObjectEndQualifierActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ReadLinkObjectEndQualifierActionBasePropertiesEditionComponent(EObject readLinkObjectEndQualifierAction,
			String editing_mode) {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					ReadLinkObjectEndQualifierActionBasePropertiesEditionComponent.this.dispose();
				else {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (readLinkObjectEndQualifierAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ReadLinkObjectEndQualifierActionPropertiesEditionPart) provider
							.getPropertiesEditionPart(UMLViewsRepository.ReadLinkObjectEndQualifierAction.class, kind,
									this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.ReadLinkObjectEndQualifierAction.class)
			this.basePart = (ReadLinkObjectEndQualifierActionPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ReadLinkObjectEndQualifierAction.class) {
			...
			// init values
			basePart.initOwnedComment(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					readLinkObjectEndQualifierAction.getVisibility());
			basePart.initClientDependency(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getNamedElement_ClientDependency());
			basePart.setIsLeaf(readLinkObjectEndQualifierAction.isLeaf());

			basePart.initOutgoing(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getActivityNode_Outgoing());
			basePart.initIncoming(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getActivityNode_Incoming());
			basePart.initInPartition(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InPartition());
			basePart.initInInterruptibleRegion(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getActivityNode_RedefinedNode());
			basePart.initHandler(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getExecutableNode_Handler());
			basePart.initLocalPrecondition(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(readLinkObjectEndQualifierAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (readLinkObjectEndQualifierAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, readLinkObjectEndQualifierAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, readLinkObjectEndQualifierAction, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, readLinkObjectEndQualifierAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, readLinkObjectEndQualifierAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, readLinkObjectEndQualifierAction,
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof ReadLinkObjectEndQualifierAction) {
			...
			readLinkObjectEndQualifierActionToUpdate.getClientDependencies()
			...
			readLinkObjectEndQualifierActionToUpdate.getInInterruptibleRegions().addAll(
			...
			readLinkObjectEndQualifierActionToUpdate.getLocalPreconditions().addAll(
					basePart.getLocalPreconditionToAdd());
			readLinkObjectEndQualifierActionToUpdate.getLocalPostconditions().addAll(
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ReadLinkObjectEndQualifierAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, readLinkObjectEndQualifierAction,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, readLinkObjectEndQualifierAction,
			...
			if (UMLViewsRepository.ReadLinkObjectEndQualifierAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, readLinkObjectEndQualifierAction,
			...
			if (UMLViewsRepository.ReadLinkObjectEndQualifierAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, readLinkObjectEndQualifierAction,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
