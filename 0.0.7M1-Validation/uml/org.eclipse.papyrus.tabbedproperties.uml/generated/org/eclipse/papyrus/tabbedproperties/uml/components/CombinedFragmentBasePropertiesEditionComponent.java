...
public class CombinedFragmentBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (combinedFragment != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (CombinedFragmentPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.CombinedFragment.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.CombinedFragment.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					combinedFragment.getVisibility());
			basePart.initClientDependency(combinedFragment, null, UMLPackage.eINSTANCE
			...
			basePart.initGeneralOrdering(combinedFragment, null, UMLPackage.eINSTANCE
			...
			basePart.initInteractionOperator((EEnum) UMLPackage.eINSTANCE.getCombinedFragment_InteractionOperator()
					.getEType(), combinedFragment.getInteractionOperator());
			basePart.initOperand(combinedFragment, null, UMLPackage.eINSTANCE.getCombinedFragment_Operand());
			basePart
					.initCfragmentGate(combinedFragment, null, UMLPackage.eINSTANCE.getCombinedFragment_CfragmentGate());
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (combinedFragment != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, combinedFragment,
			...
			for (Iterator iter = generalOrderingToMoveFromGeneralOrdering.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, combinedFragment,
						UMLPackage.eINSTANCE.getGeneralOrdering(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE
			...
			for (Iterator iter = operandToMoveFromOperand.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE
			...
			for (Iterator iter = cfragmentGateToMoveFromCfragmentGate.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, combinedFragment, UMLPackage.eINSTANCE.getGate(),
						moveElement.getElement(), moveElement.getIndex()));
			}
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof CombinedFragment) {
			...
			combinedFragmentToUpdate
					.setInteractionOperator((InteractionOperatorKind) basePart.getInteractionOperator());
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.CombinedFragment.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, combinedFragment, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, combinedFragment, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.CombinedFragment.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, combinedFragment, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.CombinedFragment.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, combinedFragment, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.CombinedFragment.interactionOperator
				|| key == UMLViewsRepository.CombinedFragment.operand;
	}
