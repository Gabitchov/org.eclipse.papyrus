...
public class DeploymentSpecificationBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (UMLPackage.eINSTANCE.getDeploymentSpecification_DeploymentLocation().equals(msg.getFeature())
							&& basePart != null)
						basePart.setDeploymentLocation((String) msg.getNewValue());

					if (UMLPackage.eINSTANCE.getDeploymentSpecification_ExecutionLocation().equals(msg.getFeature())
							&& basePart != null)
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (deploymentSpecification != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (DeploymentSpecificationPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.DeploymentSpecification.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.DeploymentSpecification.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					deploymentSpecification.getVisibility());
			basePart.initClientDependency(deploymentSpecification, null, UMLPackage.eINSTANCE
					.getNamedElement_ClientDependency());
			basePart
					.initElementImport(deploymentSpecification, null, UMLPackage.eINSTANCE.getNamespace_ElementImport());
			basePart
					.initPackageImport(deploymentSpecification, null, UMLPackage.eINSTANCE.getNamespace_PackageImport());
			...
			basePart.initTemplateBinding(deploymentSpecification, null, UMLPackage.eINSTANCE
					.getTemplateableElement_TemplateBinding());
			basePart.setIsAbstract(deploymentSpecification.isAbstract());

			basePart.initGeneralization(deploymentSpecification, null, UMLPackage.eINSTANCE
					.getClassifier_Generalization());
			basePart.initPowertypeExtent(deploymentSpecification, null, UMLPackage.eINSTANCE
					.getClassifier_PowertypeExtent());
			basePart.initRedefinedClassifier(deploymentSpecification, null, UMLPackage.eINSTANCE
			...
			basePart.initCollaborationUse(deploymentSpecification, null, UMLPackage.eINSTANCE
			...
			basePart.initNestedArtifact(deploymentSpecification, null, UMLPackage.eINSTANCE
			...
			basePart.initOwnedOperation(deploymentSpecification, null, UMLPackage.eINSTANCE
					.getArtifact_OwnedOperation());
			basePart.initOwnedAttribute(deploymentSpecification, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (deploymentSpecification != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, deploymentSpecification,
			...
			for (Iterator iter = elementImportToMoveFromElementImport.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedUseCaseToMoveFromOwnedUseCase.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE.getUseCase(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			...
			// }
			cc.append(SetCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
					.getArtifact_FileName(), basePart.getFileName()));
			...
			for (Iterator iter = nestedArtifactToAddFromNestedArtifact.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getArtifact_NestedArtifact(), iter.next()));
			...
			for (Iterator iter = nestedArtifactToMoveFromNestedArtifact.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification,
						UMLPackage.eINSTANCE.getArtifact(), moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = manifestationToAddFromManifestation.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getArtifact_Manifestation(), iter.next()));
			...
			for (Iterator iter = manifestationToMoveFromManifestation.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getManifestation(), moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedOperationToAddFromOwnedOperation.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getArtifact_OwnedOperation(), iter.next()));
			...
			for (Iterator iter = ownedOperationToMoveFromOwnedOperation.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getOperation(), moveElement.getElement(), moveElement.getIndex()));
			}
			...
			for (Iterator iter = ownedAttributeToAddFromOwnedAttribute.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getArtifact_OwnedAttribute(), iter.next()));
			...
			for (Iterator iter = ownedAttributeToMoveFromOwnedAttribute.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, deploymentSpecification,
						UMLPackage.eINSTANCE.getProperty(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
					.getDeploymentSpecification_DeploymentLocation(), basePart.getDeploymentLocation()));

			cc.append(SetCommand.create(editingDomain, deploymentSpecification, UMLPackage.eINSTANCE
					.getDeploymentSpecification_ExecutionLocation(), basePart.getExecutionLocation()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.DeploymentSpecification.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.DeploymentSpecification.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.DeploymentSpecification.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, deploymentSpecification,
			...
			if (UMLViewsRepository.DeploymentSpecification.powertypeExtent == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, deploymentSpecification,
							UMLPackage.eINSTANCE.getClassifier_PowertypeExtent(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.DeploymentSpecification.redefinedClassifier == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, deploymentSpecification,
							UMLPackage.eINSTANCE.getClassifier_RedefinedClassifier(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.DeploymentSpecification.useCase == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, deploymentSpecification,
							UMLPackage.eINSTANCE.getClassifier_UseCase(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.DeploymentSpecification.nestedArtifact == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
							.getArtifact(), event.getNewValue(), event.getNewIndex()));
			}
			...
			if (UMLViewsRepository.DeploymentSpecification.deploymentLocation == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getDeploymentSpecification_DeploymentLocation(), event.getNewValue()));

			if (UMLViewsRepository.DeploymentSpecification.executionLocation == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, deploymentSpecification, UMLPackage.eINSTANCE
						.getDeploymentSpecification_ExecutionLocation(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.DeploymentSpecification.isLeaf
				|| key == UMLViewsRepository.DeploymentSpecification.isAbstract;
	}
		...
		try {
			...
			if (UMLViewsRepository.DeploymentSpecification.deploymentLocation == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE
						.getDeploymentSpecification_DeploymentLocation().getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE
						.getDeploymentSpecification_DeploymentLocation().getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.DeploymentSpecification.executionLocation == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE
						.getDeploymentSpecification_ExecutionLocation().getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE
						.getDeploymentSpecification_ExecutionLocation().getEAttributeType(), newValue);
			}
