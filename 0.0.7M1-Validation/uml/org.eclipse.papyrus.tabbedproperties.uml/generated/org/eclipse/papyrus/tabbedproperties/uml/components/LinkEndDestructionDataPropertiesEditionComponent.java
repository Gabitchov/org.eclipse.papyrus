...
public class LinkEndDestructionDataPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	...
	public LinkEndDestructionDataPropertiesEditionComponent(EObject linkEndDestructionData, String editing_mode) {
		...
		if (linkEndDestructionData instanceof LinkEndDestructionData) {
			linkEndDestructionDataBasePropertiesEditionComponent = new LinkEndDestructionDataBasePropertiesEditionComponent(
					linkEndDestructionData, editing_mode);
			addSubComponent(linkEndDestructionDataBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(linkEndDestructionData,
					editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (LinkEndDestructionDataPropertiesEditionPart) linkEndDestructionDataBasePropertiesEditionComponent
