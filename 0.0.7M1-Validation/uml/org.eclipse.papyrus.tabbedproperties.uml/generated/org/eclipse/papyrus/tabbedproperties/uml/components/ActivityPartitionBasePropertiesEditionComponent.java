...
public class ActivityPartitionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
		...
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					...
					if (UMLPackage.eINSTANCE.getActivityPartition_IsDimension().equals(msg.getFeature())
							&& basePart != null)
						basePart.setIsDimension((Boolean) msg.getNewValue());

					if (UMLPackage.eINSTANCE.getActivityPartition_IsExternal().equals(msg.getFeature())
							&& basePart != null)
					...
					if (msg.getFeature() != null
							&& (((EStructuralFeature) msg.getFeature()) == UMLPackage.eINSTANCE
									.getActivityPartition_Subpartition() || ((EStructuralFeature) msg.getFeature())
									.getEContainingClass() == UMLPackage.eINSTANCE.getActivityPartition())) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (activityPartition != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ActivityPartitionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ActivityPartition.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ActivityPartition.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					activityPartition.getVisibility());
			basePart.initClientDependency(activityPartition, null, UMLPackage.eINSTANCE
			...
			basePart
					.initSubpartition(activityPartition, null, UMLPackage.eINSTANCE.getActivityPartition_Subpartition());
			...
			basePart.addFilterToNode(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getNodeTable().contains(element));
					return false;
				}
			...
			basePart.addFilterToEdge(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getEdgeTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (activityPartition != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE.getComment(),
						moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, activityPartition,
			// UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
					.getActivityPartition_IsDimension(), basePart.getIsDimension()));

			cc.append(SetCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
					.getActivityPartition_IsExternal(), basePart.getIsExternal()));

			List nodeToAddFromNode = basePart.getNodeToAdd();
			for (Iterator iter = nodeToAddFromNode.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
						.getActivityPartition_Node(), iter.next()));
			...
			for (Iterator iter = subpartitionToAddFromSubpartition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
						.getActivityPartition_Subpartition(), iter.next()));
			...
			for (Iterator iter = subpartitionToRefreshFromSubpartition.keySet().iterator(); iter.hasNext();) {
				...
				// Start of user code for subpartition reference refreshment from subpartition

				ActivityPartition nextElement = (ActivityPartition) iter.next();
				ActivityPartition subpartition = (ActivityPartition) subpartitionToRefreshFromSubpartition
						.get(nextElement);
			...
			for (Iterator iter = subpartitionToMoveFromSubpartition.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
						.getActivityPartition(), moveElement.getElement(), moveElement.getIndex()));
			}
			List edgeToAddFromEdge = basePart.getEdgeToAdd();
			for (Iterator iter = edgeToAddFromEdge.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, activityPartition, UMLPackage.eINSTANCE
						.getActivityPartition_Edge(), iter.next()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ActivityPartition.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ActivityPartition.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ActivityPartition.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
			...
			if (UMLViewsRepository.ActivityPartition.isDimension == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
						.getActivityPartition_IsDimension(), event.getNewValue()));

			if (UMLViewsRepository.ActivityPartition.isExternal == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
						.getActivityPartition_IsExternal(), event.getNewValue()));

			if (UMLViewsRepository.ActivityPartition.node == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Node(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Node(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Node(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ActivityPartition.subpartition == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Subpartition(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ActivityPartition.edge == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Edge(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Edge(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, activityPartition, UMLPackage.eINSTANCE
							.getActivityPartition_Edge(), event.getNewValue(), event.getNewIndex()));
			}
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ActivityPartition.isDimension
				|| key == UMLViewsRepository.ActivityPartition.isExternal;
	}
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.ActivityPartition.isDimension == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getActivityPartition_IsDimension()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getActivityPartition_IsDimension()
						.getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.ActivityPartition.isExternal == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getActivityPartition_IsExternal()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getActivityPartition_IsExternal()
						.getEAttributeType(), newValue);
			}
