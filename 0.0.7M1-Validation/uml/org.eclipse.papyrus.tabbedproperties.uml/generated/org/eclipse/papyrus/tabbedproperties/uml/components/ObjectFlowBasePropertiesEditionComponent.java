...
public class ObjectFlowBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					ObjectFlowBasePropertiesEditionComponent.this.dispose();
				else {
					...
					if (UMLPackage.eINSTANCE.getObjectFlow_IsMultireceive().equals(msg.getFeature())
							&& basePart != null)
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (objectFlow != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ObjectFlowPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ObjectFlow.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.ObjectFlow.class)
			this.basePart = (ObjectFlowPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ObjectFlow.class) {
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(), objectFlow
					.getVisibility());
			...
			basePart.addFilterToRedefinedEdge(new ViewerFilter() {
				...
				public boolean select(Viewer viewer, Object parentElement, Object element) {
					if (element instanceof EObject)
						return (!basePart.getRedefinedEdgeTable().contains(element));
					return false;
				}
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (objectFlow != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getComment(), moveElement
						.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getNamedElement_Name(),
					basePart.getName()));

			cc.append(SetCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getNamedElement_Visibility(),
					basePart.getVisibility()));

			List clientDependencyToAddFromClientDependency = basePart.getClientDependencyToAdd();
			for (Iterator iter = clientDependencyToAddFromClientDependency.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			List clientDependencyToRemoveFromClientDependency = basePart.getClientDependencyToRemove();
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, objectFlow,
			// UMLPackage.eINSTANCE.getDependency(), moveElement.getElement(),
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getRedefinableElement_IsLeaf(),
					basePart.getIsLeaf()));

			List redefinedEdgeToAddFromRedefinedEdge = basePart.getRedefinedEdgeToAdd();
			for (Iterator iter = redefinedEdgeToAddFromRedefinedEdge.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE
						.getActivityEdge_RedefinedEdge(), iter.next()));
			List redefinedEdgeToRemoveFromRedefinedEdge = basePart.getRedefinedEdgeToRemove();
			for (Iterator iter = redefinedEdgeToRemoveFromRedefinedEdge.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE
						.getActivityEdge_RedefinedEdge(), iter.next()));
			// List redefinedEdgeToMoveFromRedefinedEdge = basePart.getRedefinedEdgeToMove();
			// for (Iterator iter = redefinedEdgeToMoveFromRedefinedEdge.iterator();
			// iter.hasNext();){
			// org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement =
			// (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement)iter.next();
			// cc.append(MoveCommand.create(editingDomain, objectFlow,
			...
			for (Iterator iter = inPartitionToAddFromInPartition.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE
						.getActivityEdge_InPartition(), iter.next()));
			...
			// moveElement.getIndex()));
			// }
			cc.append(SetCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getObjectFlow_IsMulticast(),
					basePart.getIsMulticast()));

			cc.append(SetCommand.create(editingDomain, objectFlow, UMLPackage.eINSTANCE.getObjectFlow_IsMultireceive(),
					basePart.getIsMultireceive()));
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ObjectFlow.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE.getComment(),
							event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ObjectFlow.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ObjectFlow.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getNamedElement_ClientDependency(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ObjectFlow.redefinedEdge == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getActivityEdge_RedefinedEdge(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getActivityEdge_RedefinedEdge(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getActivityEdge_RedefinedEdge(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ObjectFlow.inPartition == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getActivityEdge_InPartition(), event.getNewValue()));
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getActivityEdge_InPartition(), event.getNewValue()));
				if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
							.getActivityEdge_InPartition(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.ObjectFlow.isMulticast == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
						.getObjectFlow_IsMulticast(), event.getNewValue()));

			if (UMLViewsRepository.ObjectFlow.isMultireceive == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, objectFlow, UMLPackage.eINSTANCE
						.getObjectFlow_IsMultireceive(), event.getNewValue()));
	...
	public boolean isRequired(String key, int kind) {
		return key == UMLViewsRepository.ObjectFlow.isLeaf || key == UMLViewsRepository.ObjectFlow.isMulticast
				|| key == UMLViewsRepository.ObjectFlow.isMultireceive;
	}
	...
	public Diagnostic validateValue(PropertiesEditionEvent event) {
		...
		try {
			...
			if (UMLViewsRepository.ObjectFlow.isMulticast == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getObjectFlow_IsMulticast()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getObjectFlow_IsMulticast()
						.getEAttributeType(), newValue);
			}
			if (UMLViewsRepository.ObjectFlow.isMultireceive == event.getAffectedEditor()) {
				Object newValue = EcoreUtil.createFromString(UMLPackage.eINSTANCE.getObjectFlow_IsMultireceive()
						.getEAttributeType(), newStringValue);
				ret = Diagnostician.INSTANCE.validate(UMLPackage.eINSTANCE.getObjectFlow_IsMultireceive()
						.getEAttributeType(), newValue);
			}
	...
	public void dispose() {
		if (semanticAdapter != null)
			objectFlow.eAdapters().remove(semanticAdapter);
	}
