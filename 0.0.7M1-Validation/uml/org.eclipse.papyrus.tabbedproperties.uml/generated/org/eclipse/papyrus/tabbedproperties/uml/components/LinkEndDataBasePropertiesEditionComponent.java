 ...
 */
public class LinkEndDataBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * The EObject to edit
	 */
	private LinkEndData linkEndData;
	 ...
	 * Default constructor
	 */
	public LinkEndDataBasePropertiesEditionComponent(EObject linkEndData, String editing_mode) {
		if (linkEndData instanceof LinkEndData) {
			this.linkEndData = (LinkEndData) linkEndData;
			if (IPropertiesEditionComponent.LIVE_MODE.equals(editing_mode)) {
				semanticAdapter = initializeSemanticAdapter();
				this.linkEndData.eAdapters().add(semanticAdapter);
			}
		}
	...
	private AdapterImpl initializeSemanticAdapter() {
		return new EContentAdapter() {
			...
			public void notifyChanged(Notification msg) {
				if (basePart == null)
					LinkEndDataBasePropertiesEditionComponent.this.dispose();
				else {
	...
	public java.lang.Class translatePart(String key) {
		if (BASE_PART.equals(key))
			return UMLViewsRepository.LinkEndData.class;
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (linkEndData != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (LinkEndDataPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.LinkEndData.class, kind, this);
	...
	public void setPropertiesEditionPart(java.lang.Class key, int kind, IPropertiesEditionPart propertiesEditionPart) {
		if (key == UMLViewsRepository.LinkEndData.class)
			this.basePart = (LinkEndDataPropertiesEditionPart) propertiesEditionPart;
	}
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.LinkEndData.class) {
			((IPropertiesEditionPart) basePart).setContext(elt, allResource);
			LinkEndData linkEndData = (LinkEndData) elt;
			// init values
			basePart.initOwnedComment(linkEndData, null, UMLPackage.eINSTANCE.getElement_OwnedComment());
			basePart.initQualifier(linkEndData, null, UMLPackage.eINSTANCE.getLinkEndData_Qualifier());
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (linkEndData != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, linkEndData, UMLPackage.eINSTANCE.getElement_OwnedComment(),
						iter.next()));
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, linkEndData, UMLPackage.eINSTANCE.getComment(), moveElement
			...
			for (Iterator iter = qualifierToAddFromQualifier.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, linkEndData,
						UMLPackage.eINSTANCE.getLinkEndData_Qualifier(), iter.next()));
			...
			for (Iterator iter = qualifierToMoveFromQualifier.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, linkEndData, UMLPackage.eINSTANCE.getQualifierValue(),
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof LinkEndData) {
			LinkEndData linkEndDataToUpdate = (LinkEndData) source;
			linkEndDataToUpdate.getOwnedComments().addAll(basePart.getOwnedCommentToAdd());
			linkEndDataToUpdate.getQualifiers().addAll(basePart.getQualifierToAdd());

			return linkEndDataToUpdate;
		} else
			return null;
	}
	...
	public void firePropertiesChanged(PropertiesEditionEvent event) {
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.LinkEndData.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					Comment oldValue = (Comment) event.getOldValue();
					Comment newValue = (Comment) event.getNewValue();

					// Start of user code for ownedComment live update command
					// TODO: Complete the linkEndData update command
					// End of user code

				} else if (PropertiesEditionEvent.ADD == event.getKind())
					command.append(AddCommand.create(liveEditingDomain, linkEndData, UMLPackage.eINSTANCE
							.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, linkEndData,
							UMLPackage.eINSTANCE.getComment(), event.getNewValue(), event.getNewIndex()));
			}
			if (UMLViewsRepository.LinkEndData.qualifier == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(MoveCommand.create(liveEditingDomain, linkEndData, UMLPackage.eINSTANCE
	...
	public String getHelpContent(String key, int kind) {
		if (key == UMLViewsRepository.LinkEndData.ownedComment)
			return null; //$NON-NLS-1$
		if (key == UMLViewsRepository.LinkEndData.qualifier)
			return null; //$NON-NLS-1$
	...
	public Diagnostic validate() {
		if (IPropertiesEditionComponent.BATCH_MODE.equals(editing_mode)) {
			...
			return Diagnostician.INSTANCE.validate(linkEndData);
		else
			return null;
	}
	...
	public void dispose() {
		if (semanticAdapter != null)
			linkEndData.eAdapters().remove(semanticAdapter);
	}
