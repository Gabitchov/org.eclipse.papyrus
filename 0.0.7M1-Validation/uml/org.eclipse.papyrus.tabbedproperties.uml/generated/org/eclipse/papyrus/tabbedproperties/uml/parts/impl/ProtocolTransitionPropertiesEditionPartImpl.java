 ...
 */
public class ProtocolTransitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, ProtocolTransitionPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ProtocolTransitionPropertiesEditionPart_NameLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ProtocolTransitionPropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.ProtocolTransition.visibility,
						UMLViewsRepository.SWT_KIND));
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void createElementImportAdvancedTableComposition(Composite parent) {
		...
		this.elementImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.elementImport, UMLViewsRepository.SWT_KIND));
	...
	protected void createPackageImportAdvancedTableComposition(Composite parent) {
		...
		this.packageImport.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.packageImport, UMLViewsRepository.SWT_KIND));
	...
	protected void createOwnedRuleAdvancedTableComposition(Composite parent) {
		...
		this.ownedRule.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.ownedRule, UMLViewsRepository.SWT_KIND));
	...
	protected void createIsLeafCheckbox(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.isLeaf, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createKindEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ProtocolTransitionPropertiesEditionPart_KindLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.kind, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createTriggerAdvancedTableComposition(Composite parent) {
		...
		this.trigger.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ProtocolTransition.trigger, UMLViewsRepository.SWT_KIND));
