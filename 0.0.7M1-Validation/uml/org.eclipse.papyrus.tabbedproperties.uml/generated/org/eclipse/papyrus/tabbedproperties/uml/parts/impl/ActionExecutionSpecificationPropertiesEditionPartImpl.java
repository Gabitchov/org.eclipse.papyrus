 ...
 */
public class ActionExecutionSpecificationPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements
		ISWTPropertiesEditionPart, ActionExecutionSpecificationPropertiesEditionPart {
	...
	protected void createOwnedCommentAdvancedTableComposition(Composite parent) {
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ActionExecutionSpecification.ownedComment, UMLViewsRepository.SWT_KIND));
	...
	protected void createNameText(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ActionExecutionSpecificationPropertiesEditionPart_NameLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ActionExecutionSpecification.name, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}

	protected void createVisibilityEMFComboViewer(Composite parent) {
		SWTUtils.createPartLabel(parent, UMLMessages.ActionExecutionSpecificationPropertiesEditionPart_VisibilityLabel,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ActionExecutionSpecification.visibility, UMLViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyAdvancedReferencesTable(Composite parent) {
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ActionExecutionSpecification.clientDependency, UMLViewsRepository.SWT_KIND));
	...
	protected void createCoveredAdvancedReferencesTable(Composite parent) {
		...
		this.covered.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ActionExecutionSpecification.covered, UMLViewsRepository.SWT_KIND));
	...
	protected void createGeneralOrderingAdvancedTableComposition(Composite parent) {
		...
		this.generalOrdering.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.ActionExecutionSpecification.generalOrdering, UMLViewsRepository.SWT_KIND));
