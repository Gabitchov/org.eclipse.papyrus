...
public class ClearStructuralFeatureActionBasePropertiesEditionComponent extends StandardPropertiesEditionComponent {
	 ...
	 * Default constructor
	 */
	public ClearStructuralFeatureActionBasePropertiesEditionComponent(EObject clearStructuralFeatureAction,
			String editing_mode) {
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if (clearStructuralFeatureAction != null && BASE_PART.equals(key)) {
			if (basePart == null) {
				...
				if (provider != null) {
					basePart = (ClearStructuralFeatureActionPropertiesEditionPart) provider.getPropertiesEditionPart(
							UMLViewsRepository.ClearStructuralFeatureAction.class, kind, this);
	...
	public void initPart(java.lang.Class key, int kind, EObject elt, ResourceSet allResource) {
		if (basePart != null && key == UMLViewsRepository.ClearStructuralFeatureAction.class) {
			...
			// init values
			basePart.initOwnedComment(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
			...
			basePart.initVisibility((EEnum) UMLPackage.eINSTANCE.getNamedElement_Visibility().getEType(),
					clearStructuralFeatureAction.getVisibility());
			basePart.initClientDependency(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
			...
			basePart.initInPartition(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InPartition());
			basePart.initInInterruptibleRegion(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
					.getActivityNode_InInterruptibleRegion());
			basePart.initRedefinedNode(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
			...
			basePart.initLocalPrecondition(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
					.getAction_LocalPrecondition());
			basePart.initLocalPostcondition(clearStructuralFeatureAction, null, UMLPackage.eINSTANCE
	...
	public CompoundCommand getPropertiesEditionCommand(EditingDomain editingDomain) {
		...
		if (clearStructuralFeatureAction != null) {
			...
			for (Iterator iter = ownedCommentToAddFromOwnedComment.iterator(); iter.hasNext();)
				cc.append(AddCommand.create(editingDomain, clearStructuralFeatureAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = ownedCommentToMoveFromOwnedComment.iterator(); iter.hasNext();) {
				org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement moveElement = (org.eclipse.emf.eef.runtime.impl.utils.EMFListEditUtil.MoveElement) iter
						.next();
				cc.append(MoveCommand.create(editingDomain, clearStructuralFeatureAction, UMLPackage.eINSTANCE
						.getComment(), moveElement.getElement(), moveElement.getIndex()));
			}
			cc.append(SetCommand.create(editingDomain, clearStructuralFeatureAction, UMLPackage.eINSTANCE
			...
			for (Iterator iter = clientDependencyToRemoveFromClientDependency.iterator(); iter.hasNext();)
				cc.append(RemoveCommand.create(editingDomain, clearStructuralFeatureAction, UMLPackage.eINSTANCE
						.getNamedElement_ClientDependency(), iter.next()));
			...
			// cc.append(MoveCommand.create(editingDomain, clearStructuralFeatureAction,
	...
	public EObject getPropertiesEditionObject(EObject source) {
		if (source instanceof ClearStructuralFeatureAction) {
			...
			clearStructuralFeatureActionToUpdate.getInInterruptibleRegions().addAll(
		...
		if (PropertiesEditionEvent.COMMIT == event.getState()
			...
			if (UMLViewsRepository.ClearStructuralFeatureAction.ownedComment == event.getAffectedEditor()) {
				if (PropertiesEditionEvent.SET == event.getKind()) {
					...
					command.append(AddCommand.create(liveEditingDomain, clearStructuralFeatureAction,
							UMLPackage.eINSTANCE.getElement_OwnedComment(), event.getNewValue()));
				else if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(DeleteCommand.create(liveEditingDomain, event.getNewValue()));
				else if (PropertiesEditionEvent.MOVE == event.getKind())
					command.append(MoveCommand.create(liveEditingDomain, clearStructuralFeatureAction,
			...
			if (UMLViewsRepository.ClearStructuralFeatureAction.name == event.getAffectedEditor())
				command.append(SetCommand.create(liveEditingDomain, clearStructuralFeatureAction, UMLPackage.eINSTANCE
			...
			if (UMLViewsRepository.ClearStructuralFeatureAction.clientDependency == event.getAffectedEditor()) {
				...
				if (PropertiesEditionEvent.REMOVE == event.getKind())
					command.append(RemoveCommand.create(liveEditingDomain, clearStructuralFeatureAction,
							UMLPackage.eINSTANCE.getNamedElement_ClientDependency(), event.getNewValue()));
