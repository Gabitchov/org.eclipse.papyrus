 ...
 */
public class JoinNodePropertiesEditionPartForm extends CompositePropertiesEditionPart implements
		IFormPropertiesEditionPart, JoinNodePropertiesEditionPart {
	...
	protected void createPropertiesGroup(FormToolkit widgetFactory, final Composite view) {
		...
		createIsCombineDuplicateCheckbox(widgetFactory, propertiesGroup);
	...
	protected void createOwnedCommentTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedComment = new ReferencesTable<Comment>(UMLMessages.JoinNodePropertiesEditionPart_OwnedCommentLabel,
		...
		this.ownedComment.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.ownedComment, UMLViewsRepository.FORM_KIND));
	...
	protected void moveOwnedComment(Comment element, int oldIndex, int newIndex) {
		...
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.ownedComment,
	...
	protected void createNameText(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.JoinNodePropertiesEditionPart_NameLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.JoinNode.name, UMLViewsRepository.FORM_KIND));
		...
		name.addModifyListener(new ModifyListener() {
			...
			public void modifyText(ModifyEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.name,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.name, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$

	}

	protected void createVisibilityEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		FormUtils.createPartLabel(widgetFactory, parent, UMLMessages.JoinNodePropertiesEditionPart_VisibilityLabel,
				propertiesEditionComponent.isRequired(UMLViewsRepository.JoinNode.visibility,
		...
		visibility.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.visibility,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVisibility()));
			}

		});
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.visibility, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	...
	protected void createClientDependencyReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clientDependency = new ReferencesTable<Dependency>(
				UMLMessages.JoinNodePropertiesEditionPart_ClientDependencyLabel,
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											...
											UMLViewsRepository.JoinNode.clientDependency,
		...
		this.clientDependency.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.clientDependency, UMLViewsRepository.FORM_KIND));
	...
	protected void moveClientDependency(Dependency element, int oldIndex, int newIndex) {
		...
		clientDependency.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.clientDependency,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createIsLeafCheckbox(FormToolkit widgetFactory, Composite parent) {
		...
		isLeaf.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.isLeaf,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.isLeaf, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}

	protected void createOutgoingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoing = new ReferencesTable<ActivityEdge>(UMLMessages.JoinNodePropertiesEditionPart_OutgoingLabel,
						...
						TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											JoinNodePropertiesEditionPartForm.this,
											UMLViewsRepository.JoinNode.outgoing, PropertiesEditionEvent.COMMIT,
		...
		this.outgoing.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.JoinNode.outgoing,
				UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromOutgoing(ActivityEdge element) {
		...
		outgoing.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.outgoing,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createIncomingReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incoming = new ReferencesTable<ActivityEdge>(UMLMessages.JoinNodePropertiesEditionPart_IncomingLabel,
				new ReferencesTableListener<ActivityEdge>() {
						...
						TabElementTreeSelectionDialog<ActivityEdge> dialog = new TabElementTreeSelectionDialog<ActivityEdge>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											JoinNodePropertiesEditionPartForm.this,
											UMLViewsRepository.JoinNode.incoming, PropertiesEditionEvent.COMMIT,
											PropertiesEditionEvent.ADD, null, elem));
								}
								incoming.refresh();
							}
		...
		this.incoming.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.JoinNode.incoming,
				UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromIncoming(ActivityEdge element) {
		...
		incoming.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.incoming,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createInPartitionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inPartition = new ReferencesTable<ActivityPartition>(
				UMLMessages.JoinNodePropertiesEditionPart_InPartitionLabel,
						...
						TabElementTreeSelectionDialog<ActivityPartition> dialog = new TabElementTreeSelectionDialog<ActivityPartition>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											JoinNodePropertiesEditionPartForm.this,
											UMLViewsRepository.JoinNode.inPartition, PropertiesEditionEvent.COMMIT,
											PropertiesEditionEvent.ADD, null, elem));
								}
								inPartition.refresh();
							}
		...
		this.inPartition.setHelpText(propertiesEditionComponent.getHelpContent(UMLViewsRepository.JoinNode.inPartition,
				UMLViewsRepository.FORM_KIND));
	...
	protected void moveInPartition(ActivityPartition element, int oldIndex, int newIndex) {
		...
		inPartition.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.inPartition,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createInInterruptibleRegionReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.inInterruptibleRegion = new ReferencesTable<InterruptibleActivityRegion>(
				UMLMessages.JoinNodePropertiesEditionPart_InInterruptibleRegionLabel,
						...
						TabElementTreeSelectionDialog<InterruptibleActivityRegion> dialog = new TabElementTreeSelectionDialog<InterruptibleActivityRegion>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											JoinNodePropertiesEditionPartForm.this,
											UMLViewsRepository.JoinNode.inInterruptibleRegion,
											PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
								}
		...
		this.inInterruptibleRegion.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.inInterruptibleRegion, UMLViewsRepository.FORM_KIND));
	...
	protected void moveInInterruptibleRegion(InterruptibleActivityRegion element, int oldIndex, int newIndex) {
		...
		inInterruptibleRegion.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.inInterruptibleRegion,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, editedElement, newIndex));
	}
	...
	protected void createRedefinedNodeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.redefinedNode = new ReferencesTable<ActivityNode>(
				UMLMessages.JoinNodePropertiesEditionPart_RedefinedNodeLabel,
						...
						TabElementTreeSelectionDialog<ActivityNode> dialog = new TabElementTreeSelectionDialog<ActivityNode>(
							...
							public void process(IStructuredSelection selection) {
								for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
									...
									propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
											JoinNodePropertiesEditionPartForm.this,
											UMLViewsRepository.JoinNode.redefinedNode, PropertiesEditionEvent.COMMIT,
											PropertiesEditionEvent.ADD, null, elem));
								}
		...
		this.redefinedNode.setHelpText(propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.redefinedNode, UMLViewsRepository.FORM_KIND));
	...
	protected void removeFromRedefinedNode(ActivityNode element) {
		...
		redefinedNode.refresh();
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.redefinedNode,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, editedElement));
	...
	protected void createIsCombineDuplicateCheckbox(FormToolkit widgetFactory, Composite parent) {
		isCombineDuplicate = widgetFactory.createButton(parent,
				UMLMessages.JoinNodePropertiesEditionPart_IsCombineDuplicateLabel, SWT.CHECK);
		isCombineDuplicate.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this, UMLViewsRepository.JoinNode.isCombineDuplicate,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(
									isCombineDuplicate.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				UMLViewsRepository.JoinNode.isCombineDuplicate, UMLViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initOwnedComment(EObject
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateOwnedComment(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterOwnedComment(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterOwnedComment(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#setName(String
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initVisibility(EEnum
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#setVisibility(Enumerator
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initClientDependency(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateClientDependency(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterClientDependency(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#setIsLeaf(Boolean
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initOutgoing(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateOutgoing(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterOutgoing(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterOutgoing(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initIncoming(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateIncoming(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterIncoming(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterIncoming(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initInPartition(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateInPartition(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterInPartition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterInPartition(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initInInterruptibleRegion(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateInInterruptibleRegion(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterInInterruptibleRegion(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterInInterruptibleRegion(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#initRedefinedNode(EObject
	 *      current, EReference containingFeature, EReference feature)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#updateRedefinedNode(EObject
	 *      newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addFilterRedefinedNode(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#addBusinessFilterRedefinedNode(ViewerFilter
	 *      filter)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.papyrus.tabbedproperties.uml.parts.JoinNodePropertiesEditionPart#setIsCombineDuplicate(Boolean
	 *      newValue)
	 */
