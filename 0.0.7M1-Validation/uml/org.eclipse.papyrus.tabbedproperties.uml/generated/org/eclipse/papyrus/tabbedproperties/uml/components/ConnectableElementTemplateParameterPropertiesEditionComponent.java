...
public class ConnectableElementTemplateParameterPropertiesEditionComponent extends ComposedPropertiesEditionComponent {
	 ...
	 *            the EObject to edit
	 */
	public ConnectableElementTemplateParameterPropertiesEditionComponent(EObject connectableElementTemplateParameter,
			String editing_mode) {
		super(editing_mode);
		if (connectableElementTemplateParameter instanceof ConnectableElementTemplateParameter) {
			connectableElementTemplateParameterBasePropertiesEditionComponent = new ConnectableElementTemplateParameterBasePropertiesEditionComponent(
					connectableElementTemplateParameter, editing_mode);
			addSubComponent(connectableElementTemplateParameterBasePropertiesEditionComponent);
			elementPropertiesEditionComponent = new ElementPropertiesEditionComponent(
					connectableElementTemplateParameter, editing_mode);
	...
	public IPropertiesEditionPart getPropertiesEditionPart(int kind, String key) {
		if ("Base".equals(key)) {
			basePart = (ConnectableElementTemplateParameterPropertiesEditionPart) connectableElementTemplateParameterBasePropertiesEditionComponent
