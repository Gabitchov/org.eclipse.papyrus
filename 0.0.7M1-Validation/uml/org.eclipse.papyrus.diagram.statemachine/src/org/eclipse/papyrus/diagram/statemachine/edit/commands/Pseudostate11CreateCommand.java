 ...
 * @generated
 */
public class Pseudostate11CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate11CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate11CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate11CreateCommand(req, eObject);
	}

	/**
	 * @generated
	 */
	public Pseudostate11CreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2020(newElement);
