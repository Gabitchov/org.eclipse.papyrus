...
public class Region2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Region2CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Region2CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Region2CreateCommand(req, eObject);
	}
