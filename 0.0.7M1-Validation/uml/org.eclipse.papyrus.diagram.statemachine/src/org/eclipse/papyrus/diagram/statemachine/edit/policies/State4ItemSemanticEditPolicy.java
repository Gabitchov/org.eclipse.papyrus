...
import org.eclipse.papyrus.diagram.statemachine.edit.commands.Pseudostate10CreateCommand;
import org.eclipse.papyrus.diagram.statemachine.edit.commands.Pseudostate9CreateCommand;
 ...
 * @generated
 */
public class State4ItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UMLElementTypes.Pseudostate_2018 == req.getElementType()) {
		...
		if (UMLElementTypes.Pseudostate_2019 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE
						.getState_ConnectionPoint());
			}
