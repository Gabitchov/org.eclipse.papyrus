...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate11ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate11EditPart extends BorderedBorderItemEditPart implements
	 ...
	 * @generated
	 */
	public Pseudostate11EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate11ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof PseudostateName3EditPart)
				locatorPseudostateName3EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof PseudostateName3EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorPseudostateName3EditPart(BorderItemLocator locator) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry
				.getType(PseudostateName3EditPart.VISUAL_ID));
	}
