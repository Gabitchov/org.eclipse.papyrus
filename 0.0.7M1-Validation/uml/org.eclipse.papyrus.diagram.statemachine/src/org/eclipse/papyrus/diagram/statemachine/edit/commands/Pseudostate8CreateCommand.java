...
public class Pseudostate8CreateCommand extends CreateElementCommand {
	 ...
	 * @generated
	 */
	public Pseudostate8CreateCommand(CreateElementRequest req, EObject eObject) {
		super(req);
	 ...
	 * @generated
	 */
	public static Pseudostate8CreateCommand create(CreateElementRequest req,
			EObject eObject) {
		return new Pseudostate8CreateCommand(req, eObject);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		if (newElement != null) {
			...
			UMLElementTypes.init_Pseudostate_2016(newElement);
