...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate10ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate10EditPart extends BorderedBorderItemEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate10ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof LabelEditPart) {
			...
			if (borderItemEditPart instanceof PseudostateName2EditPart)
				locatorPseudostateName2EditPart(locator);

			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof PseudostateName2EditPart) {
			BorderItemLocator locator = new BorderItemLocator(getMainFigure(),
	 ...
	 * @generated NOT
	 */
	protected void locatorPseudostateName2EditPart(BorderItemLocator locator) {
