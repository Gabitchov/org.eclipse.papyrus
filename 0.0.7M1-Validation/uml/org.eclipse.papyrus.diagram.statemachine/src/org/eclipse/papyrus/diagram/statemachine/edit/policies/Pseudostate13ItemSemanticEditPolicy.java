 ...
 * @generated
 */
public class Pseudostate13ItemSemanticEditPolicy extends
	...
	/**
	 * Modified to allow the creation of Transition links without a continer
	 * Region
	 * 
	 * @generated NOT
	 */
	protected Command getStartCreateRelationshipCommand(
		...
		if (UMLElementTypes.Transition_3001 == req.getElementType()) {
			...
			if (!UMLBaseItemSemanticEditPolicy.LinkConstraints
					.canCreateTransition_3001(container, source, null)) {
				return UnexecutableCommand.INSTANCE;
			}
			return new Command() {
			};
	...
	/**
	 * Modified to set te correct container of Transition
	 * 
	 * @generated NOT
	 */
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (UMLElementTypes.Transition_3001 == req.getElementType()) {
			...
			Region container = (Region) getRelationshipContainer(target,
