...
import org.eclipse.papyrus.diagram.statemachine.edit.policies.Pseudostate8ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Pseudostate8EditPart extends ShapeNodeEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Pseudostate8ItemSemanticEditPolicy());
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode()
				.DPtoLP(30), getMapMode().DPtoLP(25));
		return result;
	}
