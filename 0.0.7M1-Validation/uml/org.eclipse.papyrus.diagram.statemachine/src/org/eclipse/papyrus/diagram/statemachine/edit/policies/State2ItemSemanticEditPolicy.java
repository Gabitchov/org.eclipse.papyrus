...
import org.eclipse.papyrus.diagram.statemachine.edit.commands.Pseudostate11CreateCommand;
import org.eclipse.papyrus.diagram.statemachine.edit.commands.Pseudostate12CreateCommand;
import org.eclipse.papyrus.diagram.statemachine.edit.commands.Region2CreateCommand;
...
public class State2ItemSemanticEditPolicy extends UMLBaseItemSemanticEditPolicy {
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (UMLElementTypes.Region_2004 == req.getElementType()) {
		...
		if (UMLElementTypes.Pseudostate_2020 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE
						.getState_ConnectionPoint());
			}
			return getGEFWrapper(new Pseudostate11CreateCommand(req));
		}
		if (UMLElementTypes.Pseudostate_2021 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(UMLPackage.eINSTANCE
						.getState_ConnectionPoint());
			}
			return getGEFWrapper(new Pseudostate12CreateCommand(req));
		}
